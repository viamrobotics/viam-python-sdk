...
from viam.components.arm import Arm, ArmProperties, JointPositions, KinematicsFileFormat
...
class MockArm(Arm):
    def __init__(self, name: str):
        ...
        self.manual_mode_enabled_for = 0
        self.properties = ArmProperties(support_manual_mode=True, support_cartesian_commands=True)
        super().__init__(name)
    ...
    async def set_manual_mode(
        ...
        **kwargs,
        ...
        self.manual_mode_enabled_for = enabled_for
        self.extra = extra
        self.timeout = timeout
