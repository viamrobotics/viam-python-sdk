...
class _NavigationServiceModeEnumTypeWrapper(google.protobuf.internal.enum_type_wrapper._EnumTypeWrapper[_NavigationServiceMode.ValueType], builtins.type):
    ...
    NAVIGATION_SERVICE_MODE_UNSPECIFIED: NavigationServiceMode.ValueType = ...  # 0
    NAVIGATION_SERVICE_MODE_MANUAL: NavigationServiceMode.ValueType = ...  # 1
    NAVIGATION_SERVICE_MODE_WAYPOINT: NavigationServiceMode.ValueType = ...  # 2
...
class StatusStreamRequest(google.protobuf.message.Message):
    ...
    def __init__(self,
        *,
        every : typing.Optional[google.protobuf.duration_pb2.Duration] = ...,
        ) -> None: ...
...
class Status(google.protobuf.message.Message):
    ...
    class ArmsEntry(google.protobuf.message.Message):
        ...
        def __init__(self,
            *,
            key : typing.Text = ...,
            value : typing.Optional[global___ArmStatus] = ...,
            ) -> None: ...
    ...
    class BoardsEntry(google.protobuf.message.Message):
        ...
        def __init__(self,
            *,
            key : typing.Text = ...,
            value : typing.Optional[proto.api.common.v1.common_pb2.BoardStatus] = ...,
            ) -> None: ...
        def HasField(self, field_name: typing_extensions.Literal["value",b"value"]) -> builtins.bool: ...
        def ClearField(self, field_name: typing_extensions.Literal["key",b"key","value",b"value"]) -> None: ...
    ...
    class SensorsEntry(google.protobuf.message.Message):
        ...
        def __init__(self,
            *,
            key : typing.Text = ...,
            value : typing.Optional[global___SensorStatus] = ...,
            ) -> None: ...
        def HasField(self, field_name: typing_extensions.Literal["value",b"value"]) -> builtins.bool: ...
        def ClearField(self, field_name: typing_extensions.Literal["key",b"key","value",b"value"]) -> None: ...
    ...
    class ServosEntry(google.protobuf.message.Message):
        ...
        def __init__(self,
            *,
            key : typing.Text = ...,
            value : typing.Optional[global___ServoStatus] = ...,
            ) -> None: ...
        def HasField(self, field_name: typing_extensions.Literal["value",b"value"]) -> builtins.bool: ...
        def ClearField(self, field_name: typing_extensions.Literal["key",b"key","value",b"value"]) -> None: ...
    ...
    class MotorsEntry(google.protobuf.message.Message):
        ...
        def __init__(self,
            *,
            key : typing.Text = ...,
            value : typing.Optional[global___MotorStatus] = ...,
            ) -> None: ...
        def HasField(self, field_name: typing_extensions.Literal["value",b"value"]) -> builtins.bool: ...
        def ClearField(self, field_name: typing_extensions.Literal["key",b"key","value",b"value"]) -> None: ...
    ...
    class InputControllersEntry(google.protobuf.message.Message):
        ...
        def __init__(self,
            *,
            key : typing.Text = ...,
            value : typing.Optional[global___InputControllerStatus] = ...,
            ) -> None: ...
        def HasField(self, field_name: typing_extensions.Literal["value",b"value"]) -> builtins.bool: ...
        def ClearField(self, field_name: typing_extensions.Literal["key",b"key","value",b"value"]) -> None: ...
    ...
    class GantriesEntry(google.protobuf.message.Message):
        ...
        def __init__(self,
            *,
            key : typing.Text = ...,
            value : typing.Optional[global___GantryStatus] = ...,
            ) -> None: ...
        def HasField(self, field_name: typing_extensions.Literal["value",b"value"]) -> builtins.bool: ...
        def ClearField(self, field_name: typing_extensions.Literal["key",b"key","value",b"value"]) -> None: ...
    ...
    def __init__(self,
        *,
        arms : typing.Optional[typing.Mapping[typing.Text, global___ArmStatus]] = ...,
        bases : typing.Optional[typing.Mapping[typing.Text, builtins.bool]] = ...,
        grippers : typing.Optional[typing.Mapping[typing.Text, builtins.bool]] = ...,
        boards : typing.Optional[typing.Mapping[typing.Text, proto.api.common.v1.common_pb2.BoardStatus]] = ...,
        cameras : typing.Optional[typing.Mapping[typing.Text, builtins.bool]] = ...,
        sensors : typing.Optional[typing.Mapping[typing.Text, global___SensorStatus]] = ...,
        functions : typing.Optional[typing.Mapping[typing.Text, builtins.bool]] = ...,
        servos : typing.Optional[typing.Mapping[typing.Text, global___ServoStatus]] = ...,
        motors : typing.Optional[typing.Mapping[typing.Text, global___MotorStatus]] = ...,
        services : typing.Optional[typing.Mapping[typing.Text, builtins.bool]] = ...,
        input_controllers : typing.Optional[typing.Mapping[typing.Text, global___InputControllerStatus]] = ...,
        gantries : typing.Optional[typing.Mapping[typing.Text, global___GantryStatus]] = ...,
        ) -> None: ...
...
class ConfigResponse(google.protobuf.message.Message):
    ...
    def __init__(self,
        *,
        components : typing.Optional[typing.Iterable[global___ComponentConfig]] = ...,
        ) -> None: ...
...
class ArmStatus(google.protobuf.message.Message):
    ...
    def __init__(self,
        *,
        grid_position : typing.Optional[global___Pose] = ...,
        joint_positions : typing.Optional[global___JointPositions] = ...,
        ) -> None: ...
...
class FrameSystemConfig(google.protobuf.message.Message):
    ...
    def __init__(self,
        *,
        name : typing.Text = ...,
        frame_config : typing.Optional[global___FrameConfig] = ...,
        model_json : builtins.bytes = ...,
        ) -> None: ...
...
class FrameServiceConfigResponse(google.protobuf.message.Message):
    ...
    def __init__(self,
        *,
        frame_system_configs : typing.Optional[typing.Iterable[global___FrameSystemConfig]] = ...,
        ) -> None: ...
...
class ExecuteFunctionResponse(google.protobuf.message.Message):
    ...
    def __init__(self,
        *,
        results : typing.Optional[typing.Iterable[google.protobuf.struct_pb2.Value]] = ...,
        std_out : typing.Text = ...,
        std_err : typing.Text = ...,
        ) -> None: ...
...
class MotorStatus(google.protobuf.message.Message):
    ...
    def __init__(self,
        *,
        ...
        position_supported : builtins.bool = ...,
        position : builtins.float = ...,
        pid_config : typing.Optional[google.protobuf.struct_pb2.Struct] = ...,
        ) -> None: ...
...
class ResourceRunCommandResponse(google.protobuf.message.Message):
    ...
    def __init__(self,
        *,
        result : typing.Optional[google.protobuf.struct_pb2.Struct] = ...,
        ) -> None: ...
...
class NavigationServiceWaypoint(google.protobuf.message.Message):
    ...
    def __init__(self,
        *,
        id : typing.Text = ...,
        location : typing.Optional[proto.api.common.v1.common_pb2.GeoPoint] = ...,
        ) -> None: ...
...
class NavigationServiceWaypointsResponse(google.protobuf.message.Message):
    ...
    def __init__(self,
        *,
        waypoints : typing.Optional[typing.Iterable[global___NavigationServiceWaypoint]] = ...,
        ) -> None: ...
...
class ObjectManipulationServiceDoGrabRequest(google.protobuf.message.Message):
    ...
    def __init__(self,
        *,
        camera_name : typing.Text = ...,
        camera_point : typing.Optional[global___Vector3] = ...,
        gripper_name : typing.Text = ...,
        arm_name : typing.Text = ...,
        ) -> None: ...
...
class InputControllerStatus(google.protobuf.message.Message):
    ...
    def __init__(self,
        *,
        events : typing.Optional[typing.Iterable[global___InputControllerEvent]] = ...,
        ) -> None: ...
