...
class StructuredQuery(google.protobuf.message.Message):
    ...
    class FieldFilter(google.protobuf.message.Message):
        ...
        * That `field` comes first in the `order_by`.
        ...
        @property
        def value(self) -> google.firestore.v1.document_pb2.Value:
        ...
        def __init__(self,
            *,
            ...
            op : global___StructuredQuery.FieldFilter.Operator.ValueType = ...,
            value : typing.Optional[google.firestore.v1.document_pb2.Value] = ...,
            ) -> None: ...
...
class Cursor(google.protobuf.message.Message):
    ...
    @property
    def values(self) -> google.protobuf.internal.containers.RepeatedCompositeFieldContainer[google.firestore.v1.document_pb2.Value]:
    ...
    def __init__(self,
        *,
        values : typing.Optional[typing.Iterable[google.firestore.v1.document_pb2.Value]] = ...,
        before : builtins.bool = ...,
        ) -> None: ...
