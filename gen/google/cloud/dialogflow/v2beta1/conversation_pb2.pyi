...
class CreateMessageRequest(google.protobuf.message.Message):
    ...
    @property
    def message(self) -> google.cloud.dialogflow.v2beta1.participant_pb2.Message:
    ...
    def __init__(self,
        *,
        parent : typing.Text = ...,
        message : typing.Optional[google.cloud.dialogflow.v2beta1.participant_pb2.Message] = ...,
        ) -> None: ...
    def HasField(self, field_name: typing_extensions.Literal["message",b"message"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["message",b"message","parent",b"parent"]) -> None: ...
global___CreateMessageRequest = CreateMessageRequest

class BatchCreateMessagesRequest(google.protobuf.message.Message):
    ...
    @property
    def requests(self) -> google.protobuf.internal.containers.RepeatedCompositeFieldContainer[global___CreateMessageRequest]:
    ...
    def __init__(self,
        *,
        parent : typing.Text = ...,
        requests : typing.Optional[typing.Iterable[global___CreateMessageRequest]] = ...,
        ) -> None: ...
    def ClearField(self, field_name: typing_extensions.Literal["parent",b"parent","requests",b"requests"]) -> None: ...
global___BatchCreateMessagesRequest = BatchCreateMessagesRequest

class BatchCreateMessagesResponse(google.protobuf.message.Message):
    """The request message for [Conversations.BatchCreateMessagesResponse][]."""
    DESCRIPTOR: google.protobuf.descriptor.Descriptor = ...
    MESSAGES_FIELD_NUMBER: builtins.int
    @property
    def messages(self) -> google.protobuf.internal.containers.RepeatedCompositeFieldContainer[google.cloud.dialogflow.v2beta1.participant_pb2.Message]:
        """Messages created."""
        pass
    def __init__(self,
        *,
        messages : typing.Optional[typing.Iterable[google.cloud.dialogflow.v2beta1.participant_pb2.Message]] = ...,
        ) -> None: ...
    def ClearField(self, field_name: typing_extensions.Literal["messages",b"messages"]) -> None: ...
global___BatchCreateMessagesResponse = BatchCreateMessagesResponse
