...
class DetectIntentRequest(google.protobuf.message.Message):
    ...
    def query_input(self) -> global___QueryInput:
        ...
        pass
    @property
    def output_audio_config(self) -> google.cloud.dialogflow.v2beta1.audio_config_pb2.OutputAudioConfig:
    ...
    def __init__(self,
        *,
        ...
        output_audio_config : typing.Optional[google.cloud.dialogflow.v2beta1.audio_config_pb2.OutputAudioConfig] = ...,
...
class DetectIntentResponse(google.protobuf.message.Message):
    ...
    def query_result(self) -> global___QueryResult:
        ...
        pass
    @property
    def alternative_query_results(self) -> google.protobuf.internal.containers.RepeatedCompositeFieldContainer[global___QueryResult]:
    ...
    def __init__(self,
        *,
        ...
        alternative_query_results : typing.Optional[typing.Iterable[global___QueryResult]] = ...,
    ...
    def ClearField(self, field_name: typing_extensions.Literal["alternative_query_results",b"alternative_query_results","output_audio",b"output_audio","output_audio_config",b"output_audio_config","query_result",b"query_result","response_id",b"response_id","webhook_status",b"webhook_status"]) -> None: ...
...
class QueryParameters(google.protobuf.message.Message):
    ...
    KNOWLEDGE_BASE_NAMES_FIELD_NUMBER: builtins.int
    SENTIMENT_ANALYSIS_REQUEST_CONFIG_FIELD_NUMBER: builtins.int
    SUB_AGENTS_FIELD_NUMBER: builtins.int
    ...
    def geo_location(self) -> google.type.latlng_pb2.LatLng:
        ...
        pass
    @property
    def contexts(self) -> google.protobuf.internal.containers.RepeatedCompositeFieldContainer[google.cloud.dialogflow.v2beta1.context_pb2.Context]:
    ...
    def payload(self) -> google.protobuf.struct_pb2.Struct:
        ...
        pass
    @property
    def knowledge_base_names(self) -> google.protobuf.internal.containers.RepeatedScalarFieldContainer[typing.Text]:
    ...
    def sentiment_analysis_request_config(self) -> global___SentimentAnalysisRequestConfig:
        ...
        pass
    @property
    def sub_agents(self) -> google.protobuf.internal.containers.RepeatedCompositeFieldContainer[google.cloud.dialogflow.v2beta1.agent_pb2.SubAgent]:
    ...
    def __init__(self,
        *,
        ...
        contexts : typing.Optional[typing.Iterable[google.cloud.dialogflow.v2beta1.context_pb2.Context]] = ...,
        reset_contexts : builtins.bool = ...,
        ...
        knowledge_base_names : typing.Optional[typing.Iterable[typing.Text]] = ...,
        sentiment_analysis_request_config : typing.Optional[global___SentimentAnalysisRequestConfig] = ...,
        sub_agents : typing.Optional[typing.Iterable[google.cloud.dialogflow.v2beta1.agent_pb2.SubAgent]] = ...,
    ...
    def ClearField(self, field_name: typing_extensions.Literal["contexts",b"contexts","geo_location",b"geo_location","knowledge_base_names",b"knowledge_base_names","payload",b"payload","reset_contexts",b"reset_contexts","sentiment_analysis_request_config",b"sentiment_analysis_request_config","session_entity_types",b"session_entity_types","sub_agents",b"sub_agents","time_zone",b"time_zone","webhook_headers",b"webhook_headers"]) -> None: ...
...
class QueryInput(google.protobuf.message.Message):
    ...
    @property
    def audio_config(self) -> google.cloud.dialogflow.v2beta1.audio_config_pb2.InputAudioConfig:
        """Instructs the speech recognizer how to process the speech audio."""
        pass
    @property
    ...
    def event(self) -> global___EventInput:
        ...
        pass
    @property
    def dtmf(self) -> google.cloud.dialogflow.v2beta1.audio_config_pb2.TelephonyDtmfEvents:
        """The DTMF digits used to invoke intent and fill in parameter value."""
        pass
    def __init__(self,
        *,
        audio_config : typing.Optional[google.cloud.dialogflow.v2beta1.audio_config_pb2.InputAudioConfig] = ...,
        text : typing.Optional[global___TextInput] = ...,
        event : typing.Optional[global___EventInput] = ...,
        dtmf : typing.Optional[google.cloud.dialogflow.v2beta1.audio_config_pb2.TelephonyDtmfEvents] = ...,
        ) -> None: ...
    def HasField(self, field_name: typing_extensions.Literal["audio_config",b"audio_config","dtmf",b"dtmf","event",b"event","input",b"input","text",b"text"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["audio_config",b"audio_config","dtmf",b"dtmf","event",b"event","input",b"input","text",b"text"]) -> None: ...
    def WhichOneof(self, oneof_group: typing_extensions.Literal["input",b"input"]) -> typing.Optional[typing_extensions.Literal["audio_config","text","event","dtmf"]]: ...
...
class QueryResult(google.protobuf.message.Message):
    ...
    KNOWLEDGE_ANSWERS_FIELD_NUMBER: builtins.int
    ...
    def output_contexts(self) -> google.protobuf.internal.containers.RepeatedCompositeFieldContainer[google.cloud.dialogflow.v2beta1.context_pb2.Context]:
        ...
        pass
    @property
    def intent(self) -> google.cloud.dialogflow.v2beta1.intent_pb2.Intent:
    ...
    def sentiment_analysis_result(self) -> global___SentimentAnalysisResult:
        ...
        pass
    @property
    def knowledge_answers(self) -> global___KnowledgeAnswers:
    ...
    def __init__(self,
        *,
        ...
        intent : typing.Optional[google.cloud.dialogflow.v2beta1.intent_pb2.Intent] = ...,
        intent_detection_confidence : builtins.float = ...,
        ...
        knowledge_answers : typing.Optional[global___KnowledgeAnswers] = ...,
        ) -> None: ...
    def HasField(self, field_name: typing_extensions.Literal["diagnostic_info",b"diagnostic_info","intent",b"intent","knowledge_answers",b"knowledge_answers","parameters",b"parameters","sentiment_analysis_result",b"sentiment_analysis_result","webhook_payload",b"webhook_payload"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["action",b"action","all_required_params_present",b"all_required_params_present","cancels_slot_filling",b"cancels_slot_filling","diagnostic_info",b"diagnostic_info","fulfillment_messages",b"fulfillment_messages","fulfillment_text",b"fulfillment_text","intent",b"intent","intent_detection_confidence",b"intent_detection_confidence","knowledge_answers",b"knowledge_answers","language_code",b"language_code","output_contexts",b"output_contexts","parameters",b"parameters","query_text",b"query_text","sentiment_analysis_result",b"sentiment_analysis_result","speech_recognition_confidence",b"speech_recognition_confidence","webhook_payload",b"webhook_payload","webhook_source",b"webhook_source"]) -> None: ...
global___QueryResult = QueryResult

class KnowledgeAnswers(google.protobuf.message.Message):
    """Represents the result of querying a Knowledge base."""
    DESCRIPTOR: google.protobuf.descriptor.Descriptor = ...
    class Answer(google.protobuf.message.Message):
        """An answer from Knowledge Connector."""
        DESCRIPTOR: google.protobuf.descriptor.Descriptor = ...
        class _MatchConfidenceLevel:
            ValueType = typing.NewType('ValueType', builtins.int)
            V: typing_extensions.TypeAlias = ValueType
        class _MatchConfidenceLevelEnumTypeWrapper(google.protobuf.internal.enum_type_wrapper._EnumTypeWrapper[_MatchConfidenceLevel.ValueType], builtins.type):
            DESCRIPTOR: google.protobuf.descriptor.EnumDescriptor = ...
            MATCH_CONFIDENCE_LEVEL_UNSPECIFIED: KnowledgeAnswers.Answer.MatchConfidenceLevel.ValueType = ...  # 0
            """Not specified."""

            LOW: KnowledgeAnswers.Answer.MatchConfidenceLevel.ValueType = ...  # 1
            """Indicates that the confidence is low."""

            MEDIUM: KnowledgeAnswers.Answer.MatchConfidenceLevel.ValueType = ...  # 2
            """Indicates our confidence is medium."""

            HIGH: KnowledgeAnswers.Answer.MatchConfidenceLevel.ValueType = ...  # 3
            """Indicates our confidence is high."""

        class MatchConfidenceLevel(_MatchConfidenceLevel, metaclass=_MatchConfidenceLevelEnumTypeWrapper):
        ...
        FAQ_QUESTION_FIELD_NUMBER: builtins.int
        ANSWER_FIELD_NUMBER: builtins.int
        MATCH_CONFIDENCE_LEVEL_FIELD_NUMBER: builtins.int
        ...
        match_confidence_level: global___KnowledgeAnswers.Answer.MatchConfidenceLevel.ValueType = ...
        ...
        def ClearField(self, field_name: typing_extensions.Literal["answer",b"answer","faq_question",b"faq_question","match_confidence",b"match_confidence","match_confidence_level",b"match_confidence_level","source",b"source"]) -> None: ...

    ANSWERS_FIELD_NUMBER: builtins.int
    @property
    def answers(self) -> google.protobuf.internal.containers.RepeatedCompositeFieldContainer[global___KnowledgeAnswers.Answer]:
        """A list of answers from Knowledge Connector."""
        pass
    def __init__(self,
        *,
        answers : typing.Optional[typing.Iterable[global___KnowledgeAnswers.Answer]] = ...,
        ) -> None: ...
    def ClearField(self, field_name: typing_extensions.Literal["answers",b"answers"]) -> None: ...
global___KnowledgeAnswers = KnowledgeAnswers
...
class StreamingDetectIntentResponse(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing_extensions.Literal["alternative_query_results",b"alternative_query_results","output_audio",b"output_audio","output_audio_config",b"output_audio_config","query_result",b"query_result","recognition_result",b"recognition_result","response_id",b"response_id","webhook_status",b"webhook_status"]) -> None: ...
...
class StreamingRecognitionResult(google.protobuf.message.Message):
    ...
    class _MessageTypeEnumTypeWrapper(google.protobuf.internal.enum_type_wrapper._EnumTypeWrapper[_MessageType.ValueType], builtins.type):
        ...
        DTMF_DIGITS: StreamingRecognitionResult.MessageType.ValueType = ...  # 3
        ...
        PARTIAL_DTMF_DIGITS: StreamingRecognitionResult.MessageType.ValueType = ...  # 4
    ...
    LANGUAGE_CODE_FIELD_NUMBER: builtins.int
    DTMF_DIGITS_FIELD_NUMBER: builtins.int
    ...
    * Otherwise, the value is in (0.0, 1.0] where 0.0 means completely
    ...
    @property
    def speech_word_info(self) -> google.protobuf.internal.containers.RepeatedCompositeFieldContainer[google.cloud.dialogflow.v2beta1.audio_config_pb2.SpeechWordInfo]:
    ...
    @property
    def dtmf_digits(self) -> google.cloud.dialogflow.v2beta1.audio_config_pb2.TelephonyDtmfEvents:
    ...
    def __init__(self,
        *,
        ...
        confidence : builtins.float = ...,
        stability : builtins.float = ...,
        speech_word_info : typing.Optional[typing.Iterable[google.cloud.dialogflow.v2beta1.audio_config_pb2.SpeechWordInfo]] = ...,
        speech_end_offset : typing.Optional[google.protobuf.duration_pb2.Duration] = ...,
        language_code : typing.Text = ...,
        dtmf_digits : typing.Optional[google.cloud.dialogflow.v2beta1.audio_config_pb2.TelephonyDtmfEvents] = ...,
        ) -> None: ...
    def HasField(self, field_name: typing_extensions.Literal["dtmf_digits",b"dtmf_digits","speech_end_offset",b"speech_end_offset"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["confidence",b"confidence","dtmf_digits",b"dtmf_digits","is_final",b"is_final","language_code",b"language_code","message_type",b"message_type","speech_end_offset",b"speech_end_offset","speech_word_info",b"speech_word_info","stability",b"stability","transcript",b"transcript"]) -> None: ...
