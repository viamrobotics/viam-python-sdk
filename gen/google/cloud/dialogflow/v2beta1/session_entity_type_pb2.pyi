...
class SessionEntityType(google.protobuf.message.Message):
    ...
    @property
    def entities(self) -> google.protobuf.internal.containers.RepeatedCompositeFieldContainer[google.cloud.dialogflow.v2beta1.entity_type_pb2.EntityType.Entity]:
    ...
    def __init__(self,
        *,
        name : typing.Text = ...,
        entity_override_mode : global___SessionEntityType.EntityOverrideMode.ValueType = ...,
        entities : typing.Optional[typing.Iterable[google.cloud.dialogflow.v2beta1.entity_type_pb2.EntityType.Entity]] = ...,
        ) -> None: ...
