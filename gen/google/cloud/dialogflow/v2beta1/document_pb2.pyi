...
class Document(google.protobuf.message.Message):
    ...
    class _KnowledgeTypeEnumTypeWrapper(google.protobuf.internal.enum_type_wrapper._EnumTypeWrapper[_KnowledgeType.ValueType], builtins.type):
        ...
        SMART_REPLY: Document.KnowledgeType.ValueType = ...  # 4
    ...
    def HasField(self, field_name: typing_extensions.Literal["content",b"content","content_uri",b"content_uri","latest_reload_status",b"latest_reload_status","raw_content",b"raw_content","source",b"source"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["content",b"content","content_uri",b"content_uri","display_name",b"display_name","enable_auto_reload",b"enable_auto_reload","knowledge_types",b"knowledge_types","latest_reload_status",b"latest_reload_status","metadata",b"metadata","mime_type",b"mime_type","name",b"name","raw_content",b"raw_content","source",b"source"]) -> None: ...
    def WhichOneof(self, oneof_group: typing_extensions.Literal["source",b"source"]) -> typing.Optional[typing_extensions.Literal["content_uri","content","raw_content"]]: ...
...
class CreateDocumentRequest(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing_extensions.Literal["document",b"document","import_gcs_custom_metadata",b"import_gcs_custom_metadata","parent",b"parent"]) -> None: ...
...
class ImportDocumentsRequest(google.protobuf.message.Message):
    ...
    @property
    def gcs_source(self) -> google.cloud.dialogflow.v2beta1.gcs_pb2.GcsSources:
    ...
    def __init__(self,
        *,
        parent : typing.Text = ...,
        gcs_source : typing.Optional[google.cloud.dialogflow.v2beta1.gcs_pb2.GcsSources] = ...,
...
class ReloadDocumentRequest(google.protobuf.message.Message):
    ...
    @property
    def gcs_source(self) -> google.cloud.dialogflow.v2beta1.gcs_pb2.GcsSource:
    ...
    def __init__(self,
        *,
        name : typing.Text = ...,
        gcs_source : typing.Optional[google.cloud.dialogflow.v2beta1.gcs_pb2.GcsSource] = ...,
        import_gcs_custom_metadata : builtins.bool = ...,
        ) -> None: ...
    def HasField(self, field_name: typing_extensions.Literal["gcs_source",b"gcs_source","source",b"source"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["gcs_source",b"gcs_source","import_gcs_custom_metadata",b"import_gcs_custom_metadata","name",b"name","source",b"source"]) -> None: ...
    def WhichOneof(self, oneof_group: typing_extensions.Literal["source",b"source"]) -> typing.Optional[typing_extensions.Literal["gcs_source"]]: ...
