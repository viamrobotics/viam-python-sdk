...
class WebhookRequest(google.protobuf.message.Message):
    ...
    @property
    def query_result(self) -> google.cloud.dialogflow.v2.session_pb2.QueryResult:
    ...
    def __init__(self,
        *,
        session : typing.Text = ...,
        response_id : typing.Text = ...,
        query_result : typing.Optional[google.cloud.dialogflow.v2.session_pb2.QueryResult] = ...,
    ...
    def ClearField(self, field_name: typing_extensions.Literal["original_detect_intent_request",b"original_detect_intent_request","query_result",b"query_result","response_id",b"response_id","session",b"session"]) -> None: ...
...
class WebhookResponse(google.protobuf.message.Message):
    ...
    def output_contexts(self) -> google.protobuf.internal.containers.RepeatedCompositeFieldContainer[google.cloud.dialogflow.v2.context_pb2.Context]:
        ...
        pass
    @property
    def followup_event_input(self) -> google.cloud.dialogflow.v2.session_pb2.EventInput:
    ...
    def __init__(self,
        *,
        ...
        followup_event_input : typing.Optional[google.cloud.dialogflow.v2.session_pb2.EventInput] = ...,
