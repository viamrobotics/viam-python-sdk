...
class ConversationTurn(google.protobuf.message.Message):
    ...
    class UserInput(google.protobuf.message.Message):
        ...
        @property
        def input(self) -> google.cloud.dialogflow.cx.v3.session_pb2.QueryInput:
        ...
        def __init__(self,
            *,
            input : typing.Optional[google.cloud.dialogflow.cx.v3.session_pb2.QueryInput] = ...,
    ...
    class VirtualAgentOutput(google.protobuf.message.Message):
        ...
        def diagnostic_info(self) -> google.protobuf.struct_pb2.Struct:
            ...
            pass
        @property
        def triggered_intent(self) -> google.cloud.dialogflow.cx.v3.intent_pb2.Intent:
        ...
        def current_page(self) -> google.cloud.dialogflow.cx.v3.page_pb2.Page:
            ...
            pass
        @property
        def text_responses(self) -> google.protobuf.internal.containers.RepeatedCompositeFieldContainer[google.cloud.dialogflow.cx.v3.response_message_pb2.ResponseMessage.Text]:
        ...
        def __init__(self,
            *,
            ...
            triggered_intent : typing.Optional[google.cloud.dialogflow.cx.v3.intent_pb2.Intent] = ...,
            current_page : typing.Optional[google.cloud.dialogflow.cx.v3.page_pb2.Page] = ...,
            text_responses : typing.Optional[typing.Iterable[google.cloud.dialogflow.cx.v3.response_message_pb2.ResponseMessage.Text]] = ...,
...
class TransitionCoverage(google.protobuf.message.Message):
    ...
    class TransitionNode(google.protobuf.message.Message):
        ...
        FLOW_FIELD_NUMBER: builtins.int
        @property
        def page(self) -> google.cloud.dialogflow.cx.v3.page_pb2.Page:
            ...
            pass
        @property
        def flow(self) -> google.cloud.dialogflow.cx.v3.flow_pb2.Flow:
        ...
        def __init__(self,
            *,
            page : typing.Optional[google.cloud.dialogflow.cx.v3.page_pb2.Page] = ...,
            flow : typing.Optional[google.cloud.dialogflow.cx.v3.flow_pb2.Flow] = ...,
            ) -> None: ...
    ...
    class Transition(google.protobuf.message.Message):
        ...
        @property
        def transition_route(self) -> google.cloud.dialogflow.cx.v3.page_pb2.TransitionRoute:
            """Intent route or condition route."""
            pass
        @property
        def event_handler(self) -> google.cloud.dialogflow.cx.v3.page_pb2.EventHandler:
            """Event handler."""
            pass
        def __init__(self,
            *,
            ...
            covered : builtins.bool = ...,
            transition_route : typing.Optional[google.cloud.dialogflow.cx.v3.page_pb2.TransitionRoute] = ...,
            event_handler : typing.Optional[google.cloud.dialogflow.cx.v3.page_pb2.EventHandler] = ...,
            ) -> None: ...
...
class TransitionRouteGroupCoverage(google.protobuf.message.Message):
    ...
    class Coverage(google.protobuf.message.Message):
        ...
        COVERAGE_SCORE_FIELD_NUMBER: builtins.int
        @property
        def route_group(self) -> google.cloud.dialogflow.cx.v3.transition_route_group_pb2.TransitionRouteGroup:
        ...
        def __init__(self,
            *,
            route_group : typing.Optional[google.cloud.dialogflow.cx.v3.transition_route_group_pb2.TransitionRouteGroup] = ...,
