...
class Page(google.protobuf.message.Message):
    ...
    @property
    def entry_fulfillment(self) -> google.cloud.dialogflow.cx.v3.fulfillment_pb2.Fulfillment:
    ...
    def __init__(self,
        *,
        name : typing.Text = ...,
        display_name : typing.Text = ...,
        entry_fulfillment : typing.Optional[google.cloud.dialogflow.cx.v3.fulfillment_pb2.Fulfillment] = ...,
...
class Form(google.protobuf.message.Message):
    ...
    class Parameter(google.protobuf.message.Message):
        ...
        class FillBehavior(google.protobuf.message.Message):
            ...
            @property
            def initial_prompt_fulfillment(self) -> google.cloud.dialogflow.cx.v3.fulfillment_pb2.Fulfillment:
            ...
            def __init__(self,
                *,
                initial_prompt_fulfillment : typing.Optional[google.cloud.dialogflow.cx.v3.fulfillment_pb2.Fulfillment] = ...,
...
class EventHandler(google.protobuf.message.Message):
    ...
    *   If there is a [`target_flow`][google.cloud.dialogflow.cx.v3.EventHandler.target_flow] associated
    ...
    @property
    def trigger_fulfillment(self) -> google.cloud.dialogflow.cx.v3.fulfillment_pb2.Fulfillment:
    ...
    def __init__(self,
        *,
        name : typing.Text = ...,
        event : typing.Text = ...,
        trigger_fulfillment : typing.Optional[google.cloud.dialogflow.cx.v3.fulfillment_pb2.Fulfillment] = ...,
        target_page : typing.Text = ...,
        target_flow : typing.Text = ...,
        ) -> None: ...
