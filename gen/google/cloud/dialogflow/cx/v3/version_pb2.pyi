...
class Version(google.protobuf.message.Message):
    ...
    @property
    def nlu_settings(self) -> google.cloud.dialogflow.cx.v3.flow_pb2.NluSettings:
    ...
    def __init__(self,
        *,
        ...
        display_name : typing.Text = ...,
        description : typing.Text = ...,
        nlu_settings : typing.Optional[google.cloud.dialogflow.cx.v3.flow_pb2.NluSettings] = ...,
