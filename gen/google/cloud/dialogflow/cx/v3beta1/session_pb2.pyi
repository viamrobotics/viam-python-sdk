...
class DetectIntentRequest(google.protobuf.message.Message):
    ...
    def query_input(self) -> global___QueryInput:
        ...
        pass
    @property
    def output_audio_config(self) -> google.cloud.dialogflow.cx.v3beta1.audio_config_pb2.OutputAudioConfig:
    ...
    def __init__(self,
        *,
        ...
        output_audio_config : typing.Optional[google.cloud.dialogflow.cx.v3beta1.audio_config_pb2.OutputAudioConfig] = ...,
        ) -> None: ...
...
class StreamingRecognitionResult(google.protobuf.message.Message):
    ...
    * Otherwise, the value is in (0.0, 1.0] where 0.0 means completely
    ...
    @property
    def speech_word_info(self) -> google.protobuf.internal.containers.RepeatedCompositeFieldContainer[google.cloud.dialogflow.cx.v3beta1.audio_config_pb2.SpeechWordInfo]:
    ...
    def __init__(self,
        *,
        ...
        confidence : builtins.float = ...,
        stability : builtins.float = ...,
        speech_word_info : typing.Optional[typing.Iterable[google.cloud.dialogflow.cx.v3beta1.audio_config_pb2.SpeechWordInfo]] = ...,
...
class QueryParameters(google.protobuf.message.Message):
    ...
    def geo_location(self) -> google.type.latlng_pb2.LatLng:
        ...
        pass
    @property
    def session_entity_types(self) -> google.protobuf.internal.containers.RepeatedCompositeFieldContainer[google.cloud.dialogflow.cx.v3beta1.session_entity_type_pb2.SessionEntityType]:
    ...
    def __init__(self,
        *,
        ...
        session_entity_types : typing.Optional[typing.Iterable[google.cloud.dialogflow.cx.v3beta1.session_entity_type_pb2.SessionEntityType]] = ...,
...
class QueryResult(google.protobuf.message.Message):
    ...
    def parameters(self) -> google.protobuf.struct_pb2.Struct:
        ...
        pass
    @property
    def response_messages(self) -> google.protobuf.internal.containers.RepeatedCompositeFieldContainer[google.cloud.dialogflow.cx.v3beta1.response_message_pb2.ResponseMessage]:
    ...
    def current_page(self) -> google.cloud.dialogflow.cx.v3beta1.page_pb2.Page:
        ...
        pass
    @property
    def intent(self) -> google.cloud.dialogflow.cx.v3beta1.intent_pb2.Intent:
    ...
    def __init__(self,
        *,
        ...
        language_code : typing.Text = ...,
        parameters : typing.Optional[google.protobuf.struct_pb2.Struct] = ...,
        response_messages : typing.Optional[typing.Iterable[google.cloud.dialogflow.cx.v3beta1.response_message_pb2.ResponseMessage]] = ...,
        ...
        intent : typing.Optional[google.cloud.dialogflow.cx.v3beta1.intent_pb2.Intent] = ...,
        intent_detection_confidence : builtins.float = ...,
...
class AudioInput(google.protobuf.message.Message):
    ...
    AUDIO_FIELD_NUMBER: builtins.int
    @property
    def config(self) -> google.cloud.dialogflow.cx.v3beta1.audio_config_pb2.InputAudioConfig:
    ...
    def __init__(self,
        *,
        config : typing.Optional[google.cloud.dialogflow.cx.v3beta1.audio_config_pb2.InputAudioConfig] = ...,
        audio : builtins.bytes = ...,
        ) -> None: ...
