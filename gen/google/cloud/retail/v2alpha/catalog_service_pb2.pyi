...
class ListCatalogsResponse(google.protobuf.message.Message):
    ...
    @property
    def catalogs(self) -> google.protobuf.internal.containers.RepeatedCompositeFieldContainer[google.cloud.retail.v2alpha.catalog_pb2.Catalog]:
    ...
    def __init__(self,
        *,
        catalogs : typing.Optional[typing.Iterable[google.cloud.retail.v2alpha.catalog_pb2.Catalog]] = ...,
        next_page_token : typing.Text = ...,
        ) -> None: ...
...
class UpdateCatalogRequest(google.protobuf.message.Message):
    ...
    @property
    def catalog(self) -> google.cloud.retail.v2alpha.catalog_pb2.Catalog:
    ...
    def __init__(self,
        *,
        catalog : typing.Optional[google.cloud.retail.v2alpha.catalog_pb2.Catalog] = ...,
