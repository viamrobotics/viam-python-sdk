...
class _NamespaceViewEnumTypeWrapper(google.protobuf.internal.enum_type_wrapper._EnumTypeWrapper[_NamespaceView.ValueType], builtins.type):
    DESCRIPTOR: google.protobuf.descriptor.EnumDescriptor = ...
    NAMESPACE_VIEW_UNSPECIFIED: NamespaceView.ValueType = ...  # 0
    """Default/unset value, which will use BASIC view."""

    NAMESPACE_VIEW_BASIC: NamespaceView.ValueType = ...  # 1
    """Show the most basic metadata of a namespace"""

    NAMESPACE_VIEW_FULL: NamespaceView.ValueType = ...  # 2
    """Returns all metadata of a namespace"""

class NamespaceView(_NamespaceView, metaclass=_NamespaceViewEnumTypeWrapper):
...
global___NamespaceView = NamespaceView
...
class Accelerator(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing_extensions.Literal["accelerator_type",b"accelerator_type"]) -> None: ...
...
class OperationMetadata(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing_extensions.Literal["api_version",b"api_version","create_time",b"create_time","end_time",b"end_time","requested_cancellation",b"requested_cancellation","status_detail",b"status_detail","target",b"target","verb",b"verb"]) -> None: ...
global___OperationMetadata = OperationMetadata

class RemoveIamPolicyRequest(google.protobuf.message.Message):
...
global___RemoveIamPolicyRequest = RemoveIamPolicyRequest

class RemoveIamPolicyResponse(google.protobuf.message.Message):
    """Response message for RemoveIamPolicy method."""
    DESCRIPTOR: google.protobuf.descriptor.Descriptor = ...
    def __init__(self,
        ) -> None: ...
global___RemoveIamPolicyResponse = RemoveIamPolicyResponse
...
class ListNamespacesRequest(google.protobuf.message.Message):
    ...
    view: global___NamespaceView.ValueType = ...
...
class IAMPolicy(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing_extensions.Literal["policy",b"policy","status",b"status"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["policy",b"policy","status",b"status"]) -> None: ...
global___IAMPolicy = IAMPolicy
...
class Namespace(google.protobuf.message.Message):
    ...
    @property
    def iam_policy(self) -> global___IAMPolicy:
        """IAM policy associated with this namespace."""
        pass
    def __init__(self,
        *,
        name : typing.Text = ...,
        iam_policy : typing.Optional[global___IAMPolicy] = ...,
        ) -> None: ...
    def HasField(self, field_name: typing_extensions.Literal["iam_policy",b"iam_policy"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["iam_policy",b"iam_policy","name",b"name"]) -> None: ...
...
class DnsPeering(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing_extensions.Literal["description",b"description","domain",b"domain","target_network",b"target_network","target_project",b"target_project","zone",b"zone"]) -> None: ...
global___DnsPeering = DnsPeering

class AddDnsPeeringRequest(google.protobuf.message.Message):
    """Request message to create dns peering."""
    DESCRIPTOR: google.protobuf.descriptor.Descriptor = ...
    PARENT_FIELD_NUMBER: builtins.int
    DNS_PEERING_FIELD_NUMBER: builtins.int
    parent: typing.Text = ...
    """Required. The resource on which DNS peering will be created."""

    @property
    def dns_peering(self) -> global___DnsPeering:
        """Dns peering config."""
        pass
    def __init__(self,
        *,
        parent : typing.Text = ...,
        dns_peering : typing.Optional[global___DnsPeering] = ...,
        ) -> None: ...
    def HasField(self, field_name: typing_extensions.Literal["dns_peering",b"dns_peering"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["dns_peering",b"dns_peering","parent",b"parent"]) -> None: ...
global___AddDnsPeeringRequest = AddDnsPeeringRequest

class AddDnsPeeringResponse(google.protobuf.message.Message):
    """Response message for set dns peering method."""
    DESCRIPTOR: google.protobuf.descriptor.Descriptor = ...
    def __init__(self,
        ) -> None: ...
global___AddDnsPeeringResponse = AddDnsPeeringResponse

class RemoveDnsPeeringRequest(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing_extensions.Literal["parent",b"parent","zone",b"zone"]) -> None: ...
global___RemoveDnsPeeringRequest = RemoveDnsPeeringRequest

class RemoveDnsPeeringResponse(google.protobuf.message.Message):
    """Response message for set dns peering method."""
    DESCRIPTOR: google.protobuf.descriptor.Descriptor = ...
    def __init__(self,
        ) -> None: ...
global___RemoveDnsPeeringResponse = RemoveDnsPeeringResponse

class ListDnsPeeringsRequest(google.protobuf.message.Message):
...
global___ListDnsPeeringsRequest = ListDnsPeeringsRequest

class ListDnsPeeringsResponse(google.protobuf.message.Message):
    """List dns peering response."""
    DESCRIPTOR: google.protobuf.descriptor.Descriptor = ...
    DNS_PEERINGS_FIELD_NUMBER: builtins.int
    NEXT_PAGE_TOKEN_FIELD_NUMBER: builtins.int
    @property
    def dns_peerings(self) -> google.protobuf.internal.containers.RepeatedCompositeFieldContainer[global___DnsPeering]:
    ...
    def __init__(self,
        *,
        dns_peerings : typing.Optional[typing.Iterable[global___DnsPeering]] = ...,
        next_page_token : typing.Text = ...,
        ) -> None: ...
    def ClearField(self, field_name: typing_extensions.Literal["dns_peerings",b"dns_peerings","next_page_token",b"next_page_token"]) -> None: ...
global___ListDnsPeeringsResponse = ListDnsPeeringsResponse
