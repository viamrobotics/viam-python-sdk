...
class Job(google.protobuf.message.Message):
    ...
    class OriginUri(google.protobuf.message.Message):
        """The origin URI."""
        DESCRIPTOR: google.protobuf.descriptor.Descriptor = ...
        HLS_FIELD_NUMBER: builtins.int
        ...
        def ClearField(self, field_name: typing_extensions.Literal["dash",b"dash","hls",b"hls"]) -> None: ...
    ...
    ORIGIN_URI_FIELD_NUMBER: builtins.int
    ...
    @property
    def origin_uri(self) -> global___Job.OriginUri:
    ...
    @property
    def failure_details(self) -> google.protobuf.internal.containers.RepeatedCompositeFieldContainer[global___FailureDetail]:
    ...
    def __init__(self,
        *,
        ...
        priority : builtins.int = ...,
        origin_uri : typing.Optional[global___Job.OriginUri] = ...,
        state : global___Job.ProcessingState.ValueType = ...,
        progress : typing.Optional[global___Progress] = ...,
        failure_reason : typing.Text = ...,
        failure_details : typing.Optional[typing.Iterable[global___FailureDetail]] = ...,
        create_time : typing.Optional[google.protobuf.timestamp_pb2.Timestamp] = ...,
        start_time : typing.Optional[google.protobuf.timestamp_pb2.Timestamp] = ...,
        end_time : typing.Optional[google.protobuf.timestamp_pb2.Timestamp] = ...,
        ttl_after_completion_days : builtins.int = ...,
        ) -> None: ...
    def HasField(self, field_name: typing_extensions.Literal["config",b"config","create_time",b"create_time","end_time",b"end_time","job_config",b"job_config","origin_uri",b"origin_uri","progress",b"progress","start_time",b"start_time","template_id",b"template_id"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["config",b"config","create_time",b"create_time","end_time",b"end_time","failure_details",b"failure_details","failure_reason",b"failure_reason","input_uri",b"input_uri","job_config",b"job_config","name",b"name","origin_uri",b"origin_uri","output_uri",b"output_uri","priority",b"priority","progress",b"progress","start_time",b"start_time","state",b"state","template_id",b"template_id","ttl_after_completion_days",b"ttl_after_completion_days"]) -> None: ...
...
class MuxStream(google.protobuf.message.Message):
    ...
    def __init__(self,
        *,
        ...
        encryption : typing.Optional[global___Encryption] = ...,
        ) -> None: ...
    def HasField(self, field_name: typing_extensions.Literal["encryption",b"encryption","segment_settings",b"segment_settings"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["container",b"container","elementary_streams",b"elementary_streams","encryption",b"encryption","file_name",b"file_name","key",b"key","segment_settings",b"segment_settings"]) -> None: ...
...
class AudioStream(google.protobuf.message.Message):
    ...
    DESCRIPTOR: google.protobuf.descriptor.Descriptor = ...
    class AudioAtom(google.protobuf.message.Message):
        """The mapping for the `Job.edit_list` atoms with audio `EditAtom.inputs`."""
        DESCRIPTOR: google.protobuf.descriptor.Descriptor = ...
        class AudioChannel(google.protobuf.message.Message):
            """The audio channel."""
            DESCRIPTOR: google.protobuf.descriptor.Descriptor = ...
            class AudioChannelInput(google.protobuf.message.Message):
                ...
                def ClearField(self, field_name: typing_extensions.Literal["channel",b"channel","gain_db",b"gain_db","key",b"key","track",b"track"]) -> None: ...

            INPUTS_FIELD_NUMBER: builtins.int
            @property
            def inputs(self) -> google.protobuf.internal.containers.RepeatedCompositeFieldContainer[global___AudioStream.AudioAtom.AudioChannel.AudioChannelInput]:
                """List of `Job.inputs` for this audio channel."""
                pass
            def __init__(self,
                *,
                inputs : typing.Optional[typing.Iterable[global___AudioStream.AudioAtom.AudioChannel.AudioChannelInput]] = ...,
                ) -> None: ...
        ...
        @property
        def channels(self) -> google.protobuf.internal.containers.RepeatedCompositeFieldContainer[global___AudioStream.AudioAtom.AudioChannel]:
        ...
        def __init__(self,
            *,
            key : typing.Text = ...,
            channels : typing.Optional[typing.Iterable[global___AudioStream.AudioAtom.AudioChannel]] = ...,
            ) -> None: ...
        def ClearField(self, field_name: typing_extensions.Literal["channels",b"channels","key",b"key"]) -> None: ...
    ...
    def channel_layout(self) -> google.protobuf.internal.containers.RepeatedScalarFieldContainer[typing.Text]:
        ...
        pass
    @property
    def mapping(self) -> google.protobuf.internal.containers.RepeatedCompositeFieldContainer[global___AudioStream.AudioAtom]:
        """The mapping for the `Job.edit_list` atoms with audio `EditAtom.inputs`."""
        pass
    ...
    def __init__(self,
        *,
        ...
        mapping : typing.Optional[typing.Iterable[global___AudioStream.AudioAtom]] = ...,
        sample_rate_hertz : builtins.int = ...,
        ) -> None: ...
...
class TextStream(google.protobuf.message.Message):
    """Encoding of a text stream. For example, closed captions or subtitles."""
    DESCRIPTOR: google.protobuf.descriptor.Descriptor = ...
    class TextAtom(google.protobuf.message.Message):
        ...
        class TextInput(google.protobuf.message.Message):
            ...
            def ClearField(self, field_name: typing_extensions.Literal["key",b"key","track",b"track"]) -> None: ...
        ...
        @property
        def inputs(self) -> google.protobuf.internal.containers.RepeatedCompositeFieldContainer[global___TextStream.TextAtom.TextInput]:
        ...
        def __init__(self,
            *,
            key : typing.Text = ...,
            inputs : typing.Optional[typing.Iterable[global___TextStream.TextAtom.TextInput]] = ...,
            ) -> None: ...
        def ClearField(self, field_name: typing_extensions.Literal["inputs",b"inputs","key",b"key"]) -> None: ...
    ...
    @property
    def mapping(self) -> google.protobuf.internal.containers.RepeatedCompositeFieldContainer[global___TextStream.TextAtom]:
        """The mapping for the `Job.edit_list` atoms with text `EditAtom.inputs`."""
        pass
    def __init__(self,
        *,
        codec : typing.Text = ...,
        language_code : typing.Text = ...,
        mapping : typing.Optional[typing.Iterable[global___TextStream.TextAtom]] = ...,
        ) -> None: ...
    def ClearField(self, field_name: typing_extensions.Literal["codec",b"codec","language_code",b"language_code","mapping",b"mapping"]) -> None: ...
...
class Encryption(google.protobuf.message.Message):
    """Encryption settings."""
    DESCRIPTOR: google.protobuf.descriptor.Descriptor = ...
    class Aes128Encryption(google.protobuf.message.Message):
    ...
    class SampleAesEncryption(google.protobuf.message.Message):
    ...
    class MpegCommonEncryption(google.protobuf.message.Message):
        ...
        def ClearField(self, field_name: typing_extensions.Literal["key_id",b"key_id","scheme",b"scheme"]) -> None: ...

    KEY_FIELD_NUMBER: builtins.int
    IV_FIELD_NUMBER: builtins.int
    AES_128_FIELD_NUMBER: builtins.int
    SAMPLE_AES_FIELD_NUMBER: builtins.int
    MPEG_CENC_FIELD_NUMBER: builtins.int
    key: typing.Text = ...
    ...
    @property
    def aes_128(self) -> global___Encryption.Aes128Encryption:
        """Configuration for AES-128 encryption."""
        pass
    @property
    def sample_aes(self) -> global___Encryption.SampleAesEncryption:
        """Configuration for SAMPLE-AES encryption."""
        pass
    @property
    def mpeg_cenc(self) -> global___Encryption.MpegCommonEncryption:
        """Configuration for MPEG Common Encryption (MPEG-CENC)."""
        pass
    def __init__(self,
        *,
        key : typing.Text = ...,
        iv : typing.Text = ...,
        aes_128 : typing.Optional[global___Encryption.Aes128Encryption] = ...,
        sample_aes : typing.Optional[global___Encryption.SampleAesEncryption] = ...,
        mpeg_cenc : typing.Optional[global___Encryption.MpegCommonEncryption] = ...,
        ) -> None: ...
    def HasField(self, field_name: typing_extensions.Literal["aes_128",b"aes_128","encryption_mode",b"encryption_mode","mpeg_cenc",b"mpeg_cenc","sample_aes",b"sample_aes"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["aes_128",b"aes_128","encryption_mode",b"encryption_mode","iv",b"iv","key",b"key","mpeg_cenc",b"mpeg_cenc","sample_aes",b"sample_aes"]) -> None: ...
    def WhichOneof(self, oneof_group: typing_extensions.Literal["encryption_mode",b"encryption_mode"]) -> typing.Optional[typing_extensions.Literal["aes_128","sample_aes","mpeg_cenc"]]: ...
global___Encryption = Encryption

class Progress(google.protobuf.message.Message):
    """Estimated fractional progress for each step, from `0` to `1`."""
    DESCRIPTOR: google.protobuf.descriptor.Descriptor = ...
    ANALYZED_FIELD_NUMBER: builtins.int
    ENCODED_FIELD_NUMBER: builtins.int
    UPLOADED_FIELD_NUMBER: builtins.int
    NOTIFIED_FIELD_NUMBER: builtins.int
    analyzed: builtins.float = ...
    """Estimated fractional progress for `analyzing` step."""

    encoded: builtins.float = ...
    """Estimated fractional progress for `encoding` step."""

    uploaded: builtins.float = ...
    """Estimated fractional progress for `uploading` step."""

    notified: builtins.float = ...
    ...
    def ClearField(self, field_name: typing_extensions.Literal["analyzed",b"analyzed","encoded",b"encoded","notified",b"notified","uploaded",b"uploaded"]) -> None: ...
global___Progress = Progress

class FailureDetail(google.protobuf.message.Message):
