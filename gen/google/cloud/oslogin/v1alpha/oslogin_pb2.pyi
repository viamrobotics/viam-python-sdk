...
class LoginProfile(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing_extensions.Literal["name",b"name","posix_accounts",b"posix_accounts","ssh_public_keys",b"ssh_public_keys","suspended",b"suspended"]) -> None: ...
