...
class Service(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing_extensions.Literal["create_time",b"create_time","hive_metastore_config",b"hive_metastore_config","maintenance_window",b"maintenance_window","metadata_management_activity",b"metadata_management_activity","metastore_config",b"metastore_config","update_time",b"update_time"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["artifact_gcs_uri",b"artifact_gcs_uri","create_time",b"create_time","endpoint_uri",b"endpoint_uri","hive_metastore_config",b"hive_metastore_config","labels",b"labels","maintenance_window",b"maintenance_window","metadata_management_activity",b"metadata_management_activity","metastore_config",b"metastore_config","name",b"name","network",b"network","port",b"port","release_channel",b"release_channel","state",b"state","state_message",b"state_message","tier",b"tier","uid",b"uid","update_time",b"update_time"]) -> None: ...
...
class MetadataImport(google.protobuf.message.Message):
    ...
    class DatabaseDump(google.protobuf.message.Message):
        ...
        def ClearField(self, field_name: typing_extensions.Literal["database_type",b"database_type","gcs_uri",b"gcs_uri","type",b"type"]) -> None: ...
    ...
    def HasField(self, field_name: typing_extensions.Literal["create_time",b"create_time","database_dump",b"database_dump","end_time",b"end_time","metadata",b"metadata","update_time",b"update_time"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["create_time",b"create_time","database_dump",b"database_dump","description",b"description","end_time",b"end_time","metadata",b"metadata","name",b"name","state",b"state","update_time",b"update_time"]) -> None: ...
...
class Backup(google.protobuf.message.Message):
    ...
    class _StateEnumTypeWrapper(google.protobuf.internal.enum_type_wrapper._EnumTypeWrapper[_State.ValueType], builtins.type):
        ...
        RESTORING: Backup.State.ValueType = ...  # 5
    ...
    DESCRIPTION_FIELD_NUMBER: builtins.int
    RESTORING_SERVICES_FIELD_NUMBER: builtins.int
    name: typing.Text = ...
    ...
    @property
    def restoring_services(self) -> google.protobuf.internal.containers.RepeatedScalarFieldContainer[typing.Text]:
    ...
    def __init__(self,
        *,
        ...
        description : typing.Text = ...,
        restoring_services : typing.Optional[typing.Iterable[typing.Text]] = ...,
        ) -> None: ...
    ...
    def ClearField(self, field_name: typing_extensions.Literal["create_time",b"create_time","description",b"description","end_time",b"end_time","name",b"name","restoring_services",b"restoring_services","service_revision",b"service_revision","state",b"state"]) -> None: ...
...
class DatabaseDumpSpec(google.protobuf.message.Message):
    ...
    class _TypeEnumTypeWrapper(google.protobuf.internal.enum_type_wrapper._EnumTypeWrapper[_Type.ValueType], builtins.type):
        ...
        AVRO: DatabaseDumpSpec.Type.ValueType = ...  # 2
