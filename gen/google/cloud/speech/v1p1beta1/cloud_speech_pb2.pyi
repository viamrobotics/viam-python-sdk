...
class RecognitionConfig(google.protobuf.message.Message):
    ...
    class _AudioEncodingEnumTypeWrapper(google.protobuf.internal.enum_type_wrapper._EnumTypeWrapper[_AudioEncoding.ValueType], builtins.type):
        ...
        MP3: RecognitionConfig.AudioEncoding.ValueType = ...  # 8
    ...
    @property
    def adaptation(self) -> google.cloud.speech.v1p1beta1.resource_pb2.SpeechAdaptation:
        ...
        pass
    @property
    def transcript_normalization(self) -> google.cloud.speech.v1p1beta1.resource_pb2.TranscriptNormalization:
    ...
    def __init__(self,
        *,
        ...
        max_alternatives : builtins.int = ...,
        profanity_filter : builtins.bool = ...,
        adaptation : typing.Optional[google.cloud.speech.v1p1beta1.resource_pb2.SpeechAdaptation] = ...,
        transcript_normalization : typing.Optional[google.cloud.speech.v1p1beta1.resource_pb2.TranscriptNormalization] = ...,
    ...
    def HasField(self, field_name: typing_extensions.Literal["adaptation",b"adaptation","diarization_config",b"diarization_config","enable_spoken_emojis",b"enable_spoken_emojis","enable_spoken_punctuation",b"enable_spoken_punctuation","metadata",b"metadata","transcript_normalization",b"transcript_normalization"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["adaptation",b"adaptation","alternative_language_codes",b"alternative_language_codes","audio_channel_count",b"audio_channel_count","diarization_config",b"diarization_config","diarization_speaker_count",b"diarization_speaker_count","enable_automatic_punctuation",b"enable_automatic_punctuation","enable_separate_recognition_per_channel",b"enable_separate_recognition_per_channel","enable_speaker_diarization",b"enable_speaker_diarization","enable_spoken_emojis",b"enable_spoken_emojis","enable_spoken_punctuation",b"enable_spoken_punctuation","enable_word_confidence",b"enable_word_confidence","enable_word_time_offsets",b"enable_word_time_offsets","encoding",b"encoding","language_code",b"language_code","max_alternatives",b"max_alternatives","metadata",b"metadata","model",b"model","profanity_filter",b"profanity_filter","sample_rate_hertz",b"sample_rate_hertz","speech_contexts",b"speech_contexts","transcript_normalization",b"transcript_normalization","use_enhanced",b"use_enhanced"]) -> None: ...
...
class RecognitionMetadata(google.protobuf.message.Message):
    ...
    OBFUSCATED_ID_FIELD_NUMBER: builtins.int
    ...
    def ClearField(self, field_name: typing_extensions.Literal["audio_topic",b"audio_topic","industry_naics_code_of_audio",b"industry_naics_code_of_audio","interaction_type",b"interaction_type","microphone_distance",b"microphone_distance","obfuscated_id",b"obfuscated_id","original_media_type",b"original_media_type","original_mime_type",b"original_mime_type","recording_device_name",b"recording_device_name","recording_device_type",b"recording_device_type"]) -> None: ...
...
class LongRunningRecognizeMetadata(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing_extensions.Literal["last_update_time",b"last_update_time","output_config",b"output_config","start_time",b"start_time"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["last_update_time",b"last_update_time","output_config",b"output_config","progress_percent",b"progress_percent","start_time",b"start_time","uri",b"uri"]) -> None: ...
