...
class TranscriptNormalization(google.protobuf.message.Message):
    ...
    class Entry(google.protobuf.message.Message):
        ...
        def ClearField(self, field_name: typing_extensions.Literal["case_sensitive",b"case_sensitive","replace",b"replace","search",b"search"]) -> None: ...

    ENTRIES_FIELD_NUMBER: builtins.int
    @property
    def entries(self) -> google.protobuf.internal.containers.RepeatedCompositeFieldContainer[global___TranscriptNormalization.Entry]:
    ...
    def __init__(self,
        *,
        entries : typing.Optional[typing.Iterable[global___TranscriptNormalization.Entry]] = ...,
        ) -> None: ...
    def ClearField(self, field_name: typing_extensions.Literal["entries",b"entries"]) -> None: ...
global___TranscriptNormalization = TranscriptNormalization
