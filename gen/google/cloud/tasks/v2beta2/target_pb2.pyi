...
class PullTarget(google.protobuf.message.Message):
    """Pull target."""
    DESCRIPTOR: google.protobuf.descriptor.Descriptor = ...
    def __init__(self,
        ) -> None: ...
global___PullTarget = PullTarget

class PullMessage(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing_extensions.Literal["payload",b"payload","tag",b"tag"]) -> None: ...
global___PullMessage = PullMessage
...
class AppEngineHttpTarget(google.protobuf.message.Message):
    ...
    @property
    def app_engine_routing_override(self) -> global___AppEngineRouting:
        """Overrides for the
    ...
    def __init__(self,
        *,
        app_engine_routing_override : typing.Optional[global___AppEngineRouting] = ...,
        ) -> None: ...
    def HasField(self, field_name: typing_extensions.Literal["app_engine_routing_override",b"app_engine_routing_override"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["app_engine_routing_override",b"app_engine_routing_override"]) -> None: ...
...
class AppEngineHttpRequest(google.protobuf.message.Message):
    ...
    * `url =` [host][google.cloud.tasks.v2beta2.AppEngineRouting.host] `+`
    ...
    RELATIVE_URL_FIELD_NUMBER: builtins.int
    ...
    def ClearField(self, field_name: typing_extensions.Literal["app_engine_routing",b"app_engine_routing","headers",b"headers","http_method",b"http_method","payload",b"payload","relative_url",b"relative_url"]) -> None: ...
