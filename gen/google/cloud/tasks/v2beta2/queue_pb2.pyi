...
class Queue(google.protobuf.message.Message):
    ...
    PULL_TARGET_FIELD_NUMBER: builtins.int
    ...
    * `QUEUE_ID` can contain letters ([A-Za-z]), numbers ([0-9]), or
    ...
    @property
    def app_engine_http_target(self) -> google.cloud.tasks.v2beta2.target_pb2.AppEngineHttpTarget:
        ...
        pass
    @property
    def pull_target(self) -> google.cloud.tasks.v2beta2.target_pb2.PullTarget:
        """Pull target.
    ...
    def __init__(self,
        *,
        name : typing.Text = ...,
        app_engine_http_target : typing.Optional[google.cloud.tasks.v2beta2.target_pb2.AppEngineHttpTarget] = ...,
        pull_target : typing.Optional[google.cloud.tasks.v2beta2.target_pb2.PullTarget] = ...,
    ...
    def HasField(self, field_name: typing_extensions.Literal["app_engine_http_target",b"app_engine_http_target","pull_target",b"pull_target","purge_time",b"purge_time","rate_limits",b"rate_limits","retry_config",b"retry_config","stats",b"stats","target_type",b"target_type","task_ttl",b"task_ttl","tombstone_ttl",b"tombstone_ttl"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["app_engine_http_target",b"app_engine_http_target","name",b"name","pull_target",b"pull_target","purge_time",b"purge_time","rate_limits",b"rate_limits","retry_config",b"retry_config","state",b"state","stats",b"stats","target_type",b"target_type","task_ttl",b"task_ttl","tombstone_ttl",b"tombstone_ttl"]) -> None: ...
    def WhichOneof(self, oneof_group: typing_extensions.Literal["target_type",b"target_type"]) -> typing.Optional[typing_extensions.Literal["app_engine_http_target","pull_target"]]: ...
...
class RateLimits(google.protobuf.message.Message):
    ...
    """
    DESCRIPTOR: google.protobuf.descriptor.Descriptor = ...
    MAX_TASKS_DISPATCHED_PER_SECOND_FIELD_NUMBER: builtins.int
    MAX_BURST_SIZE_FIELD_NUMBER: builtins.int
    MAX_CONCURRENT_TASKS_FIELD_NUMBER: builtins.int
    max_tasks_dispatched_per_second: builtins.float = ...
    ...
    * This field is output only   for [pull queues][google.cloud.tasks.v2beta2.PullTarget]. In addition to the
    ...
    def ClearField(self, field_name: typing_extensions.Literal["max_burst_size",b"max_burst_size","max_concurrent_tasks",b"max_concurrent_tasks","max_tasks_dispatched_per_second",b"max_tasks_dispatched_per_second"]) -> None: ...
...
class RetryConfig(google.protobuf.message.Message):
    ...
    UNLIMITED_ATTEMPTS_FIELD_NUMBER: builtins.int
    ...
    unlimited_attempts: builtins.bool = ...
    ...
    def HasField(self, field_name: typing_extensions.Literal["max_attempts",b"max_attempts","max_backoff",b"max_backoff","max_retry_duration",b"max_retry_duration","min_backoff",b"min_backoff","num_attempts",b"num_attempts","unlimited_attempts",b"unlimited_attempts"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["max_attempts",b"max_attempts","max_backoff",b"max_backoff","max_doublings",b"max_doublings","max_retry_duration",b"max_retry_duration","min_backoff",b"min_backoff","num_attempts",b"num_attempts","unlimited_attempts",b"unlimited_attempts"]) -> None: ...
    def WhichOneof(self, oneof_group: typing_extensions.Literal["num_attempts",b"num_attempts"]) -> typing.Optional[typing_extensions.Literal["max_attempts","unlimited_attempts"]]: ...
