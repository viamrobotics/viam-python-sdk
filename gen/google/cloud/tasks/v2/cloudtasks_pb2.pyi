...
class ListQueuesResponse(google.protobuf.message.Message):
    ...
    @property
    def queues(self) -> google.protobuf.internal.containers.RepeatedCompositeFieldContainer[google.cloud.tasks.v2.queue_pb2.Queue]:
        """The list of queues."""
        pass
    ...
    def __init__(self,
        *,
        queues : typing.Optional[typing.Iterable[google.cloud.tasks.v2.queue_pb2.Queue]] = ...,
        next_page_token : typing.Text = ...,
        ) -> None: ...
...
class CreateQueueRequest(google.protobuf.message.Message):
    ...
    @property
    def queue(self) -> google.cloud.tasks.v2.queue_pb2.Queue:
    ...
    def __init__(self,
        *,
        parent : typing.Text = ...,
        queue : typing.Optional[google.cloud.tasks.v2.queue_pb2.Queue] = ...,
        ) -> None: ...
...
class ListTasksRequest(google.protobuf.message.Message):
    ...
    response_view: google.cloud.tasks.v2.task_pb2.Task.View.ValueType = ...
...
class ListTasksResponse(google.protobuf.message.Message):
    ...
    NEXT_PAGE_TOKEN_FIELD_NUMBER: builtins.int
    @property
    def tasks(self) -> google.protobuf.internal.containers.RepeatedCompositeFieldContainer[google.cloud.tasks.v2.task_pb2.Task]:
        """The list of tasks."""
        pass
    next_page_token: typing.Text = ...
    """A token to retrieve next page of results.
    ...
    def __init__(self,
        *,
        tasks : typing.Optional[typing.Iterable[google.cloud.tasks.v2.task_pb2.Task]] = ...,
        next_page_token : typing.Text = ...,
        ) -> None: ...
...
class CreateTaskRequest(google.protobuf.message.Message):
    ...
    @property
    def task(self) -> google.cloud.tasks.v2.task_pb2.Task:
    ...
    def __init__(self,
        *,
        parent : typing.Text = ...,
        task : typing.Optional[google.cloud.tasks.v2.task_pb2.Task] = ...,
        response_view : google.cloud.tasks.v2.task_pb2.Task.View.ValueType = ...,
        ) -> None: ...
