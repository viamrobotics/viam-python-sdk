...
"""
import builtins
import google.cloud.scheduler.v1beta1.target_pb2
...
class Job(google.protobuf.message.Message):
    ...
    * `JOB_ID` can contain only letters ([A-Za-z]), numbers ([0-9]),
    ...
    @property
    def pubsub_target(self) -> google.cloud.scheduler.v1beta1.target_pb2.PubsubTarget:
        """Pub/Sub target."""
        pass
    @property
    def app_engine_http_target(self) -> google.cloud.scheduler.v1beta1.target_pb2.AppEngineHttpTarget:
        """App Engine HTTP target."""
        pass
    @property
    def http_target(self) -> google.cloud.scheduler.v1beta1.target_pb2.HttpTarget:
        """HTTP target."""
        pass
    ...
    * English-like
    ...
    def __init__(self,
        *,
        name : typing.Text = ...,
        description : typing.Text = ...,
        pubsub_target : typing.Optional[google.cloud.scheduler.v1beta1.target_pb2.PubsubTarget] = ...,
        app_engine_http_target : typing.Optional[google.cloud.scheduler.v1beta1.target_pb2.AppEngineHttpTarget] = ...,
        http_target : typing.Optional[google.cloud.scheduler.v1beta1.target_pb2.HttpTarget] = ...,
        schedule : typing.Text = ...,
        time_zone : typing.Text = ...,
