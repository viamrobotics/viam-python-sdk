...
class CustomJobSpec(google.protobuf.message.Message):
    ...
    @property
    def base_output_directory(self) -> google.cloud.aiplatform.v1beta1.io_pb2.GcsDestination:
    ...
    def __init__(self,
        *,
        ...
        service_account : typing.Text = ...,
        network : typing.Text = ...,
        base_output_directory : typing.Optional[google.cloud.aiplatform.v1beta1.io_pb2.GcsDestination] = ...,
        tensorboard : typing.Text = ...,
        enable_web_access : builtins.bool = ...,
        ) -> None: ...
...
class WorkerPoolSpec(google.protobuf.message.Message):
    ...
    def python_package_spec(self) -> global___PythonPackageSpec:
        ...
        pass
    @property
    def machine_spec(self) -> google.cloud.aiplatform.v1beta1.machine_resources_pb2.MachineSpec:
    ...
    @property
    def disk_spec(self) -> google.cloud.aiplatform.v1beta1.machine_resources_pb2.DiskSpec:
        """Disk spec."""
        pass
    def __init__(self,
        *,
        ...
        machine_spec : typing.Optional[google.cloud.aiplatform.v1beta1.machine_resources_pb2.MachineSpec] = ...,
        replica_count : builtins.int = ...,
        disk_spec : typing.Optional[google.cloud.aiplatform.v1beta1.machine_resources_pb2.DiskSpec] = ...,
        ) -> None: ...
...
class ContainerSpec(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing_extensions.Literal["args",b"args","command",b"command","image_uri",b"image_uri"]) -> None: ...
...
class PythonPackageSpec(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing_extensions.Literal["args",b"args","executor_image_uri",b"executor_image_uri","package_uris",b"package_uris","python_module",b"python_module"]) -> None: ...
