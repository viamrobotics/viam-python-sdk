...
class Feature(google.protobuf.message.Message):
    ...
    def monitoring_config(self) -> google.cloud.aiplatform.v1beta1.featurestore_monitoring_pb2.FeaturestoreMonitoringConfig:
        ...
        pass
    @property
    def monitoring_stats(self) -> google.protobuf.internal.containers.RepeatedCompositeFieldContainer[google.cloud.aiplatform.v1beta1.feature_monitoring_stats_pb2.FeatureStatsAnomaly]:
    ...
    def __init__(self,
        *,
        ...
        monitoring_stats : typing.Optional[typing.Iterable[google.cloud.aiplatform.v1beta1.feature_monitoring_stats_pb2.FeatureStatsAnomaly]] = ...,
        ) -> None: ...
    ...
    def ClearField(self, field_name: typing_extensions.Literal["create_time",b"create_time","description",b"description","etag",b"etag","labels",b"labels","monitoring_config",b"monitoring_config","monitoring_stats",b"monitoring_stats","name",b"name","update_time",b"update_time","value_type",b"value_type"]) -> None: ...
