...
class CreateEndpointRequest(google.protobuf.message.Message):
    ...
    @property
    def endpoint(self) -> google.cloud.aiplatform.v1beta1.endpoint_pb2.Endpoint:
    ...
    def __init__(self,
        *,
        parent : typing.Text = ...,
        endpoint : typing.Optional[google.cloud.aiplatform.v1beta1.endpoint_pb2.Endpoint] = ...,
        endpoint_id : typing.Text = ...,
        ) -> None: ...
...
class ListEndpointsResponse(google.protobuf.message.Message):
    ...
    @property
    def endpoints(self) -> google.protobuf.internal.containers.RepeatedCompositeFieldContainer[google.cloud.aiplatform.v1beta1.endpoint_pb2.Endpoint]:
    ...
    def __init__(self,
        *,
        endpoints : typing.Optional[typing.Iterable[google.cloud.aiplatform.v1beta1.endpoint_pb2.Endpoint]] = ...,
        next_page_token : typing.Text = ...,
        ) -> None: ...
...
class DeployModelRequest(google.protobuf.message.Message):
    ...
    @property
    def deployed_model(self) -> google.cloud.aiplatform.v1beta1.endpoint_pb2.DeployedModel:
    ...
    def __init__(self,
        *,
        endpoint : typing.Text = ...,
        deployed_model : typing.Optional[google.cloud.aiplatform.v1beta1.endpoint_pb2.DeployedModel] = ...,
