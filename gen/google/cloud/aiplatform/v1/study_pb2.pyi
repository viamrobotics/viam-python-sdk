...
class StudySpec(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing_extensions.Literal["automated_stopping_spec",b"automated_stopping_spec","decay_curve_stopping_spec",b"decay_curve_stopping_spec","median_automated_stopping_spec",b"median_automated_stopping_spec"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["algorithm",b"algorithm","automated_stopping_spec",b"automated_stopping_spec","decay_curve_stopping_spec",b"decay_curve_stopping_spec","measurement_selection_type",b"measurement_selection_type","median_automated_stopping_spec",b"median_automated_stopping_spec","metrics",b"metrics","observation_noise",b"observation_noise","parameters",b"parameters"]) -> None: ...
    def WhichOneof(self, oneof_group: typing_extensions.Literal["automated_stopping_spec",b"automated_stopping_spec"]) -> typing.Optional[typing_extensions.Literal["decay_curve_stopping_spec","median_automated_stopping_spec"]]: ...
