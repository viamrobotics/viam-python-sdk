...
"""
import builtins
import google.cloud.aiplatform.v1.explanation_metadata_pb2
...
class ExplanationSpec(google.protobuf.message.Message):
    ...
    def parameters(self) -> global___ExplanationParameters:
        ...
        pass
    @property
    def metadata(self) -> google.cloud.aiplatform.v1.explanation_metadata_pb2.ExplanationMetadata:
    ...
    def __init__(self,
        *,
        ...
        metadata : typing.Optional[google.cloud.aiplatform.v1.explanation_metadata_pb2.ExplanationMetadata] = ...,
        ) -> None: ...
...
class ExplanationParameters(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing_extensions.Literal["integrated_gradients_attribution",b"integrated_gradients_attribution","method",b"method","output_indices",b"output_indices","sampled_shapley_attribution",b"sampled_shapley_attribution","xrai_attribution",b"xrai_attribution"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["integrated_gradients_attribution",b"integrated_gradients_attribution","method",b"method","output_indices",b"output_indices","sampled_shapley_attribution",b"sampled_shapley_attribution","top_k",b"top_k","xrai_attribution",b"xrai_attribution"]) -> None: ...
    def WhichOneof(self, oneof_group: typing_extensions.Literal["method",b"method"]) -> typing.Optional[typing_extensions.Literal["sampled_shapley_attribution","integrated_gradients_attribution","xrai_attribution"]]: ...
