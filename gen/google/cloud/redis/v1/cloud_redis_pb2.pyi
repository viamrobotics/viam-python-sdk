...
class Instance(google.protobuf.message.Message):
    ...
    class _StateEnumTypeWrapper(google.protobuf.internal.enum_type_wrapper._EnumTypeWrapper[_State.ValueType], builtins.type):
        ...
        FAILING_OVER: Instance.State.ValueType = ...  # 9
    ...
    def ClearField(self, field_name: typing_extensions.Literal["alternative_location_id",b"alternative_location_id","authorized_network",b"authorized_network","connect_mode",b"connect_mode","create_time",b"create_time","current_location_id",b"current_location_id","display_name",b"display_name","host",b"host","labels",b"labels","location_id",b"location_id","memory_size_gb",b"memory_size_gb","name",b"name","nodes",b"nodes","persistence_iam_identity",b"persistence_iam_identity","port",b"port","read_endpoint",b"read_endpoint","read_endpoint_port",b"read_endpoint_port","read_replicas_mode",b"read_replicas_mode","redis_configs",b"redis_configs","redis_version",b"redis_version","replica_count",b"replica_count","reserved_ip_range",b"reserved_ip_range","state",b"state","status_message",b"status_message","tier",b"tier"]) -> None: ...
