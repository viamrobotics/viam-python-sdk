...
"""
import builtins
import google.cloud.bigquery.migration.tasks.translation.v2alpha.dataset_reference_pb2
...
class BteqOptions(google.protobuf.message.Message):
    ...
    @property
    def project_dataset(self) -> google.cloud.bigquery.migration.tasks.translation.v2alpha.dataset_reference_pb2.DatasetReference:
    ...
    def __init__(self,
        *,
        project_dataset : typing.Optional[google.cloud.bigquery.migration.tasks.translation.v2alpha.dataset_reference_pb2.DatasetReference] = ...,
        default_path_uri : typing.Text = ...,
