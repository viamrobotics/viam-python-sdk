...
class CreateReadSessionRequest(google.protobuf.message.Message):
    ...
    @property
    def read_session(self) -> google.cloud.bigquery.storage.v1.stream_pb2.ReadSession:
    ...
    def __init__(self,
        *,
        parent : typing.Text = ...,
        read_session : typing.Optional[google.cloud.bigquery.storage.v1.stream_pb2.ReadSession] = ...,
        max_stream_count : builtins.int = ...,
        ) -> None: ...
...
class ReadRowsResponse(google.protobuf.message.Message):
    ...
    @property
    def avro_rows(self) -> google.cloud.bigquery.storage.v1.avro_pb2.AvroRows:
        """Serialized row data in AVRO format."""
        pass
    @property
    def arrow_record_batch(self) -> google.cloud.bigquery.storage.v1.arrow_pb2.ArrowRecordBatch:
    ...
    def __init__(self,
        *,
        avro_rows : typing.Optional[google.cloud.bigquery.storage.v1.avro_pb2.AvroRows] = ...,
        arrow_record_batch : typing.Optional[google.cloud.bigquery.storage.v1.arrow_pb2.ArrowRecordBatch] = ...,
        row_count : builtins.int = ...,
...
class SplitReadStreamResponse(google.protobuf.message.Message):
    ...
    @property
    def primary_stream(self) -> google.cloud.bigquery.storage.v1.stream_pb2.ReadStream:
        ...
        pass
    @property
    def remainder_stream(self) -> google.cloud.bigquery.storage.v1.stream_pb2.ReadStream:
    ...
    def __init__(self,
        *,
        primary_stream : typing.Optional[google.cloud.bigquery.storage.v1.stream_pb2.ReadStream] = ...,
        remainder_stream : typing.Optional[google.cloud.bigquery.storage.v1.stream_pb2.ReadStream] = ...,
        ) -> None: ...
...
class CreateWriteStreamRequest(google.protobuf.message.Message):
    ...
    @property
    def write_stream(self) -> google.cloud.bigquery.storage.v1.stream_pb2.WriteStream:
        """Required. Stream to be created."""
        pass
    def __init__(self,
        *,
        parent : typing.Text = ...,
        write_stream : typing.Optional[google.cloud.bigquery.storage.v1.stream_pb2.WriteStream] = ...,
        ) -> None: ...
...
class AppendRowsRequest(google.protobuf.message.Message):
    ...
    class ProtoData(google.protobuf.message.Message):
        ...
        @property
        def writer_schema(self) -> google.cloud.bigquery.storage.v1.protobuf_pb2.ProtoSchema:
            ...
            pass
        @property
        def rows(self) -> google.cloud.bigquery.storage.v1.protobuf_pb2.ProtoRows:
        ...
        def __init__(self,
            *,
            writer_schema : typing.Optional[google.cloud.bigquery.storage.v1.protobuf_pb2.ProtoSchema] = ...,
            rows : typing.Optional[google.cloud.bigquery.storage.v1.protobuf_pb2.ProtoRows] = ...,
            ) -> None: ...
...
class AppendRowsResponse(google.protobuf.message.Message):
    ...
    def error(self) -> google.rpc.status_pb2.Status:
        ...
        pass
    @property
    def updated_schema(self) -> google.cloud.bigquery.storage.v1.table_pb2.TableSchema:
    ...
    def __init__(self,
        *,
        ...
        updated_schema : typing.Optional[google.cloud.bigquery.storage.v1.table_pb2.TableSchema] = ...,
        ) -> None: ...
...
class StorageError(google.protobuf.message.Message):
    ...
    class _StorageErrorCodeEnumTypeWrapper(google.protobuf.internal.enum_type_wrapper._EnumTypeWrapper[_StorageErrorCode.ValueType], builtins.type):
        ...
        SCHEMA_MISMATCH_EXTRA_FIELDS: StorageError.StorageErrorCode.ValueType = ...  # 7
