...
class InputConfig(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing_extensions.Literal["bigquery_source",b"bigquery_source","gcs_source",b"gcs_source","params",b"params","source",b"source"]) -> None: ...
...
class BatchPredictInputConfig(google.protobuf.message.Message):
    ...
    def WhichOneof(self, oneof_group: typing_extensions.Literal["source",b"source"]) -> typing.Optional[typing_extensions.Literal["gcs_source","bigquery_source"]]: ...
global___BatchPredictInputConfig = BatchPredictInputConfig

class DocumentInputConfig(google.protobuf.message.Message):
...
global___DocumentInputConfig = DocumentInputConfig
...
class BatchPredictOutputConfig(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing_extensions.Literal["bigquery_destination",b"bigquery_destination","destination",b"destination","gcs_destination",b"gcs_destination"]) -> None: ...
    def WhichOneof(self, oneof_group: typing_extensions.Literal["destination",b"destination"]) -> typing.Optional[typing_extensions.Literal["gcs_destination","bigquery_destination"]]: ...
global___BatchPredictOutputConfig = BatchPredictOutputConfig

class ModelExportOutputConfig(google.protobuf.message.Message):
    ...
    GCS_DESTINATION_FIELD_NUMBER: builtins.int
    GCR_DESTINATION_FIELD_NUMBER: builtins.int
    ...
    def gcs_destination(self) -> global___GcsDestination:
        ...
        pass
    @property
    def gcr_destination(self) -> global___GcrDestination:
    ...
    * core_ml - Used for iOS mobile devices.
    ...
    def __init__(self,
        *,
        gcs_destination : typing.Optional[global___GcsDestination] = ...,
        gcr_destination : typing.Optional[global___GcrDestination] = ...,
        model_format : typing.Text = ...,
        params : typing.Optional[typing.Mapping[typing.Text, typing.Text]] = ...,
        ) -> None: ...
    def HasField(self, field_name: typing_extensions.Literal["destination",b"destination","gcr_destination",b"gcr_destination","gcs_destination",b"gcs_destination"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["destination",b"destination","gcr_destination",b"gcr_destination","gcs_destination",b"gcs_destination","model_format",b"model_format","params",b"params"]) -> None: ...
    def WhichOneof(self, oneof_group: typing_extensions.Literal["destination",b"destination"]) -> typing.Optional[typing_extensions.Literal["gcs_destination","gcr_destination"]]: ...
global___ModelExportOutputConfig = ModelExportOutputConfig

class ExportEvaluatedExamplesOutputConfig(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing_extensions.Literal["bigquery_destination",b"bigquery_destination","destination",b"destination"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["bigquery_destination",b"bigquery_destination","destination",b"destination"]) -> None: ...
    def WhichOneof(self, oneof_group: typing_extensions.Literal["destination",b"destination"]) -> typing.Optional[typing_extensions.Literal["bigquery_destination"]]: ...
global___ExportEvaluatedExamplesOutputConfig = ExportEvaluatedExamplesOutputConfig
...
class GcrDestination(google.protobuf.message.Message):
    ...
    * [HOSTNAME]/[PROJECT-ID]/[IMAGE]:[TAG]
    ...
    def ClearField(self, field_name: typing_extensions.Literal["output_uri",b"output_uri"]) -> None: ...
global___GcrDestination = GcrDestination
