...
class TextSentimentEvaluationMetrics(google.protobuf.message.Message):
    ...
    @property
    def confusion_matrix(self) -> google.cloud.automl.v1.classification_pb2.ClassificationEvaluationMetrics.ConfusionMatrix:
    ...
    def __init__(self,
        *,
        ...
        linear_kappa : builtins.float = ...,
        quadratic_kappa : builtins.float = ...,
        confusion_matrix : typing.Optional[google.cloud.automl.v1.classification_pb2.ClassificationEvaluationMetrics.ConfusionMatrix] = ...,
        ) -> None: ...
    def HasField(self, field_name: typing_extensions.Literal["confusion_matrix",b"confusion_matrix"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["confusion_matrix",b"confusion_matrix","f1_score",b"f1_score","linear_kappa",b"linear_kappa","mean_absolute_error",b"mean_absolute_error","mean_squared_error",b"mean_squared_error","precision",b"precision","quadratic_kappa",b"quadratic_kappa","recall",b"recall"]) -> None: ...
