...
class EntityResult(google.protobuf.message.Message):
    ...
    @property
    def entity(self) -> google.datastore.v1.entity_pb2.Entity:
    ...
    def __init__(self,
        *,
        entity : typing.Optional[google.datastore.v1.entity_pb2.Entity] = ...,
        version : builtins.int = ...,
        cursor : builtins.bytes = ...,
        ) -> None: ...
...
class PropertyFilter(google.protobuf.message.Message):
    ...
    @property
    def value(self) -> google.datastore.v1.entity_pb2.Value:
    ...
    def __init__(self,
        *,
        property : typing.Optional[global___PropertyReference] = ...,
        op : global___PropertyFilter.Operator.ValueType = ...,
        value : typing.Optional[google.datastore.v1.entity_pb2.Value] = ...,
        ) -> None: ...
