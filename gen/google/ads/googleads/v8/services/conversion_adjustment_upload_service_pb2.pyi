...
import google.ads.googleads.v8.enums.conversion_adjustment_type_pb2
...
class ConversionAdjustment(google.protobuf.message.Message):
    ...
    adjustment_type: google.ads.googleads.v8.enums.conversion_adjustment_type_pb2.ConversionAdjustmentTypeEnum.ConversionAdjustmentType.ValueType = ...
    """The adjustment type."""
    ...
    def HasField(self, field_name: typing_extensions.Literal["_adjustment_date_time",b"_adjustment_date_time","_conversion_action",b"_conversion_action","_user_agent",b"_user_agent","adjustment_date_time",b"adjustment_date_time","conversion_action",b"conversion_action","conversion_identifier",b"conversion_identifier","gclid_date_time_pair",b"gclid_date_time_pair","order_id",b"order_id","restatement_value",b"restatement_value","user_agent",b"user_agent"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["_adjustment_date_time",b"_adjustment_date_time","_conversion_action",b"_conversion_action","_user_agent",b"_user_agent","adjustment_date_time",b"adjustment_date_time","adjustment_type",b"adjustment_type","conversion_action",b"conversion_action","conversion_identifier",b"conversion_identifier","gclid_date_time_pair",b"gclid_date_time_pair","order_id",b"order_id","restatement_value",b"restatement_value","user_agent",b"user_agent","user_identifiers",b"user_identifiers"]) -> None: ...
    @typing.overload
