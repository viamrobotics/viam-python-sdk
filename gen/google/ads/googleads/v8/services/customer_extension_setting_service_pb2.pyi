...
class MutateCustomerExtensionSettingsRequest(google.protobuf.message.Message):
    ...
    @property
    def operations(self) -> google.protobuf.internal.containers.RepeatedCompositeFieldContainer[global___CustomerExtensionSettingOperation]:
    ...
    def __init__(self,
        *,
        customer_id : typing.Text = ...,
        operations : typing.Optional[typing.Iterable[global___CustomerExtensionSettingOperation]] = ...,
        partial_failure : builtins.bool = ...,
        validate_only : builtins.bool = ...,
        response_content_type : google.ads.googleads.v8.enums.response_content_type_pb2.ResponseContentTypeEnum.ResponseContentType.ValueType = ...,
        ) -> None: ...
...
class CustomerExtensionSettingOperation(google.protobuf.message.Message):
    ...
    def update_mask(self) -> google.protobuf.field_mask_pb2.FieldMask:
        ...
        pass
    @property
    def create(self) -> google.ads.googleads.v8.resources.customer_extension_setting_pb2.CustomerExtensionSetting:
        """Create operation: No resource name is expected for the new customer
        extension setting.
        """
        pass
    @property
    def update(self) -> google.ads.googleads.v8.resources.customer_extension_setting_pb2.CustomerExtensionSetting:
    ...
    def __init__(self,
        *,
        ...
        create : typing.Optional[google.ads.googleads.v8.resources.customer_extension_setting_pb2.CustomerExtensionSetting] = ...,
        update : typing.Optional[google.ads.googleads.v8.resources.customer_extension_setting_pb2.CustomerExtensionSetting] = ...,
        remove : typing.Text = ...,
        ) -> None: ...
...
class MutateCustomerExtensionSettingsResponse(google.protobuf.message.Message):
    ...
    def partial_failure_error(self) -> google.rpc.status_pb2.Status:
        ...
        pass
    @property
    def results(self) -> google.protobuf.internal.containers.RepeatedCompositeFieldContainer[global___MutateCustomerExtensionSettingResult]:
        """All results for the mutate."""
        pass
    def __init__(self,
        *,
        partial_failure_error : typing.Optional[google.rpc.status_pb2.Status] = ...,
        results : typing.Optional[typing.Iterable[global___MutateCustomerExtensionSettingResult]] = ...,
        ) -> None: ...
...
class MutateCustomerExtensionSettingResult(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing_extensions.Literal["customer_extension_setting",b"customer_extension_setting"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["customer_extension_setting",b"customer_extension_setting","resource_name",b"resource_name"]) -> None: ...
