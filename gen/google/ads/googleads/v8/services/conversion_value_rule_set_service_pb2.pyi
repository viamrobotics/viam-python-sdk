...
class GetConversionValueRuleSetRequest(google.protobuf.message.Message):
    """Request message for
...
global___GetConversionValueRuleSetRequest = GetConversionValueRuleSetRequest

class MutateConversionValueRuleSetsRequest(google.protobuf.message.Message):
    """Request message for
    ...
    @property
    def operations(self) -> google.protobuf.internal.containers.RepeatedCompositeFieldContainer[global___ConversionValueRuleSetOperation]:
    ...
    def __init__(self,
        *,
        customer_id : typing.Text = ...,
        operations : typing.Optional[typing.Iterable[global___ConversionValueRuleSetOperation]] = ...,
        partial_failure : builtins.bool = ...,
        validate_only : builtins.bool = ...,
        response_content_type : google.ads.googleads.v8.enums.response_content_type_pb2.ResponseContentTypeEnum.ResponseContentType.ValueType = ...,
        ) -> None: ...
...
global___MutateConversionValueRuleSetsRequest = MutateConversionValueRuleSetsRequest

class ConversionValueRuleSetOperation(google.protobuf.message.Message):
    ...
    def update_mask(self) -> google.protobuf.field_mask_pb2.FieldMask:
        ...
        pass
    @property
    def create(self) -> google.ads.googleads.v8.resources.conversion_value_rule_set_pb2.ConversionValueRuleSet:
        """Create operation: No resource name is expected for the new conversion
        value rule set.
        """
        pass
    @property
    def update(self) -> google.ads.googleads.v8.resources.conversion_value_rule_set_pb2.ConversionValueRuleSet:
    ...
    def __init__(self,
        *,
        ...
        create : typing.Optional[google.ads.googleads.v8.resources.conversion_value_rule_set_pb2.ConversionValueRuleSet] = ...,
        update : typing.Optional[google.ads.googleads.v8.resources.conversion_value_rule_set_pb2.ConversionValueRuleSet] = ...,
        remove : typing.Text = ...,
        ) -> None: ...
...
global___ConversionValueRuleSetOperation = ConversionValueRuleSetOperation

class MutateConversionValueRuleSetsResponse(google.protobuf.message.Message):
    ...
    @property
    def results(self) -> google.protobuf.internal.containers.RepeatedCompositeFieldContainer[global___MutateConversionValueRuleSetResult]:
    ...
    def __init__(self,
        *,
        results : typing.Optional[typing.Iterable[global___MutateConversionValueRuleSetResult]] = ...,
...
global___MutateConversionValueRuleSetsResponse = MutateConversionValueRuleSetsResponse

class MutateConversionValueRuleSetResult(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing_extensions.Literal["conversion_value_rule_set",b"conversion_value_rule_set"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["conversion_value_rule_set",b"conversion_value_rule_set","resource_name",b"resource_name"]) -> None: ...
global___MutateConversionValueRuleSetResult = MutateConversionValueRuleSetResult
