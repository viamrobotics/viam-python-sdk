...
class MutateBiddingStrategiesRequest(google.protobuf.message.Message):
    ...
    @property
    def operations(self) -> google.protobuf.internal.containers.RepeatedCompositeFieldContainer[global___BiddingStrategyOperation]:
    ...
    def __init__(self,
        *,
        customer_id : typing.Text = ...,
        operations : typing.Optional[typing.Iterable[global___BiddingStrategyOperation]] = ...,
        partial_failure : builtins.bool = ...,
        validate_only : builtins.bool = ...,
        response_content_type : google.ads.googleads.v8.enums.response_content_type_pb2.ResponseContentTypeEnum.ResponseContentType.ValueType = ...,
        ) -> None: ...
...
class BiddingStrategyOperation(google.protobuf.message.Message):
    ...
    def update_mask(self) -> google.protobuf.field_mask_pb2.FieldMask:
        ...
        pass
    @property
    def create(self) -> google.ads.googleads.v8.resources.bidding_strategy_pb2.BiddingStrategy:
        """Create operation: No resource name is expected for the new bidding
        strategy.
        """
        pass
    @property
    def update(self) -> google.ads.googleads.v8.resources.bidding_strategy_pb2.BiddingStrategy:
    ...
    def __init__(self,
        *,
        ...
        create : typing.Optional[google.ads.googleads.v8.resources.bidding_strategy_pb2.BiddingStrategy] = ...,
        update : typing.Optional[google.ads.googleads.v8.resources.bidding_strategy_pb2.BiddingStrategy] = ...,
        remove : typing.Text = ...,
        ) -> None: ...
...
class MutateBiddingStrategiesResponse(google.protobuf.message.Message):
    ...
    def partial_failure_error(self) -> google.rpc.status_pb2.Status:
        ...
        pass
    @property
    def results(self) -> google.protobuf.internal.containers.RepeatedCompositeFieldContainer[global___MutateBiddingStrategyResult]:
        """All results for the mutate."""
        pass
    def __init__(self,
        *,
        partial_failure_error : typing.Optional[google.rpc.status_pb2.Status] = ...,
        results : typing.Optional[typing.Iterable[global___MutateBiddingStrategyResult]] = ...,
        ) -> None: ...
...
class MutateBiddingStrategyResult(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing_extensions.Literal["bidding_strategy",b"bidding_strategy"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["bidding_strategy",b"bidding_strategy","resource_name",b"resource_name"]) -> None: ...
