...
class MutateCampaignExperimentsRequest(google.protobuf.message.Message):
    ...
    @property
    def operations(self) -> google.protobuf.internal.containers.RepeatedCompositeFieldContainer[global___CampaignExperimentOperation]:
    ...
    def __init__(self,
        *,
        customer_id : typing.Text = ...,
        operations : typing.Optional[typing.Iterable[global___CampaignExperimentOperation]] = ...,
        partial_failure : builtins.bool = ...,
        validate_only : builtins.bool = ...,
        response_content_type : google.ads.googleads.v8.enums.response_content_type_pb2.ResponseContentTypeEnum.ResponseContentType.ValueType = ...,
        ) -> None: ...
...
class CampaignExperimentOperation(google.protobuf.message.Message):
    ...
    def update_mask(self) -> google.protobuf.field_mask_pb2.FieldMask:
        ...
        pass
    @property
    def update(self) -> google.ads.googleads.v8.resources.campaign_experiment_pb2.CampaignExperiment:
    ...
    def __init__(self,
        *,
        ...
        update : typing.Optional[google.ads.googleads.v8.resources.campaign_experiment_pb2.CampaignExperiment] = ...,
        remove : typing.Text = ...,
        ) -> None: ...
...
class MutateCampaignExperimentsResponse(google.protobuf.message.Message):
    ...
    def partial_failure_error(self) -> google.rpc.status_pb2.Status:
        ...
        pass
    @property
    def results(self) -> google.protobuf.internal.containers.RepeatedCompositeFieldContainer[global___MutateCampaignExperimentResult]:
        """All results for the mutate."""
        pass
    def __init__(self,
        *,
        partial_failure_error : typing.Optional[google.rpc.status_pb2.Status] = ...,
        results : typing.Optional[typing.Iterable[global___MutateCampaignExperimentResult]] = ...,
        ) -> None: ...
...
class MutateCampaignExperimentResult(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing_extensions.Literal["campaign_experiment",b"campaign_experiment"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["campaign_experiment",b"campaign_experiment","resource_name",b"resource_name"]) -> None: ...
...
class CreateCampaignExperimentRequest(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing_extensions.Literal["campaign_experiment",b"campaign_experiment"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["campaign_experiment",b"campaign_experiment","customer_id",b"customer_id","validate_only",b"validate_only"]) -> None: ...
...
class CreateCampaignExperimentMetadata(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing_extensions.Literal["campaign_experiment",b"campaign_experiment"]) -> None: ...
...
class GraduateCampaignExperimentRequest(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing_extensions.Literal["campaign_budget",b"campaign_budget","campaign_experiment",b"campaign_experiment","validate_only",b"validate_only"]) -> None: ...
...
class GraduateCampaignExperimentResponse(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing_extensions.Literal["graduated_campaign",b"graduated_campaign"]) -> None: ...
...
class PromoteCampaignExperimentRequest(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing_extensions.Literal["campaign_experiment",b"campaign_experiment","validate_only",b"validate_only"]) -> None: ...
