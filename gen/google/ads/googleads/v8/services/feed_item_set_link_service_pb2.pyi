...
class FeedItemSetLinkOperation(google.protobuf.message.Message):
    ...
    @property
    def create(self) -> google.ads.googleads.v8.resources.feed_item_set_link_pb2.FeedItemSetLink:
    ...
    def __init__(self,
        *,
        create : typing.Optional[google.ads.googleads.v8.resources.feed_item_set_link_pb2.FeedItemSetLink] = ...,
        remove : typing.Text = ...,
        ) -> None: ...
