...
class AdGroupAdLabelOperation(google.protobuf.message.Message):
    ...
    @property
    def create(self) -> google.ads.googleads.v8.resources.ad_group_ad_label_pb2.AdGroupAdLabel:
    ...
    def __init__(self,
        *,
        create : typing.Optional[google.ads.googleads.v8.resources.ad_group_ad_label_pb2.AdGroupAdLabel] = ...,
        remove : typing.Text = ...,
        ) -> None: ...
