...
class MutateCampaignCriteriaRequest(google.protobuf.message.Message):
    ...
    @property
    def operations(self) -> google.protobuf.internal.containers.RepeatedCompositeFieldContainer[global___CampaignCriterionOperation]:
    ...
    def __init__(self,
        *,
        customer_id : typing.Text = ...,
        operations : typing.Optional[typing.Iterable[global___CampaignCriterionOperation]] = ...,
        partial_failure : builtins.bool = ...,
        validate_only : builtins.bool = ...,
        response_content_type : google.ads.googleads.v8.enums.response_content_type_pb2.ResponseContentTypeEnum.ResponseContentType.ValueType = ...,
        ) -> None: ...
...
class CampaignCriterionOperation(google.protobuf.message.Message):
    ...
    def update_mask(self) -> google.protobuf.field_mask_pb2.FieldMask:
        ...
        pass
    @property
    def create(self) -> google.ads.googleads.v8.resources.campaign_criterion_pb2.CampaignCriterion:
        """Create operation: No resource name is expected for the new criterion."""
        pass
    @property
    def update(self) -> google.ads.googleads.v8.resources.campaign_criterion_pb2.CampaignCriterion:
    ...
    def __init__(self,
        *,
        ...
        create : typing.Optional[google.ads.googleads.v8.resources.campaign_criterion_pb2.CampaignCriterion] = ...,
        update : typing.Optional[google.ads.googleads.v8.resources.campaign_criterion_pb2.CampaignCriterion] = ...,
        remove : typing.Text = ...,
        ) -> None: ...
...
class MutateCampaignCriteriaResponse(google.protobuf.message.Message):
    ...
    def partial_failure_error(self) -> google.rpc.status_pb2.Status:
        ...
        pass
    @property
    def results(self) -> google.protobuf.internal.containers.RepeatedCompositeFieldContainer[global___MutateCampaignCriterionResult]:
        """All results for the mutate."""
        pass
    def __init__(self,
        *,
        partial_failure_error : typing.Optional[google.rpc.status_pb2.Status] = ...,
        results : typing.Optional[typing.Iterable[global___MutateCampaignCriterionResult]] = ...,
        ) -> None: ...
...
class MutateCampaignCriterionResult(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing_extensions.Literal["campaign_criterion",b"campaign_criterion"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["campaign_criterion",b"campaign_criterion","resource_name",b"resource_name"]) -> None: ...
