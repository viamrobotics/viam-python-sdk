...
if _descriptor._USE_C_DESCRIPTORS == False:
  ...
  _CUSTOMEREXTENSIONSETTINGSERVICE.methods_by_name['GetCustomerExtensionSetting']._serialized_options = b'\332A\rresource_name\202\323\344\223\002=\022;/v9/{resource_name=customers/*/customerExtensionSettings/*}'
  _CUSTOMEREXTENSIONSETTINGSERVICE.methods_by_name['MutateCustomerExtensionSettings']._options = None
  _CUSTOMEREXTENSIONSETTINGSERVICE.methods_by_name['MutateCustomerExtensionSettings']._serialized_options = b'\332A\026customer_id,operations\202\323\344\223\002C\">/v9/customers/{customer_id=*}/customerExtensionSettings:mutate:\001*'
