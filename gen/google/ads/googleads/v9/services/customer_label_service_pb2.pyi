...
class CustomerLabelOperation(google.protobuf.message.Message):
    ...
    @property
    def create(self) -> google.ads.googleads.v9.resources.customer_label_pb2.CustomerLabel:
    ...
    def __init__(self,
        *,
        create : typing.Optional[google.ads.googleads.v9.resources.customer_label_pb2.CustomerLabel] = ...,
        remove : typing.Text = ...,
        ) -> None: ...
