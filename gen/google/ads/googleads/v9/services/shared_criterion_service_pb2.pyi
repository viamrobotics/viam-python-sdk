...
class SharedCriterionOperation(google.protobuf.message.Message):
    ...
    @property
    def create(self) -> google.ads.googleads.v9.resources.shared_criterion_pb2.SharedCriterion:
    ...
    def __init__(self,
        *,
        create : typing.Optional[google.ads.googleads.v9.resources.shared_criterion_pb2.SharedCriterion] = ...,
        remove : typing.Text = ...,
        ) -> None: ...
