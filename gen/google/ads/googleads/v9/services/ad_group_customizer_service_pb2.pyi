...
class MutateAdGroupCustomizersRequest(google.protobuf.message.Message):
    """Request message for
    ...
    @property
    def operations(self) -> google.protobuf.internal.containers.RepeatedCompositeFieldContainer[global___AdGroupCustomizerOperation]:
    ...
    def __init__(self,
        *,
        customer_id : typing.Text = ...,
        operations : typing.Optional[typing.Iterable[global___AdGroupCustomizerOperation]] = ...,
        partial_failure : builtins.bool = ...,
        validate_only : builtins.bool = ...,
        response_content_type : google.ads.googleads.v9.enums.response_content_type_pb2.ResponseContentTypeEnum.ResponseContentType.ValueType = ...,
        ) -> None: ...
...
global___MutateAdGroupCustomizersRequest = MutateAdGroupCustomizersRequest

class AdGroupCustomizerOperation(google.protobuf.message.Message):
    """A single operation (create, remove) on an customizer attribute."""
    DESCRIPTOR: google.protobuf.descriptor.Descriptor = ...
    CREATE_FIELD_NUMBER: builtins.int
    REMOVE_FIELD_NUMBER: builtins.int
    @property
    def create(self) -> google.ads.googleads.v9.resources.ad_group_customizer_pb2.AdGroupCustomizer:
    ...
    def __init__(self,
        *,
        create : typing.Optional[google.ads.googleads.v9.resources.ad_group_customizer_pb2.AdGroupCustomizer] = ...,
        remove : typing.Text = ...,
        ) -> None: ...
...
global___AdGroupCustomizerOperation = AdGroupCustomizerOperation

class MutateAdGroupCustomizersResponse(google.protobuf.message.Message):
    """Response message for an ad group customizer mutate."""
    DESCRIPTOR: google.protobuf.descriptor.Descriptor = ...
    RESULTS_FIELD_NUMBER: builtins.int
    PARTIAL_FAILURE_ERROR_FIELD_NUMBER: builtins.int
    @property
    def results(self) -> google.protobuf.internal.containers.RepeatedCompositeFieldContainer[global___MutateAdGroupCustomizerResult]:
    ...
    def __init__(self,
        *,
        results : typing.Optional[typing.Iterable[global___MutateAdGroupCustomizerResult]] = ...,
...
global___MutateAdGroupCustomizersResponse = MutateAdGroupCustomizersResponse

class MutateAdGroupCustomizerResult(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing_extensions.Literal["ad_group_customizer",b"ad_group_customizer"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["ad_group_customizer",b"ad_group_customizer","resource_name",b"resource_name"]) -> None: ...
global___MutateAdGroupCustomizerResult = MutateAdGroupCustomizerResult
