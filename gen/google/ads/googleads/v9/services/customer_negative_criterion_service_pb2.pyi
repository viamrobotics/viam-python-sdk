...
class CustomerNegativeCriterionOperation(google.protobuf.message.Message):
    ...
    @property
    def create(self) -> google.ads.googleads.v9.resources.customer_negative_criterion_pb2.CustomerNegativeCriterion:
    ...
    def __init__(self,
        *,
        create : typing.Optional[google.ads.googleads.v9.resources.customer_negative_criterion_pb2.CustomerNegativeCriterion] = ...,
        remove : typing.Text = ...,
        ) -> None: ...
