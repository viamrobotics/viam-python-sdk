...
class LabelOperation(google.protobuf.message.Message):
    ...
    def update_mask(self) -> google.protobuf.field_mask_pb2.FieldMask:
        ...
        pass
    @property
    def create(self) -> google.ads.googleads.v9.resources.label_pb2.Label:
        """Create operation: No resource name is expected for the new label."""
        pass
    @property
    def update(self) -> google.ads.googleads.v9.resources.label_pb2.Label:
    ...
    def __init__(self,
        *,
        ...
        create : typing.Optional[google.ads.googleads.v9.resources.label_pb2.Label] = ...,
        update : typing.Optional[google.ads.googleads.v9.resources.label_pb2.Label] = ...,
        remove : typing.Text = ...,
        ) -> None: ...
