...
class CreateCustomerClientRequest(google.protobuf.message.Message):
    ...
    @property
    def customer_client(self) -> google.ads.googleads.v9.resources.customer_pb2.Customer:
    ...
    access_role: google.ads.googleads.v9.enums.access_role_pb2.AccessRoleEnum.AccessRole.ValueType = ...
    ...
    def __init__(self,
        *,
        customer_id : typing.Text = ...,
        customer_client : typing.Optional[google.ads.googleads.v9.resources.customer_pb2.Customer] = ...,
...
class CustomerOperation(google.protobuf.message.Message):
    ...
    @property
    def update(self) -> google.ads.googleads.v9.resources.customer_pb2.Customer:
    ...
    def __init__(self,
        *,
        update : typing.Optional[google.ads.googleads.v9.resources.customer_pb2.Customer] = ...,
