...
"""
import builtins
import google.ads.googleads.v9.enums.conversion_value_rule_status_pb2
import google.ads.googleads.v9.enums.value_rule_device_type_pb2
import google.ads.googleads.v9.enums.value_rule_geo_location_match_type_pb2
import google.ads.googleads.v9.enums.value_rule_operation_pb2
...
class ConversionValueRule(google.protobuf.message.Message):
    ...
    class ValueRuleAction(google.protobuf.message.Message):
        ...
        operation: google.ads.googleads.v9.enums.value_rule_operation_pb2.ValueRuleOperationEnum.ValueRuleOperation.ValueType = ...
    ...
    class ValueRuleGeoLocationCondition(google.protobuf.message.Message):
        ...
        def excluded_geo_target_constants(self) -> google.protobuf.internal.containers.RepeatedScalarFieldContainer[typing.Text]:
            ...
            pass
        excluded_geo_match_type: google.ads.googleads.v9.enums.value_rule_geo_location_match_type_pb2.ValueRuleGeoLocationMatchTypeEnum.ValueRuleGeoLocationMatchType.ValueType = ...
        ...
        def geo_target_constants(self) -> google.protobuf.internal.containers.RepeatedScalarFieldContainer[typing.Text]:
            ...
            pass
        geo_match_type: google.ads.googleads.v9.enums.value_rule_geo_location_match_type_pb2.ValueRuleGeoLocationMatchTypeEnum.ValueRuleGeoLocationMatchType.ValueType = ...
    ...
    class ValueRuleDeviceCondition(google.protobuf.message.Message):
        ...
        @property
        def device_types(self) -> google.protobuf.internal.containers.RepeatedScalarFieldContainer[google.ads.googleads.v9.enums.value_rule_device_type_pb2.ValueRuleDeviceTypeEnum.ValueRuleDeviceType.ValueType]:
            """Value for device type condition."""
            pass
        def __init__(self,
            *,
            device_types : typing.Optional[typing.Iterable[google.ads.googleads.v9.enums.value_rule_device_type_pb2.ValueRuleDeviceTypeEnum.ValueRuleDeviceType.ValueType]] = ...,
            ) -> None: ...
    ...
    ** Read-only **
    ...
    status: google.ads.googleads.v9.enums.conversion_value_rule_status_pb2.ConversionValueRuleStatusEnum.ConversionValueRuleStatus.ValueType = ...
