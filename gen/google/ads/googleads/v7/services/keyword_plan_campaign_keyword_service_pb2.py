...
if _descriptor._USE_C_DESCRIPTORS == False:
  ...
  _KEYWORDPLANCAMPAIGNKEYWORDSERVICE.methods_by_name['GetKeywordPlanCampaignKeyword']._serialized_options = b'\332A\rresource_name\202\323\344\223\002?\022=/v7/{resource_name=customers/*/keywordPlanCampaignKeywords/*}'
  _KEYWORDPLANCAMPAIGNKEYWORDSERVICE.methods_by_name['MutateKeywordPlanCampaignKeywords']._options = None
  _KEYWORDPLANCAMPAIGNKEYWORDSERVICE.methods_by_name['MutateKeywordPlanCampaignKeywords']._serialized_options = b'\332A\026customer_id,operations\202\323\344\223\002E\"@/v7/customers/{customer_id=*}/keywordPlanCampaignKeywords:mutate:\001*'
