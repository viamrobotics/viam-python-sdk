...
class CampaignSharedSetOperation(google.protobuf.message.Message):
    ...
    @property
    def create(self) -> google.ads.googleads.v7.resources.campaign_shared_set_pb2.CampaignSharedSet:
    ...
    def __init__(self,
        *,
        create : typing.Optional[google.ads.googleads.v7.resources.campaign_shared_set_pb2.CampaignSharedSet] = ...,
        remove : typing.Text = ...,
        ) -> None: ...
