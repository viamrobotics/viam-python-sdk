...
class AdGroupCriterionLabelOperation(google.protobuf.message.Message):
    ...
    @property
    def create(self) -> google.ads.googleads.v7.resources.ad_group_criterion_label_pb2.AdGroupCriterionLabel:
    ...
    def __init__(self,
        *,
        create : typing.Optional[google.ads.googleads.v7.resources.ad_group_criterion_label_pb2.AdGroupCriterionLabel] = ...,
        remove : typing.Text = ...,
        ) -> None: ...
