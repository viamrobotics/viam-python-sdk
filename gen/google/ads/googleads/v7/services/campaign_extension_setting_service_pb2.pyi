...
class MutateCampaignExtensionSettingsRequest(google.protobuf.message.Message):
    ...
    @property
    def operations(self) -> google.protobuf.internal.containers.RepeatedCompositeFieldContainer[global___CampaignExtensionSettingOperation]:
    ...
    def __init__(self,
        *,
        customer_id : typing.Text = ...,
        operations : typing.Optional[typing.Iterable[global___CampaignExtensionSettingOperation]] = ...,
        partial_failure : builtins.bool = ...,
        validate_only : builtins.bool = ...,
        response_content_type : google.ads.googleads.v7.enums.response_content_type_pb2.ResponseContentTypeEnum.ResponseContentType.ValueType = ...,
        ) -> None: ...
...
class CampaignExtensionSettingOperation(google.protobuf.message.Message):
    ...
    def update_mask(self) -> google.protobuf.field_mask_pb2.FieldMask:
        ...
        pass
    @property
    def create(self) -> google.ads.googleads.v7.resources.campaign_extension_setting_pb2.CampaignExtensionSetting:
        """Create operation: No resource name is expected for the new campaign
        extension setting.
        """
        pass
    @property
    def update(self) -> google.ads.googleads.v7.resources.campaign_extension_setting_pb2.CampaignExtensionSetting:
    ...
    def __init__(self,
        *,
        ...
        create : typing.Optional[google.ads.googleads.v7.resources.campaign_extension_setting_pb2.CampaignExtensionSetting] = ...,
        update : typing.Optional[google.ads.googleads.v7.resources.campaign_extension_setting_pb2.CampaignExtensionSetting] = ...,
        remove : typing.Text = ...,
        ) -> None: ...
...
class MutateCampaignExtensionSettingsResponse(google.protobuf.message.Message):
    ...
    def partial_failure_error(self) -> google.rpc.status_pb2.Status:
        ...
        pass
    @property
    def results(self) -> google.protobuf.internal.containers.RepeatedCompositeFieldContainer[global___MutateCampaignExtensionSettingResult]:
        """All results for the mutate."""
        pass
    def __init__(self,
        *,
        partial_failure_error : typing.Optional[google.rpc.status_pb2.Status] = ...,
        results : typing.Optional[typing.Iterable[global___MutateCampaignExtensionSettingResult]] = ...,
        ) -> None: ...
...
class MutateCampaignExtensionSettingResult(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing_extensions.Literal["campaign_extension_setting",b"campaign_extension_setting"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["campaign_extension_setting",b"campaign_extension_setting","resource_name",b"resource_name"]) -> None: ...
