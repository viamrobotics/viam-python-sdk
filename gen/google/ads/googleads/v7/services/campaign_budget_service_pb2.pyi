...
class MutateCampaignBudgetsRequest(google.protobuf.message.Message):
    ...
    @property
    def operations(self) -> google.protobuf.internal.containers.RepeatedCompositeFieldContainer[global___CampaignBudgetOperation]:
    ...
    def __init__(self,
        *,
        customer_id : typing.Text = ...,
        operations : typing.Optional[typing.Iterable[global___CampaignBudgetOperation]] = ...,
        partial_failure : builtins.bool = ...,
        validate_only : builtins.bool = ...,
        response_content_type : google.ads.googleads.v7.enums.response_content_type_pb2.ResponseContentTypeEnum.ResponseContentType.ValueType = ...,
        ) -> None: ...
...
class CampaignBudgetOperation(google.protobuf.message.Message):
    ...
    def update_mask(self) -> google.protobuf.field_mask_pb2.FieldMask:
        ...
        pass
    @property
    def create(self) -> google.ads.googleads.v7.resources.campaign_budget_pb2.CampaignBudget:
        """Create operation: No resource name is expected for the new budget."""
        pass
    @property
    def update(self) -> google.ads.googleads.v7.resources.campaign_budget_pb2.CampaignBudget:
    ...
    def __init__(self,
        *,
        ...
        create : typing.Optional[google.ads.googleads.v7.resources.campaign_budget_pb2.CampaignBudget] = ...,
        update : typing.Optional[google.ads.googleads.v7.resources.campaign_budget_pb2.CampaignBudget] = ...,
        remove : typing.Text = ...,
        ) -> None: ...
...
class MutateCampaignBudgetsResponse(google.protobuf.message.Message):
    ...
    def partial_failure_error(self) -> google.rpc.status_pb2.Status:
        ...
        pass
    @property
    def results(self) -> google.protobuf.internal.containers.RepeatedCompositeFieldContainer[global___MutateCampaignBudgetResult]:
        """All results for the mutate."""
        pass
    def __init__(self,
        *,
        partial_failure_error : typing.Optional[google.rpc.status_pb2.Status] = ...,
        results : typing.Optional[typing.Iterable[global___MutateCampaignBudgetResult]] = ...,
        ) -> None: ...
...
class MutateCampaignBudgetResult(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing_extensions.Literal["campaign_budget",b"campaign_budget"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["campaign_budget",b"campaign_budget","resource_name",b"resource_name"]) -> None: ...
