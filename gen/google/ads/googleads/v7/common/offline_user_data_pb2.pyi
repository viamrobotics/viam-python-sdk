...
"""
import builtins
import google.ads.googleads.v7.enums.user_identifier_source_pb2
...
class UserIdentifier(google.protobuf.message.Message):
    ...
    user_identifier_source: google.ads.googleads.v7.enums.user_identifier_source_pb2.UserIdentifierSourceEnum.UserIdentifierSource.ValueType = ...
...
class TransactionAttribute(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing_extensions.Literal["_conversion_action",b"_conversion_action","_currency_code",b"_currency_code","_custom_value",b"_custom_value","_order_id",b"_order_id","_transaction_amount_micros",b"_transaction_amount_micros","_transaction_date_time",b"_transaction_date_time","conversion_action",b"conversion_action","currency_code",b"currency_code","custom_value",b"custom_value","order_id",b"order_id","store_attribute",b"store_attribute","transaction_amount_micros",b"transaction_amount_micros","transaction_date_time",b"transaction_date_time"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["_conversion_action",b"_conversion_action","_currency_code",b"_currency_code","_custom_value",b"_custom_value","_order_id",b"_order_id","_transaction_amount_micros",b"_transaction_amount_micros","_transaction_date_time",b"_transaction_date_time","conversion_action",b"conversion_action","currency_code",b"currency_code","custom_value",b"custom_value","order_id",b"order_id","store_attribute",b"store_attribute","transaction_amount_micros",b"transaction_amount_micros","transaction_date_time",b"transaction_date_time"]) -> None: ...
    @typing.overload
...
class UserAttribute(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing_extensions.Literal["_lifetime_value_bucket",b"_lifetime_value_bucket","_lifetime_value_micros",b"_lifetime_value_micros","lifetime_value_bucket",b"lifetime_value_bucket","lifetime_value_micros",b"lifetime_value_micros"]) -> None: ...
    @typing.overload
