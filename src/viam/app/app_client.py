...
class AppClient:
    ...
    async def update_organization(
        ...
        """
        organization_id = await self._get_organization_id()
        request = UpdateOrganizationRequest(organization_id=organization_id, public_namespace=public_namespace, region=region, cid=None)
    ...
    async def delete_organization(self, org_id: Optional[str] = None) -> None:
        ...
        """
        organization_id = org_id if org_id else self._get_organization_id()
