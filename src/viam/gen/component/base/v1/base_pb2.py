...
if _descriptor._USE_C_DESCRIPTORS == False:
    ...
    _GETPROPERTIESRESPONSE._serialized_start = 1177
    _GETPROPERTIESRESPONSE._serialized_end = 1287
    _BASESERVICE._serialized_start = 1290
    _BASESERVICE._serialized_end = 2667