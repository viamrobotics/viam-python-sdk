...
_builder.BuildTopDescriptorsAndMessages(
    DESCRIPTOR, "component.base.v1.base_pb2", globals()
)
if _descriptor._USE_C_DESCRIPTORS == False:
    ...
    _BASESERVICE.methods_by_name[
        "MoveStraight"
    ]._serialized_options = b'\xa0\x92)\x01\x82\xd3\xe4\x93\x022"0/viam/api/v1/component/base/{name}/move_straight'
    _BASESERVICE.methods_by_name["Spin"]._options = None
    _BASESERVICE.methods_by_name[
        "Spin"
    ]._serialized_options = (
        b"\xa0\x92)\x01\x82\xd3\xe4\x93\x02)\"'/viam/api/v1/component/base/{name}/spin"
    )
    _BASESERVICE.methods_by_name["SetPower"]._options = None
    _BASESERVICE.methods_by_name[
        "SetPower"
    ]._serialized_options = b'\xa0\x92)\x01\x82\xd3\xe4\x93\x02.",/viam/api/v1/component/base/{name}/set_power'
    _BASESERVICE.methods_by_name["SetVelocity"]._options = None
    _BASESERVICE.methods_by_name[
        "SetVelocity"
    ]._serialized_options = b'\xa0\x92)\x01\x82\xd3\xe4\x93\x021"//viam/api/v1/component/base/{name}/set_velocity'
    _BASESERVICE.methods_by_name["Stop"]._options = None
    _BASESERVICE.methods_by_name[
        "Stop"
    ]._serialized_options = (
        b"\x82\xd3\xe4\x93\x02)\"'/viam/api/v1/component/base/{name}/stop"
    )
    _BASESERVICE.methods_by_name["IsMoving"]._options = None
    _BASESERVICE.methods_by_name[
        "IsMoving"
    ]._serialized_options = (
        b"\x82\xd3\xe4\x93\x02.\x12,/viam/api/v1/component/base/{name}/is_moving"
    )
    _BASESERVICE.methods_by_name["DoCommand"]._options = None
    _BASESERVICE.methods_by_name[
        "DoCommand"
    ]._serialized_options = (
        b'\x82\xd3\xe4\x93\x02/"-/viam/api/v1/component/base/{name}/do_command'
    )
    _BASESERVICE.methods_by_name["GetGeometries"]._options = None
    _BASESERVICE.methods_by_name[
        "GetGeometries"
    ]._serialized_options = (
        b"\x82\xd3\xe4\x93\x02/\x12-/viam/api/v1/component/base/{name}/geometries"
    )
    _BASESERVICE.methods_by_name["GetProperties"]._options = None
    _BASESERVICE.methods_by_name[
        "GetProperties"
    ]._serialized_options = (
        b"\x82\xd3\xe4\x93\x02/\x12-/viam/api/v1/component/base/{name}/properties"
    )
