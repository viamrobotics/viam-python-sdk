...
_runtime_version.ValidateProtobufRuntimeVersion(_runtime_version.Domain.PUBLIC, 5, 28, 2, '', 'component/base/v1/base.proto')
...
if not _descriptor._USE_C_DESCRIPTORS:
    ...
    _globals['_BASESERVICE']._serialized_end = 2730