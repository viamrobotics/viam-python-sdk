...
_builder.BuildTopDescriptorsAndMessages(
    DESCRIPTOR, "component.powersensor.v1.powersensor_pb2", globals()
)
if _descriptor._USE_C_DESCRIPTORS == False:
    ...
    _POWERSENSORSERVICE.methods_by_name[
        ...
        b"\x82\xd3\xe4\x93\x024\x122/viam/api/v1/component/power_sensor/{name}/voltage"
    )
    _POWERSENSORSERVICE.methods_by_name["GetCurrent"]._options = None
    _POWERSENSORSERVICE.methods_by_name[
        "GetCurrent"
    ]._serialized_options = (
        b"\x82\xd3\xe4\x93\x024\x122/viam/api/v1/component/power_sensor/{name}/current"
    )
    _POWERSENSORSERVICE.methods_by_name["GetPower"]._options = None
    _POWERSENSORSERVICE.methods_by_name[
        "GetPower"
    ]._serialized_options = (
        b"\x82\xd3\xe4\x93\x022\x120/viam/api/v1/component/power_sensor/{name}/power"
    )
    _POWERSENSORSERVICE.methods_by_name["GetReadings"]._options = None
    _POWERSENSORSERVICE.methods_by_name[
        "GetReadings"
    ]._serialized_options = (
        b"\x82\xd3\xe4\x93\x025\x123/viam/api/v1/component/power_sensor/{name}/readings"
    )
    _POWERSENSORSERVICE.methods_by_name["DoCommand"]._options = None
    _POWERSENSORSERVICE.methods_by_name[
        "DoCommand"
    ]._serialized_options = (
        b'\x82\xd3\xe4\x93\x027"5/viam/api/v1/component/power_sensor/{name}/do_command'
    )
