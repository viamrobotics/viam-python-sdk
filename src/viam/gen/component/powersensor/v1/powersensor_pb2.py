...
if not _descriptor._USE_C_DESCRIPTORS:
    ...
    _globals['_POWERSENSORSERVICE'].methods_by_name['GetStatus']._loaded_options = None
    _globals['_POWERSENSORSERVICE'].methods_by_name['GetStatus']._serialized_options = b'\x82\xd3\xe4\x93\x027\x125/viam/api/v1/component/power_sensor/{name}/get_status'
    ...
    _globals['_POWERSENSORSERVICE']._serialized_end = 1582