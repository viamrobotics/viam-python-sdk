...
class AudioOutServiceBase(abc.ABC):
    ...
    def __mapping__(self) -> typing.Dict[str, grpclib.const.Handler]:
        return {
            '/viam.component.audioout.v1.AudioOutService/Play': grpclib.const.Handler(
                self.Play,
                grpclib.const.Cardinality.UNARY_UNARY,
                component.audioout.v1.audioout_pb2.PlayRequest,
                component.audioout.v1.audioout_pb2.PlayResponse,
            ),
            '/viam.component.audioout.v1.AudioOutService/PlayStream': grpclib.const.Handler(
                self.PlayStream,
                grpclib.const.Cardinality.STREAM_UNARY,
                component.audioout.v1.audioout_pb2.PlayStreamRequest,
                component.audioout.v1.audioout_pb2.PlayStreamResponse,
            ),
            '/viam.component.audioout.v1.AudioOutService/GetProperties': grpclib.const.Handler(
                self.GetProperties,
                grpclib.const.Cardinality.UNARY_UNARY,
                common.v1.common_pb2.GetPropertiesRequest,
                common.v1.common_pb2.GetPropertiesResponse,
            ),
            '/viam.component.audioout.v1.AudioOutService/DoCommand': grpclib.const.Handler(
                self.DoCommand,
                grpclib.const.Cardinality.UNARY_UNARY,
                common.v1.common_pb2.DoCommandRequest,
                common.v1.common_pb2.DoCommandResponse,
            ),
            '/viam.component.audioout.v1.AudioOutService/GetStatus': grpclib.const.Handler(
                self.GetStatus,
                grpclib.const.Cardinality.UNARY_UNARY,
                common.v1.common_pb2.GetStatusRequest,
                common.v1.common_pb2.GetStatusResponse,
            ),
            '/viam.component.audioout.v1.AudioOutService/GetGeometries': grpclib.const.Handler(
                self.GetGeometries,
                grpclib.const.Cardinality.UNARY_UNARY,
...
class AudioOutServiceStub:
    ...
    def __init__(self, channel: grpclib.client.Channel) -> None:
        ...
        self.PlayStream = grpclib.client.StreamUnaryMethod(
            channel,
