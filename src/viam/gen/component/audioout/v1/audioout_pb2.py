...
_runtime_version.ValidateProtobufRuntimeVersion(_runtime_version.Domain.PUBLIC, 6, 33, 5, '', 'component/audioout/v1/audioout.proto')
...
if not _descriptor._USE_C_DESCRIPTORS:
    ...
    _globals['_AUDIOOUTSERVICE'].methods_by_name['GetStatus']._serialized_options = b'\x82\xd3\xe4\x93\x021\x12//viam/api/v1/service/audioout/{name}/get_status'
