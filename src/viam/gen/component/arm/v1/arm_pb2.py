...
if not _descriptor._USE_C_DESCRIPTORS:
    ...
    _globals['_ARMSERVICE'].methods_by_name['SetManualMode']._loaded_options = None
    _globals['_ARMSERVICE'].methods_by_name['SetManualMode']._serialized_options = b'\x82\xd3\xe4\x93\x02/\x1a-/viam/api/v1/component/arm/{name}/manual_mode'
    _globals['_ARMSERVICE'].methods_by_name['GetManualMode']._loaded_options = None
    _globals['_ARMSERVICE'].methods_by_name['GetManualMode']._serialized_options = b'\x82\xd3\xe4\x93\x02/\x12-/viam/api/v1/component/arm/{name}/manual_mode'
    _globals['_ARMSERVICE'].methods_by_name['GetProperties']._loaded_options = None
    _globals['_ARMSERVICE'].methods_by_name['GetProperties']._serialized_options = b'\x82\xd3\xe4\x93\x02,\x12*/viam/api/v1/component/arm/{name}/features'
    ...
    _globals['_SETMANUALMODEREQUEST']._serialized_start = 3096
    _globals['_SETMANUALMODEREQUEST']._serialized_end = 3251
    _globals['_SETMANUALMODERESPONSE']._serialized_start = 3253
    _globals['_SETMANUALMODERESPONSE']._serialized_end = 3276
    _globals['_GETMANUALMODEREQUEST']._serialized_start = 3278
    _globals['_GETMANUALMODEREQUEST']._serialized_end = 3367
    _globals['_GETMANUALMODERESPONSE']._serialized_start = 3369
    _globals['_GETMANUALMODERESPONSE']._serialized_end = 3425
    _globals['_GETPROPERTIESREQUEST']._serialized_start = 3427
    _globals['_GETPROPERTIESREQUEST']._serialized_end = 3516
    _globals['_GETPROPERTIESRESPONSE']._serialized_start = 3519
    _globals['_GETPROPERTIESRESPONSE']._serialized_end = 3652
    _globals['_ARMSERVICE']._serialized_start = 3655
    _globals['_ARMSERVICE']._serialized_end = 6251