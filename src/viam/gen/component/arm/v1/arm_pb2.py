...
_builder.BuildTopDescriptorsAndMessages(
    DESCRIPTOR, "component.arm.v1.arm_pb2", globals()
)
if _descriptor._USE_C_DESCRIPTORS == False:
    ...
    _ARMSERVICE.methods_by_name[
        ...
        b"\x82\xd3\xe4\x93\x02,\x12*/viam/api/v1/component/arm/{name}/position"
    )
    _ARMSERVICE.methods_by_name["MoveToPosition"]._options = None
    _ARMSERVICE.methods_by_name[
        "MoveToPosition"
    ]._serialized_options = b"\xa0\x92)\x01\x82\xd3\xe4\x93\x02,\x1a*/viam/api/v1/component/arm/{name}/position"
    _ARMSERVICE.methods_by_name["GetJointPositions"]._options = None
    _ARMSERVICE.methods_by_name[
        "GetJointPositions"
    ]._serialized_options = (
        b"\x82\xd3\xe4\x93\x023\x121/viam/api/v1/component/arm/{name}/joint_positions"
    )
    _ARMSERVICE.methods_by_name["MoveToJointPositions"]._options = None
    _ARMSERVICE.methods_by_name[
        "MoveToJointPositions"
    ]._serialized_options = b"\xa0\x92)\x01\x82\xd3\xe4\x93\x023\x1a1/viam/api/v1/component/arm/{name}/joint_positions"
    _ARMSERVICE.methods_by_name["Stop"]._options = None
    _ARMSERVICE.methods_by_name[
        "Stop"
    ]._serialized_options = (
        b'\x82\xd3\xe4\x93\x02("&/viam/api/v1/component/arm/{name}/stop'
    )
    _ARMSERVICE.methods_by_name["IsMoving"]._options = None
    _ARMSERVICE.methods_by_name[
        "IsMoving"
    ]._serialized_options = (
        b"\x82\xd3\xe4\x93\x02-\x12+/viam/api/v1/component/arm/{name}/is_moving"
    )
    _ARMSERVICE.methods_by_name["DoCommand"]._options = None
    _ARMSERVICE.methods_by_name[
        "DoCommand"
    ]._serialized_options = (
        b'\x82\xd3\xe4\x93\x02.",/viam/api/v1/component/arm/{name}/do_command'
    )
    _ARMSERVICE.methods_by_name["GetKinematics"]._options = None
    _ARMSERVICE.methods_by_name[
        "GetKinematics"
    ]._serialized_options = (
        b"\x82\xd3\xe4\x93\x02.\x12,/viam/api/v1/component/arm/{name}/kinematics"
    )
    _ARMSERVICE.methods_by_name["GetGeometries"]._options = None
    _ARMSERVICE.methods_by_name[
        "GetGeometries"
    ]._serialized_options = (
        b"\x82\xd3\xe4\x93\x02.\x12,/viam/api/v1/component/arm/{name}/geometries"
    )
