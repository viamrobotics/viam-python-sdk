...
if not _descriptor._USE_C_DESCRIPTORS:
    ...
    _globals['_MOVEOPTIONS']._serialized_end = 1897
    _globals['_ARMSERVICE']._serialized_start = 1900
    _globals['_ARMSERVICE']._serialized_end = 3828