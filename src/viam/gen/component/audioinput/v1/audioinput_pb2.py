...
_builder.BuildTopDescriptorsAndMessages(
    DESCRIPTOR, "component.audioinput.v1.audioinput_pb2", globals()
)
if _descriptor._USE_C_DESCRIPTORS == False:
    ...
    _AUDIOINPUTSERVICE.methods_by_name[
        "Properties"
    ]._serialized_options = (
        b"\x82\xd3\xe4\x93\x025\x123/viam/api/v1/component/audioinput/{name}/properties"
    )
    _AUDIOINPUTSERVICE.methods_by_name["Record"]._options = None
    _AUDIOINPUTSERVICE.methods_by_name[
        "Record"
    ]._serialized_options = (
        b"\x82\xd3\xe4\x93\x021\x12//viam/api/v1/component/audioinput/{name}/record"
    )
    _AUDIOINPUTSERVICE.methods_by_name["DoCommand"]._options = None
    _AUDIOINPUTSERVICE.methods_by_name[
        "DoCommand"
    ]._serialized_options = (
        b'\x82\xd3\xe4\x93\x025"3/viam/api/v1/component/audioinput/{name}/do_command'
    )
    _AUDIOINPUTSERVICE.methods_by_name["GetGeometries"]._options = None
    _AUDIOINPUTSERVICE.methods_by_name[
        "GetGeometries"
    ]._serialized_options = (
        b"\x82\xd3\xe4\x93\x025\x123/viam/api/v1/component/audioinput/{name}/geometries"
    )
