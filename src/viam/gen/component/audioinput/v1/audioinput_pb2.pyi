...
class _SampleFormatEnumTypeWrapper(
    google.protobuf.internal.enum_type_wrapper._EnumTypeWrapper[
        _SampleFormat.ValueType
    ],
    builtins.type,
):
...
class RecordRequest(google.protobuf.message.Message):
    ...
    def ClearField(
        self,
        field_name: typing_extensions.Literal["duration", b"duration", "name", b"name"],
    ) -> None: ...
...
class AudioChunk(google.protobuf.message.Message):
    ...
    def __init__(
        self, *, data: builtins.bytes = ..., length: builtins.int = ...
    ) -> None: ...
    def ClearField(
        self,
        field_name: typing_extensions.Literal["data", b"data", "length", b"length"],
    ) -> None: ...
...
class ChunksRequest(google.protobuf.message.Message):
    ...
    def ClearField(
        self,
        field_name: typing_extensions.Literal[
            "name", b"name", "sample_format", b"sample_format"
        ],
    ) -> None: ...
...
class ChunksResponse(google.protobuf.message.Message):
    ...
    def __init__(
        self,
        *,
        info: global___AudioChunkInfo | None = ...,
        chunk: global___AudioChunk | None = ...,
    ) -> None: ...
    def HasField(
        self,
        field_name: typing_extensions.Literal[
            "chunk", b"chunk", "info", b"info", "type", b"type"
        ],
    ) -> builtins.bool: ...
    def ClearField(
        self,
    ...
    ) -> typing_extensions.Literal["info", "chunk"] | None: ...
