...
_builder.BuildTopDescriptorsAndMessages(
    DESCRIPTOR, "component.generic.v1.generic_pb2", globals()
)
if _descriptor._USE_C_DESCRIPTORS == False:
    ...
    _GENERICSERVICE.methods_by_name[
        ...
        b'\x82\xd3\xe4\x93\x022"0/viam/api/v1/component/generic/{name}/do_command'
    )
    _GENERICSERVICE.methods_by_name["GetGeometries"]._options = None
    _GENERICSERVICE.methods_by_name[
        "GetGeometries"
    ]._serialized_options = (
        b"\x82\xd3\xe4\x93\x022\x120/viam/api/v1/component/generic/{name}/geometries"
    )
