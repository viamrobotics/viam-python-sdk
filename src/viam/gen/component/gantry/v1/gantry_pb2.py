...
if not _descriptor._USE_C_DESCRIPTORS:
    ...
    _globals['_GANTRYSERVICE'].methods_by_name['GetStatus']._loaded_options = None
    _globals['_GANTRYSERVICE'].methods_by_name['GetStatus']._serialized_options = b'\x82\xd3\xe4\x93\x021\x12//viam/api/v1/component/gantry/{name}/get_status'
    ...
    _globals['_GANTRYSERVICE']._serialized_end = 2577