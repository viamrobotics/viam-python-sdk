...
_builder.BuildTopDescriptorsAndMessages(
    DESCRIPTOR, "component.gantry.v1.gantry_pb2", globals()
)
if _descriptor._USE_C_DESCRIPTORS == False:
    ...
    _GANTRYSERVICE.methods_by_name[
        ...
        b"\x82\xd3\xe4\x93\x02/\x12-/viam/api/v1/component/gantry/{name}/position"
    )
    _GANTRYSERVICE.methods_by_name["MoveToPosition"]._options = None
    _GANTRYSERVICE.methods_by_name[
        "MoveToPosition"
    ]._serialized_options = b"\xa0\x92)\x01\x82\xd3\xe4\x93\x02/\x1a-/viam/api/v1/component/gantry/{name}/position"
    _GANTRYSERVICE.methods_by_name["Home"]._options = None
    _GANTRYSERVICE.methods_by_name[
        "Home"
    ]._serialized_options = (
        b"\x82\xd3\xe4\x93\x02+\x1a)/viam/api/v1/component/gantry/{name}/home"
    )
    _GANTRYSERVICE.methods_by_name["GetLengths"]._options = None
    _GANTRYSERVICE.methods_by_name[
        "GetLengths"
    ]._serialized_options = (
        b"\x82\xd3\xe4\x93\x02.\x12,/viam/api/v1/component/gantry/{name}/lengths"
    )
    _GANTRYSERVICE.methods_by_name["Stop"]._options = None
    _GANTRYSERVICE.methods_by_name[
        "Stop"
    ]._serialized_options = (
        b'\x82\xd3\xe4\x93\x02+")/viam/api/v1/component/gantry/{name}/stop'
    )
    _GANTRYSERVICE.methods_by_name["IsMoving"]._options = None
    _GANTRYSERVICE.methods_by_name[
        "IsMoving"
    ]._serialized_options = (
        b"\x82\xd3\xe4\x93\x020\x12./viam/api/v1/component/gantry/{name}/is_moving"
    )
    _GANTRYSERVICE.methods_by_name["DoCommand"]._options = None
    _GANTRYSERVICE.methods_by_name[
        "DoCommand"
    ]._serialized_options = (
        b'\x82\xd3\xe4\x93\x021"//viam/api/v1/component/gantry/{name}/do_command'
    )
    _GANTRYSERVICE.methods_by_name["GetGeometries"]._options = None
    _GANTRYSERVICE.methods_by_name[
        "GetGeometries"
    ]._serialized_options = (
        b"\x82\xd3\xe4\x93\x021\x12//viam/api/v1/component/gantry/{name}/geometries"
    )
