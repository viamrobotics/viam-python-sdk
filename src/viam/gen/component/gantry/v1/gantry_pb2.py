...
if _descriptor._USE_C_DESCRIPTORS == False:
    ...
    _GANTRYSERVICE.methods_by_name['GetKinematics']._options = None
    _GANTRYSERVICE.methods_by_name['GetKinematics']._serialized_options = b'\x82\xd3\xe4\x93\x021\x12//viam/api/v1/component/gantry/{name}/kinematics'
