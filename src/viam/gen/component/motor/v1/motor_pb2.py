...
if not _descriptor._USE_C_DESCRIPTORS:
    ...
    _globals['_MOTORSERVICE'].methods_by_name['GetStatus']._loaded_options = None
    _globals['_MOTORSERVICE'].methods_by_name['GetStatus']._serialized_options = b'\x82\xd3\xe4\x93\x020\x12./viam/api/v1/component/motor/{name}/get_status'
    ...
    _globals['_MOTORSERVICE']._serialized_end = 3590