...
if _descriptor._USE_C_DESCRIPTORS == False:
    ...
    _globals['_RESETZEROPOSITIONREQUEST']._serialized_start = 599
    _globals['_RESETZEROPOSITIONREQUEST']._serialized_end = 716
    _globals['_RESETZEROPOSITIONRESPONSE']._serialized_start = 718
    _globals['_RESETZEROPOSITIONRESPONSE']._serialized_end = 745
    _globals['_GETPOSITIONREQUEST']._serialized_start = 747
    _globals['_GETPOSITIONREQUEST']._serialized_end = 834
    _globals['_GETPOSITIONRESPONSE']._serialized_start = 836
    _globals['_GETPOSITIONRESPONSE']._serialized_end = 885
    _globals['_STOPREQUEST']._serialized_start = 887
    _globals['_STOPREQUEST']._serialized_end = 967
    _globals['_STOPRESPONSE']._serialized_start = 969
    _globals['_STOPRESPONSE']._serialized_end = 983
    _globals['_ISPOWEREDREQUEST']._serialized_start = 985
    _globals['_ISPOWEREDREQUEST']._serialized_end = 1070
    _globals['_ISPOWEREDRESPONSE']._serialized_start = 1072
    _globals['_ISPOWEREDRESPONSE']._serialized_end = 1141
    _globals['_GETPROPERTIESREQUEST']._serialized_start = 1143
    _globals['_GETPROPERTIESREQUEST']._serialized_end = 1232
    _globals['_GETPROPERTIESRESPONSE']._serialized_start = 1234
    _globals['_GETPROPERTIESRESPONSE']._serialized_end = 1304
    _globals['_STATUS']._serialized_start = 1306
    _globals['_STATUS']._serialized_end = 1402
    _globals['_ISMOVINGREQUEST']._serialized_start = 1404
    _globals['_ISMOVINGREQUEST']._serialized_end = 1441
    _globals['_ISMOVINGRESPONSE']._serialized_start = 1443
    _globals['_ISMOVINGRESPONSE']._serialized_end = 1490
    _globals['_MOTORSERVICE']._serialized_start = 1493
    _globals['_MOTORSERVICE']._serialized_end = 3182