...
if _descriptor._USE_C_DESCRIPTORS == False:
    ...
    _STATUS._serialized_start = 1307
    _STATUS._serialized_end = 1450
    _MOTORSERVICE._serialized_start = 1453
    _MOTORSERVICE._serialized_end = 2699