...
_builder.BuildTopDescriptorsAndMessages(
    DESCRIPTOR, "component.motor.v1.motor_pb2", globals()
)
if _descriptor._USE_C_DESCRIPTORS == False:
    ...
    _MOTORSERVICE.methods_by_name[
        "SetPower"
    ]._serialized_options = b"\xa0\x92)\x01\x82\xd3\xe4\x93\x02+\x1a)/viam/api/v1/component/motor/{name}/power"
    _MOTORSERVICE.methods_by_name["GoFor"]._options = None
    _MOTORSERVICE.methods_by_name[
        "GoFor"
    ]._serialized_options = b"\xa0\x92)\x01\x82\xd3\xe4\x93\x02,\x1a*/viam/api/v1/component/motor/{name}/go_for"
    _MOTORSERVICE.methods_by_name["GoTo"]._options = None
    _MOTORSERVICE.methods_by_name[
        "GoTo"
    ]._serialized_options = b"\xa0\x92)\x01\x82\xd3\xe4\x93\x02+\x1a)/viam/api/v1/component/motor/{name}/go_to"
    _MOTORSERVICE.methods_by_name["ResetZeroPosition"]._options = None
    _MOTORSERVICE.methods_by_name[
        "ResetZeroPosition"
    ]._serialized_options = (
        b"\x82\xd3\xe4\x93\x02*\x1a(/viam/api/v1/component/motor/{name}/zero"
    )
    _MOTORSERVICE.methods_by_name["GetPosition"]._options = None
    _MOTORSERVICE.methods_by_name[
        "GetPosition"
    ]._serialized_options = (
        b"\x82\xd3\xe4\x93\x02.\x12,/viam/api/v1/component/motor/{name}/position"
    )
    _MOTORSERVICE.methods_by_name["GetProperties"]._options = None
    _MOTORSERVICE.methods_by_name[
        "GetProperties"
    ]._serialized_options = (
        b"\x82\xd3\xe4\x93\x02.\x12,/viam/api/v1/component/motor/{name}/features"
    )
    _MOTORSERVICE.methods_by_name["Stop"]._options = None
    _MOTORSERVICE.methods_by_name[
        "Stop"
    ]._serialized_options = (
        b"\x82\xd3\xe4\x93\x02*\x1a(/viam/api/v1/component/motor/{name}/stop"
    )
    _MOTORSERVICE.methods_by_name["IsPowered"]._options = None
    _MOTORSERVICE.methods_by_name[
        "IsPowered"
    ]._serialized_options = (
        b"\x82\xd3\xe4\x93\x02-\x12+/viam/api/v1/component/motor/{name}/powered"
    )
    _MOTORSERVICE.methods_by_name["IsMoving"]._options = None
    _MOTORSERVICE.methods_by_name[
        "IsMoving"
    ]._serialized_options = (
        b"\x82\xd3\xe4\x93\x02/\x12-/viam/api/v1/component/motor/{name}/is_moving"
    )
    _MOTORSERVICE.methods_by_name["DoCommand"]._options = None
    _MOTORSERVICE.methods_by_name[
        "DoCommand"
    ]._serialized_options = (
        b'\x82\xd3\xe4\x93\x020"./viam/api/v1/component/motor/{name}/do_command'
    )
    _MOTORSERVICE.methods_by_name["GetGeometries"]._options = None
    _MOTORSERVICE.methods_by_name[
        "GetGeometries"
    ]._serialized_options = (
        b"\x82\xd3\xe4\x93\x020\x12./viam/api/v1/component/motor/{name}/geometries"
    )
