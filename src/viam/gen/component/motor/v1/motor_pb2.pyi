...
class SetPowerRequest(google.protobuf.message.Message):
    ...
    def ClearField(
        ...
        field_name: typing_extensions.Literal[
            "extra", b"extra", "name", b"name", "power_pct", b"power_pct"
        ],
    ) -> None: ...
...
class ResetZeroPositionRequest(google.protobuf.message.Message):
    ...
    def ClearField(
        self,
        field_name: typing_extensions.Literal[
            "extra", b"extra", "name", b"name", "offset", b"offset"
        ],
    ) -> None: ...
...
class GetPositionResponse(google.protobuf.message.Message):
    ...
    def ClearField(
        self, field_name: typing_extensions.Literal["position", b"position"]
    ) -> None: ...
...
class IsPoweredResponse(google.protobuf.message.Message):
    ...
    def __init__(
        self, *, is_on: builtins.bool = ..., power_pct: builtins.float = ...
    ) -> None: ...
    def ClearField(
        self,
        field_name: typing_extensions.Literal[
            "is_on", b"is_on", "power_pct", b"power_pct"
        ],
    ) -> None: ...
...
class GetPropertiesResponse(google.protobuf.message.Message):
    ...
    def ClearField(
        self,
        field_name: typing_extensions.Literal[
            "position_reporting", b"position_reporting"
        ],
    ) -> None: ...
