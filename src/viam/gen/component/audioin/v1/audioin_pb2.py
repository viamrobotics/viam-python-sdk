...
_builder.BuildTopDescriptorsAndMessages(DESCRIPTOR, 'component.audioin.v1.audioin_pb2', globals())
if _descriptor._USE_C_DESCRIPTORS == False:
    DESCRIPTOR._options = None
    DESCRIPTOR._serialized_options = b'\n\x1dcom.viam.component.audioin.v1Z$go.viam.com/api/component/audioin/v1'
    _AUDIOINSERVICE.methods_by_name['GetAudio']._options = None
    _AUDIOINSERVICE.methods_by_name['GetAudio']._serialized_options = b'\x82\xd3\xe4\x93\x021\x12//viam/api/v1/component/audioin/{name}/get_audio'
    _AUDIOINSERVICE.methods_by_name['GetProperties']._options = None
    _AUDIOINSERVICE.methods_by_name['GetProperties']._serialized_options = b'\x82\xd3\xe4\x93\x022\x120/viam/api/v1/component/audioin/{name}/properties'
    _AUDIOINSERVICE.methods_by_name['DoCommand']._options = None
    _AUDIOINSERVICE.methods_by_name['DoCommand']._serialized_options = b'\x82\xd3\xe4\x93\x020"./viam/api/v1/service/audioin/{name}/do_command'
    _AUDIOINSERVICE.methods_by_name['GetGeometries']._options = None
    _AUDIOINSERVICE.methods_by_name['GetGeometries']._serialized_options = b'\x82\xd3\xe4\x93\x022\x120/viam/api/v1/component/audioin/{name}/geometries'
    _GETAUDIOREQUEST._serialized_start = 150
    _GETAUDIOREQUEST._serialized_end = 400
    _GETAUDIORESPONSE._serialized_start = 402
    _GETAUDIORESPONSE._serialized_end = 512
    _AUDIOCHUNK._serialized_start = 515
    _AUDIOCHUNK._serialized_end = 768
    _AUDIOINSERVICE._serialized_start = 771
    _AUDIOINSERVICE._serialized_end = 1393