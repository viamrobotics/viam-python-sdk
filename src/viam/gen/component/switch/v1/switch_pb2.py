...
_runtime_version.ValidateProtobufRuntimeVersion(_runtime_version.Domain.PUBLIC, 5, 29, 1, '', 'component/switch/v1/switch.proto')
...
if not _descriptor._USE_C_DESCRIPTORS:
    ...
    _globals['_GETNUMBEROFPOSITIONSRESPONSE']._serialized_end = 602
    _globals['_SWITCHSERVICE']._serialized_start = 605
    _globals['_SWITCHSERVICE']._serialized_end = 1302