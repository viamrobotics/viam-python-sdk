...
if not _descriptor._USE_C_DESCRIPTORS:
    ...
    _globals['_SWITCHSERVICE'].methods_by_name['SetPosition']._serialized_options = b'\xa0\x92)\x01\x82\xd3\xe4\x93\x023\x1a1/viam/api/v1/component/switch/{name}/set_position'
    ...
    _globals['_SWITCHSERVICE'].methods_by_name['GetStatus']._loaded_options = None
    _globals['_SWITCHSERVICE'].methods_by_name['GetStatus']._serialized_options = b'\x82\xd3\xe4\x93\x021\x12//viam/api/v1/component/switch/{name}/get_status'
    ...
    _globals['_SWITCHSERVICE']._serialized_end = 1470