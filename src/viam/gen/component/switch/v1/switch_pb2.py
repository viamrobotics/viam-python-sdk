...
_builder.BuildTopDescriptorsAndMessages(DESCRIPTOR, 'component.switch.v1.switch_pb2', globals())
if _descriptor._USE_C_DESCRIPTORS == False:
    DESCRIPTOR._options = None
    DESCRIPTOR._serialized_options = b'\n\x1ccom.viam.component.switch.v1Z#go.viam.com/api/component/switch/v1'
    _SWITCHSERVICE.methods_by_name['SetPosition']._options = None
    _SWITCHSERVICE.methods_by_name['SetPosition']._serialized_options = b'\x82\xd3\xe4\x93\x023\x1a1/viam/api/v1/component/switch/{name}/set_position'
    _SWITCHSERVICE.methods_by_name['GetPosition']._options = None
    _SWITCHSERVICE.methods_by_name['GetPosition']._serialized_options = b'\x82\xd3\xe4\x93\x023\x1a1/viam/api/v1/component/switch/{name}/get_position'
    _SWITCHSERVICE.methods_by_name['GetNumberOfPositions']._options = None
    _SWITCHSERVICE.methods_by_name['GetNumberOfPositions']._serialized_options = b'\x82\xd3\xe4\x93\x02>\x1a</viam/api/v1/component/switch/{name}/get_number_of_positions'
    _SWITCHSERVICE.methods_by_name['DoCommand']._options = None
    _SWITCHSERVICE.methods_by_name['DoCommand']._serialized_options = b'\x82\xd3\xe4\x93\x021"//viam/api/v1/component/switch/{name}/do_command'
    _SETPOSITIONREQUEST._serialized_start = 146
    _SETPOSITIONREQUEST._serialized_end = 261
    _SETPOSITIONRESPONSE._serialized_start = 263
    _SETPOSITIONRESPONSE._serialized_end = 284
    _GETPOSITIONREQUEST._serialized_start = 286
    _GETPOSITIONREQUEST._serialized_end = 373
    _GETPOSITIONRESPONSE._serialized_start = 375
    _GETPOSITIONRESPONSE._serialized_end = 424
    _GETNUMBEROFPOSITIONSREQUEST._serialized_start = 426
    _GETNUMBEROFPOSITIONSREQUEST._serialized_end = 522
    _GETNUMBEROFPOSITIONSRESPONSE._serialized_start = 524
    _GETNUMBEROFPOSITIONSRESPONSE._serialized_end = 626
    _SWITCHSERVICE._serialized_start = 629
    _SWITCHSERVICE._serialized_end = 1326