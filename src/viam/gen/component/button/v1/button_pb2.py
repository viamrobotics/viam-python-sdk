...
if not _descriptor._USE_C_DESCRIPTORS:
    ...
    _globals['_BUTTONSERVICE'].methods_by_name['Push']._serialized_options = b'\xa0\x92)\x01\x82\xd3\xe4\x93\x02+\x1a)/viam/api/v1/component/button/{name}/push'
    ...
    _globals['_BUTTONSERVICE'].methods_by_name['GetStatus']._loaded_options = None
    _globals['_BUTTONSERVICE'].methods_by_name['GetStatus']._serialized_options = b'\x82\xd3\xe4\x93\x021\x12//viam/api/v1/component/button/{name}/get_status'
    ...
    _globals['_BUTTONSERVICE']._serialized_end = 683