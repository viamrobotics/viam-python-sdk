...
_builder.BuildTopDescriptorsAndMessages(
    DESCRIPTOR, "component.board.v1.board_pb2", globals()
)
if _descriptor._USE_C_DESCRIPTORS == False:
    ...
    _BOARDSERVICE.methods_by_name[
        ...
        b"\x82\xd3\xe4\x93\x02,\x12*/viam/api/v1/component/board/{name}/status"
    )
    _BOARDSERVICE.methods_by_name["SetGPIO"]._options = None
    _BOARDSERVICE.methods_by_name[
        "SetGPIO"
    ]._serialized_options = (
        b"\x82\xd3\xe4\x93\x02*\x1a(/viam/api/v1/component/board/{name}/gpio"
    )
    _BOARDSERVICE.methods_by_name["GetGPIO"]._options = None
    _BOARDSERVICE.methods_by_name[
        "GetGPIO"
    ]._serialized_options = (
        b"\x82\xd3\xe4\x93\x02*\x12(/viam/api/v1/component/board/{name}/gpio"
    )
    _BOARDSERVICE.methods_by_name["PWM"]._options = None
    _BOARDSERVICE.methods_by_name[
        "PWM"
    ]._serialized_options = (
        b"\x82\xd3\xe4\x93\x02)\x12'/viam/api/v1/component/board/{name}/pwm"
    )
    _BOARDSERVICE.methods_by_name["SetPWM"]._options = None
    _BOARDSERVICE.methods_by_name[
        "SetPWM"
    ]._serialized_options = (
        b"\x82\xd3\xe4\x93\x02)\x1a'/viam/api/v1/component/board/{name}/pwm"
    )
    _BOARDSERVICE.methods_by_name["PWMFrequency"]._options = None
    _BOARDSERVICE.methods_by_name[
        "PWMFrequency"
    ]._serialized_options = (
        b"\x82\xd3\xe4\x93\x02.\x12,/viam/api/v1/component/board/{name}/pwm_freq"
    )
    _BOARDSERVICE.methods_by_name["SetPWMFrequency"]._options = None
    _BOARDSERVICE.methods_by_name[
        "SetPWMFrequency"
    ]._serialized_options = (
        b"\x82\xd3\xe4\x93\x02.\x1a,/viam/api/v1/component/board/{name}/pwm_freq"
    )
    _BOARDSERVICE.methods_by_name["DoCommand"]._options = None
    _BOARDSERVICE.methods_by_name[
        "DoCommand"
    ]._serialized_options = (
        b'\x82\xd3\xe4\x93\x020"./viam/api/v1/component/board/{name}/do_command'
    )
    _BOARDSERVICE.methods_by_name["ReadAnalogReader"]._options = None
    _BOARDSERVICE.methods_by_name[
        "ReadAnalogReader"
    ]._serialized_options = b"\x82\xd3\xe4\x93\x02S\x12Q/viam/api/v1/component/board/{board_name}/analog_reader/{analog_reader_name}/read"
    _BOARDSERVICE.methods_by_name["WriteAnalog"]._options = None
    _BOARDSERVICE.methods_by_name[
        "WriteAnalog"
    ]._serialized_options = (
        b"\x82\xd3\xe4\x93\x022\x1a0/viam/api/v1/component/board/{name}/analog_write"
    )
    _BOARDSERVICE.methods_by_name["GetDigitalInterruptValue"]._options = None
    _BOARDSERVICE.methods_by_name[
        "GetDigitalInterruptValue"
    ]._serialized_options = b"\x82\xd3\xe4\x93\x02\\\x12Z/viam/api/v1/component/board/{board_name}/digital_interrupt/{digital_interrupt_name}/value"
    _BOARDSERVICE.methods_by_name["SetPowerMode"]._options = None
    _BOARDSERVICE.methods_by_name[
        "SetPowerMode"
    ]._serialized_options = (
        b"\x82\xd3\xe4\x93\x020\x1a./viam/api/v1/component/board/{name}/power_mode"
    )
    _BOARDSERVICE.methods_by_name["GetGeometries"]._options = None
    _BOARDSERVICE.methods_by_name[
        "GetGeometries"
    ]._serialized_options = (
        b"\x82\xd3\xe4\x93\x020\x12./viam/api/v1/component/board/{name}/geometries"
    )
