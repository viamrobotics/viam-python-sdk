...
if _descriptor._USE_C_DESCRIPTORS == False:
    ...
    _globals['_POWERMODE']._serialized_start = 1949
    _globals['_POWERMODE']._serialized_end = 2040
    _globals['_STATUSREQUEST']._serialized_start = 175
    _globals['_STATUSREQUEST']._serialized_end = 257
    _globals['_STATUSRESPONSE']._serialized_start = 259
    _globals['_STATUSRESPONSE']._serialized_end = 328
    _globals['_SETGPIOREQUEST']._serialized_start = 330
    _globals['_SETGPIOREQUEST']._serialized_end = 451
    _globals['_SETGPIORESPONSE']._serialized_start = 453
    _globals['_SETGPIORESPONSE']._serialized_end = 470
    _globals['_GETGPIOREQUEST']._serialized_start = 472
    _globals['_GETGPIOREQUEST']._serialized_end = 573
    _globals['_GETGPIORESPONSE']._serialized_start = 575
    _globals['_GETGPIORESPONSE']._serialized_end = 612
    _globals['_PWMREQUEST']._serialized_start = 614
    _globals['_PWMREQUEST']._serialized_end = 711
    _globals['_PWMRESPONSE']._serialized_start = 713
    _globals['_PWMRESPONSE']._serialized_end = 764
    _globals['_SETPWMREQUEST']._serialized_start = 767
    _globals['_SETPWMREQUEST']._serialized_end = 905
    _globals['_SETPWMRESPONSE']._serialized_start = 907
    _globals['_SETPWMRESPONSE']._serialized_end = 923
    _globals['_PWMFREQUENCYREQUEST']._serialized_start = 925
    _globals['_PWMFREQUENCYREQUEST']._serialized_end = 1031
    _globals['_PWMFREQUENCYRESPONSE']._serialized_start = 1033
    _globals['_PWMFREQUENCYRESPONSE']._serialized_end = 1090
    _globals['_SETPWMFREQUENCYREQUEST']._serialized_start = 1093
    _globals['_SETPWMFREQUENCYREQUEST']._serialized_end = 1237
    _globals['_SETPWMFREQUENCYRESPONSE']._serialized_start = 1239
    _globals['_SETPWMFREQUENCYRESPONSE']._serialized_end = 1264
    _globals['_READANALOGREADERREQUEST']._serialized_start = 1267
    _globals['_READANALOGREADERREQUEST']._serialized_end = 1416
    _globals['_READANALOGREADERRESPONSE']._serialized_start = 1418
    _globals['_READANALOGREADERRESPONSE']._serialized_end = 1466
    _globals['_GETDIGITALINTERRUPTVALUEREQUEST']._serialized_start = 1469
    _globals['_GETDIGITALINTERRUPTVALUEREQUEST']._serialized_end = 1634
    _globals['_GETDIGITALINTERRUPTVALUERESPONSE']._serialized_start = 1636
    _globals['_GETDIGITALINTERRUPTVALUERESPONSE']._serialized_end = 1692
    _globals['_SETPOWERMODEREQUEST']._serialized_start = 1695
    _globals['_SETPOWERMODEREQUEST']._serialized_end = 1923
    _globals['_SETPOWERMODERESPONSE']._serialized_start = 1925
    _globals['_SETPOWERMODERESPONSE']._serialized_end = 1947
    _globals['_BOARDSERVICE']._serialized_start = 2043
    _globals['_BOARDSERVICE']._serialized_end = 4016