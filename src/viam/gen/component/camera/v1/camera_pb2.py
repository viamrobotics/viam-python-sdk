...
if _descriptor._USE_C_DESCRIPTORS == False:
    ...
    _globals['_FORMAT']._serialized_start = 1788
    _globals['_FORMAT']._serialized_end = 1896
    _globals['_GETIMAGEREQUEST']._serialized_start = 143
    _globals['_GETIMAGEREQUEST']._serialized_end = 209
    _globals['_GETIMAGERESPONSE']._serialized_start = 211
    _globals['_GETIMAGERESPONSE']._serialized_end = 280
    _globals['_GETIMAGESREQUEST']._serialized_start = 282
    _globals['_GETIMAGESREQUEST']._serialized_end = 320
    _globals['_GETIMAGESRESPONSE']._serialized_start = 323
    _globals['_GETIMAGESRESPONSE']._serialized_end = 480
    _globals['_IMAGE']._serialized_start = 482
    _globals['_IMAGE']._serialized_end = 602
    _globals['_RENDERFRAMEREQUEST']._serialized_start = 604
    _globals['_RENDERFRAMEREQUEST']._serialized_end = 673
    _globals['_GETPOINTCLOUDREQUEST']._serialized_start = 675
    _globals['_GETPOINTCLOUDREQUEST']._serialized_end = 746
    _globals['_GETPOINTCLOUDRESPONSE']._serialized_start = 748
    _globals['_GETPOINTCLOUDRESPONSE']._serialized_end = 833
    _globals['_GETPROPERTIESREQUEST']._serialized_start = 835
    _globals['_GETPROPERTIESREQUEST']._serialized_end = 877
    _globals['_GETPROPERTIESRESPONSE']._serialized_start = 880
    _globals['_GETPROPERTIESRESPONSE']._serialized_end = 1137
    _globals['_WEBCAMS']._serialized_start = 1139
    _globals['_WEBCAMS']._serialized_end = 1208
    _globals['_WEBCAM']._serialized_start = 1211
    _globals['_WEBCAM']._serialized_end = 1369
    _globals['_PROPERTY']._serialized_start = 1372
    _globals['_PROPERTY']._serialized_end = 1504
    _globals['_INTRINSICPARAMETERS']._serialized_start = 1507
    _globals['_INTRINSICPARAMETERS']._serialized_end = 1708
    _globals['_DISTORTIONPARAMETERS']._serialized_start = 1710
    _globals['_DISTORTIONPARAMETERS']._serialized_end = 1786
    _globals['_CAMERASERVICE']._serialized_start = 1899
    _globals['_CAMERASERVICE']._serialized_end = 3002