...
_builder.BuildTopDescriptorsAndMessages(
    DESCRIPTOR, "component.camera.v1.camera_pb2", globals()
)
if _descriptor._USE_C_DESCRIPTORS == False:
    ...
    _CAMERASERVICE.methods_by_name[
        ...
        b"\x82\xd3\xe4\x93\x02,\x12*/viam/api/v1/component/camera/{name}/image"
    )
    _CAMERASERVICE.methods_by_name["GetImages"]._options = None
    _CAMERASERVICE.methods_by_name[
        "GetImages"
    ]._serialized_options = (
        b"\x82\xd3\xe4\x93\x02-\x12+/viam/api/v1/component/camera/{name}/images"
    )
    _CAMERASERVICE.methods_by_name["RenderFrame"]._options = None
    _CAMERASERVICE.methods_by_name[
        "RenderFrame"
    ]._serialized_options = (
        b"\x82\xd3\xe4\x93\x023\x121/viam/api/v1/component/camera/{name}/render_frame"
    )
    _CAMERASERVICE.methods_by_name["GetPointCloud"]._options = None
    _CAMERASERVICE.methods_by_name[
        "GetPointCloud"
    ]._serialized_options = (
        b"\x82\xd3\xe4\x93\x022\x120/viam/api/v1/component/camera/{name}/point_cloud"
    )
    _CAMERASERVICE.methods_by_name["GetProperties"]._options = None
    _CAMERASERVICE.methods_by_name[
        "GetProperties"
    ]._serialized_options = (
        b"\x82\xd3\xe4\x93\x021\x12//viam/api/v1/component/camera/{name}/properties"
    )
    _CAMERASERVICE.methods_by_name["DoCommand"]._options = None
    _CAMERASERVICE.methods_by_name[
        "DoCommand"
    ]._serialized_options = (
        b'\x82\xd3\xe4\x93\x021"//viam/api/v1/component/camera/{name}/do_command'
    )
    _CAMERASERVICE.methods_by_name["GetGeometries"]._options = None
    _CAMERASERVICE.methods_by_name[
        "GetGeometries"
    ]._serialized_options = (
        b"\x82\xd3\xe4\x93\x021\x12//viam/api/v1/component/camera/{name}/geometries"
    )
