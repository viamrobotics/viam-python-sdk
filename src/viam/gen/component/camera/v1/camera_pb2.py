...
if not _descriptor._USE_C_DESCRIPTORS:
    ...
    _globals['_CAMERASERVICE'].methods_by_name['GetStatus']._loaded_options = None
    _globals['_CAMERASERVICE'].methods_by_name['GetStatus']._serialized_options = b'\x82\xd3\xe4\x93\x021\x12//viam/api/v1/component/camera/{name}/get_status'
    ...
    _globals['_GETIMAGESREQUEST']._serialized_start = 171
    _globals['_GETIMAGESREQUEST']._serialized_end = 304
    _globals['_GETIMAGESRESPONSE']._serialized_start = 307
    _globals['_GETIMAGESRESPONSE']._serialized_end = 464
    _globals['_IMAGE']._serialized_start = 467
    _globals['_IMAGE']._serialized_end = 629
    _globals['_GETPOINTCLOUDREQUEST']._serialized_start = 631
    _globals['_GETPOINTCLOUDREQUEST']._serialized_end = 749
    _globals['_GETPOINTCLOUDRESPONSE']._serialized_start = 751
    _globals['_GETPOINTCLOUDRESPONSE']._serialized_end = 836
    _globals['_GETPROPERTIESREQUEST']._serialized_start = 838
    _globals['_GETPROPERTIESREQUEST']._serialized_end = 880
    _globals['_GETPROPERTIESRESPONSE']._serialized_start = 883
    _globals['_GETPROPERTIESRESPONSE']._serialized_end = 1376
    _globals['_WEBCAMS']._serialized_start = 1378
    _globals['_WEBCAMS']._serialized_end = 1447
    _globals['_WEBCAM']._serialized_start = 1450
    _globals['_WEBCAM']._serialized_end = 1608
    _globals['_PROPERTY']._serialized_start = 1611
    _globals['_PROPERTY']._serialized_end = 1743
    _globals['_INTRINSICPARAMETERS']._serialized_start = 1746
    _globals['_INTRINSICPARAMETERS']._serialized_end = 1947
    _globals['_DISTORTIONPARAMETERS']._serialized_start = 1949
    _globals['_DISTORTIONPARAMETERS']._serialized_end = 2025
    _globals['_EXTRINSICPARAMETERS']._serialized_start = 2028
    _globals['_EXTRINSICPARAMETERS']._serialized_end = 2171
    _globals['_CAMERASERVICE']._serialized_start = 2174
    _globals['_CAMERASERVICE']._serialized_end = 3122