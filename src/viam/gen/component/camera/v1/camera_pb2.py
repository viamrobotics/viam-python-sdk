...
_runtime_version.ValidateProtobufRuntimeVersion(_runtime_version.Domain.PUBLIC, 7, 34, 0, '', 'component/camera/v1/camera.proto')
...
if not _descriptor._USE_C_DESCRIPTORS:
    ...
    _globals['_FORMAT']._serialized_start = 2500
    _globals['_FORMAT']._serialized_end = 2608
    ...
    _globals['_GETPROPERTIESRESPONSE']._serialized_end = 1703
    _globals['_WEBCAMS']._serialized_start = 1705
    _globals['_WEBCAMS']._serialized_end = 1774
    _globals['_WEBCAM']._serialized_start = 1777
    _globals['_WEBCAM']._serialized_end = 1935
    _globals['_PROPERTY']._serialized_start = 1938
    _globals['_PROPERTY']._serialized_end = 2070
    _globals['_INTRINSICPARAMETERS']._serialized_start = 2073
    _globals['_INTRINSICPARAMETERS']._serialized_end = 2274
    _globals['_DISTORTIONPARAMETERS']._serialized_start = 2276
    _globals['_DISTORTIONPARAMETERS']._serialized_end = 2352
    _globals['_EXTRINSICPARAMETERS']._serialized_start = 2355
    _globals['_EXTRINSICPARAMETERS']._serialized_end = 2498
    _globals['_CAMERASERVICE']._serialized_start = 2611
    _globals['_CAMERASERVICE']._serialized_end = 3714