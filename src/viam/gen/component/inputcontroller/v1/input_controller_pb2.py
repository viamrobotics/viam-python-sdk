...
_builder.BuildTopDescriptorsAndMessages(
    DESCRIPTOR, "component.inputcontroller.v1.input_controller_pb2", globals()
)
if _descriptor._USE_C_DESCRIPTORS == False:
    ...
    _INPUTCONTROLLERSERVICE.methods_by_name[
        ...
        b"\x82\xd3\xe4\x93\x024\x122/viam/api/v1/component/input/{controller}/controls"
    )
    _INPUTCONTROLLERSERVICE.methods_by_name["GetEvents"]._options = None
    _INPUTCONTROLLERSERVICE.methods_by_name[
        "GetEvents"
    ]._serialized_options = (
        b"\x82\xd3\xe4\x93\x022\x120/viam/api/v1/component/input/{controller}/events"
    )
    _INPUTCONTROLLERSERVICE.methods_by_name["StreamEvents"]._options = None
    _INPUTCONTROLLERSERVICE.methods_by_name[
        "StreamEvents"
    ]._serialized_options = b"\x82\xd3\xe4\x93\x028\x126/viam/api/v1/component/input/{controller}/event_stream"
    _INPUTCONTROLLERSERVICE.methods_by_name["TriggerEvent"]._options = None
    _INPUTCONTROLLERSERVICE.methods_by_name[
        "TriggerEvent"
    ]._serialized_options = (
        b'\x82\xd3\xe4\x93\x021"//viam/api/v1/component/input/{controller}/event'
    )
    _INPUTCONTROLLERSERVICE.methods_by_name["DoCommand"]._options = None
    _INPUTCONTROLLERSERVICE.methods_by_name[
        "DoCommand"
    ]._serialized_options = (
        b'\x82\xd3\xe4\x93\x020"./viam/api/v1/component/input/{name}/do_command'
    )
    _INPUTCONTROLLERSERVICE.methods_by_name["GetGeometries"]._options = None
    _INPUTCONTROLLERSERVICE.methods_by_name[
        "GetGeometries"
    ]._serialized_options = (
        b"\x82\xd3\xe4\x93\x020\x12./viam/api/v1/component/input/{name}/geometries"
    )
