...
class _PositionTypeEnumTypeWrapper(
    google.protobuf.internal.enum_type_wrapper._EnumTypeWrapper[
        _PositionType.ValueType
    ],
    builtins.type,
):
...
class GetPositionRequest(google.protobuf.message.Message):
    ...
    def __init__(
        ...
        *,
        name: builtins.str = ...,
        position_type: global___PositionType.ValueType | None = ...,
    ...
    def WhichOneof(
        self,
        oneof_group: typing_extensions.Literal["_position_type", b"_position_type"],
    ) -> typing_extensions.Literal["position_type"] | None: ...
...
class GetPositionResponse(google.protobuf.message.Message):
    ...
    def ClearField(
        self,
        field_name: typing_extensions.Literal[
            "position_type", b"position_type", "value", b"value"
        ],
    ) -> None: ...
...
class GetPropertiesResponse(google.protobuf.message.Message):
    ...
    def ClearField(
        ...
        field_name: typing_extensions.Literal[
            ...
            b"angle_degrees_supported",
            "ticks_count_supported",
            b"ticks_count_supported",
        ],
    ) -> None: ...
