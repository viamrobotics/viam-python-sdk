...
if _descriptor._USE_C_DESCRIPTORS == False:
    ...
    _ENCODERSERVICE.methods_by_name[
        ...
        b"\x82\xd3\xe4\x93\x024\x122/viam/api/v1/component/encoder/{name}/get_position"
    )
    _ENCODERSERVICE.methods_by_name["ResetPosition"]._options = None
    _ENCODERSERVICE.methods_by_name[
        "ResetPosition"
    ]._serialized_options = b"\x82\xd3\xe4\x93\x026\x124/viam/api/v1/component/encoder/{name}/reset_position"
    _ENCODERSERVICE.methods_by_name["GetProperties"]._options = None
    _ENCODERSERVICE.methods_by_name[
        "GetProperties"
    ]._serialized_options = (
        b'\x82\xd3\xe4\x93\x026"4/viam/api/v1/component/encoder/{name}/get_properties'
    )
    _ENCODERSERVICE.methods_by_name["DoCommand"]._options = None
    _ENCODERSERVICE.methods_by_name[
        "DoCommand"
    ]._serialized_options = (
        b'\x82\xd3\xe4\x93\x022"0/viam/api/v1/component/encoder/{name}/do_command'
    )
    _ENCODERSERVICE.methods_by_name["GetGeometries"]._options = None
    _ENCODERSERVICE.methods_by_name[
        "GetGeometries"
    ]._serialized_options = (
        b"\x82\xd3\xe4\x93\x022\x120/viam/api/v1/component/encoder/{name}/geometries"
    )
