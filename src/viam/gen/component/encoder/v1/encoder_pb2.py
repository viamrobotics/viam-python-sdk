...
if not _descriptor._USE_C_DESCRIPTORS:
    ...
    _globals['_ENCODERSERVICE'].methods_by_name['GetStatus']._loaded_options = None
    _globals['_ENCODERSERVICE'].methods_by_name['GetStatus']._serialized_options = b'\x82\xd3\xe4\x93\x022\x120/viam/api/v1/component/encoder/{name}/get_status'
    ...
    _globals['_ENCODERSERVICE']._serialized_end = 1896