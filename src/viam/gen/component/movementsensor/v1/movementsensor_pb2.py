...
if not _descriptor._USE_C_DESCRIPTORS:
    ...
    _globals['_MOVEMENTSENSORSERVICE'].methods_by_name['GetStatus']._loaded_options = None
    _globals['_MOVEMENTSENSORSERVICE'].methods_by_name['GetStatus']._serialized_options = b'\x82\xd3\xe4\x93\x029\x127/viam/api/v1/component/movementsensor/{name}/get_status'
    ...
    _globals['_MOVEMENTSENSORSERVICE']._serialized_end = 4587