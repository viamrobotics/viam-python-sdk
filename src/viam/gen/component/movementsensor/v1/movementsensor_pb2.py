...
_builder.BuildTopDescriptorsAndMessages(
    DESCRIPTOR, "component.movementsensor.v1.movementsensor_pb2", globals()
)
if _descriptor._USE_C_DESCRIPTORS == False:
    ...
    _MOVEMENTSENSORSERVICE.methods_by_name[
        "GetLinearVelocity"
    ]._serialized_options = b"\x82\xd3\xe4\x93\x02>\x12</viam/api/v1/component/movementsensor/{name}/linear_velocity"
    _MOVEMENTSENSORSERVICE.methods_by_name["GetAngularVelocity"]._options = None
    _MOVEMENTSENSORSERVICE.methods_by_name[
        "GetAngularVelocity"
    ]._serialized_options = b"\x82\xd3\xe4\x93\x02?\x12=/viam/api/v1/component/movementsensor/{name}/angular_velocity"
    _MOVEMENTSENSORSERVICE.methods_by_name["GetCompassHeading"]._options = None
    _MOVEMENTSENSORSERVICE.methods_by_name[
        "GetCompassHeading"
    ]._serialized_options = b"\x82\xd3\xe4\x93\x02>\x12</viam/api/v1/component/movementsensor/{name}/compass_heading"
    _MOVEMENTSENSORSERVICE.methods_by_name["GetOrientation"]._options = None
    _MOVEMENTSENSORSERVICE.methods_by_name[
        "GetOrientation"
    ]._serialized_options = b"\x82\xd3\xe4\x93\x02:\x128/viam/api/v1/component/movementsensor/{name}/orientation"
    _MOVEMENTSENSORSERVICE.methods_by_name["GetPosition"]._options = None
    _MOVEMENTSENSORSERVICE.methods_by_name[
        "GetPosition"
    ]._serialized_options = b"\x82\xd3\xe4\x93\x027\x125/viam/api/v1/component/movementsensor/{name}/position"
    _MOVEMENTSENSORSERVICE.methods_by_name["GetProperties"]._options = None
    _MOVEMENTSENSORSERVICE.methods_by_name[
        "GetProperties"
    ]._serialized_options = b"\x82\xd3\xe4\x93\x029\x127/viam/api/v1/component/movementsensor/{name}/properties"
    _MOVEMENTSENSORSERVICE.methods_by_name["GetAccuracy"]._options = None
    _MOVEMENTSENSORSERVICE.methods_by_name[
        "GetAccuracy"
    ]._serialized_options = b"\x82\xd3\xe4\x93\x027\x125/viam/api/v1/component/movementsensor/{name}/accuracy"
    _MOVEMENTSENSORSERVICE.methods_by_name["GetLinearAcceleration"]._options = None
    _MOVEMENTSENSORSERVICE.methods_by_name[
        "GetLinearAcceleration"
    ]._serialized_options = b"\x82\xd3\xe4\x93\x02B\x12@/viam/api/v1/component/movementsensor/{name}/linear_acceleration"
    _MOVEMENTSENSORSERVICE.methods_by_name["DoCommand"]._options = None
    _MOVEMENTSENSORSERVICE.methods_by_name[
        "DoCommand"
    ]._serialized_options = b'\x82\xd3\xe4\x93\x029"7/viam/api/v1/component/movementsensor/{name}/do_command'
    _MOVEMENTSENSORSERVICE.methods_by_name["GetGeometries"]._options = None
    _MOVEMENTSENSORSERVICE.methods_by_name[
        "GetGeometries"
    ]._serialized_options = b"\x82\xd3\xe4\x93\x029\x127/viam/api/v1/component/movementsensor/{name}/geometries"
    _MOVEMENTSENSORSERVICE.methods_by_name["GetReadings"]._options = None
    _MOVEMENTSENSORSERVICE.methods_by_name[
        "GetReadings"
    ]._serialized_options = b"\x82\xd3\xe4\x93\x027\x125/viam/api/v1/component/movementsensor/{name}/readings"
