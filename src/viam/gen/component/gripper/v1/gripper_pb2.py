...
if not _descriptor._USE_C_DESCRIPTORS:
    ...
    _globals['_GRIPPERSERVICE'].methods_by_name['GetCurrentInputs']._loaded_options = None
    _globals['_GRIPPERSERVICE'].methods_by_name['GetCurrentInputs']._serialized_options = b'\x82\xd3\xe4\x93\x02.\x12,/viam/api/v1/component/gripper/{name}/inputs'
    _globals['_GRIPPERSERVICE'].methods_by_name['GoToInputs']._loaded_options = None
    _globals['_GRIPPERSERVICE'].methods_by_name['GoToInputs']._serialized_options = b'\xa0\x92)\x01\x82\xd3\xe4\x93\x02.\x1a,/viam/api/v1/component/gripper/{name}/inputs'
    ...
    _globals['_GRIPPERSERVICE'].methods_by_name['GetStatus']._loaded_options = None
    _globals['_GRIPPERSERVICE'].methods_by_name['GetStatus']._serialized_options = b'\x82\xd3\xe4\x93\x022\x120/viam/api/v1/component/gripper/{name}/get_status'
    ...
    _globals['_GETCURRENTINPUTSREQUEST']._serialized_start = 825
    _globals['_GETCURRENTINPUTSREQUEST']._serialized_end = 917
    _globals['_GETCURRENTINPUTSRESPONSE']._serialized_start = 919
    _globals['_GETCURRENTINPUTSRESPONSE']._serialized_end = 969
    _globals['_GOTOINPUTSREQUEST']._serialized_start = 971
    _globals['_GOTOINPUTSREQUEST']._serialized_end = 1081
    _globals['_GOTOINPUTSRESPONSE']._serialized_start = 1083
    _globals['_GOTOINPUTSRESPONSE']._serialized_end = 1103
    _globals['_GRIPPERSERVICE']._serialized_start = 1106
    _globals['_GRIPPERSERVICE']._serialized_end = 2849