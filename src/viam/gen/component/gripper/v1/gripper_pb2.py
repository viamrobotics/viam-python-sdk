...
if _descriptor._USE_C_DESCRIPTORS == False:
    ...
    _GRIPPERSERVICE.methods_by_name[
        "Open"
    ]._serialized_options = b"\xa0\x92)\x01\x82\xd3\xe4\x93\x02,\x1a*/viam/api/v1/component/gripper/{name}/open"
    _GRIPPERSERVICE.methods_by_name["Grab"]._options = None
    _GRIPPERSERVICE.methods_by_name[
        "Grab"
    ]._serialized_options = b"\xa0\x92)\x01\x82\xd3\xe4\x93\x02,\x1a*/viam/api/v1/component/gripper/{name}/grab"
    _GRIPPERSERVICE.methods_by_name["Stop"]._options = None
    _GRIPPERSERVICE.methods_by_name[
        "Stop"
    ]._serialized_options = (
        b'\x82\xd3\xe4\x93\x02,"*/viam/api/v1/component/gripper/{name}/stop'
    )
    _GRIPPERSERVICE.methods_by_name["IsMoving"]._options = None
    _GRIPPERSERVICE.methods_by_name[
        "IsMoving"
    ]._serialized_options = (
        b"\x82\xd3\xe4\x93\x021\x12//viam/api/v1/component/gripper/{name}/is_moving"
    )
    _GRIPPERSERVICE.methods_by_name["DoCommand"]._options = None
    _GRIPPERSERVICE.methods_by_name[
        "DoCommand"
    ]._serialized_options = (
        b'\x82\xd3\xe4\x93\x022"0/viam/api/v1/component/gripper/{name}/do_command'
    )
    _GRIPPERSERVICE.methods_by_name["GetGeometries"]._options = None
    _GRIPPERSERVICE.methods_by_name[
        "GetGeometries"
    ]._serialized_options = (
        b"\x82\xd3\xe4\x93\x022\x120/viam/api/v1/component/gripper/{name}/geometries"
    )
