...
if _descriptor._USE_C_DESCRIPTORS == False:
    ...
    _GRIPPERSERVICE.methods_by_name['IsHoldingSomething']._options = None
    _GRIPPERSERVICE.methods_by_name['IsHoldingSomething']._serialized_options = b'\x82\xd3\xe4\x93\x02<\x12:/viam/api/v1/component/gripper/{name}/is_holding_something'
    ...
    _GRIPPERSERVICE.methods_by_name['GetKinematics']._options = None
    _GRIPPERSERVICE.methods_by_name['GetKinematics']._serialized_options = b'\x82\xd3\xe4\x93\x022\x120/viam/api/v1/component/gripper/{name}/kinematics'
    ...
    _ISHOLDINGSOMETHINGREQUEST._serialized_start = 604
    _ISHOLDINGSOMETHINGREQUEST._serialized_end = 698
    _ISHOLDINGSOMETHINGRESPONSE._serialized_start = 700
    _ISHOLDINGSOMETHINGRESPONSE._serialized_end = 823
    _GRIPPERSERVICE._serialized_start = 826
    _GRIPPERSERVICE._serialized_end = 2082