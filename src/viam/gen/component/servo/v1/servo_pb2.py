...
_builder.BuildTopDescriptorsAndMessages(
    DESCRIPTOR, "component.servo.v1.servo_pb2", globals()
)
if _descriptor._USE_C_DESCRIPTORS == False:
    ...
    _SERVOSERVICE.methods_by_name[
        "Move"
    ]._serialized_options = b"\xa0\x92)\x01\x82\xd3\xe4\x93\x02*\x1a(/viam/api/v1/component/servo/{name}/move"
    _SERVOSERVICE.methods_by_name["GetPosition"]._options = None
    _SERVOSERVICE.methods_by_name[
        "GetPosition"
    ]._serialized_options = (
        b"\x82\xd3\xe4\x93\x02.\x12,/viam/api/v1/component/servo/{name}/position"
    )
    _SERVOSERVICE.methods_by_name["Stop"]._options = None
    _SERVOSERVICE.methods_by_name[
        "Stop"
    ]._serialized_options = (
        b'\x82\xd3\xe4\x93\x02*"(/viam/api/v1/component/servo/{name}/stop'
    )
    _SERVOSERVICE.methods_by_name["IsMoving"]._options = None
    _SERVOSERVICE.methods_by_name[
        "IsMoving"
    ]._serialized_options = (
        b"\x82\xd3\xe4\x93\x02/\x12-/viam/api/v1/component/servo/{name}/is_moving"
    )
    _SERVOSERVICE.methods_by_name["DoCommand"]._options = None
    _SERVOSERVICE.methods_by_name[
        "DoCommand"
    ]._serialized_options = (
        b'\x82\xd3\xe4\x93\x020"./viam/api/v1/component/servo/{name}/do_command'
    )
    _SERVOSERVICE.methods_by_name["GetGeometries"]._options = None
    _SERVOSERVICE.methods_by_name[
        "GetGeometries"
    ]._serialized_options = (
        b"\x82\xd3\xe4\x93\x020\x12./viam/api/v1/component/servo/{name}/geometries"
    )
