...
if not _descriptor._USE_C_DESCRIPTORS:
    ...
    _globals['_SERVOSERVICE'].methods_by_name['GetStatus']._loaded_options = None
    _globals['_SERVOSERVICE'].methods_by_name['GetStatus']._serialized_options = b'\x82\xd3\xe4\x93\x020\x12./viam/api/v1/component/servo/{name}/get_status'
    ...
    _globals['_SERVOSERVICE']._serialized_end = 1711