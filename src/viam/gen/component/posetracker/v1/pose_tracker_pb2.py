...
_builder.BuildTopDescriptorsAndMessages(
    DESCRIPTOR, "component.posetracker.v1.pose_tracker_pb2", globals()
)
if _descriptor._USE_C_DESCRIPTORS == False:
    ...
    _POSETRACKERSERVICE.methods_by_name[
        ...
        b"\x82\xd3\xe4\x93\x022\x120/viam/api/v1/component/pose_tracker/{name}/poses"
    )
    _POSETRACKERSERVICE.methods_by_name["DoCommand"]._options = None
    _POSETRACKERSERVICE.methods_by_name[
        "DoCommand"
    ]._serialized_options = (
        b'\x82\xd3\xe4\x93\x027"5/viam/api/v1/component/pose_tracker/{name}/do_command'
    )
    _POSETRACKERSERVICE.methods_by_name["GetGeometries"]._options = None
    _POSETRACKERSERVICE.methods_by_name[
        "GetGeometries"
    ]._serialized_options = b"\x82\xd3\xe4\x93\x027\x125/viam/api/v1/component/pose_tracker/{name}/geometries"
