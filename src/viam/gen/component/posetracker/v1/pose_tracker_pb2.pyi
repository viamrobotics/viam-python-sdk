...
class GetPosesRequest(google.protobuf.message.Message):
    ...
    def __init__(
        ...
        *,
        name: builtins.str = ...,
        body_names: collections.abc.Iterable[builtins.str] | None = ...,
    ...
    def ClearField(
        ...
        field_name: typing_extensions.Literal[
            "body_names", b"body_names", "extra", b"extra", "name", b"name"
        ],
    ) -> None: ...
...
class GetPosesResponse(google.protobuf.message.Message):
    ...
    class BodyPosesEntry(google.protobuf.message.Message):
        ...
        def __init__(
            ...
            *,
            key: builtins.str = ...,
            value: common.v1.common_pb2.PoseInFrame | None = ...,
        ) -> None: ...
        def HasField(
    ...
    def body_poses(
        ...
        builtins.str, common.v1.common_pb2.PoseInFrame
    ]:
    ...
    def __init__(
        self,
        *,
        body_poses: collections.abc.Mapping[
            builtins.str, common.v1.common_pb2.PoseInFrame
        ]
        | None = ...,
    ) -> None: ...
    def ClearField(
        self, field_name: typing_extensions.Literal["body_poses", b"body_poses"]
    ) -> None: ...
