...
if _descriptor._USE_C_DESCRIPTORS == False:
    ...
    _globals['_GETREADINGSREQUEST']._serialized_start = 146
    _globals['_GETREADINGSREQUEST']._serialized_end = 233
    _globals['_GETREADINGSRESPONSE']._serialized_start = 236
    _globals['_GETREADINGSRESPONSE']._serialized_end = 431
    _globals['_GETREADINGSRESPONSE_READINGSENTRY']._serialized_start = 348
    _globals['_GETREADINGSRESPONSE_READINGSENTRY']._serialized_end = 431
    _globals['_SENSORSERVICE']._serialized_start = 434
    _globals['_SENSORSERVICE']._serialized_end = 905