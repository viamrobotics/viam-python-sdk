...
_builder.BuildTopDescriptorsAndMessages(
    DESCRIPTOR, "component.sensor.v1.sensor_pb2", globals()
)
if _descriptor._USE_C_DESCRIPTORS == False:
    ...
    _SENSORSERVICE.methods_by_name[
        ...
        b"\x82\xd3\xe4\x93\x02/\x12-/viam/api/v1/component/sensor/{name}/readings"
    )
    _SENSORSERVICE.methods_by_name["DoCommand"]._options = None
    _SENSORSERVICE.methods_by_name[
        "DoCommand"
    ]._serialized_options = (
        b'\x82\xd3\xe4\x93\x021"//viam/api/v1/component/sensor/{name}/do_command'
    )
    _SENSORSERVICE.methods_by_name["GetGeometries"]._options = None
    _SENSORSERVICE.methods_by_name[
        "GetGeometries"
    ]._serialized_options = (
        b"\x82\xd3\xe4\x93\x021\x12//viam/api/v1/component/sensor/{name}/geometries"
    )
