...
_runtime_version.ValidateProtobufRuntimeVersion(_runtime_version.Domain.PUBLIC, 6, 33, 5, '', 'module/v1/module.proto')
...
if not _descriptor._USE_C_DESCRIPTORS:
    ...
    _globals['_READYREQUEST'].fields_by_name['parent_address']._loaded_options = None
    _globals['_READYREQUEST'].fields_by_name['parent_address']._serialized_options = b'\x18\x01'
    ...
    _globals['_READYREQUEST']._serialized_start = 625
    _globals['_READYREQUEST']._serialized_end = 763
    _globals['_READYRESPONSE']._serialized_start = 766
    _globals['_READYRESPONSE']._serialized_end = 900
    _globals['_VALIDATECONFIGREQUEST']._serialized_start = 902
    _globals['_VALIDATECONFIGREQUEST']._serialized_end = 979
    _globals['_VALIDATECONFIGRESPONSE']._serialized_start = 981
    _globals['_VALIDATECONFIGRESPONSE']._serialized_end = 1094
    _globals['_MODULESERVICE']._serialized_start = 1097
    _globals['_MODULESERVICE']._serialized_end = 1576