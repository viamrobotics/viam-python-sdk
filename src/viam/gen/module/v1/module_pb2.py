...
if _descriptor._USE_C_DESCRIPTORS == False:
    ...
    _globals['_READYREQUEST']._serialized_end = 677
    _globals['_READYRESPONSE']._serialized_start = 679
    _globals['_READYRESPONSE']._serialized_end = 776
    _globals['_VALIDATECONFIGREQUEST']._serialized_start = 778
    _globals['_VALIDATECONFIGREQUEST']._serialized_end = 855
    _globals['_VALIDATECONFIGRESPONSE']._serialized_start = 857
    _globals['_VALIDATECONFIGRESPONSE']._serialized_end = 917
    _globals['_MODULESERVICE']._serialized_start = 920
    _globals['_MODULESERVICE']._serialized_end = 1399