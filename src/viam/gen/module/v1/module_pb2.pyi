...
class AddResourceRequest(google.protobuf.message.Message):
    ...
    def __init__(
        self,
        *,
        config: app.v1.robot_pb2.ComponentConfig | None = ...,
    ...
    def ClearField(
        ...
        field_name: typing_extensions.Literal[
            "config", b"config", "dependencies", b"dependencies"
        ],
    ) -> None: ...
...
class HandlerDefinition(google.protobuf.message.Message):
    ...
    def __init__(
        self,
        *,
        subtype: robot.v1.robot_pb2.ResourceRPCSubtype | None = ...,
        models: collections.abc.Iterable[builtins.str] | None = ...,
    ) -> None: ...
    def HasField(
    ...
    def ClearField(
        self,
        field_name: typing_extensions.Literal[
            "models", b"models", "subtype", b"subtype"
        ],
    ) -> None: ...
...
class HandlerMap(google.protobuf.message.Message):
    ...
    def __init__(
        self,
        *,
        handlers: collections.abc.Iterable[global___HandlerDefinition] | None = ...,
    ) -> None: ...
    def ClearField(
        self, field_name: typing_extensions.Literal["handlers", b"handlers"]
    ) -> None: ...
...
class ReadyRequest(google.protobuf.message.Message):
    ...
    def ClearField(
        self, field_name: typing_extensions.Literal["parent_address", b"parent_address"]
    ) -> None: ...
...
class ReadyResponse(google.protobuf.message.Message):
    ...
    def __init__(
        ...
        *,
        ready: builtins.bool = ...,
        handlermap: global___HandlerMap | None = ...,
    ) -> None: ...
    def HasField(
        self, field_name: typing_extensions.Literal["handlermap", b"handlermap"]
    ) -> builtins.bool: ...
    def ClearField(
        self,
        field_name: typing_extensions.Literal[
            "handlermap", b"handlermap", "ready", b"ready"
        ],
    ) -> None: ...
...
class ValidateConfigRequest(google.protobuf.message.Message):
    ...
    def config(self) -> app.v1.robot_pb2.ComponentConfig: ...
    def __init__(
        self, *, config: app.v1.robot_pb2.ComponentConfig | None = ...
    ) -> None: ...
    def HasField(
        self, field_name: typing_extensions.Literal["config", b"config"]
    ) -> builtins.bool: ...
...
class ValidateConfigResponse(google.protobuf.message.Message):
    ...
    def __init__(
        self, *, dependencies: collections.abc.Iterable[builtins.str] | None = ...
    ) -> None: ...
    def ClearField(
