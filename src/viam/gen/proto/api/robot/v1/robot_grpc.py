...
class RobotServiceStub:
    ...
    def __init__(self, channel: grpclib.client.Channel) -> None:
        ...
        self.StopAll = grpclib.client.UnaryUnaryMethod(channel, '/proto.api.robot.v1.RobotService/StopAll', proto.api.robot.v1.robot_pb2.StopAllRequest, proto.api.robot.v1.robot_pb2.StopAllResponse)