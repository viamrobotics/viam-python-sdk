...
FrameSystemConfigRequest = _reflection.GeneratedProtocolMessageType('FrameSystemConfigRequest', (_message.Message,), {'DESCRIPTOR': _FRAMESYSTEMCONFIGREQUEST, '__module__': 'proto.api.robot.v1.robot_pb2'})
...
TransformPoseRequest = _reflection.GeneratedProtocolMessageType('TransformPoseRequest', (_message.Message,), {'DESCRIPTOR': _TRANSFORMPOSEREQUEST, '__module__': 'proto.api.robot.v1.robot_pb2'})
...
DiscoveryQuery = _reflection.GeneratedProtocolMessageType('DiscoveryQuery', (_message.Message,), {'DESCRIPTOR': _DISCOVERYQUERY, '__module__': 'proto.api.robot.v1.robot_pb2'})
_sym_db.RegisterMessage(DiscoveryQuery)
Discovery = _reflection.GeneratedProtocolMessageType('Discovery', (_message.Message,), {'DESCRIPTOR': _DISCOVERY, '__module__': 'proto.api.robot.v1.robot_pb2'})
_sym_db.RegisterMessage(Discovery)
DiscoverComponentsRequest = _reflection.GeneratedProtocolMessageType('DiscoverComponentsRequest', (_message.Message,), {'DESCRIPTOR': _DISCOVERCOMPONENTSREQUEST, '__module__': 'proto.api.robot.v1.robot_pb2'})
_sym_db.RegisterMessage(DiscoverComponentsRequest)
DiscoverComponentsResponse = _reflection.GeneratedProtocolMessageType('DiscoverComponentsResponse', (_message.Message,), {'DESCRIPTOR': _DISCOVERCOMPONENTSRESPONSE, '__module__': 'proto.api.robot.v1.robot_pb2'})
_sym_db.RegisterMessage(DiscoverComponentsResponse)
Status = _reflection.GeneratedProtocolMessageType('Status', (_message.Message,), {'DESCRIPTOR': _STATUS, '__module__': 'proto.api.robot.v1.robot_pb2'})
_sym_db.RegisterMessage(Status)
GetStatusRequest = _reflection.GeneratedProtocolMessageType('GetStatusRequest', (_message.Message,), {'DESCRIPTOR': _GETSTATUSREQUEST, '__module__': 'proto.api.robot.v1.robot_pb2'})
_sym_db.RegisterMessage(GetStatusRequest)
GetStatusResponse = _reflection.GeneratedProtocolMessageType('GetStatusResponse', (_message.Message,), {'DESCRIPTOR': _GETSTATUSRESPONSE, '__module__': 'proto.api.robot.v1.robot_pb2'})
_sym_db.RegisterMessage(GetStatusResponse)
StreamStatusRequest = _reflection.GeneratedProtocolMessageType('StreamStatusRequest', (_message.Message,), {'DESCRIPTOR': _STREAMSTATUSREQUEST, '__module__': 'proto.api.robot.v1.robot_pb2'})
_sym_db.RegisterMessage(StreamStatusRequest)
StreamStatusResponse = _reflection.GeneratedProtocolMessageType('StreamStatusResponse', (_message.Message,), {'DESCRIPTOR': _STREAMSTATUSRESPONSE, '__module__': 'proto.api.robot.v1.robot_pb2'})
