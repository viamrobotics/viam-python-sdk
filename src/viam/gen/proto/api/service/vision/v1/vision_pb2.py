...
GetDetectorNamesResponse = _reflection.GeneratedProtocolMessageType('GetDetectorNamesResponse', (_message.Message,), {'DESCRIPTOR': _GETDETECTORNAMESRESPONSE, '__module__': 'proto.api.service.vision.v1.vision_pb2'})
...
GetDetectionsRequest = _reflection.GeneratedProtocolMessageType('GetDetectionsRequest', (_message.Message,), {'DESCRIPTOR': _GETDETECTIONSREQUEST, '__module__': 'proto.api.service.vision.v1.vision_pb2'})
_sym_db.RegisterMessage(GetDetectionsRequest)
GetDetectionsResponse = _reflection.GeneratedProtocolMessageType('GetDetectionsResponse', (_message.Message,), {'DESCRIPTOR': _GETDETECTIONSRESPONSE, '__module__': 'proto.api.service.vision.v1.vision_pb2'})
_sym_db.RegisterMessage(GetDetectionsResponse)
Detection = _reflection.GeneratedProtocolMessageType('Detection', (_message.Message,), {'DESCRIPTOR': _DETECTION, '__module__': 'proto.api.service.vision.v1.vision_pb2'})
...
GetSegmenterNamesResponse = _reflection.GeneratedProtocolMessageType('GetSegmenterNamesResponse', (_message.Message,), {'DESCRIPTOR': _GETSEGMENTERNAMESRESPONSE, '__module__': 'proto.api.service.vision.v1.vision_pb2'})
_sym_db.RegisterMessage(GetSegmenterNamesResponse)
GetSegmenterParametersRequest = _reflection.GeneratedProtocolMessageType('GetSegmenterParametersRequest', (_message.Message,), {'DESCRIPTOR': _GETSEGMENTERPARAMETERSREQUEST, '__module__': 'proto.api.service.vision.v1.vision_pb2'})
...
GetSegmenterParametersResponse = _reflection.GeneratedProtocolMessageType('GetSegmenterParametersResponse', (_message.Message,), {'DESCRIPTOR': _GETSEGMENTERPARAMETERSRESPONSE, '__module__': 'proto.api.service.vision.v1.vision_pb2'})
_sym_db.RegisterMessage(GetSegmenterParametersResponse)
GetObjectPointCloudsRequest = _reflection.GeneratedProtocolMessageType('GetObjectPointCloudsRequest', (_message.Message,), {'DESCRIPTOR': _GETOBJECTPOINTCLOUDSREQUEST, '__module__': 'proto.api.service.vision.v1.vision_pb2'})
_sym_db.RegisterMessage(GetObjectPointCloudsRequest)
GetObjectPointCloudsResponse = _reflection.GeneratedProtocolMessageType('GetObjectPointCloudsResponse', (_message.Message,), {'DESCRIPTOR': _GETOBJECTPOINTCLOUDSRESPONSE, '__module__': 'proto.api.service.vision.v1.vision_pb2'})
