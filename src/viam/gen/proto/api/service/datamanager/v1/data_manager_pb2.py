...
_SENSORMETADATA = DESCRIPTOR.message_types_by_name['SensorMetadata']
_SENSORDATA = DESCRIPTOR.message_types_by_name['SensorData']
SensorMetadata = _reflection.GeneratedProtocolMessageType('SensorMetadata', (_message.Message,), {'DESCRIPTOR': _SENSORMETADATA, '__module__': 'proto.api.service.datamanager.v1.data_manager_pb2'})
_sym_db.RegisterMessage(SensorMetadata)
SensorData = _reflection.GeneratedProtocolMessageType('SensorData', (_message.Message,), {'DESCRIPTOR': _SENSORDATA, '__module__': 'proto.api.service.datamanager.v1.data_manager_pb2'})
