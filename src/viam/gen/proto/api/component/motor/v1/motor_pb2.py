...
if _descriptor._USE_C_DESCRIPTORS == False:
    ...
    _STATUS._serialized_start = 887
    _STATUS._serialized_end = 1030
    _MOTORSERVICE._serialized_start = 1033
    _MOTORSERVICE._serialized_end = 2341