...
class MotorServiceBase(abc.ABC):
    ...
    @abc.abstractmethod
    async def GetProperties(self, stream: 'grpclib.server.Stream[proto.api.component.motor.v1.motor_pb2.GetPropertiesRequest, proto.api.component.motor.v1.motor_pb2.GetPropertiesResponse]') -> None:
        pass
...
class MotorServiceStub:
    ...
    def __init__(self, channel: grpclib.client.Channel) -> None:
        ...
        self.GetProperties = grpclib.client.UnaryUnaryMethod(channel, '/proto.api.component.motor.v1.MotorService/GetProperties', proto.api.component.motor.v1.motor_pb2.GetPropertiesRequest, proto.api.component.motor.v1.motor_pb2.GetPropertiesResponse)
