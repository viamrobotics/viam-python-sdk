...
SetVelocityRequest = _reflection.GeneratedProtocolMessageType('SetVelocityRequest', (_message.Message,), {'DESCRIPTOR': _SETVELOCITYREQUEST, '__module__': 'proto.api.component.base.v1.base_pb2'})
