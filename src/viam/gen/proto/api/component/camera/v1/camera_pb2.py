...
Webcam = _reflection.GeneratedProtocolMessageType('Webcam', (_message.Message,), {'DESCRIPTOR': _WEBCAM, '__module__': 'proto.api.component.camera.v1.camera_pb2'})
_sym_db.RegisterMessage(Webcam)
Property = _reflection.GeneratedProtocolMessageType('Property', (_message.Message,), {'DESCRIPTOR': _PROPERTY, '__module__': 'proto.api.component.camera.v1.camera_pb2'})
_sym_db.RegisterMessage(Property)
Video = _reflection.GeneratedProtocolMessageType('Video', (_message.Message,), {'DESCRIPTOR': _VIDEO, '__module__': 'proto.api.component.camera.v1.camera_pb2'})
