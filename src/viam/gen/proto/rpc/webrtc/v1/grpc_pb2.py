...
PacketMessage = _reflection.GeneratedProtocolMessageType('PacketMessage', (_message.Message,), {'DESCRIPTOR': _PACKETMESSAGE, '__module__': 'proto.rpc.webrtc.v1.grpc_pb2'})
_sym_db.RegisterMessage(PacketMessage)
Stream = _reflection.GeneratedProtocolMessageType('Stream', (_message.Message,), {'DESCRIPTOR': _STREAM, '__module__': 'proto.rpc.webrtc.v1.grpc_pb2'})
_sym_db.RegisterMessage(Stream)
Request = _reflection.GeneratedProtocolMessageType('Request', (_message.Message,), {'DESCRIPTOR': _REQUEST, '__module__': 'proto.rpc.webrtc.v1.grpc_pb2'})
_sym_db.RegisterMessage(Request)
RequestHeaders = _reflection.GeneratedProtocolMessageType('RequestHeaders', (_message.Message,), {'DESCRIPTOR': _REQUESTHEADERS, '__module__': 'proto.rpc.webrtc.v1.grpc_pb2'})
_sym_db.RegisterMessage(RequestHeaders)
RequestMessage = _reflection.GeneratedProtocolMessageType('RequestMessage', (_message.Message,), {'DESCRIPTOR': _REQUESTMESSAGE, '__module__': 'proto.rpc.webrtc.v1.grpc_pb2'})
_sym_db.RegisterMessage(RequestMessage)
Response = _reflection.GeneratedProtocolMessageType('Response', (_message.Message,), {'DESCRIPTOR': _RESPONSE, '__module__': 'proto.rpc.webrtc.v1.grpc_pb2'})
_sym_db.RegisterMessage(Response)
ResponseHeaders = _reflection.GeneratedProtocolMessageType('ResponseHeaders', (_message.Message,), {'DESCRIPTOR': _RESPONSEHEADERS, '__module__': 'proto.rpc.webrtc.v1.grpc_pb2'})
_sym_db.RegisterMessage(ResponseHeaders)
ResponseMessage = _reflection.GeneratedProtocolMessageType('ResponseMessage', (_message.Message,), {'DESCRIPTOR': _RESPONSEMESSAGE, '__module__': 'proto.rpc.webrtc.v1.grpc_pb2'})
_sym_db.RegisterMessage(ResponseMessage)
ResponseTrailers = _reflection.GeneratedProtocolMessageType('ResponseTrailers', (_message.Message,), {'DESCRIPTOR': _RESPONSETRAILERS, '__module__': 'proto.rpc.webrtc.v1.grpc_pb2'})
_sym_db.RegisterMessage(ResponseTrailers)
Strings = _reflection.GeneratedProtocolMessageType('Strings', (_message.Message,), {'DESCRIPTOR': _STRINGS, '__module__': 'proto.rpc.webrtc.v1.grpc_pb2'})
_sym_db.RegisterMessage(Strings)
Metadata = _reflection.GeneratedProtocolMessageType('Metadata', (_message.Message,), {'MdEntry': _reflection.GeneratedProtocolMessageType('MdEntry', (_message.Message,), {'DESCRIPTOR': _METADATA_MDENTRY, '__module__': 'proto.rpc.webrtc.v1.grpc_pb2'}), 'DESCRIPTOR': _METADATA, '__module__': 'proto.rpc.webrtc.v1.grpc_pb2'})
