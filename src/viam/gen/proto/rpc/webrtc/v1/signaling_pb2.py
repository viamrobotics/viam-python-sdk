...
_builder.BuildTopDescriptorsAndMessages(
    DESCRIPTOR, "proto.rpc.webrtc.v1.signaling_pb2", globals()
)
if _descriptor._USE_C_DESCRIPTORS == False:
    ...
    _SIGNALINGSERVICE.methods_by_name[
        "Call"
    ]._serialized_options = b'\x82\xd3\xe4\x93\x02\x15"\x13/rpc/webrtc/v1/call'
    _SIGNALINGSERVICE.methods_by_name["CallUpdate"]._options = None
    _SIGNALINGSERVICE.methods_by_name[
        "CallUpdate"
    ]._serialized_options = (
        b"\x82\xd3\xe4\x93\x02\x1c\x1a\x1a/rpc/webrtc/v1/call_update"
    )
    _SIGNALINGSERVICE.methods_by_name["OptionalWebRTCConfig"]._options = None
    _SIGNALINGSERVICE.methods_by_name[
        "OptionalWebRTCConfig"
    ]._serialized_options = (
        b"\x82\xd3\xe4\x93\x02'\x12%/rpc/webrtc/v1/optional_webrtc_config"
    )
