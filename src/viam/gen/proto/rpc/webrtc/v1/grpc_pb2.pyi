...
class PacketMessage(google.protobuf.message.Message):
    ...
    def __init__(
        self, *, data: builtins.bytes = ..., eom: builtins.bool = ...
    ) -> None: ...
    def ClearField(
        self, field_name: typing_extensions.Literal["data", b"data", "eom", b"eom"]
    ) -> None: ...
...
class Request(google.protobuf.message.Message):
    ...
    def __init__(
        ...
        *,
        ...
        headers: global___RequestHeaders | None = ...,
        message: global___RequestMessage | None = ...,
        rst_stream: builtins.bool = ...,
    ) -> None: ...
    def HasField(
        self,
    ...
    ) -> typing_extensions.Literal["headers", "message", "rst_stream"] | None: ...
...
class RequestHeaders(google.protobuf.message.Message):
    ...
    def HasField(
        self,
        field_name: typing_extensions.Literal[
            "metadata", b"metadata", "timeout", b"timeout"
        ],
    ) -> builtins.bool: ...
    def ClearField(
        self,
        field_name: typing_extensions.Literal[
            "metadata", b"metadata", "method", b"method", "timeout", b"timeout"
        ],
    ) -> None: ...
...
class RequestMessage(google.protobuf.message.Message):
    ...
    def __init__(
        ...
        *,
        has_message: builtins.bool = ...,
        packet_message: global___PacketMessage | None = ...,
        eos: builtins.bool = ...,
    ) -> None: ...
    def HasField(
        self, field_name: typing_extensions.Literal["packet_message", b"packet_message"]
    ) -> builtins.bool: ...
    def ClearField(
        self,
        field_name: typing_extensions.Literal[
...
class Response(google.protobuf.message.Message):
    ...
    def __init__(
        ...
        *,
        stream: global___Stream | None = ...,
        headers: global___ResponseHeaders | None = ...,
        message: global___ResponseMessage | None = ...,
        trailers: global___ResponseTrailers | None = ...,
    ) -> None: ...
    def HasField(
        self,
        field_name: typing_extensions.Literal[
    ...
    def WhichOneof(
        self, oneof_group: typing_extensions.Literal["type", b"type"]
    ) -> typing_extensions.Literal["headers", "message", "trailers"] | None: ...
...
class ResponseMessage(google.protobuf.message.Message):
    ...
    def packet_message(self) -> global___PacketMessage: ...
    def __init__(
        self, *, packet_message: global___PacketMessage | None = ...
    ) -> None: ...
    def HasField(
        self, field_name: typing_extensions.Literal["packet_message", b"packet_message"]
    ) -> builtins.bool: ...
...
class ResponseTrailers(google.protobuf.message.Message):
    ...
    def HasField(
        self,
        field_name: typing_extensions.Literal[
            "metadata", b"metadata", "status", b"status"
        ],
    ) -> builtins.bool: ...
    def ClearField(
        self,
...
class Metadata(google.protobuf.message.Message):
    ...
    class MdEntry(google.protobuf.message.Message):
        ...
        def __init__(
            self, *, key: builtins.str = ..., value: global___Strings | None = ...
        ) -> None: ...
        def HasField(
    ...
    def md(
        ...
        builtins.str, global___Strings
    ]: ...
    def __init__(
        self,
        *,
        md: collections.abc.Mapping[builtins.str, global___Strings] | None = ...,
    ) -> None: ...
    def ClearField(
        self, field_name: typing_extensions.Literal["md", b"md"]
    ) -> None: ...
