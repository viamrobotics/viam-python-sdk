...
class SignalingServiceStub:
    ...
    def __init__(self, channel: grpclib.client.Channel) -> None:
        ...
        self.ReportConnectionMetadata = grpclib.client.UnaryUnaryMethod(channel, '/proto.rpc.webrtc.v1.SignalingService/ReportConnectionMetadata', proto.rpc.webrtc.v1.signaling_pb2.ReportConnectionMetadataRequest, proto.rpc.webrtc.v1.signaling_pb2.ReportConnectionMetadataResponse)