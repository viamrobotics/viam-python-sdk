...
_runtime_version.ValidateProtobufRuntimeVersion(_runtime_version.Domain.PUBLIC, 5, 28, 2, '', 'proto/rpc/examples/fileupload/v1/fileupload.proto')
_sym_db = _symbol_database.Default()
DESCRIPTOR = _descriptor_pool.Default().AddSerializedFile(b'\n1proto/rpc/examples/fileupload/v1/fileupload.proto\x12 proto.rpc.examples.fileupload.v1"R\n\x11UploadFileRequest\x12\x14\n\x04name\x18\x01 \x01(\tH\x00R\x04name\x12\x1f\n\nchunk_data\x18\x02 \x01(\x0cH\x00R\tchunkDataB\x06\n\x04data"<\n\x12UploadFileResponse\x12\x12\n\x04name\x18\x01 \x01(\tR\x04name\x12\x12\n\x04size\x18\x02 \x01(\x03R\x04size2\x90\x01\n\x11FileUploadService\x12{\n\nUploadFile\x123.proto.rpc.examples.fileupload.v1.UploadFileRequest\x1a4.proto.rpc.examples.fileupload.v1.UploadFileResponse"\x00(\x01B4Z2go.viam.com/utils/proto/rpc/examples/fileupload/v1b\x06proto3')
_globals = globals()
...
if not _descriptor._USE_C_DESCRIPTORS:
    ...
    _globals['DESCRIPTOR']._serialized_options = b'Z2go.viam.com/utils/proto/rpc/examples/fileupload/v1'
    ...
    _globals['_FILEUPLOADSERVICE']._serialized_end = 378