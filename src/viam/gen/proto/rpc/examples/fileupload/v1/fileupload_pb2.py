...
UploadFileRequest = _reflection.GeneratedProtocolMessageType('UploadFileRequest', (_message.Message,), {'DESCRIPTOR': _UPLOADFILEREQUEST, '__module__': 'proto.rpc.examples.fileupload.v1.fileupload_pb2'})
_sym_db.RegisterMessage(UploadFileRequest)
UploadFileResponse = _reflection.GeneratedProtocolMessageType('UploadFileResponse', (_message.Message,), {'DESCRIPTOR': _UPLOADFILERESPONSE, '__module__': 'proto.rpc.examples.fileupload.v1.fileupload_pb2'})
_sym_db.RegisterMessage(UploadFileResponse)
_FILEUPLOADSERVICE = DESCRIPTOR.services_by_name['FileUploadService']
