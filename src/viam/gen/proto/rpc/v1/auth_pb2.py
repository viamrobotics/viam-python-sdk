...
if _descriptor._USE_C_DESCRIPTORS == False:
    ...
    _AUTHSERVICE.methods_by_name[
        "Authenticate"
    ]._serialized_options = b'\x82\xd3\xe4\x93\x02\x16"\x14/rpc/v1/authenticate'
    _EXTERNALAUTHSERVICE.methods_by_name["AuthenticateTo"]._options = None
    _EXTERNALAUTHSERVICE.methods_by_name[
        "AuthenticateTo"
    ]._serialized_options = b'\x82\xd3\xe4\x93\x02\x19"\x17/rpc/v1/authenticate_to'
