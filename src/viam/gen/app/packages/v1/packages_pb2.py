...
_runtime_version.ValidateProtobufRuntimeVersion(_runtime_version.Domain.PUBLIC, 5, 28, 1, '', 'app/packages/v1/packages.proto')
...
_builder.BuildTopDescriptorsAndMessages(DESCRIPTOR, 'app.packages.v1.packages_pb2', _globals)
if not _descriptor._USE_C_DESCRIPTORS:
    _globals['DESCRIPTOR']._loaded_options = None
    _globals['DESCRIPTOR']._serialized_options = b'Z\x1fgo.viam.com/api/app/packages/v1'
    _globals['_PACKAGESERVICE'].methods_by_name['CreatePackage']._loaded_options = None
    _globals['_PACKAGESERVICE'].methods_by_name['CreatePackage']._serialized_options = b'\x82\xd3\xe4\x93\x02\x15"\x13/packages/v1/create'
    _globals['_PACKAGESERVICE'].methods_by_name['DeletePackage']._loaded_options = None
    _globals['_PACKAGESERVICE'].methods_by_name['DeletePackage']._serialized_options = b'\x82\xd3\xe4\x93\x02\x15*\x13/packages/v1/delete'
    _globals['_PACKAGESERVICE'].methods_by_name['GetPackage']._loaded_options = None
    _globals['_PACKAGESERVICE'].methods_by_name['GetPackage']._serialized_options = b'\x82\xd3\xe4\x93\x02\x12\x12\x10/packages/v1/get'
    _globals['_PACKAGESERVICE'].methods_by_name['ListPackages']._loaded_options = None
    _globals['_PACKAGESERVICE'].methods_by_name['ListPackages']._serialized_options = b'\x82\xd3\xe4\x93\x02\x13\x12\x11/packages/v1/list'
    _globals['_PACKAGETYPE']._serialized_start = 1753
    _globals['_PACKAGETYPE']._serialized_end = 1931
    _globals['_FILEINFO']._serialized_start = 149
    _globals['_FILEINFO']._serialized_end = 256
    _globals['_PACKAGEINFO']._serialized_start = 259
    _globals['_PACKAGEINFO']._serialized_end = 567
    _globals['_CREATEPACKAGEREQUEST']._serialized_start = 569
    _globals['_CREATEPACKAGEREQUEST']._serialized_end = 689
    _globals['_CREATEPACKAGERESPONSE']._serialized_start = 691
    _globals['_CREATEPACKAGERESPONSE']._serialized_end = 756
    _globals['_DELETEPACKAGEREQUEST']._serialized_start = 758
    _globals['_DELETEPACKAGEREQUEST']._serialized_end = 877
    _globals['_DELETEPACKAGERESPONSE']._serialized_start = 879
    _globals['_DELETEPACKAGERESPONSE']._serialized_end = 902
    _globals['_PACKAGE']._serialized_start = 905
    _globals['_PACKAGE']._serialized_end = 1090
    _globals['_GETPACKAGEREQUEST']._serialized_start = 1093
    _globals['_GETPACKAGEREQUEST']._serialized_end = 1323
    _globals['_GETPACKAGERESPONSE']._serialized_start = 1325
    _globals['_GETPACKAGERESPONSE']._serialized_end = 1402
    _globals['_LISTPACKAGESREQUEST']._serialized_start = 1405
    _globals['_LISTPACKAGESREQUEST']._serialized_end = 1667
    _globals['_LISTPACKAGESRESPONSE']._serialized_start = 1669
    _globals['_LISTPACKAGESRESPONSE']._serialized_end = 1750
    _globals['_PACKAGESERVICE']._serialized_start = 1934
    _globals['_PACKAGESERVICE']._serialized_end = 2478