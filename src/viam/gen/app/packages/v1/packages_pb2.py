...
_builder.BuildTopDescriptorsAndMessages(
    DESCRIPTOR, "app.packages.v1.packages_pb2", globals()
)
if _descriptor._USE_C_DESCRIPTORS == False:
    ...
    _PACKAGESERVICE.methods_by_name[
        "CreatePackage"
    ]._serialized_options = b'\x82\xd3\xe4\x93\x02\x15"\x13/packages/v1/create'
    _PACKAGESERVICE.methods_by_name["DeletePackage"]._options = None
    _PACKAGESERVICE.methods_by_name[
        "DeletePackage"
    ]._serialized_options = b"\x82\xd3\xe4\x93\x02\x15*\x13/packages/v1/delete"
    _PACKAGESERVICE.methods_by_name["GetPackage"]._options = None
    _PACKAGESERVICE.methods_by_name[
        "GetPackage"
    ]._serialized_options = b"\x82\xd3\xe4\x93\x02\x12\x12\x10/packages/v1/get"
    _PACKAGESERVICE.methods_by_name["ListPackages"]._options = None
    _PACKAGESERVICE.methods_by_name[
        "ListPackages"
    ]._serialized_options = b"\x82\xd3\xe4\x93\x02\x13\x12\x11/packages/v1/list"
    _PACKAGETYPE._serialized_start = 1696
    _PACKAGETYPE._serialized_end = 1844
    _FILEINFO._serialized_start = 149
    _FILEINFO._serialized_end = 199
    _PACKAGEINFO._serialized_start = 202
    _PACKAGEINFO._serialized_end = 510
    _CREATEPACKAGEREQUEST._serialized_start = 512
    _CREATEPACKAGEREQUEST._serialized_end = 632
    _CREATEPACKAGERESPONSE._serialized_start = 634
    _CREATEPACKAGERESPONSE._serialized_end = 699
    _DELETEPACKAGEREQUEST._serialized_start = 701
    _DELETEPACKAGEREQUEST._serialized_end = 820
    _DELETEPACKAGERESPONSE._serialized_start = 822
    _DELETEPACKAGERESPONSE._serialized_end = 845
    _PACKAGE._serialized_start = 848
    _PACKAGE._serialized_end = 1033
    _GETPACKAGEREQUEST._serialized_start = 1036
    _GETPACKAGEREQUEST._serialized_end = 1266
    _GETPACKAGERESPONSE._serialized_start = 1268
    _GETPACKAGERESPONSE._serialized_end = 1345
    _LISTPACKAGESREQUEST._serialized_start = 1348
    _LISTPACKAGESREQUEST._serialized_end = 1610
    _LISTPACKAGESRESPONSE._serialized_start = 1612
    _LISTPACKAGESRESPONSE._serialized_end = 1693
    _PACKAGESERVICE._serialized_start = 1847
    _PACKAGESERVICE._serialized_end = 2391
