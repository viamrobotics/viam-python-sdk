...
if not _descriptor._USE_C_DESCRIPTORS:
    ...
    _globals['_PACKAGETYPE']._serialized_start = 1696
    _globals['_PACKAGETYPE']._serialized_end = 1874
    _globals['_FILEINFO']._serialized_start = 149
    _globals['_FILEINFO']._serialized_end = 199
    _globals['_PACKAGEINFO']._serialized_start = 202
    _globals['_PACKAGEINFO']._serialized_end = 510
    _globals['_CREATEPACKAGEREQUEST']._serialized_start = 512
    _globals['_CREATEPACKAGEREQUEST']._serialized_end = 632
    _globals['_CREATEPACKAGERESPONSE']._serialized_start = 634
    _globals['_CREATEPACKAGERESPONSE']._serialized_end = 699
    _globals['_DELETEPACKAGEREQUEST']._serialized_start = 701
    _globals['_DELETEPACKAGEREQUEST']._serialized_end = 820
    _globals['_DELETEPACKAGERESPONSE']._serialized_start = 822
    _globals['_DELETEPACKAGERESPONSE']._serialized_end = 845
    _globals['_PACKAGE']._serialized_start = 848
    _globals['_PACKAGE']._serialized_end = 1033
    _globals['_GETPACKAGEREQUEST']._serialized_start = 1036
    _globals['_GETPACKAGEREQUEST']._serialized_end = 1266
    _globals['_GETPACKAGERESPONSE']._serialized_start = 1268
    _globals['_GETPACKAGERESPONSE']._serialized_end = 1345
    _globals['_LISTPACKAGESREQUEST']._serialized_start = 1348
    _globals['_LISTPACKAGESREQUEST']._serialized_end = 1610
    _globals['_LISTPACKAGESRESPONSE']._serialized_start = 1612
    _globals['_LISTPACKAGESRESPONSE']._serialized_end = 1693
    _globals['_PACKAGESERVICE']._serialized_start = 1877
    _globals['_PACKAGESERVICE']._serialized_end = 2421