...
class _PackageTypeEnumTypeWrapper(
    google.protobuf.internal.enum_type_wrapper._EnumTypeWrapper[_PackageType.ValueType],
    builtins.type,
):
...
class FileInfo(google.protobuf.message.Message):
    ...
    def __init__(
        self, *, name: builtins.str = ..., size: builtins.int = ...
    ) -> None: ...
    def ClearField(
        self, field_name: typing_extensions.Literal["name", b"name", "size", b"size"]
    ) -> None: ...
...
class PackageInfo(google.protobuf.message.Message):
    ...
    def __init__(
        ...
        *,
        ...
        files: collections.abc.Iterable[global___FileInfo] | None = ...,
        metadata: google.protobuf.struct_pb2.Struct | None = ...,
    ) -> None: ...
    def HasField(
        self,
        field_name: typing_extensions.Literal[
            "_platform", b"_platform", "metadata", b"metadata", "platform", b"platform"
        ],
    ) -> builtins.bool: ...
    def ClearField(
        self,
...
class CreatePackageRequest(google.protobuf.message.Message):
    ...
    def __init__(
        self, *, info: global___PackageInfo | None = ..., contents: builtins.bytes = ...
    ) -> None: ...
    def HasField(
        self,
        field_name: typing_extensions.Literal[
            "contents", b"contents", "info", b"info", "package", b"package"
        ],
    ) -> builtins.bool: ...
    def ClearField(
        self,
    ...
    def WhichOneof(
        self, oneof_group: typing_extensions.Literal["package", b"package"]
    ) -> typing_extensions.Literal["info", "contents"] | None: ...
...
class CreatePackageResponse(google.protobuf.message.Message):
    ...
    def __init__(
        self, *, id: builtins.str = ..., version: builtins.str = ...
    ) -> None: ...
    def ClearField(
...
class Package(google.protobuf.message.Message):
    ...
    def __init__(
        self,
        *,
        info: global___PackageInfo | None = ...,
        url: builtins.str = ...,
    ...
    def HasField(
        self,
        field_name: typing_extensions.Literal[
            "created_on", b"created_on", "info", b"info"
        ],
    ) -> builtins.bool: ...
    def ClearField(
        self,
...
class GetPackageRequest(google.protobuf.message.Message):
    ...
    def __init__(
        ...
        *,
        id: builtins.str = ...,
        version: builtins.str = ...,
        include_url: builtins.bool | None = ...,
        type: global___PackageType.ValueType | None = ...,
        platform: builtins.str | None = ...,
    ) -> None: ...
    def HasField(
        self,
    ...
    @typing.overload
    def WhichOneof(
        self, oneof_group: typing_extensions.Literal["_include_url", b"_include_url"]
    ) -> typing_extensions.Literal["include_url"] | None: ...
    @typing.overload
    def WhichOneof(
        self, oneof_group: typing_extensions.Literal["_platform", b"_platform"]
    ) -> typing_extensions.Literal["platform"] | None: ...
...
class GetPackageResponse(google.protobuf.message.Message):
    ...
    def HasField(
        self, field_name: typing_extensions.Literal["package", b"package"]
    ) -> builtins.bool: ...
    def ClearField(
        self, field_name: typing_extensions.Literal["package", b"package"]
    ) -> None: ...
...
class ListPackagesRequest(google.protobuf.message.Message):
    ...
    @typing.overload
    def WhichOneof(
        self, oneof_group: typing_extensions.Literal["_version", b"_version"]
    ) -> typing_extensions.Literal["version"] | None: ...
...
class ListPackagesResponse(google.protobuf.message.Message):
    ...
    def __init__(
        self, *, packages: collections.abc.Iterable[global___Package] | None = ...
    ) -> None: ...
    def ClearField(
        self, field_name: typing_extensions.Literal["packages", b"packages"]
    ) -> None: ...
