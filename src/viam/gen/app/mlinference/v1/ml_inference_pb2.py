...
_builder.BuildTopDescriptorsAndMessages(DESCRIPTOR, 'app.mlinference.v1.ml_inference_pb2', globals())
if _descriptor._USE_C_DESCRIPTORS == False:
    DESCRIPTOR._options = None
    DESCRIPTOR._serialized_options = b'Z"go.viam.com/api/app/mlinference/v1'
    _GETINFERENCEREQUEST._serialized_start = 125
    _GETINFERENCEREQUEST._serialized_end = 376
    _GETINFERENCERESPONSE._serialized_start = 379
    _GETINFERENCERESPONSE._serialized_end = 543
    _MLINFERENCESERVICE._serialized_start = 546
    _MLINFERENCESERVICE._serialized_end = 675