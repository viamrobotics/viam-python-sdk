...
class _OrderEnumTypeWrapper(
    google.protobuf.internal.enum_type_wrapper._EnumTypeWrapper[_Order.ValueType],
    builtins.type,
):
...
class Filter(google.protobuf.message.Message):
    ...
    def __init__(
        ...
        *,
        ...
        part_name: builtins.str = ...,
        part_id: builtins.str = ...,
        location_ids: collections.abc.Iterable[builtins.str] | None = ...,
        organization_ids: collections.abc.Iterable[builtins.str] | None = ...,
        mime_type: collections.abc.Iterable[builtins.str] | None = ...,
        interval: global___CaptureInterval | None = ...,
        tags_filter: global___TagsFilter | None = ...,
        bbox_labels: collections.abc.Iterable[builtins.str] | None = ...,
        dataset_id: builtins.str = ...,
    ) -> None: ...
    def HasField(
        self,
        field_name: typing_extensions.Literal[
            "interval", b"interval", "tags_filter", b"tags_filter"
        ],
    ) -> builtins.bool: ...
    def ClearField(
        self,
...
class TagsFilter(google.protobuf.message.Message):
    ...
    def ClearField(
        self, field_name: typing_extensions.Literal["tags", b"tags", "type", b"type"]
    ) -> None: ...
...
class CaptureMetadata(google.protobuf.message.Message):
    ...
    def method_parameters(
        ...
        builtins.str, google.protobuf.any_pb2.Any
    ]: ...
    @property
    def tags(
        self,
    ...
    def __init__(
        ...
        *,
        ...
        component_name: builtins.str = ...,
        method_name: builtins.str = ...,
        method_parameters: collections.abc.Mapping[
            builtins.str, google.protobuf.any_pb2.Any
        ]
        | None = ...,
        tags: collections.abc.Iterable[builtins.str] | None = ...,
...
class TabularDataByFilterRequest(google.protobuf.message.Message):
    ...
    def __init__(
        self,
        *,
        data_request: global___DataRequest | None = ...,
        count_only: builtins.bool = ...,
        include_internal_data: builtins.bool = ...,
    ) -> None: ...
    def HasField(
        self, field_name: typing_extensions.Literal["data_request", b"data_request"]
    ) -> builtins.bool: ...
    def ClearField(
        self,
        field_name: typing_extensions.Literal[
            ...
            "data_request",
            b"data_request",
            "include_internal_data",
            b"include_internal_data",
        ],
    ) -> None: ...
...
class TabularDataByFilterResponse(google.protobuf.message.Message):
    ...
    def __init__(
        self,
        *,
        metadata: collections.abc.Iterable[global___CaptureMetadata] | None = ...,
        data: collections.abc.Iterable[global___TabularData] | None = ...,
        count: builtins.int = ...,
        last: builtins.str = ...,
        total_size_bytes: builtins.int = ...,
    ) -> None: ...
...
class TabularData(google.protobuf.message.Message):
    ...
    def __init__(
        ...
        *,
        ...
        metadata_index: builtins.int = ...,
        time_requested: google.protobuf.timestamp_pb2.Timestamp | None = ...,
        time_received: google.protobuf.timestamp_pb2.Timestamp | None = ...,
    ) -> None: ...
    def HasField(
        self,
        field_name: typing_extensions.Literal[
...
class TabularDataBySQLRequest(google.protobuf.message.Message):
    ...
    def __init__(
        self, *, organization_id: builtins.str = ..., sql_query: builtins.str = ...
    ) -> None: ...
    def ClearField(
        self,
        field_name: typing_extensions.Literal[
            "organization_id", b"organization_id", "sql_query", b"sql_query"
        ],
    ) -> None: ...
...
class TabularDataByMQLRequest(google.protobuf.message.Message):
    ...
    def __init__(
        ...
        *,
        organization_id: builtins.str = ...,
        mql_binary: collections.abc.Iterable[builtins.bytes] | None = ...,
    ) -> None: ...
    def ClearField(
        self,
        field_name: typing_extensions.Literal[
            "mql_binary", b"mql_binary", "organization_id", b"organization_id"
        ],
    ) -> None: ...
...
class BinaryData(google.protobuf.message.Message):
    ...
    def ClearField(
        self,
        field_name: typing_extensions.Literal[
            "binary", b"binary", "metadata", b"metadata"
        ],
    ) -> None: ...
...
class BinaryDataByFilterResponse(google.protobuf.message.Message):
    ...
    def __init__(
        self,
        *,
        data: collections.abc.Iterable[global___BinaryData] | None = ...,
        count: builtins.int = ...,
        last: builtins.str = ...,
        total_size_bytes: builtins.int = ...,
    ) -> None: ...
...
class BinaryDataByIDsRequest(google.protobuf.message.Message):
    ...
    def __init__(
        ...
        *,
        include_binary: builtins.bool = ...,
        binary_ids: collections.abc.Iterable[global___BinaryID] | None = ...,
    ) -> None: ...
    def ClearField(
        self,
        field_name: typing_extensions.Literal[
            "binary_ids", b"binary_ids", "include_binary", b"include_binary"
        ],
    ) -> None: ...
...
class BinaryDataByIDsResponse(google.protobuf.message.Message):
    ...
    def ClearField(
        self, field_name: typing_extensions.Literal["count", b"count", "data", b"data"]
    ) -> None: ...
...
class Annotations(google.protobuf.message.Message):
    ...
    def __init__(
        self, *, bboxes: collections.abc.Iterable[global___BoundingBox] | None = ...
    ) -> None: ...
    def ClearField(
        self, field_name: typing_extensions.Literal["bboxes", b"bboxes"]
    ) -> None: ...
...
class BinaryMetadata(google.protobuf.message.Message):
    ...
    def __init__(
        ...
        *,
        id: builtins.str = ...,
        capture_metadata: global___CaptureMetadata | None = ...,
        time_requested: google.protobuf.timestamp_pb2.Timestamp | None = ...,
        time_received: google.protobuf.timestamp_pb2.Timestamp | None = ...,
        file_name: builtins.str = ...,
        file_ext: builtins.str = ...,
        uri: builtins.str = ...,
        annotations: global___Annotations | None = ...,
...
class DeleteTabularDataResponse(google.protobuf.message.Message):
    ...
    def ClearField(
        self, field_name: typing_extensions.Literal["deleted_count", b"deleted_count"]
    ) -> None: ...
...
class DeleteBinaryDataByFilterRequest(google.protobuf.message.Message):
    ...
    def ClearField(
        self,
        field_name: typing_extensions.Literal[
            "filter", b"filter", "include_internal_data", b"include_internal_data"
        ],
    ) -> None: ...
...
class DeleteBinaryDataByIDsRequest(google.protobuf.message.Message):
    ...
    def __init__(
        self, *, binary_ids: collections.abc.Iterable[global___BinaryID] | None = ...
    ) -> None: ...
    def ClearField(
        self, field_name: typing_extensions.Literal["binary_ids", b"binary_ids"]
    ) -> None: ...
...
class AddTagsToBinaryDataByIDsRequest(google.protobuf.message.Message):
    ...
    def ClearField(
        self,
        field_name: typing_extensions.Literal[
            "binary_ids", b"binary_ids", "tags", b"tags"
        ],
    ) -> None: ...
...
class AddTagsToBinaryDataByFilterRequest(google.protobuf.message.Message):
    ...
    def ClearField(
        self,
        field_name: typing_extensions.Literal["filter", b"filter", "tags", b"tags"],
    ) -> None: ...
...
class TagsByFilterResponse(google.protobuf.message.Message):
    ...
    def __init__(
        self, *, tags: collections.abc.Iterable[builtins.str] | None = ...
    ) -> None: ...
    def ClearField(
        self, field_name: typing_extensions.Literal["tags", b"tags"]
    ) -> None: ...
...
class AddBoundingBoxToImageByIDRequest(google.protobuf.message.Message):
    ...
    def __init__(
        self,
        *,
        binary_id: global___BinaryID | None = ...,
        label: builtins.str = ...,
        x_min_normalized: builtins.float = ...,
        y_min_normalized: builtins.float = ...,
        x_max_normalized: builtins.float = ...,
    ...
    def HasField(
        self, field_name: typing_extensions.Literal["binary_id", b"binary_id"]
    ) -> builtins.bool: ...
    def ClearField(
        self,
        field_name: typing_extensions.Literal[
...
class AddBoundingBoxToImageByIDResponse(google.protobuf.message.Message):
    ...
    def ClearField(
        self, field_name: typing_extensions.Literal["bbox_id", b"bbox_id"]
    ) -> None: ...
...
class RemoveBoundingBoxFromImageByIDRequest(google.protobuf.message.Message):
    ...
    def __init__(
        self, *, binary_id: global___BinaryID | None = ..., bbox_id: builtins.str = ...
    ) -> None: ...
    def HasField(
        self, field_name: typing_extensions.Literal["binary_id", b"binary_id"]
    ) -> builtins.bool: ...
    def ClearField(
        self,
        field_name: typing_extensions.Literal[
            "bbox_id", b"bbox_id", "binary_id", b"binary_id"
        ],
    ) -> None: ...
...
class BoundingBoxLabelsByFilterResponse(google.protobuf.message.Message):
    ...
    def __init__(
        self, *, labels: collections.abc.Iterable[builtins.str] | None = ...
    ) -> None: ...
    def ClearField(
        self, field_name: typing_extensions.Literal["labels", b"labels"]
    ) -> None: ...
...
class ConfigureDatabaseUserRequest(google.protobuf.message.Message):
    ...
    def __init__(
        self, *, organization_id: builtins.str = ..., password: builtins.str = ...
    ) -> None: ...
    def ClearField(
        self,
        field_name: typing_extensions.Literal[
            "organization_id", b"organization_id", "password", b"password"
        ],
    ) -> None: ...
...
class AddBinaryDataToDatasetByIDsRequest(google.protobuf.message.Message):
    ...
    def ClearField(
        self,
        field_name: typing_extensions.Literal[
            "binary_ids", b"binary_ids", "dataset_id", b"dataset_id"
        ],
    ) -> None: ...
