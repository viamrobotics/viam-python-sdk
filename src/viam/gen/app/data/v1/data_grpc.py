...
class DataServiceStub:
    ...
    def __init__(self, channel: grpclib.client.Channel) -> None:
        ...
        self.GetDataPipeline = grpclib.client.UnaryUnaryMethod(channel, '/viam.app.data.v1.DataService/GetDataPipeline', app.data.v1.data_pb2.GetDataPipelineRequest, app.data.v1.data_pb2.GetDataPipelineResponse)
        self.ListDataPipelines = grpclib.client.UnaryUnaryMethod(channel, '/viam.app.data.v1.DataService/ListDataPipelines', app.data.v1.data_pb2.ListDataPipelinesRequest, app.data.v1.data_pb2.ListDataPipelinesResponse)
        self.CreateDataPipeline = grpclib.client.UnaryUnaryMethod(channel, '/viam.app.data.v1.DataService/CreateDataPipeline', app.data.v1.data_pb2.CreateDataPipelineRequest, app.data.v1.data_pb2.CreateDataPipelineResponse)
        self.UpdateDataPipeline = grpclib.client.UnaryUnaryMethod(channel, '/viam.app.data.v1.DataService/UpdateDataPipeline', app.data.v1.data_pb2.UpdateDataPipelineRequest, app.data.v1.data_pb2.UpdateDataPipelineResponse)
        self.DeleteDataPipeline = grpclib.client.UnaryUnaryMethod(channel, '/viam.app.data.v1.DataService/DeleteDataPipeline', app.data.v1.data_pb2.DeleteDataPipelineRequest, app.data.v1.data_pb2.DeleteDataPipelineResponse)