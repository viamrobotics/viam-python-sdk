...
class DataServiceBase(abc.ABC):
    ...
    @abc.abstractmethod
    async def ExportTabularData(self, stream: 'grpclib.server.Stream[app.data.v1.data_pb2.ExportTabularDataRequest, app.data.v1.data_pb2.ExportTabularDataResponse]') -> None:
        pass

    @abc.abstractmethod
    async def GetLatestTabularData(self, stream: 'grpclib.server.Stream[app.data.v1.data_pb2.GetLatestTabularDataRequest, app.data.v1.data_pb2.GetLatestTabularDataResponse]') -> None:
        pass
    ...
    @abc.abstractmethod
    async def UpdateBoundingBox(self, stream: 'grpclib.server.Stream[app.data.v1.data_pb2.UpdateBoundingBoxRequest, app.data.v1.data_pb2.UpdateBoundingBoxResponse]') -> None:
        pass
    ...
    @abc.abstractmethod
    async def AddSequencesToDataset(self, stream: 'grpclib.server.Stream[app.data.v1.data_pb2.AddSequencesToDatasetRequest, app.data.v1.data_pb2.AddSequencesToDatasetResponse]') -> None:
        pass

    @abc.abstractmethod
    async def RemoveSequencesFromDataset(self, stream: 'grpclib.server.Stream[app.data.v1.data_pb2.RemoveSequencesFromDatasetRequest, app.data.v1.data_pb2.RemoveSequencesFromDatasetResponse]') -> None:
        pass
...
class DataServiceStub:
    ...
    def __init__(self, channel: grpclib.client.Channel) -> None:
        ...
        self.ExportTabularData = grpclib.client.UnaryStreamMethod(channel, '/viam.app.data.v1.DataService/ExportTabularData', app.data.v1.data_pb2.ExportTabularDataRequest, app.data.v1.data_pb2.ExportTabularDataResponse)
        self.GetLatestTabularData = grpclib.client.UnaryUnaryMethod(channel, '/viam.app.data.v1.DataService/GetLatestTabularData', app.data.v1.data_pb2.GetLatestTabularDataRequest, app.data.v1.data_pb2.GetLatestTabularDataResponse)
        ...
        self.UpdateBoundingBox = grpclib.client.UnaryUnaryMethod(channel, '/viam.app.data.v1.DataService/UpdateBoundingBox', app.data.v1.data_pb2.UpdateBoundingBoxRequest, app.data.v1.data_pb2.UpdateBoundingBoxResponse)
        ...
        self.AddSequencesToDataset = grpclib.client.UnaryUnaryMethod(channel, '/viam.app.data.v1.DataService/AddSequencesToDataset', app.data.v1.data_pb2.AddSequencesToDatasetRequest, app.data.v1.data_pb2.AddSequencesToDatasetResponse)
        self.RemoveSequencesFromDataset = grpclib.client.UnaryUnaryMethod(channel, '/viam.app.data.v1.DataService/RemoveSequencesFromDataset', app.data.v1.data_pb2.RemoveSequencesFromDatasetRequest, app.data.v1.data_pb2.RemoveSequencesFromDatasetResponse)
        ...
        self.CreateSequence = grpclib.client.UnaryUnaryMethod(channel, '/viam.app.data.v1.DataService/CreateSequence', app.data.v1.data_pb2.CreateSequenceRequest, app.data.v1.data_pb2.CreateSequenceResponse)
        self.GetSequence = grpclib.client.UnaryUnaryMethod(channel, '/viam.app.data.v1.DataService/GetSequence', app.data.v1.data_pb2.GetSequenceRequest, app.data.v1.data_pb2.GetSequenceResponse)
        self.UpdateSequence = grpclib.client.UnaryUnaryMethod(channel, '/viam.app.data.v1.DataService/UpdateSequence', app.data.v1.data_pb2.UpdateSequenceRequest, app.data.v1.data_pb2.UpdateSequenceResponse)
        self.DeleteSequence = grpclib.client.UnaryUnaryMethod(channel, '/viam.app.data.v1.DataService/DeleteSequence', app.data.v1.data_pb2.DeleteSequenceRequest, app.data.v1.data_pb2.DeleteSequenceResponse)
        self.ListSequences = grpclib.client.UnaryUnaryMethod(channel, '/viam.app.data.v1.DataService/ListSequences', app.data.v1.data_pb2.ListSequencesRequest, app.data.v1.data_pb2.ListSequencesResponse)
        self.SequencesByDatasetID = grpclib.client.UnaryUnaryMethod(channel, '/viam.app.data.v1.DataService/SequencesByDatasetID', app.data.v1.data_pb2.SequencesByDatasetIDRequest, app.data.v1.data_pb2.SequencesByDatasetIDResponse)
        self.GetSequenceBinaryData = grpclib.client.UnaryUnaryMethod(channel, '/viam.app.data.v1.DataService/GetSequenceBinaryData', app.data.v1.data_pb2.GetSequenceBinaryDataRequest, app.data.v1.data_pb2.GetSequenceBinaryDataResponse)