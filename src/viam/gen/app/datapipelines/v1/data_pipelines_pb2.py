...
if not _descriptor._USE_C_DESCRIPTORS:
    ...
    _globals['_DATAPIPELINESSERVICE']._serialized_start = 1305
    _globals['_DATAPIPELINESSERVICE']._serialized_end = 2240