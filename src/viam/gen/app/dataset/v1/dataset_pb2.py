...
if not _descriptor._USE_C_DESCRIPTORS:
    ...
    _globals['_DATASETTYPE']._serialized_start = 1765
    _globals['_DATASETTYPE']._serialized_end = 1840
    _globals['_SEQUENCEDATASETEXPORTSTATUS']._serialized_start = 1843
    _globals['_SEQUENCEDATASETEXPORTSTATUS']._serialized_end = 2053
    ...
    _globals['_LISTDATASETSBYORGANIZATIONIDREQUEST']._serialized_start = 638
    _globals['_LISTDATASETSBYORGANIZATIONIDREQUEST']._serialized_end = 784
    _globals['_LISTDATASETSBYORGANIZATIONIDRESPONSE']._serialized_start = 786
    _globals['_LISTDATASETSBYORGANIZATIONIDRESPONSE']._serialized_end = 882
    _globals['_LISTDATASETSBYIDSREQUEST']._serialized_start = 884
    _globals['_LISTDATASETSBYIDSREQUEST']._serialized_end = 928
    _globals['_LISTDATASETSBYIDSRESPONSE']._serialized_start = 930
    _globals['_LISTDATASETSBYIDSRESPONSE']._serialized_end = 1015
    _globals['_MERGEDATASETSREQUEST']._serialized_start = 1017
    _globals['_MERGEDATASETSREQUEST']._serialized_end = 1133
    _globals['_MERGEDATASETSRESPONSE']._serialized_start = 1135
    _globals['_MERGEDATASETSRESPONSE']._serialized_end = 1189
    _globals['_STARTSEQUENCEDATASETEXPORTREQUEST']._serialized_start = 1191
    _globals['_STARTSEQUENCEDATASETEXPORTREQUEST']._serialized_end = 1257
    _globals['_STARTSEQUENCEDATASETEXPORTRESPONSE']._serialized_start = 1259
    _globals['_STARTSEQUENCEDATASETEXPORTRESPONSE']._serialized_end = 1318
    _globals['_GETSEQUENCEDATASETEXPORTREQUEST']._serialized_start = 1320
    _globals['_GETSEQUENCEDATASETEXPORTREQUEST']._serialized_end = 1376
    _globals['_GETSEQUENCEDATASETEXPORTRESPONSE']._serialized_start = 1379
    _globals['_GETSEQUENCEDATASETEXPORTRESPONSE']._serialized_end = 1763
    _globals['_DATASETSERVICE']._serialized_start = 2056
    _globals['_DATASETSERVICE']._serialized_end = 3036