...
class Dataset(google.protobuf.message.Message):
    ...
    def HasField(
        self, field_name: typing_extensions.Literal["time_created", b"time_created"]
    ) -> builtins.bool: ...
    def ClearField(
        self,
...
class CreateDatasetRequest(google.protobuf.message.Message):
    ...
    def __init__(
        self, *, name: builtins.str = ..., organization_id: builtins.str = ...
    ) -> None: ...
    def ClearField(
        self,
        field_name: typing_extensions.Literal[
...
class ListDatasetsByOrganizationIDResponse(google.protobuf.message.Message):
    ...
    def __init__(
        self, *, datasets: collections.abc.Iterable[global___Dataset] | None = ...
    ) -> None: ...
    def ClearField(
        self, field_name: typing_extensions.Literal["datasets", b"datasets"]
    ) -> None: ...
...
class ListDatasetsByIDsRequest(google.protobuf.message.Message):
    ...
    def __init__(
        self, *, ids: collections.abc.Iterable[builtins.str] | None = ...
    ) -> None: ...
    def ClearField(
        self, field_name: typing_extensions.Literal["ids", b"ids"]
    ) -> None: ...
