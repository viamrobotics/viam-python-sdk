...
if _descriptor._USE_C_DESCRIPTORS == False:
    ...
    _APPAGENTCONFIG.fields_by_name[
        "subsystem_configs"
    ]._serialized_options = (
        b'\x9a\x84\x9e\x031bson:"subsystem_configs" json:"subsystem_configs"'
    )
    _APPSUBSYSTEMCONFIG.fields_by_name["release_channel"]._options = None
    _APPSUBSYSTEMCONFIG.fields_by_name[
        "release_channel"
    ]._serialized_options = (
        b'\x9a\x84\x9e\x03-bson:"release_channel" json:"release_channel"'
    )
    _APPSUBSYSTEMCONFIG.fields_by_name["pin_version"]._options = None
    _APPSUBSYSTEMCONFIG.fields_by_name[
        "pin_version"
    ]._serialized_options = b'\x9a\x84\x9e\x03%bson:"pin_version" json:"pin_version"'
    _APPSUBSYSTEMCONFIG.fields_by_name["pin_url"]._options = None
    _APPSUBSYSTEMCONFIG.fields_by_name[
        "pin_url"
    ]._serialized_options = b'\x9a\x84\x9e\x03\x1dbson:"pin_url" json:"pin_url"'
    _APPSUBSYSTEMCONFIG.fields_by_name["disable_subsystem"]._options = None
    _APPSUBSYSTEMCONFIG.fields_by_name[
        "disable_subsystem"
    ]._serialized_options = (
        b'\x9a\x84\x9e\x031bson:"disable_subsystem" json:"disable_subsystem"'
    )
    _APPSUBSYSTEMCONFIG.fields_by_name["attributes"]._options = None
    _APPSUBSYSTEMCONFIG.fields_by_name[
        "attributes"
    ]._serialized_options = b'\x9a\x84\x9e\x03#bson:"attributes" json:"attributes"'
