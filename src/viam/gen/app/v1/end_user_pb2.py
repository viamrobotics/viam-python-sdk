...
if not _descriptor._USE_C_DESCRIPTORS:
    ...
    _globals['_REGISTERAUTHAPPLICATIONRESPONSE']._serialized_end = 517
    _globals['_UPDATEAUTHAPPLICATIONREQUEST']._serialized_start = 520
    _globals['_UPDATEAUTHAPPLICATIONREQUEST']._serialized_end = 756
    _globals['_UPDATEAUTHAPPLICATIONRESPONSE']._serialized_start = 758
    _globals['_UPDATEAUTHAPPLICATIONRESPONSE']._serialized_end = 871
    _globals['_ENDUSERSERVICE']._serialized_start = 874
    _globals['_ENDUSERSERVICE']._serialized_end = 1296