...
if _descriptor._USE_C_DESCRIPTORS == False:
    ...
    _USAGECOSTTYPE.values_by_name['USAGE_COST_TYPE_DATA_UPLOAD']._options = None
    _USAGECOSTTYPE.values_by_name['USAGE_COST_TYPE_DATA_UPLOAD']._serialized_options = b'\x08\x01'
    _USAGECOSTTYPE.values_by_name['USAGE_COST_TYPE_DATA_EGRESS']._options = None
    _USAGECOSTTYPE.values_by_name['USAGE_COST_TYPE_DATA_EGRESS']._serialized_options = b'\x08\x01'
    _USAGECOSTTYPE.values_by_name['USAGE_COST_TYPE_CLOUD_STORAGE']._options = None
    _USAGECOSTTYPE.values_by_name['USAGE_COST_TYPE_CLOUD_STORAGE']._serialized_options = b'\x08\x01'
    _USAGECOSTTYPE.values_by_name['USAGE_COST_TYPE_OTHER_CLOUD_STORAGE']._options = None
    _USAGECOSTTYPE.values_by_name['USAGE_COST_TYPE_OTHER_CLOUD_STORAGE']._serialized_options = b'\x08\x01'
    _GETCURRENTMONTHUSAGERESPONSE.fields_by_name['cloud_storage_usage_cost']._options = None
    _GETCURRENTMONTHUSAGERESPONSE.fields_by_name['cloud_storage_usage_cost']._serialized_options = b'\x18\x01'
    _GETCURRENTMONTHUSAGERESPONSE.fields_by_name['data_upload_usage_cost']._options = None
    _GETCURRENTMONTHUSAGERESPONSE.fields_by_name['data_upload_usage_cost']._serialized_options = b'\x18\x01'
    _GETCURRENTMONTHUSAGERESPONSE.fields_by_name['data_egres_usage_cost']._options = None
    _GETCURRENTMONTHUSAGERESPONSE.fields_by_name['data_egres_usage_cost']._serialized_options = b'\x18\x01'
    _GETCURRENTMONTHUSAGERESPONSE.fields_by_name['remote_control_usage_cost']._options = None
    _GETCURRENTMONTHUSAGERESPONSE.fields_by_name['remote_control_usage_cost']._serialized_options = b'\x18\x01'
    _GETCURRENTMONTHUSAGERESPONSE.fields_by_name['standard_compute_usage_cost']._options = None
    _GETCURRENTMONTHUSAGERESPONSE.fields_by_name['standard_compute_usage_cost']._serialized_options = b'\x18\x01'
    _GETCURRENTMONTHUSAGERESPONSE.fields_by_name['discount_amount']._options = None
    _GETCURRENTMONTHUSAGERESPONSE.fields_by_name['discount_amount']._serialized_options = b'\x18\x01'
    _GETCURRENTMONTHUSAGERESPONSE.fields_by_name['total_usage_with_discount']._options = None
    _GETCURRENTMONTHUSAGERESPONSE.fields_by_name['total_usage_with_discount']._serialized_options = b'\x18\x01'
    _GETCURRENTMONTHUSAGERESPONSE.fields_by_name['total_usage_without_discount']._options = None
    _GETCURRENTMONTHUSAGERESPONSE.fields_by_name['total_usage_without_discount']._serialized_options = b'\x18\x01'
    _GETCURRENTMONTHUSAGERESPONSE.fields_by_name['per_machine_usage_cost']._options = None
    _GETCURRENTMONTHUSAGERESPONSE.fields_by_name['per_machine_usage_cost']._serialized_options = b'\x18\x01'
    _GETCURRENTMONTHUSAGERESPONSE.fields_by_name['binary_data_cloud_storage_usage_cost']._options = None
    _GETCURRENTMONTHUSAGERESPONSE.fields_by_name['binary_data_cloud_storage_usage_cost']._serialized_options = b'\x18\x01'
    _GETCURRENTMONTHUSAGERESPONSE.fields_by_name['other_cloud_storage_usage_cost']._options = None
    _GETCURRENTMONTHUSAGERESPONSE.fields_by_name['other_cloud_storage_usage_cost']._serialized_options = b'\x18\x01'
    _PAYMENTMETHODTYPE._serialized_start = 3896
    _PAYMENTMETHODTYPE._serialized_end = 4021
    _USAGECOSTTYPE._serialized_start = 4024
    _USAGECOSTTYPE._serialized_end = 5180
    _SOURCETYPE._serialized_start = 5182
    _SOURCETYPE._serialized_end = 5270
    _INVOICESUMMARY._serialized_start = 71
    _INVOICESUMMARY._serialized_end = 341
    _PAYMENTMETHODCARD._serialized_start = 343
    _PAYMENTMETHODCARD._serialized_end = 426
    _VERIFICATIONINFO._serialized_start = 428
    _VERIFICATIONINFO._serialized_end = 546
    _PAYMENTMETHODUSBANKACCOUNT._serialized_start = 549
    _PAYMENTMETHODUSBANKACCOUNT._serialized_end = 853
    _GETCURRENTMONTHUSAGEREQUEST._serialized_start = 855
    _GETCURRENTMONTHUSAGEREQUEST._serialized_end = 907
    _USAGECOST._serialized_start = 909
    _USAGECOST._serialized_end = 1005
    _RESOURCEUSAGECOSTSBYSOURCE._serialized_start = 1008
    _RESOURCEUSAGECOSTSBYSOURCE._serialized_end = 1206
    _RESOURCEUSAGECOSTS._serialized_start = 1209
    _RESOURCEUSAGECOSTS._serialized_end = 1416
    _GETCURRENTMONTHUSAGERESPONSE._serialized_start = 1419
    _GETCURRENTMONTHUSAGERESPONSE._serialized_end = 2392
    _GETORGBILLINGINFORMATIONREQUEST._serialized_start = 2394
    _GETORGBILLINGINFORMATIONREQUEST._serialized_end = 2450
    _GETORGBILLINGINFORMATIONRESPONSE._serialized_start = 2453
    _GETORGBILLINGINFORMATIONRESPONSE._serialized_end = 2831
    _GETINVOICESSUMMARYREQUEST._serialized_start = 2833
    _GETINVOICESSUMMARYREQUEST._serialized_end = 2883
    _GETINVOICESSUMMARYRESPONSE._serialized_start = 2886
    _GETINVOICESSUMMARYRESPONSE._serialized_end = 3020
    _GETINVOICEPDFREQUEST._serialized_start = 3022
    _GETINVOICEPDFREQUEST._serialized_end = 3083
    _GETINVOICEPDFRESPONSE._serialized_start = 3085
    _GETINVOICEPDFRESPONSE._serialized_end = 3130
    _SENDPAYMENTREQUIREDEMAILREQUEST._serialized_start = 3132
    _SENDPAYMENTREQUIREDEMAILREQUEST._serialized_end = 3254
    _SENDPAYMENTREQUIREDEMAILRESPONSE._serialized_start = 3256
    _SENDPAYMENTREQUIREDEMAILRESPONSE._serialized_end = 3290
    _GETAVAILABLEBILLINGTIERSREQUEST._serialized_start = 3292
    _GETAVAILABLEBILLINGTIERSREQUEST._serialized_end = 3325
    _GETAVAILABLEBILLINGTIERSRESPONSE._serialized_start = 3327
    _GETAVAILABLEBILLINGTIERSRESPONSE._serialized_end = 3383
    _UPDATEORGANIZATIONBILLINGTIERREQUEST._serialized_start = 3385
    _UPDATEORGANIZATIONBILLINGTIERREQUEST._serialized_end = 3499
    _UPDATEORGANIZATIONBILLINGTIERRESPONSE._serialized_start = 3501
    _UPDATEORGANIZATIONBILLINGTIERRESPONSE._serialized_end = 3540
    _CREATEINVOICEANDCHARGEIMMEDIATELYREQUEST._serialized_start = 3543
    _CREATEINVOICEANDCHARGEIMMEDIATELYREQUEST._serialized_end = 3818
    _CREATEINVOICEANDCHARGEIMMEDIATELYRESPONSE._serialized_start = 3820
    _CREATEINVOICEANDCHARGEIMMEDIATELYRESPONSE._serialized_end = 3894
    _BILLINGSERVICE._serialized_start = 5273
    _BILLINGSERVICE._serialized_end = 6240