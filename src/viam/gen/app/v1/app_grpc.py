...
class AppServiceBase(abc.ABC):
    ...
    @abc.abstractmethod
    async def CreateOAuthAppUser(self, stream: 'grpclib.server.Stream[app.v1.app_pb2.CreateOAuthAppUserRequest, app.v1.app_pb2.CreateOAuthAppUserResponse]') -> None:
        pass
    ...
    @abc.abstractmethod
    async def DeprecateRegistryItem(self, stream: 'grpclib.server.Stream[app.v1.app_pb2.DeprecateRegistryItemRequest, app.v1.app_pb2.DeprecateRegistryItemResponse]') -> None:
        pass

    @abc.abstractmethod
    async def UndeprecateRegistryItem(self, stream: 'grpclib.server.Stream[app.v1.app_pb2.UndeprecateRegistryItemRequest, app.v1.app_pb2.UndeprecateRegistryItemResponse]') -> None:
        pass
    ...
    @abc.abstractmethod
    async def DeprecateRegistryItemVersion(self, stream: 'grpclib.server.Stream[app.v1.app_pb2.DeprecateRegistryItemVersionRequest, app.v1.app_pb2.DeprecateRegistryItemVersionResponse]') -> None:
        pass

    @abc.abstractmethod
    async def UndeprecateRegistryItemVersion(self, stream: 'grpclib.server.Stream[app.v1.app_pb2.UndeprecateRegistryItemVersionRequest, app.v1.app_pb2.UndeprecateRegistryItemVersionResponse]') -> None:
        pass
...
class AppServiceStub:
    ...
    def __init__(self, channel: grpclib.client.Channel) -> None:
        ...
        self.CreateOAuthAppUser = grpclib.client.UnaryUnaryMethod(channel, '/viam.app.v1.AppService/CreateOAuthAppUser', app.v1.app_pb2.CreateOAuthAppUserRequest, app.v1.app_pb2.CreateOAuthAppUserResponse)
        ...
        self.DeprecateRegistryItem = grpclib.client.UnaryUnaryMethod(channel, '/viam.app.v1.AppService/DeprecateRegistryItem', app.v1.app_pb2.DeprecateRegistryItemRequest, app.v1.app_pb2.DeprecateRegistryItemResponse)
        self.UndeprecateRegistryItem = grpclib.client.UnaryUnaryMethod(channel, '/viam.app.v1.AppService/UndeprecateRegistryItem', app.v1.app_pb2.UndeprecateRegistryItemRequest, app.v1.app_pb2.UndeprecateRegistryItemResponse)
        ...
        self.DeprecateRegistryItemVersion = grpclib.client.UnaryUnaryMethod(channel, '/viam.app.v1.AppService/DeprecateRegistryItemVersion', app.v1.app_pb2.DeprecateRegistryItemVersionRequest, app.v1.app_pb2.DeprecateRegistryItemVersionResponse)
        self.UndeprecateRegistryItemVersion = grpclib.client.UnaryUnaryMethod(channel, '/viam.app.v1.AppService/UndeprecateRegistryItemVersion', app.v1.app_pb2.UndeprecateRegistryItemVersionRequest, app.v1.app_pb2.UndeprecateRegistryItemVersionResponse)
        ...
        self.UploadDevicePushToken = grpclib.client.UnaryUnaryMethod(channel, '/viam.app.v1.AppService/UploadDevicePushToken', app.v1.app_pb2.UploadDevicePushTokenRequest, app.v1.app_pb2.UploadDevicePushTokenResponse)
        self.DeleteDevicePushToken = grpclib.client.UnaryUnaryMethod(channel, '/viam.app.v1.AppService/DeleteDevicePushToken', app.v1.app_pb2.DeleteDevicePushTokenRequest, app.v1.app_pb2.DeleteDevicePushTokenResponse)
        self.GetDevicePushTokens = grpclib.client.UnaryUnaryMethod(channel, '/viam.app.v1.AppService/GetDevicePushTokens', app.v1.app_pb2.GetDevicePushTokensRequest, app.v1.app_pb2.GetDevicePushTokensResponse)
        self.SetFirebaseConfig = grpclib.client.UnaryUnaryMethod(channel, '/viam.app.v1.AppService/SetFirebaseConfig', app.v1.app_pb2.SetFirebaseConfigRequest, app.v1.app_pb2.SetFirebaseConfigResponse)
        self.GetFirebaseConfig = grpclib.client.UnaryUnaryMethod(channel, '/viam.app.v1.AppService/GetFirebaseConfig', app.v1.app_pb2.GetFirebaseConfigRequest, app.v1.app_pb2.GetFirebaseConfigResponse)
        self.DeleteFirebaseConfig = grpclib.client.UnaryUnaryMethod(channel, '/viam.app.v1.AppService/DeleteFirebaseConfig', app.v1.app_pb2.DeleteFirebaseConfigRequest, app.v1.app_pb2.DeleteFirebaseConfigResponse)