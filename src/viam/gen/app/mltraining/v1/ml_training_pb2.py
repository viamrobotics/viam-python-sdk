...
_builder.BuildTopDescriptorsAndMessages(
    DESCRIPTOR, "app.mltraining.v1.ml_training_pb2", globals()
)
if _descriptor._USE_C_DESCRIPTORS == False:
    ...
    _SUBMITTRAININGJOBREQUEST.fields_by_name[
        "dataset_id"
    ]._serialized_options = b'\x9a\x84\x9e\x03#bson:"dataset_id" json:"dataset_id"'
    _SUBMITTRAININGJOBREQUEST.fields_by_name["organization_id"]._options = None
    _SUBMITTRAININGJOBREQUEST.fields_by_name[
        "organization_id"
    ]._serialized_options = (
        b'\x9a\x84\x9e\x03-bson:"organization_id" json:"organization_id"'
    )
    _SUBMITTRAININGJOBREQUEST.fields_by_name["model_name"]._options = None
    _SUBMITTRAININGJOBREQUEST.fields_by_name[
        "model_name"
    ]._serialized_options = b'\x9a\x84\x9e\x03#bson:"model_name" json:"model_name"'
    _SUBMITTRAININGJOBREQUEST.fields_by_name["model_version"]._options = None
    _SUBMITTRAININGJOBREQUEST.fields_by_name[
        "model_version"
    ]._serialized_options = (
        b'\x9a\x84\x9e\x03)bson:"model_version" json:"model_version"'
    )
    _SUBMITTRAININGJOBREQUEST.fields_by_name["model_type"]._options = None
    _SUBMITTRAININGJOBREQUEST.fields_by_name[
        "model_type"
    ]._serialized_options = b'\x9a\x84\x9e\x03#bson:"model_type" json:"model_type"'
    _SUBMITTRAININGJOBREQUEST.fields_by_name["tags"]._options = None
    _SUBMITTRAININGJOBREQUEST.fields_by_name[
        "tags"
    ]._serialized_options = b'\x9a\x84\x9e\x03\x17bson:"tags" json:"tags"'
    _TRAININGJOBMETADATA.fields_by_name["request"]._options = None
    _TRAININGJOBMETADATA.fields_by_name[
        "request"
    ]._serialized_options = b'\x9a\x84\x9e\x03\x1dbson:"request" json:"request"'
    _TRAININGJOBMETADATA.fields_by_name["status"]._options = None
    _TRAININGJOBMETADATA.fields_by_name[
        "status"
    ]._serialized_options = b'\x9a\x84\x9e\x03\x1bbson:"status" json:"status"'
    ...
    _TRAININGJOBMETADATA.fields_by_name[
        ...
        b'\x9a\x84\x9e\x03)bson:"last_modified" json:"last_modified"'
    )
    _TRAININGJOBMETADATA.fields_by_name["synced_model_id"]._options = None
    _TRAININGJOBMETADATA.fields_by_name[
        "synced_model_id"
    ]._serialized_options = (
        b'\x9a\x84\x9e\x03-bson:"synced_model_id" json:"synced_model_id"'
    )
    ...
    _TRAININGJOBMETADATA.fields_by_name[
        "error_status"
    ]._serialized_options = b'\x9a\x84\x9e\x03\'bson:"error_status" json:"error_status"'
    _TRAININGJOBMETADATA.fields_by_name["training_started"]._options = None
    _TRAININGJOBMETADATA.fields_by_name[
        "training_started"
    ]._serialized_options = (
        b'\x9a\x84\x9e\x03/bson:"training_started" json:"training_started"'
    )
    _TRAININGJOBMETADATA.fields_by_name["training_ended"]._options = None
    _TRAININGJOBMETADATA.fields_by_name[
        "training_ended"
    ]._serialized_options = (
        b'\x9a\x84\x9e\x03+bson:"training_ended" json:"training_ended"'
    )
