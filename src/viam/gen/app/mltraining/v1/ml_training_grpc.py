...
class MLTrainingServiceStub:
    ...
    def __init__(self, channel: grpclib.client.Channel) -> None:
        ...
        self.ListContainers = grpclib.client.UnaryUnaryMethod(channel, '/viam.app.mltraining.v1.MLTrainingService/ListContainers', app.mltraining.v1.ml_training_pb2.ListContainersRequest, app.mltraining.v1.ml_training_pb2.ListContainersResponse)
        self.RegisterCustomTrainingContainer = grpclib.client.UnaryUnaryMethod(channel, '/viam.app.mltraining.v1.MLTrainingService/RegisterCustomTrainingContainer', app.mltraining.v1.ml_training_pb2.RegisterCustomTrainingContainerRequest, app.mltraining.v1.ml_training_pb2.RegisterCustomTrainingContainerResponse)
        self.DeleteCustomTrainingContainer = grpclib.client.UnaryUnaryMethod(channel, '/viam.app.mltraining.v1.MLTrainingService/DeleteCustomTrainingContainer', app.mltraining.v1.ml_training_pb2.DeleteCustomTrainingContainerRequest, app.mltraining.v1.ml_training_pb2.DeleteCustomTrainingContainerResponse)