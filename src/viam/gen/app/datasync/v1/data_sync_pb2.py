...
_builder.BuildTopDescriptorsAndMessages(
    DESCRIPTOR, "app.datasync.v1.data_sync_pb2", globals()
)
if _descriptor._USE_C_DESCRIPTORS == False:
    ...
    _DATASYNCSERVICE.methods_by_name[
        "DataCaptureUpload"
    ]._serialized_options = b'\x82\xd3\xe4\x93\x02"" /datasync/v1/data_capture_upload'
    _DATASYNCSERVICE.methods_by_name["FileUpload"]._options = None
    _DATASYNCSERVICE.methods_by_name[
        "FileUpload"
    ]._serialized_options = b'\x82\xd3\xe4\x93\x02\x1a"\x18/datasync/v1/file_upload'
    _DATASYNCSERVICE.methods_by_name["StreamingDataCaptureUpload"]._options = None
    _DATASYNCSERVICE.methods_by_name[
        "StreamingDataCaptureUpload"
    ]._serialized_options = (
        b'\x82\xd3\xe4\x93\x02,"*/datasync/v1/streaming_data_capture_upload'
    )
