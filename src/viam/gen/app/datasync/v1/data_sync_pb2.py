...
if _descriptor._USE_C_DESCRIPTORS == False:
    ...
    _globals['_DATATYPE']._serialized_start = 2080
    _globals['_DATATYPE']._serialized_end = 2196
    _globals['_DATACAPTUREUPLOADREQUEST']._serialized_start = 148
    _globals['_DATACAPTUREUPLOADREQUEST']._serialized_end = 315
    _globals['_DATACAPTUREUPLOADRESPONSE']._serialized_start = 317
    _globals['_DATACAPTUREUPLOADRESPONSE']._serialized_end = 369
    _globals['_FILEUPLOADREQUEST']._serialized_start = 372
    _globals['_FILEUPLOADREQUEST']._serialized_end = 547
    _globals['_FILEUPLOADRESPONSE']._serialized_start = 549
    _globals['_FILEUPLOADRESPONSE']._serialized_end = 594
    _globals['_SENSORMETADATA']._serialized_start = 597
    _globals['_SENSORMETADATA']._serialized_end = 745
    _globals['_SENSORDATA']._serialized_start = 748
    _globals['_SENSORDATA']._serialized_end = 911
    _globals['_FILEDATA']._serialized_start = 913
    _globals['_FILEDATA']._serialized_end = 943
    _globals['_UPLOADMETADATA']._serialized_start = 946
    _globals['_UPLOADMETADATA']._serialized_end = 1475
    _globals['_UPLOADMETADATA_METHODPARAMETERSENTRY']._serialized_start = 1345
    _globals['_UPLOADMETADATA_METHODPARAMETERSENTRY']._serialized_end = 1434
    _globals['_CAPTUREINTERVAL']._serialized_start = 1477
    _globals['_CAPTUREINTERVAL']._serialized_end = 1590
    _globals['_DATACAPTUREMETADATA']._serialized_start = 1593
    _globals['_DATACAPTUREMETADATA']._serialized_end = 2078
    _globals['_DATACAPTUREMETADATA_METHODPARAMETERSENTRY']._serialized_start = 1345
    _globals['_DATACAPTUREMETADATA_METHODPARAMETERSENTRY']._serialized_end = 1434
    _globals['_DATASYNCSERVICE']._serialized_start = 2199
    _globals['_DATASYNCSERVICE']._serialized_end = 2433