...
_builder.BuildTopDescriptorsAndMessages(
    DESCRIPTOR, "service.sensors.v1.sensors_pb2", globals()
)
if _descriptor._USE_C_DESCRIPTORS == False:
    ...
    _SENSORSSERVICE.methods_by_name[
        "GetSensors"
    ]._serialized_options = (
        b"\x88\x02\x01\x82\xd3\xe4\x93\x02%\x12#/viam/api/v1/service/{name}/sensors"
    )
    _SENSORSSERVICE.methods_by_name["GetReadings"]._options = None
    _SENSORSSERVICE.methods_by_name[
        "GetReadings"
    ]._serialized_options = b"\x88\x02\x01\x82\xd3\xe4\x93\x02.\x12,/viam/api/v1/service/sensors/{name}/readings"
    _SENSORSSERVICE.methods_by_name["DoCommand"]._options = None
    _SENSORSSERVICE.methods_by_name[
        "DoCommand"
    ]._serialized_options = b'\x88\x02\x01\x82\xd3\xe4\x93\x020"./viam/api/v1/service/sensors/{name}/do_command'
