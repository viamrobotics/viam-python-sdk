...
class MotionServiceBase(abc.ABC):
    ...
    @abc.abstractmethod
    async def MoveOnGlobeNew(self, stream: 'grpclib.server.Stream[service.motion.v1.motion_pb2.MoveOnGlobeNewRequest, service.motion.v1.motion_pb2.MoveOnGlobeNewResponse]') -> None:
        pass
...
class MotionServiceStub:
    ...
    def __init__(self, channel: grpclib.client.Channel) -> None:
        ...
        self.MoveOnGlobeNew = grpclib.client.UnaryUnaryMethod(channel, '/viam.service.motion.v1.MotionService/MoveOnGlobeNew', service.motion.v1.motion_pb2.MoveOnGlobeNewRequest, service.motion.v1.motion_pb2.MoveOnGlobeNewResponse)
