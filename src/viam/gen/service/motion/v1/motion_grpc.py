...
class MotionServiceBase(abc.ABC):
    ...
    @abc.abstractmethod
    async def MoveOnMapNew(self, stream: 'grpclib.server.Stream[service.motion.v1.motion_pb2.MoveOnMapNewRequest, service.motion.v1.motion_pb2.MoveOnMapNewResponse]') -> None:
        pass
...
class MotionServiceStub:
    ...
    def __init__(self, channel: grpclib.client.Channel) -> None:
        ...
        self.MoveOnMapNew = grpclib.client.UnaryUnaryMethod(channel, '/viam.service.motion.v1.MotionService/MoveOnMapNew', service.motion.v1.motion_pb2.MoveOnMapNewRequest, service.motion.v1.motion_pb2.MoveOnMapNewResponse)
