...
_builder.BuildTopDescriptorsAndMessages(
    DESCRIPTOR, "service.motion.v1.motion_pb2", globals()
)
if _descriptor._USE_C_DESCRIPTORS == False:
    ...
    _MOTIONSERVICE.methods_by_name[
        "Move"
    ]._serialized_options = (
        b"\x82\xd3\xe4\x93\x02)\"'/viam/api/v1/service/motion/{name}/move"
    )
    _MOTIONSERVICE.methods_by_name["MoveOnMap"]._options = None
    _MOTIONSERVICE.methods_by_name[
        "MoveOnMap"
    ]._serialized_options = (
        b'\x82\xd3\xe4\x93\x020"./viam/api/v1/service/motion/{name}/move_on_map'
    )
    _MOTIONSERVICE.methods_by_name["MoveOnGlobe"]._options = None
    _MOTIONSERVICE.methods_by_name[
        "MoveOnGlobe"
    ]._serialized_options = (
        b'\x82\xd3\xe4\x93\x022"0/viam/api/v1/service/motion/{name}/move_on_globe'
    )
    _MOTIONSERVICE.methods_by_name["GetPose"]._options = None
    _MOTIONSERVICE.methods_by_name[
        "GetPose"
    ]._serialized_options = (
        b"\x82\xd3\xe4\x93\x02)\x12'/viam/api/v1/service/motion/{name}/pose"
    )
    _MOTIONSERVICE.methods_by_name["StopPlan"]._options = None
    _MOTIONSERVICE.methods_by_name[
        "StopPlan"
    ]._serialized_options = (
        b"\x82\xd3\xe4\x93\x02.\x1a,/viam/api/v1/service/motion/{name}/stop_plan"
    )
    _MOTIONSERVICE.methods_by_name["ListPlanStatuses"]._options = None
    _MOTIONSERVICE.methods_by_name[
        "ListPlanStatuses"
    ]._serialized_options = b"\x82\xd3\xe4\x93\x027\x125/viam/api/v1/service/motion/{name}/list_plan_statuses"
    _MOTIONSERVICE.methods_by_name["GetPlan"]._options = None
    _MOTIONSERVICE.methods_by_name[
        "GetPlan"
    ]._serialized_options = (
        b"\x82\xd3\xe4\x93\x02-\x12+/viam/api/v1/service/motion/{name}/get_plan"
    )
    _MOTIONSERVICE.methods_by_name["DoCommand"]._options = None
    _MOTIONSERVICE.methods_by_name[
        "DoCommand"
    ]._serialized_options = (
        b'\x82\xd3\xe4\x93\x02/"-/viam/api/v1/service/motion/{name}/do_command'
    )
    _PLANSTATE._serialized_start = 5458
    _PLANSTATE._serialized_end = 5598
    ...
    _MOVEONGLOBEREQUEST._serialized_end = 2339
    _MOVEONGLOBERESPONSE._serialized_start = 2341
    _MOVEONGLOBERESPONSE._serialized_end = 2397
    _GETPOSEREQUEST._serialized_start = 2400
    _GETPOSEREQUEST._serialized_end = 2681
    _GETPOSERESPONSE._serialized_start = 2683
    _GETPOSERESPONSE._serialized_end = 2749
    _STOPPLANREQUEST._serialized_start = 2752
    _STOPPLANREQUEST._serialized_end = 2905
    _STOPPLANRESPONSE._serialized_start = 2907
    _STOPPLANRESPONSE._serialized_end = 2925
    _LISTPLANSTATUSESREQUEST._serialized_start = 2928
    _LISTPLANSTATUSESREQUEST._serialized_end = 3064
    _LISTPLANSTATUSESRESPONSE._serialized_start = 3066
    _LISTPLANSTATUSESRESPONSE._serialized_end = 3187
    _GETPLANREQUEST._serialized_start = 3190
    _GETPLANREQUEST._serialized_end = 3437
    _GETPLANRESPONSE._serialized_start = 3440
    _GETPLANRESPONSE._serialized_end = 3633
    _CONSTRAINTS._serialized_start = 3636
    _CONSTRAINTS._serialized_end = 3943
    _LINEARCONSTRAINT._serialized_start = 3946
    _LINEARCONSTRAINT._serialized_end = 4133
    _ORIENTATIONCONSTRAINT._serialized_start = 4135
    _ORIENTATIONCONSTRAINT._serialized_end = 4256
    _COLLISIONSPECIFICATION._serialized_start = 4259
    _COLLISIONSPECIFICATION._serialized_end = 4452
    _COLLISIONSPECIFICATION_ALLOWEDFRAMECOLLISIONS._serialized_start = 4380
    _COLLISIONSPECIFICATION_ALLOWEDFRAMECOLLISIONS._serialized_end = 4452
    _PLANWITHSTATUS._serialized_start = 4455
    _PLANWITHSTATUS._serialized_end = 4656
    _PLANSTATUSWITHID._serialized_start = 4659
    _PLANSTATUSWITHID._serialized_end = 4866
    _PLANSTATUS._serialized_start = 4869
    _PLANSTATUS._serialized_end = 5036
    _PLAN._serialized_start = 5039
    _PLAN._serialized_end = 5221
    _PLANSTEP._serialized_start = 5224
    _PLANSTEP._serialized_end = 5395
    _PLANSTEP_STEPENTRY._serialized_start = 5300
    _PLANSTEP_STEPENTRY._serialized_end = 5395
    _COMPONENTSTATE._serialized_start = 5397
    _COMPONENTSTATE._serialized_end = 5455
    _MOTIONSERVICE._serialized_start = 5601
    _MOTIONSERVICE._serialized_end = 6826
