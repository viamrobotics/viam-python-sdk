...
if not _descriptor._USE_C_DESCRIPTORS:
    ...
    _globals['_MAPPINGMODE']._serialized_start = 1080
    _globals['_MAPPINGMODE']._serialized_end = 1226
    _globals['_SENSORTYPE']._serialized_start = 1228
    _globals['_SENSORTYPE']._serialized_end = 1326
    _globals['_GETPOSITIONREQUEST']._serialized_start = 136
    _globals['_GETPOSITIONREQUEST']._serialized_end = 176
    _globals['_GETPOSITIONRESPONSE']._serialized_start = 179
    _globals['_GETPOSITIONRESPONSE']._serialized_end = 338
    _globals['_GETPOINTCLOUDMAPREQUEST']._serialized_start = 340
    _globals['_GETPOINTCLOUDMAPREQUEST']._serialized_end = 456
    _globals['_GETPOINTCLOUDMAPRESPONSE']._serialized_start = 458
    _globals['_GETPOINTCLOUDMAPRESPONSE']._serialized_end = 535
    _globals['_GETINTERNALSTATEREQUEST']._serialized_start = 537
    _globals['_GETINTERNALSTATEREQUEST']._serialized_end = 582
    _globals['_GETINTERNALSTATERESPONSE']._serialized_start = 584
    _globals['_GETINTERNALSTATERESPONSE']._serialized_end = 660
    _globals['_GETPROPERTIESREQUEST']._serialized_start = 662
    _globals['_GETPROPERTIESREQUEST']._serialized_end = 704
    _globals['_GETPROPERTIESRESPONSE']._serialized_start = 707
    _globals['_GETPROPERTIESRESPONSE']._serialized_end = 989
    _globals['_SENSORINFO']._serialized_start = 991
    _globals['_SENSORINFO']._serialized_end = 1077
    _globals['_SLAMSERVICE']._serialized_start = 1329
    _globals['_SLAMSERVICE']._serialized_end = 2141