...
if _descriptor._USE_C_DESCRIPTORS == False:
    ...
    _globals['_GETPOSITIONREQUEST']._serialized_start = 169
    _globals['_GETPOSITIONREQUEST']._serialized_end = 209
    _globals['_GETPOSITIONRESPONSE']._serialized_start = 212
    _globals['_GETPOSITIONRESPONSE']._serialized_end = 371
    _globals['_GETPOINTCLOUDMAPREQUEST']._serialized_start = 373
    _globals['_GETPOINTCLOUDMAPREQUEST']._serialized_end = 418
    _globals['_GETPOINTCLOUDMAPRESPONSE']._serialized_start = 420
    _globals['_GETPOINTCLOUDMAPRESPONSE']._serialized_end = 497
    _globals['_GETINTERNALSTATEREQUEST']._serialized_start = 499
    _globals['_GETINTERNALSTATEREQUEST']._serialized_end = 544
    _globals['_GETINTERNALSTATERESPONSE']._serialized_start = 546
    _globals['_GETINTERNALSTATERESPONSE']._serialized_end = 622
    _globals['_GETLATESTMAPINFOREQUEST']._serialized_start = 624
    _globals['_GETLATESTMAPINFOREQUEST']._serialized_end = 669
    _globals['_GETLATESTMAPINFORESPONSE']._serialized_start = 671
    _globals['_GETLATESTMAPINFORESPONSE']._serialized_end = 765
    _globals['_SLAMSERVICE']._serialized_start = 768
    _globals['_SLAMSERVICE']._serialized_end = 1596