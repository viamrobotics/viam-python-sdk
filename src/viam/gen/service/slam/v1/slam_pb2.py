...
_builder.BuildTopDescriptorsAndMessages(
    DESCRIPTOR, "service.slam.v1.slam_pb2", globals()
)
if _descriptor._USE_C_DESCRIPTORS == False:
    ...
    _SLAMSERVICE.methods_by_name[
        "GetPosition"
    ]._serialized_options = (
        b"\x82\xd3\xe4\x93\x02+\x12)/viam/api/v1/service/slam/{name}/position"
    )
    _SLAMSERVICE.methods_by_name["GetPointCloudMap"]._options = None
    _SLAMSERVICE.methods_by_name[
        "GetPointCloudMap"
    ]._serialized_options = (
        b"\x82\xd3\xe4\x93\x022\x120/viam/api/v1/service/slam/{name}/point_cloud_map"
    )
    _SLAMSERVICE.methods_by_name["GetInternalState"]._options = None
    _SLAMSERVICE.methods_by_name[
        "GetInternalState"
    ]._serialized_options = (
        b"\x82\xd3\xe4\x93\x021\x12//viam/api/v1/service/slam/{name}/internal_state"
    )
    _SLAMSERVICE.methods_by_name["GetProperties"]._options = None
    _SLAMSERVICE.methods_by_name[
        "GetProperties"
    ]._serialized_options = (
        b"\x82\xd3\xe4\x93\x02-\x12+/viam/api/v1/service/slam/{name}/properties"
    )
    _SLAMSERVICE.methods_by_name["DoCommand"]._options = None
    _SLAMSERVICE.methods_by_name[
        "DoCommand"
    ]._serialized_options = (
        b'\x82\xd3\xe4\x93\x02-"+/viam/api/v1/service/slam/{name}/do_command'
    )
