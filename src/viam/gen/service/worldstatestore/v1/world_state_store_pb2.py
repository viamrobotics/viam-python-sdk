...
if not _descriptor._USE_C_DESCRIPTORS:
    ...
    _globals['_WORLDSTATESTORESERVICE'].methods_by_name['GetStatus']._loaded_options = None
    _globals['_WORLDSTATESTORESERVICE'].methods_by_name['GetStatus']._serialized_options = b'\x82\xd3\xe4\x93\x028\x126/viam/api/v1/service/worldstatestore/{name}/get_status'
    ...
    _globals['_WORLDSTATESTORESERVICE']._serialized_end = 1838