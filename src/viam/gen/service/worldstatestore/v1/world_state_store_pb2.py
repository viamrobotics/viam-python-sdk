...
_builder.BuildTopDescriptorsAndMessages(DESCRIPTOR, 'service.worldstatestore.v1.world_state_store_pb2', globals())
if _descriptor._USE_C_DESCRIPTORS == False:
    DESCRIPTOR._options = None
    DESCRIPTOR._serialized_options = b'\n#com.viam.service.worldstatestore.v1Z*go.viam.com/api/service/worldstatestore/v1'
    _WORLDSTATESTORESERVICE.methods_by_name['StreamTransformChanges']._options = None
    _WORLDSTATESTORESERVICE.methods_by_name['StreamTransformChanges']._serialized_options = b'\x82\xd3\xe4\x93\x02F\x12D/viam/api/v1/service/worldstatestore/{name}/stream_transform_changes'
    _WORLDSTATESTORESERVICE.methods_by_name['DoCommand']._options = None
    _WORLDSTATESTORESERVICE.methods_by_name['DoCommand']._serialized_options = b'\x82\xd3\xe4\x93\x028"6/viam/api/v1/service/worldstatestore/{name}/do_command'
    _TRANSFORMCHANGETYPE._serialized_start = 873
    _TRANSFORMCHANGETYPE._serialized_end = 1036
    _LISTUUIDSREQUEST._serialized_start = 205
    _LISTUUIDSREQUEST._serialized_end = 290
    _LISTUUIDSRESPONSE._serialized_start = 292
    _LISTUUIDSRESPONSE._serialized_end = 333
    _GETTRANSFORMREQUEST._serialized_start = 335
    _GETTRANSFORMREQUEST._serialized_end = 443
    _GETTRANSFORMRESPONSE._serialized_start = 445
    _GETTRANSFORMRESPONSE._serialized_end = 524
    _STREAMTRANSFORMCHANGESREQUEST._serialized_start = 526
    _STREAMTRANSFORMCHANGESREQUEST._serialized_end = 624
    _STREAMTRANSFORMCHANGESRESPONSE._serialized_start = 627
    _STREAMTRANSFORMCHANGESRESPONSE._serialized_end = 870
    _WORLDSTATESTORESERVICE._serialized_start = 1039
    _WORLDSTATESTORESERVICE._serialized_end = 1691