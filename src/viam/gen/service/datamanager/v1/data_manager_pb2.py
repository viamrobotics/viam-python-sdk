...
_builder.BuildTopDescriptorsAndMessages(
    DESCRIPTOR, "service.datamanager.v1.data_manager_pb2", globals()
)
if _descriptor._USE_C_DESCRIPTORS == False:
    ...
    _DATAMANAGERSERVICE.methods_by_name[
        "Sync"
    ]._serialized_options = (
        b'\x82\xd3\xe4\x93\x022"0/viam/api/v1/service/datamanager/{name}/datasync'
    )
    _DATAMANAGERSERVICE.methods_by_name["DoCommand"]._options = None
    _DATAMANAGERSERVICE.methods_by_name[
        "DoCommand"
    ]._serialized_options = (
        b'\x82\xd3\xe4\x93\x024"2/viam/api/v1/service/datamanager/{name}/do_command'
    )
