...
if _descriptor._USE_C_DESCRIPTORS == False:
    ...
    _DATAMANAGERSERVICE.methods_by_name['UploadBinaryDataToDatasets']._options = None
    _DATAMANAGERSERVICE.methods_by_name['UploadBinaryDataToDatasets']._serialized_options = b'\x82\xd3\xe4\x93\x02H"F/viam/api/v1/service/datamanager/{name}/upload_binary_data_to_datasets'
    _SYNCREQUEST._serialized_start = 191
    _SYNCREQUEST._serialized_end = 271
    _SYNCRESPONSE._serialized_start = 273
    _SYNCRESPONSE._serialized_end = 287
    _UPLOADBINARYDATATODATASETSREQUEST._serialized_start = 290
    _UPLOADBINARYDATATODATASETSREQUEST._serialized_end = 539
    _UPLOADBINARYDATATODATASETSRESPONSE._serialized_start = 541
    _UPLOADBINARYDATATODATASETSRESPONSE._serialized_end = 577
    _DATAMANAGERSERVICE._serialized_start = 580
    _DATAMANAGERSERVICE._serialized_end = 1135