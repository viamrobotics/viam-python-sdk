...
_runtime_version.ValidateProtobufRuntimeVersion(_runtime_version.Domain.PUBLIC, 6, 33, 5, '', 'service/datamanager/v1/data_manager.proto')
...
if not _descriptor._USE_C_DESCRIPTORS:
    ...
    _globals['_DATAMANAGERSERVICE'].methods_by_name['GetStatus']._loaded_options = None
    _globals['_DATAMANAGERSERVICE'].methods_by_name['GetStatus']._serialized_options = b'\x82\xd3\xe4\x93\x024\x122/viam/api/v1/service/datamanager/{name}/get_status'
    ...
    _globals['_DATAMANAGERSERVICE']._serialized_end = 1278