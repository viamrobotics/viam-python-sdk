...
if not _descriptor._USE_C_DESCRIPTORS:
    ...
    _globals['_SHELLSERVICE'].methods_by_name['GetStatus']._loaded_options = None
    _globals['_SHELLSERVICE'].methods_by_name['GetStatus']._serialized_options = b'\x82\xd3\xe4\x93\x02.\x12,/viam/api/v1/service/shell/{name}/get_status'
    ...
    _globals['_SHELLSERVICE']._serialized_end = 2609