...
if not _descriptor._USE_C_DESCRIPTORS:
    ...
    _globals['_VIDEOSERVICE'].methods_by_name['GetStatus']._loaded_options = None
    _globals['_VIDEOSERVICE'].methods_by_name['GetStatus']._serialized_options = b'\x82\xd3\xe4\x93\x02.\x12,/viam/api/v1/service/video/{name}/get_status'
    ...
    _globals['_VIDEOSERVICE']._serialized_end = 1066