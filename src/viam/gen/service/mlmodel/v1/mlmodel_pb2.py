...
_builder.BuildTopDescriptorsAndMessages(
    DESCRIPTOR, "service.mlmodel.v1.mlmodel_pb2", globals()
)
if _descriptor._USE_C_DESCRIPTORS == False:
    ...
    _MLMODELSERVICE.methods_by_name[
        "Infer"
    ]._serialized_options = (
        b'\x82\xd3\xe4\x93\x02+")/viam/api/v1/service/mlmodel/{name}/infer'
    )
    _MLMODELSERVICE.methods_by_name["Metadata"]._options = None
    _MLMODELSERVICE.methods_by_name[
        "Metadata"
    ]._serialized_options = (
        b"\x82\xd3\xe4\x93\x02.\x12,/viam/api/v1/service/mlmodel/{name}/metadata"
    )
