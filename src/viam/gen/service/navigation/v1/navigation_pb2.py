...
_builder.BuildTopDescriptorsAndMessages(
    DESCRIPTOR, "service.navigation.v1.navigation_pb2", globals()
)
if _descriptor._USE_C_DESCRIPTORS == False:
    ...
    _NAVIGATIONSERVICE.methods_by_name[
        "GetMode"
    ]._serialized_options = (
        b"\x82\xd3\xe4\x93\x02-\x12+/viam/api/v1/service/navigation/{name}/mode"
    )
    _NAVIGATIONSERVICE.methods_by_name["SetMode"]._options = None
    _NAVIGATIONSERVICE.methods_by_name[
        "SetMode"
    ]._serialized_options = (
        b"\x82\xd3\xe4\x93\x02-\x1a+/viam/api/v1/service/navigation/{name}/mode"
    )
    _NAVIGATIONSERVICE.methods_by_name["GetLocation"]._options = None
    _NAVIGATIONSERVICE.methods_by_name[
        "GetLocation"
    ]._serialized_options = (
        b"\x82\xd3\xe4\x93\x021\x12//viam/api/v1/service/navigation/{name}/location"
    )
    _NAVIGATIONSERVICE.methods_by_name["GetWaypoints"]._options = None
    _NAVIGATIONSERVICE.methods_by_name[
        "GetWaypoints"
    ]._serialized_options = (
        b"\x82\xd3\xe4\x93\x022\x120/viam/api/v1/service/navigation/{name}/waypoints"
    )
    _NAVIGATIONSERVICE.methods_by_name["AddWaypoint"]._options = None
    _NAVIGATIONSERVICE.methods_by_name[
        "AddWaypoint"
    ]._serialized_options = (
        b'\x82\xd3\xe4\x93\x022"0/viam/api/v1/service/navigation/{name}/waypoints'
    )
    _NAVIGATIONSERVICE.methods_by_name["RemoveWaypoint"]._options = None
    _NAVIGATIONSERVICE.methods_by_name[
        "RemoveWaypoint"
    ]._serialized_options = (
        b"\x82\xd3\xe4\x93\x027*5/viam/api/v1/service/navigation/{name}/waypoints/{id}"
    )
    _NAVIGATIONSERVICE.methods_by_name["GetObstacles"]._options = None
    _NAVIGATIONSERVICE.methods_by_name[
        "GetObstacles"
    ]._serialized_options = b"\x82\xd3\xe4\x93\x026\x124/viam/api/v1/service/navigation/{name}/get_obstacles"
    _NAVIGATIONSERVICE.methods_by_name["GetPaths"]._options = None
    _NAVIGATIONSERVICE.methods_by_name[
        "GetPaths"
    ]._serialized_options = (
        b"\x82\xd3\xe4\x93\x022\x120/viam/api/v1/service/navigation/{name}/get_paths"
    )
    _NAVIGATIONSERVICE.methods_by_name["GetProperties"]._options = None
    _NAVIGATIONSERVICE.methods_by_name[
        "GetProperties"
    ]._serialized_options = (
        b"\x82\xd3\xe4\x93\x023\x121/viam/api/v1/service/navigation/{name}/properties"
    )
    _NAVIGATIONSERVICE.methods_by_name["DoCommand"]._options = None
    _NAVIGATIONSERVICE.methods_by_name[
        "DoCommand"
    ]._serialized_options = (
        b'\x82\xd3\xe4\x93\x023"1/viam/api/v1/service/navigation/{name}/do_command'
    )
