...
if not _descriptor._USE_C_DESCRIPTORS:
    ...
    _globals['_NAVIGATIONSERVICE'].methods_by_name['GetStatus']._loaded_options = None
    _globals['_NAVIGATIONSERVICE'].methods_by_name['GetStatus']._serialized_options = b'\x82\xd3\xe4\x93\x023\x121/viam/api/v1/service/navigation/{name}/get_status'
    ...
    _globals['_NAVIGATIONSERVICE']._serialized_end = 3819