...
class _MapTypeEnumTypeWrapper(
    google.protobuf.internal.enum_type_wrapper._EnumTypeWrapper[_MapType.ValueType],
    builtins.type,
):
...
class _ModeEnumTypeWrapper(
    google.protobuf.internal.enum_type_wrapper._EnumTypeWrapper[_Mode.ValueType],
    builtins.type,
):
    DESCRIPTOR: google.protobuf.descriptor.EnumDescriptor
...
class SetModeRequest(google.protobuf.message.Message):
    ...
    def ClearField(
        ...
        field_name: typing_extensions.Literal[
            "extra", b"extra", "mode", b"mode", "name", b"name"
        ],
    ) -> None: ...
...
class Waypoint(google.protobuf.message.Message):
    ...
    def __init__(
        ...
        *,
        id: builtins.str = ...,
        location: common.v1.common_pb2.GeoPoint | None = ...,
    ) -> None: ...
    def HasField(
    ...
    def ClearField(
        self,
        field_name: typing_extensions.Literal["id", b"id", "location", b"location"],
    ) -> None: ...
...
class GetLocationResponse(google.protobuf.message.Message):
    ...
    def ClearField(
        self,
        field_name: typing_extensions.Literal[
            "compass_heading", b"compass_heading", "location", b"location"
        ],
    ) -> None: ...
...
class GetWaypointsResponse(google.protobuf.message.Message):
    ...
    def __init__(
        self, *, waypoints: collections.abc.Iterable[global___Waypoint] | None = ...
    ) -> None: ...
    def ClearField(
        self, field_name: typing_extensions.Literal["waypoints", b"waypoints"]
    ) -> None: ...
...
class AddWaypointRequest(google.protobuf.message.Message):
    ...
    def HasField(
        self,
        field_name: typing_extensions.Literal[
            "extra", b"extra", "location", b"location"
        ],
    ) -> builtins.bool: ...
    def ClearField(
        self,
        field_name: typing_extensions.Literal[
            "extra", b"extra", "location", b"location", "name", b"name"
        ],
    ) -> None: ...
...
class RemoveWaypointRequest(google.protobuf.message.Message):
    ...
    def ClearField(
        self,
        field_name: typing_extensions.Literal[
            "extra", b"extra", "id", b"id", "name", b"name"
        ],
    ) -> None: ...
...
class GetObstaclesResponse(google.protobuf.message.Message):
    ...
    def ClearField(
        self, field_name: typing_extensions.Literal["obstacles", b"obstacles"]
    ) -> None: ...
...
class Path(google.protobuf.message.Message):
    ...
    def __init__(
        ...
        *,
        destination_waypoint_id: builtins.str = ...,
        geopoints: collections.abc.Iterable[common.v1.common_pb2.GeoPoint] | None = ...,
    ) -> None: ...
    def ClearField(
        self,
        field_name: typing_extensions.Literal[
            "destination_waypoint_id",
            b"destination_waypoint_id",
            "geopoints",
            b"geopoints",
        ],
    ) -> None: ...
...
class GetPathsResponse(google.protobuf.message.Message):
    ...
    def __init__(
        self, *, paths: collections.abc.Iterable[global___Path] | None = ...
    ) -> None: ...
    def ClearField(
        self, field_name: typing_extensions.Literal["paths", b"paths"]
    ) -> None: ...
...
class GetPropertiesResponse(google.protobuf.message.Message):
    ...
    def ClearField(
        self, field_name: typing_extensions.Literal["map_type", b"map_type"]
    ) -> None: ...
