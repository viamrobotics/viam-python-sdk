...
_runtime_version.ValidateProtobufRuntimeVersion(_runtime_version.Domain.PUBLIC, 6, 33, 5, '', 'service/vision/v1/vision.proto')
...
if not _descriptor._USE_C_DESCRIPTORS:
    ...
    _globals['_VISIONSERVICE'].methods_by_name['GetStatus']._loaded_options = None
    _globals['_VISIONSERVICE'].methods_by_name['GetStatus']._serialized_options = b'\x82\xd3\xe4\x93\x02/\x12-/viam/api/v1/service/vision/{name}/get_status'
    ...
    _globals['_GETPROPERTIESRESPONSE']._serialized_end = 3175
    _globals['_VISIONSERVICE']._serialized_start = 3178
    _globals['_VISIONSERVICE']._serialized_end = 4801