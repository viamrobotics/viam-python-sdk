...
_builder.BuildTopDescriptorsAndMessages(
    DESCRIPTOR, "service.vision.v1.vision_pb2", globals()
)
if _descriptor._USE_C_DESCRIPTORS == False:
    ...
    _VISIONSERVICE.methods_by_name[
        "GetDetectionsFromCamera"
    ]._serialized_options = (
        b'\x82\xd3\xe4\x93\x026"4/viam/api/v1/service/vision/{name}/camera_detections'
    )
    _VISIONSERVICE.methods_by_name["GetDetections"]._options = None
    _VISIONSERVICE.methods_by_name[
        "GetDetections"
    ]._serialized_options = (
        b'\x82\xd3\xe4\x93\x02/"-/viam/api/v1/service/vision/{name}/detections'
    )
    _VISIONSERVICE.methods_by_name["GetClassificationsFromCamera"]._options = None
    _VISIONSERVICE.methods_by_name[
        "GetClassificationsFromCamera"
    ]._serialized_options = b'\x82\xd3\xe4\x93\x02;"9/viam/api/v1/service/vision/{name}/camera_classifications'
    _VISIONSERVICE.methods_by_name["GetClassifications"]._options = None
    _VISIONSERVICE.methods_by_name[
        "GetClassifications"
    ]._serialized_options = (
        b'\x82\xd3\xe4\x93\x024"2/viam/api/v1/service/vision/{name}/classifications'
    )
    _VISIONSERVICE.methods_by_name["GetObjectPointClouds"]._options = None
    _VISIONSERVICE.methods_by_name[
        "GetObjectPointClouds"
    ]._serialized_options = (
        b'\x82\xd3\xe4\x93\x028"6/viam/api/v1/service/vision/{name}/object_point_clouds'
    )
    _VISIONSERVICE.methods_by_name["DoCommand"]._options = None
    _VISIONSERVICE.methods_by_name[
        "DoCommand"
    ]._serialized_options = (
        b'\x82\xd3\xe4\x93\x02/"-/viam/api/v1/service/vision/{name}/do_command'
    )
