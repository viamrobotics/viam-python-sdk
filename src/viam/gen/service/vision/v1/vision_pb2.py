...
if _descriptor._USE_C_DESCRIPTORS == False:
    ...
    _globals['_GETDETECTIONSREQUEST']._serialized_start = 143
    _globals['_GETDETECTIONSREQUEST']._serialized_end = 329
    _globals['_GETDETECTIONSRESPONSE']._serialized_start = 331
    _globals['_GETDETECTIONSRESPONSE']._serialized_end = 421
    _globals['_GETDETECTIONSFROMCAMERAREQUEST']._serialized_start = 424
    _globals['_GETDETECTIONSFROMCAMERAREQUEST']._serialized_end = 556
    _globals['_GETDETECTIONSFROMCAMERARESPONSE']._serialized_start = 558
    _globals['_GETDETECTIONSFROMCAMERARESPONSE']._serialized_end = 658
    _globals['_DETECTION']._serialized_start = 661
    _globals['_DETECTION']._serialized_end = 879
    _globals['_GETCLASSIFICATIONSREQUEST']._serialized_start = 882
    _globals['_GETCLASSIFICATIONSREQUEST']._serialized_end = 1087
    _globals['_GETCLASSIFICATIONSRESPONSE']._serialized_start = 1089
    _globals['_GETCLASSIFICATIONSRESPONSE']._serialized_end = 1199
    _globals['_GETCLASSIFICATIONSFROMCAMERAREQUEST']._serialized_start = 1202
    _globals['_GETCLASSIFICATIONSFROMCAMERAREQUEST']._serialized_end = 1353
    _globals['_GETCLASSIFICATIONSFROMCAMERARESPONSE']._serialized_start = 1355
    _globals['_GETCLASSIFICATIONSFROMCAMERARESPONSE']._serialized_end = 1475
    _globals['_CLASSIFICATION']._serialized_start = 1477
    _globals['_CLASSIFICATION']._serialized_end = 1556
    _globals['_GETOBJECTPOINTCLOUDSREQUEST']._serialized_start = 1559
    _globals['_GETOBJECTPOINTCLOUDSREQUEST']._serialized_end = 1717
    _globals['_GETOBJECTPOINTCLOUDSRESPONSE']._serialized_start = 1719
    _globals['_GETOBJECTPOINTCLOUDSRESPONSE']._serialized_end = 1838
    _globals['_VISIONSERVICE']._serialized_start = 1841
    _globals['_VISIONSERVICE']._serialized_end = 2968