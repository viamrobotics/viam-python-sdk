...
class _KinematicsFileFormatEnumTypeWrapper(
    google.protobuf.internal.enum_type_wrapper._EnumTypeWrapper[
        _KinematicsFileFormat.ValueType
    ],
    builtins.type,
):
...
class KinematicsFileFormat(
    _KinematicsFileFormat, metaclass=_KinematicsFileFormatEnumTypeWrapper
): ...
...
class BoardStatus(google.protobuf.message.Message):
    ...
    class AnalogsEntry(google.protobuf.message.Message):
        ...
        def __init__(
            self, *, key: builtins.str = ..., value: global___AnalogStatus | None = ...
        ) -> None: ...
        def HasField(
    ...
    class DigitalInterruptsEntry(google.protobuf.message.Message):
        ...
        def __init__(
            ...
            *,
            key: builtins.str = ...,
            value: global___DigitalInterruptStatus | None = ...,
        ) -> None: ...
        def HasField(
            self, field_name: typing_extensions.Literal["value", b"value"]
        ) -> builtins.bool: ...
    ...
    def analogs(
        ...
        builtins.str, global___AnalogStatus
    ]: ...
    @property
    def digital_interrupts(
        self,
    ) -> google.protobuf.internal.containers.MessageMap[
        builtins.str, global___DigitalInterruptStatus
    ]: ...
    def __init__(
        self,
        *,
        analogs: collections.abc.Mapping[builtins.str, global___AnalogStatus]
        | None = ...,
        digital_interrupts: collections.abc.Mapping[
            builtins.str, global___DigitalInterruptStatus
        ]
        | None = ...,
    ) -> None: ...
    def ClearField(
        self,
        field_name: typing_extensions.Literal[
            "analogs", b"analogs", "digital_interrupts", b"digital_interrupts"
        ],
    ) -> None: ...
...
class Orientation(google.protobuf.message.Message):
    ...
    def ClearField(
        self,
        field_name: typing_extensions.Literal[
            "o_x", b"o_x", "o_y", b"o_y", "o_z", b"o_z", "theta", b"theta"
        ],
    ) -> None: ...
...
class PoseInFrame(google.protobuf.message.Message):
    ...
    def __init__(
        self, *, reference_frame: builtins.str = ..., pose: global___Pose | None = ...
    ) -> None: ...
    def HasField(
    ...
    def ClearField(
        self,
        field_name: typing_extensions.Literal[
            "pose", b"pose", "reference_frame", b"reference_frame"
        ],
    ) -> None: ...
...
class Sphere(google.protobuf.message.Message):
    ...
    def ClearField(
        self, field_name: typing_extensions.Literal["radius_mm", b"radius_mm"]
    ) -> None: ...
...
class Capsule(google.protobuf.message.Message):
    ...
    def __init__(
        self, *, radius_mm: builtins.float = ..., length_mm: builtins.float = ...
    ) -> None: ...
    def ClearField(
        self,
        field_name: typing_extensions.Literal[
            "length_mm", b"length_mm", "radius_mm", b"radius_mm"
        ],
    ) -> None: ...
...
class RectangularPrism(google.protobuf.message.Message):
    ...
    def HasField(
        self, field_name: typing_extensions.Literal["dims_mm", b"dims_mm"]
    ) -> builtins.bool: ...
    def ClearField(
        self, field_name: typing_extensions.Literal["dims_mm", b"dims_mm"]
    ) -> None: ...
...
class Geometry(google.protobuf.message.Message):
    ...
    def __init__(
        self,
        *,
        center: global___Pose | None = ...,
        sphere: global___Sphere | None = ...,
        box: global___RectangularPrism | None = ...,
        capsule: global___Capsule | None = ...,
        label: builtins.str = ...,
    ) -> None: ...
    def HasField(
        self,
    ...
    def WhichOneof(
        self, oneof_group: typing_extensions.Literal["geometry_type", b"geometry_type"]
    ) -> typing_extensions.Literal["sphere", "box", "capsule"] | None: ...
...
class GeometriesInFrame(google.protobuf.message.Message):
    ...
    def ClearField(
        self,
        field_name: typing_extensions.Literal[
            "geometries", b"geometries", "reference_frame", b"reference_frame"
        ],
    ) -> None: ...
...
class PointCloudObject(google.protobuf.message.Message):
    ...
    def __init__(
        ...
        *,
        point_cloud: builtins.bytes = ...,
        geometries: global___GeometriesInFrame | None = ...,
    ) -> None: ...
    def HasField(
        self, field_name: typing_extensions.Literal["geometries", b"geometries"]
    ) -> builtins.bool: ...
    def ClearField(
        self,
        field_name: typing_extensions.Literal[
            "geometries", b"geometries", "point_cloud", b"point_cloud"
        ],
    ) -> None: ...
...
class GeoPoint(google.protobuf.message.Message):
    ...
    def __init__(
        self, *, latitude: builtins.float = ..., longitude: builtins.float = ...
    ) -> None: ...
    def ClearField(
        self,
        field_name: typing_extensions.Literal[
...
class GeoObstacle(google.protobuf.message.Message):
    ...
    def __init__(
        self,
        *,
        location: global___GeoPoint | None = ...,
        geometries: collections.abc.Iterable[global___Geometry] | None = ...,
    ) -> None: ...
    def HasField(
    ...
    def ClearField(
        self,
        field_name: typing_extensions.Literal[
            "geometries", b"geometries", "location", b"location"
        ],
    ) -> None: ...
...
class Transform(google.protobuf.message.Message):
    ...
    def __init__(
        ...
        *,
        reference_frame: builtins.str = ...,
        pose_in_observer_frame: global___PoseInFrame | None = ...,
        physical_object: global___Geometry | None = ...,
    ) -> None: ...
    def HasField(
        self,
        field_name: typing_extensions.Literal[
    ...
    def WhichOneof(
        self,
        oneof_group: typing_extensions.Literal["_physical_object", b"_physical_object"],
    ) -> typing_extensions.Literal["physical_object"] | None: ...
...
class WorldState(google.protobuf.message.Message):
    ...
    def __init__(
        self,
        *,
        obstacles: collections.abc.Iterable[global___GeometriesInFrame] | None = ...,
        transforms: collections.abc.Iterable[global___Transform] | None = ...,
    ) -> None: ...
    def ClearField(
        self,
        field_name: typing_extensions.Literal[
            "obstacles", b"obstacles", "transforms", b"transforms"
        ],
    ) -> None: ...
...
class ResponseMetadata(google.protobuf.message.Message):
    ...
    def __init__(
        self, *, captured_at: google.protobuf.timestamp_pb2.Timestamp | None = ...
    ) -> None: ...
    def HasField(
        self,
        field_name: typing_extensions.Literal[
            "_captured_at", b"_captured_at", "captured_at", b"captured_at"
        ],
    ) -> builtins.bool: ...
    def ClearField(
        self,
    ...
    def WhichOneof(
        self, oneof_group: typing_extensions.Literal["_captured_at", b"_captured_at"]
    ) -> typing_extensions.Literal["captured_at"] | None: ...
...
class DoCommandRequest(google.protobuf.message.Message):
    ...
    def __init__(
        ...
        *,
        name: builtins.str = ...,
        command: google.protobuf.struct_pb2.Struct | None = ...,
    ) -> None: ...
    def HasField(
        self, field_name: typing_extensions.Literal["command", b"command"]
    ) -> builtins.bool: ...
    def ClearField(
        self,
        field_name: typing_extensions.Literal["command", b"command", "name", b"name"],
    ) -> None: ...
...
class DoCommandResponse(google.protobuf.message.Message):
    ...
    def __init__(
        self, *, result: google.protobuf.struct_pb2.Struct | None = ...
    ) -> None: ...
    def HasField(
...
class GetKinematicsResponse(google.protobuf.message.Message):
    ...
    def ClearField(
        self,
        field_name: typing_extensions.Literal[
            "format", b"format", "kinematics_data", b"kinematics_data"
        ],
    ) -> None: ...
...
class GetGeometriesResponse(google.protobuf.message.Message):
    ...
    def __init__(
        self, *, geometries: collections.abc.Iterable[global___Geometry] | None = ...
    ) -> None: ...
    def ClearField(
        self, field_name: typing_extensions.Literal["geometries", b"geometries"]
    ) -> None: ...
...
class LogEntry(google.protobuf.message.Message):
    ...
    def __init__(
        ...
        *,
        ...
        logger_name: builtins.str = ...,
        message: builtins.str = ...,
        caller: google.protobuf.struct_pb2.Struct | None = ...,
        stack: builtins.str = ...,
        fields: collections.abc.Iterable[google.protobuf.struct_pb2.Struct]
        | None = ...,
    ) -> None: ...
    def HasField(
        self,
        field_name: typing_extensions.Literal["caller", b"caller", "time", b"time"],
    ) -> builtins.bool: ...
    def ClearField(
        self,
        field_name: typing_extensions.Literal[
...
safety_heartbeat_monitored: google.protobuf.internal.extension_dict._ExtensionFieldDescriptor[
