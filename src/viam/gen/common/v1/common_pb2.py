...
_runtime_version.ValidateProtobufRuntimeVersion(_runtime_version.Domain.PUBLIC, 5, 28, 2, '', 'common/v1/common.proto')
...
if not _descriptor._USE_C_DESCRIPTORS:
    ...
    _globals['_KINEMATICSFILEFORMAT']._serialized_start = 3113
    _globals['_KINEMATICSFILEFORMAT']._serialized_end = 3240
    ...
    _globals['_GEOMETRY']._serialized_start = 792
    _globals['_GEOMETRY']._serialized_end = 1044
    _globals['_GEOMETRIESINFRAME']._serialized_start = 1046
    _globals['_GEOMETRIESINFRAME']._serialized_end = 1164
    _globals['_POINTCLOUDOBJECT']._serialized_start = 1166
    _globals['_POINTCLOUDOBJECT']._serialized_end = 1284
    _globals['_GEOPOINT']._serialized_start = 1286
    _globals['_GEOPOINT']._serialized_end = 1354
    _globals['_GEOGEOMETRY']._serialized_start = 1356
    _globals['_GEOGEOMETRY']._serialized_end = 1481
    _globals['_TRANSFORM']._serialized_start = 1484
    _globals['_TRANSFORM']._serialized_end = 1710
    _globals['_WORLDSTATE']._serialized_start = 1713
    _globals['_WORLDSTATE']._serialized_end = 1849
    _globals['_ACTUATORSTATUS']._serialized_start = 1851
    _globals['_ACTUATORSTATUS']._serialized_end = 1896
    _globals['_RESPONSEMETADATA']._serialized_start = 1898
    _globals['_RESPONSEMETADATA']._serialized_end = 1998
    _globals['_DOCOMMANDREQUEST']._serialized_start = 2000
    _globals['_DOCOMMANDREQUEST']._serialized_end = 2089
    _globals['_DOCOMMANDRESPONSE']._serialized_start = 2091
    _globals['_DOCOMMANDRESPONSE']._serialized_end = 2159
    _globals['_GETKINEMATICSREQUEST']._serialized_start = 2161
    _globals['_GETKINEMATICSREQUEST']._serialized_end = 2250
    _globals['_GETKINEMATICSRESPONSE']._serialized_start = 2252
    _globals['_GETKINEMATICSRESPONSE']._serialized_end = 2378
    _globals['_GETGEOMETRIESREQUEST']._serialized_start = 2380
    _globals['_GETGEOMETRIESREQUEST']._serialized_end = 2469
    _globals['_GETGEOMETRIESRESPONSE']._serialized_start = 2471
    _globals['_GETGEOMETRIESRESPONSE']._serialized_end = 2552
    _globals['_GETREADINGSREQUEST']._serialized_start = 2554
    _globals['_GETREADINGSREQUEST']._serialized_end = 2641
    _globals['_GETREADINGSRESPONSE']._serialized_start = 2644
    _globals['_GETREADINGSRESPONSE']._serialized_end = 2829
    _globals['_GETREADINGSRESPONSE_READINGSENTRY']._serialized_start = 2746
    _globals['_GETREADINGSRESPONSE_READINGSENTRY']._serialized_end = 2829
    _globals['_LOGENTRY']._serialized_start = 2832
    _globals['_LOGENTRY']._serialized_end = 3111