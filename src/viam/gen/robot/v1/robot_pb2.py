...
if _descriptor._USE_C_DESCRIPTORS == False:
    ...
    _ROBOTSERVICE.methods_by_name[
        "GetOperations"
    ]._serialized_options = (
        b"\x82\xd3\xe4\x93\x02\x1e\x12\x1c/viam/api/v1/operations/list"
    )
    _ROBOTSERVICE.methods_by_name["GetSessions"]._options = None
    _ROBOTSERVICE.methods_by_name[
        "GetSessions"
    ]._serialized_options = (
        b"\x82\xd3\xe4\x93\x02\x1c\x12\x1a/viam/api/v1/sessions/list"
    )
    _ROBOTSERVICE.methods_by_name["ResourceNames"]._options = None
    _ROBOTSERVICE.methods_by_name[
        "ResourceNames"
    ]._serialized_options = (
        b"\x82\xd3\xe4\x93\x02\x1d\x12\x1b/viam/api/v1/resources/list"
    )
    _ROBOTSERVICE.methods_by_name["ResourceRPCSubtypes"]._options = None
    _ROBOTSERVICE.methods_by_name[
        "ResourceRPCSubtypes"
    ]._serialized_options = (
        b"\x82\xd3\xe4\x93\x02)\x12'/viam/api/v1/resource_rpc_subtypes/list"
    )
    _ROBOTSERVICE.methods_by_name["CancelOperation"]._options = None
    _ROBOTSERVICE.methods_by_name[
        "CancelOperation"
    ]._serialized_options = b'\x82\xd3\xe4\x93\x02 "\x1e/viam/api/v1/operations/cancel'
    _ROBOTSERVICE.methods_by_name["BlockForOperation"]._options = None
    _ROBOTSERVICE.methods_by_name[
        "BlockForOperation"
    ]._serialized_options = (
        b'\x82\xd3\xe4\x93\x02\x1f"\x1d/viam/api/v1/operations/block'
    )
    _ROBOTSERVICE.methods_by_name["DiscoverComponents"]._options = None
    _ROBOTSERVICE.methods_by_name[
        "DiscoverComponents"
    ]._serialized_options = (
        b"\x82\xd3\xe4\x93\x02#\x12!/viam/api/v1/discovery/components"
    )
    _ROBOTSERVICE.methods_by_name["FrameSystemConfig"]._options = None
    _ROBOTSERVICE.methods_by_name[
        "FrameSystemConfig"
    ]._serialized_options = (
        b'\x82\xd3\xe4\x93\x02"\x12 /viam/api/v1/frame_system/config'
    )
    _ROBOTSERVICE.methods_by_name["TransformPose"]._options = None
    _ROBOTSERVICE.methods_by_name[
        "TransformPose"
    ]._serialized_options = (
        b"\x82\xd3\xe4\x93\x02*\x12(/viam/api/v1/frame_system/transform_pose"
    )
    _ROBOTSERVICE.methods_by_name["TransformPCD"]._options = None
    _ROBOTSERVICE.methods_by_name[
        "TransformPCD"
    ]._serialized_options = (
        b"\x82\xd3\xe4\x93\x02)\x12'/viam/api/v1/frame_system/transform_pcd"
    )
    _ROBOTSERVICE.methods_by_name["GetStatus"]._options = None
    _ROBOTSERVICE.methods_by_name[
        "GetStatus"
    ]._serialized_options = b"\x82\xd3\xe4\x93\x02\x15\x12\x13/viam/api/v1/status"
    _ROBOTSERVICE.methods_by_name["StreamStatus"]._options = None
    _ROBOTSERVICE.methods_by_name[
        "StreamStatus"
    ]._serialized_options = (
        b"\x82\xd3\xe4\x93\x02\x1c\x12\x1a/viam/api/v1/status/stream"
    )
    _ROBOTSERVICE.methods_by_name["StopAll"]._options = None
    _ROBOTSERVICE.methods_by_name[
        "StopAll"
    ]._serialized_options = b"\x82\xd3\xe4\x93\x02\x17\x12\x15/viam/api/v1/stop_all"
    _ROBOTSERVICE.methods_by_name["StartSession"]._options = None
    _ROBOTSERVICE.methods_by_name[
        "StartSession"
    ]._serialized_options = b'\x82\xd3\xe4\x93\x02\x17"\x15/viam/api/v1/sessions'
    _ROBOTSERVICE.methods_by_name["SendSessionHeartbeat"]._options = None
    _ROBOTSERVICE.methods_by_name[
        "SendSessionHeartbeat"
    ]._serialized_options = (
        b'\x82\xd3\xe4\x93\x02&"$/viam/api/v1/sessions/{id}/heartbeat'
    )
    _ROBOTSERVICE.methods_by_name["Log"]._options = None
    _ROBOTSERVICE.methods_by_name[
        "Log"
    ]._serialized_options = b'\x82\xd3\xe4\x93\x02\x12"\x10/viam/api/v1/log'
    _ROBOTSERVICE.methods_by_name["GetCloudMetadata"]._options = None
    _ROBOTSERVICE.methods_by_name[
        "GetCloudMetadata"
    ]._serialized_options = (
        b"\x82\xd3\xe4\x93\x02\x1d\x12\x1b/viam/api/v1/cloud_metadata"
    )
    _PEERCONNECTIONTYPE._serialized_start = 3870
    _PEERCONNECTIONTYPE._serialized_end = 3992
    ...
    _GETCLOUDMETADATARESPONSE._serialized_end = 3868
    _ROBOTSERVICE._serialized_start = 3995
    _ROBOTSERVICE._serialized_end = 6262
