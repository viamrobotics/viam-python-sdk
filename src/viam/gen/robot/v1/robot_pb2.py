...
if _descriptor._USE_C_DESCRIPTORS == False:
    ...
    _PEERCONNECTIONTYPE._serialized_start = 3707
    _PEERCONNECTIONTYPE._serialized_end = 3829
    ...
    _ROBOTSERVICE._serialized_end = 5960