...
class _PeerConnectionTypeEnumTypeWrapper(
    google.protobuf.internal.enum_type_wrapper._EnumTypeWrapper[
        _PeerConnectionType.ValueType
    ],
    builtins.type,
):
...
class PeerConnectionType(
    _PeerConnectionType, metaclass=_PeerConnectionTypeEnumTypeWrapper
): ...
...
class FrameSystemConfig(google.protobuf.message.Message):
    ...
    def __init__(
        self,
        *,
        frame: common.v1.common_pb2.Transform | None = ...,
        kinematics: google.protobuf.struct_pb2.Struct | None = ...,
    ) -> None: ...
    def HasField(
        self,
        field_name: typing_extensions.Literal[
            "frame", b"frame", "kinematics", b"kinematics"
        ],
    ) -> builtins.bool: ...
    def ClearField(
        self,
...
class FrameSystemConfigRequest(google.protobuf.message.Message):
    ...
    def ClearField(
        self,
        field_name: typing_extensions.Literal[
            "supplemental_transforms", b"supplemental_transforms"
        ],
    ) -> None: ...
...
class FrameSystemConfigResponse(google.protobuf.message.Message):
    ...
    def __init__(
        self,
        *,
        frame_system_configs: collections.abc.Iterable[global___FrameSystemConfig]
        | None = ...,
    ) -> None: ...
    def ClearField(
        self,
        field_name: typing_extensions.Literal[
            "frame_system_configs", b"frame_system_configs"
        ],
    ) -> None: ...
...
class TransformPoseRequest(google.protobuf.message.Message):
    ...
    def __init__(
        self,
        *,
        source: common.v1.common_pb2.PoseInFrame | None = ...,
        destination: builtins.str = ...,
        supplemental_transforms: collections.abc.Iterable[
            common.v1.common_pb2.Transform
        ]
...
class TransformPCDResponse(google.protobuf.message.Message):
    ...
    def ClearField(
        self,
        field_name: typing_extensions.Literal["point_cloud_pcd", b"point_cloud_pcd"],
    ) -> None: ...
...
class ResourceNamesResponse(google.protobuf.message.Message):
    ...
    def __init__(
        self,
        *,
        resources: collections.abc.Iterable[common.v1.common_pb2.ResourceName]
        | None = ...,
    ) -> None: ...
    def ClearField(
...
class ResourceRPCSubtype(google.protobuf.message.Message):
    ...
    def __init__(
        self,
        *,
        subtype: common.v1.common_pb2.ResourceName | None = ...,
        proto_service: builtins.str = ...,
    ) -> None: ...
    def HasField(
        self, field_name: typing_extensions.Literal["subtype", b"subtype"]
    ) -> builtins.bool: ...
    def ClearField(
        self,
        field_name: typing_extensions.Literal[
            "proto_service", b"proto_service", "subtype", b"subtype"
        ],
    ) -> None: ...
...
class ResourceRPCSubtypesResponse(google.protobuf.message.Message):
    ...
    def __init__(
        self,
        *,
        resource_rpc_subtypes: collections.abc.Iterable[global___ResourceRPCSubtype]
        | None = ...,
    ) -> None: ...
    def ClearField(
        self,
        field_name: typing_extensions.Literal[
            "resource_rpc_subtypes", b"resource_rpc_subtypes"
        ],
    ) -> None: ...
...
class GetOperationsResponse(google.protobuf.message.Message):
    ...
    def __init__(
        self, *, operations: collections.abc.Iterable[global___Operation] | None = ...
    ) -> None: ...
    def ClearField(
        self, field_name: typing_extensions.Literal["operations", b"operations"]
    ) -> None: ...
...
class PeerConnectionInfo(google.protobuf.message.Message):
    ...
    def __init__(
        ...
        *,
        type: global___PeerConnectionType.ValueType = ...,
        remote_address: builtins.str | None = ...,
        local_address: builtins.str | None = ...,
    ) -> None: ...
    def HasField(
        self,
        field_name: typing_extensions.Literal[
    ...
    def WhichOneof(
        self,
        oneof_group: typing_extensions.Literal["_local_address", b"_local_address"],
    ) -> typing_extensions.Literal["local_address"] | None: ...
    @typing.overload
    def WhichOneof(
        self,
        oneof_group: typing_extensions.Literal["_remote_address", b"_remote_address"],
    ) -> typing_extensions.Literal["remote_address"] | None: ...
...
class Session(google.protobuf.message.Message):
    ...
    def __init__(
        ...
        *,
        id: builtins.str = ...,
        peer_connection_info: global___PeerConnectionInfo | None = ...,
    ) -> None: ...
    def HasField(
        self,
        field_name: typing_extensions.Literal[
            "_peer_connection_info",
            b"_peer_connection_info",
            "peer_connection_info",
            b"peer_connection_info",
        ],
    ) -> builtins.bool: ...
    def ClearField(
        self,
    ...
    def WhichOneof(
        ...
        oneof_group: typing_extensions.Literal[
            "_peer_connection_info", b"_peer_connection_info"
        ],
    ) -> typing_extensions.Literal["peer_connection_info"] | None: ...
...
class GetSessionsResponse(google.protobuf.message.Message):
    ...
    def __init__(
        self, *, sessions: collections.abc.Iterable[global___Session] | None = ...
    ) -> None: ...
    def ClearField(
...
class DiscoveryQuery(google.protobuf.message.Message):
    ...
    def __init__(
        self, *, subtype: builtins.str = ..., model: builtins.str = ...
    ) -> None: ...
    def ClearField(
        self,
        field_name: typing_extensions.Literal["model", b"model", "subtype", b"subtype"],
    ) -> None: ...
...
class Discovery(google.protobuf.message.Message):
    ...
    def __init__(
        self,
        *,
        query: global___DiscoveryQuery | None = ...,
        results: google.protobuf.struct_pb2.Struct | None = ...,
    ) -> None: ...
    def HasField(
        self,
        field_name: typing_extensions.Literal["query", b"query", "results", b"results"],
    ) -> builtins.bool: ...
    def ClearField(
        self,
        field_name: typing_extensions.Literal["query", b"query", "results", b"results"],
...
class DiscoverComponentsRequest(google.protobuf.message.Message):
    ...
    def __init__(
        self, *, queries: collections.abc.Iterable[global___DiscoveryQuery] | None = ...
    ) -> None: ...
    def ClearField(
        self, field_name: typing_extensions.Literal["queries", b"queries"]
    ) -> None: ...
...
class DiscoverComponentsResponse(google.protobuf.message.Message):
    ...
    def __init__(
        self, *, discovery: collections.abc.Iterable[global___Discovery] | None = ...
    ) -> None: ...
    def ClearField(
        self, field_name: typing_extensions.Literal["discovery", b"discovery"]
    ) -> None: ...
...
class Status(google.protobuf.message.Message):
    ...
    def __init__(
        ...
        *,
        ...
        status: google.protobuf.struct_pb2.Struct | None = ...,
        last_reconfigured: google.protobuf.timestamp_pb2.Timestamp | None = ...,
    ) -> None: ...
    def HasField(
        self,
        field_name: typing_extensions.Literal[
...
class GetStatusRequest(google.protobuf.message.Message):
    ...
    def __init__(
        self,
        *,
        resource_names: collections.abc.Iterable[common.v1.common_pb2.ResourceName]
        | None = ...,
    ) -> None: ...
    def ClearField(
...
class GetStatusResponse(google.protobuf.message.Message):
    ...
    def __init__(
        self, *, status: collections.abc.Iterable[global___Status] | None = ...
    ) -> None: ...
    def ClearField(
...
class StreamStatusRequest(google.protobuf.message.Message):
    ...
    def HasField(
        self, field_name: typing_extensions.Literal["every", b"every"]
    ) -> builtins.bool: ...
    def ClearField(
        self,
        field_name: typing_extensions.Literal[
            "every", b"every", "resource_names", b"resource_names"
        ],
    ) -> None: ...
...
class StopExtraParameters(google.protobuf.message.Message):
    ...
    def HasField(
        self,
        field_name: typing_extensions.Literal["name", b"name", "params", b"params"],
    ) -> builtins.bool: ...
    def ClearField(
        self,
        field_name: typing_extensions.Literal["name", b"name", "params", b"params"],
...
class StopAllRequest(google.protobuf.message.Message):
    ...
    def __init__(
        self,
        *,
        extra: collections.abc.Iterable[global___StopExtraParameters] | None = ...,
    ) -> None: ...
    def ClearField(
...
class StartSessionRequest(google.protobuf.message.Message):
    ...
    def ClearField(
        self, field_name: typing_extensions.Literal["resume", b"resume"]
    ) -> None: ...
...
class StartSessionResponse(google.protobuf.message.Message):
    ...
    def __init__(
        ...
        *,
        id: builtins.str = ...,
        heartbeat_window: google.protobuf.duration_pb2.Duration | None = ...,
    ) -> None: ...
    def HasField(
        self,
    ...
    def ClearField(
        self,
        field_name: typing_extensions.Literal[
            "heartbeat_window", b"heartbeat_window", "id", b"id"
        ],
    ) -> None: ...
