...
@typing_extensions.final
class ModuleLogRequest(google.protobuf.message.Message):
    DESCRIPTOR: google.protobuf.descriptor.Descriptor
    ...
    def __init__(self, *, logs: collections.abc.Iterable[app.v1.app_pb2.LogEntry] | None=...) -> None:
        ...

    def ClearField(self, field_name: typing_extensions.Literal['logs', b'logs']) -> None:
        ...
global___ModuleLogRequest = ModuleLogRequest

@typing_extensions.final
class ModuleLogResponse(google.protobuf.message.Message):
    DESCRIPTOR: google.protobuf.descriptor.Descriptor

    def __init__(self) -> None:
        ...
global___ModuleLogResponse = ModuleLogResponse