...
class RobotServiceStub:
    ...
    def __init__(self, channel: grpclib.client.Channel) -> None:
        ...
        self.ModuleLog = grpclib.client.UnaryUnaryMethod(channel, '/viam.robot.v1.RobotService/ModuleLog', robot.v1.robot_pb2.ModuleLogRequest, robot.v1.robot_pb2.ModuleLogResponse)