...
class RobotServiceStub:
    ...
    def __init__(self, channel: grpclib.client.Channel) -> None:
        ...
        self.SendTraces = grpclib.client.UnaryUnaryMethod(channel, '/viam.robot.v1.RobotService/SendTraces', robot.v1.robot_pb2.SendTracesRequest, robot.v1.robot_pb2.SendTracesResponse)
        self.UploadDataFromPath = grpclib.client.UnaryUnaryMethod(channel, '/viam.robot.v1.RobotService/UploadDataFromPath', robot.v1.robot_pb2.UploadDataFromPathRequest, robot.v1.robot_pb2.UploadDataFromPathResponse)