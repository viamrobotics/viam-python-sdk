...
class BoardRPCService(BoardServiceBase, ResourceRPCServiceBase[Board]):
    ...
    async def PWMFrequency(
        self, stream: Stream[PWMFrequencyRequest, PWMFrequencyResponse]
    ) -> None:
        request = await stream.recv_message()
        assert request is not None
        name = request.name
    ...
    async def SetPWMFrequency(
        self, stream: Stream[SetPWMFrequencyRequest, SetPWMFrequencyResponse]
    ) -> None:
        request = await stream.recv_message()
        assert request is not None
        name = request.name
    ...
    async def ReadAnalogReader(
        self, stream: Stream[ReadAnalogReaderRequest, ReadAnalogReaderResponse]
    ) -> None:
        request = await stream.recv_message()
        assert request is not None
    ...
    async def SetPowerMode(
        self, stream: Stream[SetPowerModeRequest, SetPowerModeResponse]
    ) -> None:
        request = await stream.recv_message()
        assert request is not None
        name = request.name
    ...
    async def WriteAnalog(
        self, stream: Stream[WriteAnalogRequest, WriteAnalogResponse]
    ) -> None:
        request = await stream.recv_message()
        assert request is not None
        name = request.name
