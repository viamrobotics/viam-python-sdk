...
class ArmService(ArmServiceBase, ComponentServiceBase[Arm]):
    ...
    async def GetEndPosition(self, stream: Stream[GetEndPositionRequest, GetEndPositionResponse]) -> None:
        ...
        try:
            ...
            raise e.grpc_error
        position = await self._run_with_operation(arm.get_end_position, extra=struct_to_dict(request.extra))
    ...
    async def MoveToPosition(self, stream: Stream[MoveToPositionRequest, MoveToPositionResponse]) -> None:
        ...
        try:
            ...
            raise e.grpc_error
        await self._run_with_operation(arm.move_to_position, request.to, request.world_state, extra=struct_to_dict(request.extra))
    ...
    async def GetJointPositions(self, stream: Stream[GetJointPositionsRequest, GetJointPositionsResponse]) -> None:
        ...
        try:
            ...
            raise e.grpc_error
        positions = await self._run_with_operation(arm.get_joint_positions, extra=struct_to_dict(request.extra))
    ...
    async def MoveToJointPositions(self, stream: Stream[MoveToJointPositionsRequest, MoveToJointPositionsResponse]) -> None:
        ...
        try:
            ...
            raise e.grpc_error
        await self._run_with_operation(arm.move_to_joint_positions, request.positions, extra=struct_to_dict(request.extra))
    ...
    async def Stop(self, stream: Stream[StopRequest, StopResponse]) -> None:
        ...
        try:
            ...
            raise e.grpc_error
        await self._run_with_operation(arm.stop, extra=struct_to_dict(request.extra))
