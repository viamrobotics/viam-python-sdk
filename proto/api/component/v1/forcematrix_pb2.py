...
Matrix = _reflection.GeneratedProtocolMessageType('Matrix', (_message.Message,), {
  'DESCRIPTOR' : _MATRIX,
  '__module__' : 'proto.api.component.v1.forcematrix_pb2'
  # @@protoc_insertion_point(class_scope:proto.api.component.v1.Matrix)
  })
_sym_db.RegisterMessage(Matrix)

ForceMatrixServiceReadMatrixRequest = _reflection.GeneratedProtocolMessageType('ForceMatrixServiceReadMatrixRequest', (_message.Message,), {
  'DESCRIPTOR' : _FORCEMATRIXSERVICEREADMATRIXREQUEST,
  '__module__' : 'proto.api.component.v1.forcematrix_pb2'
  # @@protoc_insertion_point(class_scope:proto.api.component.v1.ForceMatrixServiceReadMatrixRequest)
  })
_sym_db.RegisterMessage(ForceMatrixServiceReadMatrixRequest)

ForceMatrixServiceReadMatrixResponse = _reflection.GeneratedProtocolMessageType('ForceMatrixServiceReadMatrixResponse', (_message.Message,), {
  'DESCRIPTOR' : _FORCEMATRIXSERVICEREADMATRIXRESPONSE,
  '__module__' : 'proto.api.component.v1.forcematrix_pb2'
  # @@protoc_insertion_point(class_scope:proto.api.component.v1.ForceMatrixServiceReadMatrixResponse)
  })
_sym_db.RegisterMessage(ForceMatrixServiceReadMatrixResponse)

ForceMatrixServiceDetectSlipRequest = _reflection.GeneratedProtocolMessageType('ForceMatrixServiceDetectSlipRequest', (_message.Message,), {
  'DESCRIPTOR' : _FORCEMATRIXSERVICEDETECTSLIPREQUEST,
  '__module__' : 'proto.api.component.v1.forcematrix_pb2'
  # @@protoc_insertion_point(class_scope:proto.api.component.v1.ForceMatrixServiceDetectSlipRequest)
  })
_sym_db.RegisterMessage(ForceMatrixServiceDetectSlipRequest)

ForceMatrixServiceDetectSlipResponse = _reflection.GeneratedProtocolMessageType('ForceMatrixServiceDetectSlipResponse', (_message.Message,), {
  'DESCRIPTOR' : _FORCEMATRIXSERVICEDETECTSLIPRESPONSE,
  '__module__' : 'proto.api.component.v1.forcematrix_pb2'
  # @@protoc_insertion_point(class_scope:proto.api.component.v1.ForceMatrixServiceDetectSlipResponse)
  })
...
if _descriptor._USE_C_DESCRIPTORS == False:
  ...
  _FORCEMATRIXSERVICE.methods_by_name['ReadMatrix']._serialized_options = b'\202\323\344\223\002.\022,/api/v1/component/force_matrix/{name}/matrix'
  _FORCEMATRIXSERVICE.methods_by_name['DetectSlip']._options = None
  _FORCEMATRIXSERVICE.methods_by_name['DetectSlip']._serialized_options = b'\202\323\344\223\0026\0224/api/v1/component/force_matrix/{name}/slip_detection'
