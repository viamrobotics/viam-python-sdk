...
import proto.api.component.v1.input_controller_pb2
...
class InputControllerServiceBase(abc.ABC):
    ...
    def __mapping__(self) -> typing.Dict[str, grpclib.const.Handler]:
        return {
            '/proto.api.component.v1.InputControllerService/GetControls': grpclib.const.Handler(
                self.GetControls,
                grpclib.const.Cardinality.UNARY_UNARY,
                proto.api.component.v1.input_controller_pb2.InputControllerServiceGetControlsRequest,
                proto.api.component.v1.input_controller_pb2.InputControllerServiceGetControlsResponse,
            ),
            '/proto.api.component.v1.InputControllerService/GetEvents': grpclib.const.Handler(
                self.GetEvents,
                grpclib.const.Cardinality.UNARY_UNARY,
                proto.api.component.v1.input_controller_pb2.InputControllerServiceGetEventsRequest,
                proto.api.component.v1.input_controller_pb2.InputControllerServiceGetEventsResponse,
            ),
            '/proto.api.component.v1.InputControllerService/StreamEvents': grpclib.const.Handler(
                self.StreamEvents,
                grpclib.const.Cardinality.UNARY_STREAM,
                proto.api.component.v1.input_controller_pb2.InputControllerServiceStreamEventsRequest,
                proto.api.component.v1.input_controller_pb2.InputControllerServiceStreamEventsResponse,
            ),
            '/proto.api.component.v1.InputControllerService/TriggerEvent': grpclib.const.Handler(
                self.TriggerEvent,
                grpclib.const.Cardinality.UNARY_UNARY,
                proto.api.component.v1.input_controller_pb2.InputControllerServiceTriggerEventRequest,
                proto.api.component.v1.input_controller_pb2.InputControllerServiceTriggerEventResponse,
            ),
        }
