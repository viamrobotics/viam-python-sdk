...
class ICECandidate(google.protobuf.message.Message):
    ...
    def __init__(self,
        *,
        candidate : typing.Text = ...,
        sdp_mid : typing.Optional[typing.Text] = ...,
        sdpm_line_index : typing.Optional[builtins.int] = ...,
...
class CallResponseUpdateStage(google.protobuf.message.Message):
    ...
    def __init__(self,
        *,
        candidate : typing.Optional[global___ICECandidate] = ...,
        ) -> None: ...
...
class CallResponse(google.protobuf.message.Message):
    ...
    def __init__(self,
        *,
        uuid : typing.Text = ...,
        init : typing.Optional[global___CallResponseInitStage] = ...,
        update : typing.Optional[global___CallResponseUpdateStage] = ...,
        ) -> None: ...
...
class WebRTCConfig(google.protobuf.message.Message):
    ...
    def __init__(self,
        *,
        additional_ice_servers : typing.Optional[typing.Iterable[global___ICEServer]] = ...,
        disable_trickle : builtins.bool = ...,
        ) -> None: ...
...
class AnswerRequestInitStage(google.protobuf.message.Message):
    ...
    def __init__(self,
        *,
        sdp : typing.Text = ...,
        optional_config : typing.Optional[global___WebRTCConfig] = ...,
        ) -> None: ...
...
class AnswerRequest(google.protobuf.message.Message):
    ...
    def __init__(self,
        *,
        uuid : typing.Text = ...,
        init : typing.Optional[global___AnswerRequestInitStage] = ...,
        update : typing.Optional[global___AnswerRequestUpdateStage] = ...,
        done : typing.Optional[global___AnswerRequestDoneStage] = ...,
        error : typing.Optional[global___AnswerRequestErrorStage] = ...,
        ) -> None: ...
...
class AnswerResponse(google.protobuf.message.Message):
    ...
    def __init__(self,
        *,
        uuid : typing.Text = ...,
        init : typing.Optional[global___AnswerResponseInitStage] = ...,
        update : typing.Optional[global___AnswerResponseUpdateStage] = ...,
        done : typing.Optional[global___AnswerResponseDoneStage] = ...,
        error : typing.Optional[global___AnswerResponseErrorStage] = ...,
        ) -> None: ...
    def HasField(self, field_name: typing_extensions.Literal["done",b"done","error",b"error","init",b"init","stage",b"stage","update",b"update"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["done",b"done","error",b"error","init",b"init","stage",b"stage","update",b"update","uuid",b"uuid"]) -> None: ...
    def WhichOneof(self, oneof_group: typing_extensions.Literal["stage",b"stage"]) -> typing.Optional[typing_extensions.Literal["init","update","done","error"]]: ...
...
class OptionalWebRTCConfigResponse(google.protobuf.message.Message):
    ...
    def __init__(self,
        *,
        config : typing.Optional[global___WebRTCConfig] = ...,
        ) -> None: ...
