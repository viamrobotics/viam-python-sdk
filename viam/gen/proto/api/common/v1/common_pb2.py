...
PointCloudObject = _reflection.GeneratedProtocolMessageType('PointCloudObject', (_message.Message,), {'DESCRIPTOR': _POINTCLOUDOBJECT, '__module__': 'proto.api.common.v1.common_pb2', '__doc__': 'Attributes:\n      point_cloud:\n          image frame expressed in bytes\n      geometries:\n          volume of a given geometry\n  '})
...
Transform = _reflection.GeneratedProtocolMessageType('Transform', (_message.Message,), {'DESCRIPTOR': _TRANSFORM, '__module__': 'proto.api.common.v1.common_pb2', '__doc__': 'Attributes:\n      reference_frame:\n          the name of a given reference frame\n      pose_in_observer_frame:\n          the pose of the above reference frame with respect to a\n          different observer reference frame\n  '})
_sym_db.RegisterMessage(Transform)
WorldState = _reflection.GeneratedProtocolMessageType('WorldState', (_message.Message,), {'DESCRIPTOR': _WORLDSTATE, '__module__': 'proto.api.common.v1.common_pb2', '__doc__': 'Attributes:\n      transforms:\n          a list of Transforms needed to transform a pose from one\n          reference frame to another; this field is optional\n  '})
