...
GetPositionRequest = _reflection.GeneratedProtocolMessageType('GetPositionRequest', (_message.Message,), {
                                                              'DESCRIPTOR': _GETPOSITIONREQUEST, '__module__': 'proto.api.service.slam.v1.slam_pb2', '__doc__': 'Attributes:\n      name:\n          Name of slam service\n  '})
...
GetPositionResponse = _reflection.GeneratedProtocolMessageType('GetPositionResponse', (_message.Message,), {
                                                               'DESCRIPTOR': _GETPOSITIONRESPONSE, '__module__': 'proto.api.service.slam.v1.slam_pb2', '__doc__': 'Attributes:\n      pose:\n          Current position of the robot within the World frame.\n  '})
