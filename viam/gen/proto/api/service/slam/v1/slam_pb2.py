...
GetPositionRequest = _reflection.GeneratedProtocolMessageType('GetPositionRequest', (_message.Message,), {'DESCRIPTOR': _GETPOSITIONREQUEST, '__module__': 'proto.api.service.slam.v1.slam_pb2', '__doc__': 'Attributes:\n      name:\n          Name of slam service\n  '})
_sym_db.RegisterMessage(GetPositionRequest)
GetPositionResponse = _reflection.GeneratedProtocolMessageType('GetPositionResponse', (_message.Message,), {'DESCRIPTOR': _GETPOSITIONRESPONSE, '__module__': 'proto.api.service.slam.v1.slam_pb2', '__doc__': 'Attributes:\n      pose:\n          Current position of the robot within the World frame.\n  '})
_sym_db.RegisterMessage(GetPositionResponse)
GetMapRequest = _reflection.GeneratedProtocolMessageType('GetMapRequest', (_message.Message,), {'DESCRIPTOR': _GETMAPREQUEST, '__module__': 'proto.api.service.slam.v1.slam_pb2', '__doc__': 'Attributes:\n      name:\n          Name of slam service\n      mime_type:\n          Requested MIME type of response (image/jpeg or image/pcd)\n      camera_position:\n          Optional parameter for image/jpeg mime_type, used to project\n          point cloud into a 2D image.  |\n      include_robot_marker:\n          Optional parameter for image/jpeg mime_type, defaults to\n          false. | Tells us whether to include the robot position on the\n          2D image.\n  '})
_sym_db.RegisterMessage(GetMapRequest)
GetMapResponse = _reflection.GeneratedProtocolMessageType('GetMapResponse', (_message.Message,), {'DESCRIPTOR': _GETMAPRESPONSE, '__module__': 'proto.api.service.slam.v1.slam_pb2', '__doc__': 'Attributes:\n      map:\n          Image or point cloud of mime_type.\n      mime_type:\n          Actual MIME type of response (image/jpeg or image/pcd)\n  '})
