...
_DETECTORNAMESREQUEST = DESCRIPTOR.message_types_by_name['DetectorNamesRequest']
_DETECTORNAMESRESPONSE = DESCRIPTOR.message_types_by_name['DetectorNamesResponse']
...
DetectorNamesRequest = _reflection.GeneratedProtocolMessageType('DetectorNamesRequest', (_message.Message,), {'DESCRIPTOR': _DETECTORNAMESREQUEST, '__module__': 'proto.api.service.objectdetection.v1.object_detection_pb2'})
_sym_db.RegisterMessage(DetectorNamesRequest)
DetectorNamesResponse = _reflection.GeneratedProtocolMessageType('DetectorNamesResponse', (_message.Message,), {'DESCRIPTOR': _DETECTORNAMESRESPONSE, '__module__': 'proto.api.service.objectdetection.v1.object_detection_pb2', '__doc__': 'Attributes:\n      detector_names:\n          detectors in the registry\n  '})
_sym_db.RegisterMessage(DetectorNamesResponse)
AddDetectorRequest = _reflection.GeneratedProtocolMessageType('AddDetectorRequest', (_message.Message,), {'DESCRIPTOR': _ADDDETECTORREQUEST, '__module__': 'proto.api.service.objectdetection.v1.object_detection_pb2'})
_sym_db.RegisterMessage(AddDetectorRequest)
AddDetectorResponse = _reflection.GeneratedProtocolMessageType('AddDetectorResponse', (_message.Message,), {'DESCRIPTOR': _ADDDETECTORRESPONSE, '__module__': 'proto.api.service.objectdetection.v1.object_detection_pb2'})
_sym_db.RegisterMessage(AddDetectorResponse)
DetectRequest = _reflection.GeneratedProtocolMessageType('DetectRequest', (_message.Message,), {'DESCRIPTOR': _DETECTREQUEST, '__module__': 'proto.api.service.objectdetection.v1.object_detection_pb2', '__doc__': 'Attributes:\n      camera_name:\n          name of camera source to use as input\n      detector_name:\n          name of the registered detector to use\n  '})
_sym_db.RegisterMessage(DetectRequest)
DetectResponse = _reflection.GeneratedProtocolMessageType('DetectResponse', (_message.Message,), {'DESCRIPTOR': _DETECTRESPONSE, '__module__': 'proto.api.service.objectdetection.v1.object_detection_pb2', '__doc__': 'Attributes:\n      detections:\n          the bounding boxes and labels\n  '})
_sym_db.RegisterMessage(DetectResponse)
Detection = _reflection.GeneratedProtocolMessageType('Detection', (_message.Message,), {'DESCRIPTOR': _DETECTION, '__module__': 'proto.api.service.objectdetection.v1.object_detection_pb2', '__doc__': 'Attributes:\n      x_min:\n          the four corners of the box\n      confidence:\n          the confidence of the detection\n      class_name:\n          label associated with the detected object\n  '})
_sym_db.RegisterMessage(Detection)
_OBJECTDETECTIONSERVICE = DESCRIPTOR.services_by_name['ObjectDetectionService']
