...
ConfigRequest = _reflection.GeneratedProtocolMessageType('ConfigRequest', (_message.Message,), {'DESCRIPTOR': _CONFIGREQUEST, '__module__': 'proto.api.service.framesystem.v1.frame_system_pb2', '__doc__': 'Attributes:\n      supplemental_transforms:\n          pose information on any additional reference frames that are\n          needed to supplement the robot’s frame system\n  '})
...
if _descriptor._USE_C_DESCRIPTORS == False:
    ...
    _CONFIGREQUEST._serialized_end = 402
    _CONFIGRESPONSE._serialized_start = 404
    _CONFIGRESPONSE._serialized_end = 512
    _TRANSFORMPOSEREQUEST._serialized_start = 515
    _TRANSFORMPOSEREQUEST._serialized_end = 718
    _TRANSFORMPOSERESPONSE._serialized_start = 720
    _TRANSFORMPOSERESPONSE._serialized_end = 797
    _FRAMESYSTEMSERVICE._serialized_start = 800
    _FRAMESYSTEMSERVICE._serialized_end = 1169