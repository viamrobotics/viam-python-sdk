...
class RobotServiceBase(abc.ABC):
    ...
    @abc.abstractmethod
    async def SensorReadings(self, stream: 'grpclib.server.Stream[proto.api.robot.v1.robot_pb2.SensorReadingsRequest, proto.api.robot.v1.robot_pb2.SensorReadingsResponse]') -> None:
        pass
...
class RobotServiceStub:
    ...
    def __init__(self, channel: grpclib.client.Channel) -> None:
        ...
        self.SensorReadings = grpclib.client.UnaryUnaryMethod(channel, '/proto.api.robot.v1.RobotService/SensorReadings', proto.api.robot.v1.robot_pb2.SensorReadingsRequest, proto.api.robot.v1.robot_pb2.SensorReadingsResponse)
