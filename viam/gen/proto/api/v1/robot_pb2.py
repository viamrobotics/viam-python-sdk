...
_FRAMESERVICECONFIGREQUEST = DESCRIPTOR.message_types_by_name['FrameServiceConfigRequest']
_FRAMESERVICECONFIGRESPONSE = DESCRIPTOR.message_types_by_name['FrameServiceConfigResponse']
...
_OBJECTMANIPULATIONSERVICEDOGRABREQUEST = DESCRIPTOR.message_types_by_name['ObjectManipulationServiceDoGrabRequest']
_OBJECTMANIPULATIONSERVICEDOGRABRESPONSE = DESCRIPTOR.message_types_by_name['ObjectManipulationServiceDoGrabResponse']
...
FrameConfig = _reflection.GeneratedProtocolMessageType('FrameConfig', (_message.Message,), {'DESCRIPTOR': _FRAMECONFIG, '__module__': 'proto.api.v1.robot_pb2'})
_sym_db.RegisterMessage(FrameConfig)
FrameSystemConfig = _reflection.GeneratedProtocolMessageType('FrameSystemConfig', (_message.Message,), {'DESCRIPTOR': _FRAMESYSTEMCONFIG, '__module__': 'proto.api.v1.robot_pb2'})
_sym_db.RegisterMessage(FrameSystemConfig)
FrameServiceConfigRequest = _reflection.GeneratedProtocolMessageType('FrameServiceConfigRequest', (_message.Message,), {'DESCRIPTOR': _FRAMESERVICECONFIGREQUEST, '__module__': 'proto.api.v1.robot_pb2'})
_sym_db.RegisterMessage(FrameServiceConfigRequest)
FrameServiceConfigResponse = _reflection.GeneratedProtocolMessageType('FrameServiceConfigResponse', (_message.Message,), {'DESCRIPTOR': _FRAMESERVICECONFIGRESPONSE, '__module__': 'proto.api.v1.robot_pb2'})
_sym_db.RegisterMessage(FrameServiceConfigResponse)
Vector3 = _reflection.GeneratedProtocolMessageType('Vector3', (_message.Message,), {'DESCRIPTOR': _VECTOR3, '__module__': 'proto.api.v1.robot_pb2'})
...
ObjectManipulationServiceDoGrabRequest = _reflection.GeneratedProtocolMessageType('ObjectManipulationServiceDoGrabRequest', (_message.Message,), {'DESCRIPTOR': _OBJECTMANIPULATIONSERVICEDOGRABREQUEST, '__module__': 'proto.api.v1.robot_pb2'})
_sym_db.RegisterMessage(ObjectManipulationServiceDoGrabRequest)
ObjectManipulationServiceDoGrabResponse = _reflection.GeneratedProtocolMessageType('ObjectManipulationServiceDoGrabResponse', (_message.Message,), {'DESCRIPTOR': _OBJECTMANIPULATIONSERVICEDOGRABRESPONSE, '__module__': 'proto.api.v1.robot_pb2'})
...
if _descriptor._USE_C_DESCRIPTORS == False:
    ...
    _ROBOTSERVICE.methods_by_name['FrameServiceConfig']._options = None
    _ROBOTSERVICE.methods_by_name['FrameServiceConfig']._serialized_options = b'\x82\xd3\xe4\x93\x02&\x12$/api/v1/services/frame_system/config'
    ...
    _ROBOTSERVICE.methods_by_name['ObjectManipulationServiceDoGrab']._options = None
    _ROBOTSERVICE.methods_by_name['ObjectManipulationServiceDoGrab']._serialized_options = b'\x82\xd3\xe4\x93\x02-"+/api/v1/services/objectmanipulation/do_grab'
    _NAVIGATIONSERVICEMODE._serialized_start = 5535
    _NAVIGATIONSERVICEMODE._serialized_end = 5673
    ...
    _FRAMECONFIG._serialized_start = 2779
    _FRAMECONFIG._serialized_end = 2856
    _FRAMESYSTEMCONFIG._serialized_start = 2859
    _FRAMESYSTEMCONFIG._serialized_end = 2991
    _FRAMESERVICECONFIGREQUEST._serialized_start = 2993
    _FRAMESERVICECONFIGREQUEST._serialized_end = 3020
    _FRAMESERVICECONFIGRESPONSE._serialized_start = 3022
    _FRAMESERVICECONFIGRESPONSE._serialized_end = 3133
    _VECTOR3._serialized_start = 3135
    _VECTOR3._serialized_end = 3186
    _SENSORSTATUS._serialized_start = 3188
    _SENSORSTATUS._serialized_end = 3222
    _SENSORREADINGSREQUEST._serialized_start = 3224
    _SENSORREADINGSREQUEST._serialized_end = 3267
    _SENSORREADINGSRESPONSE._serialized_start = 3269
    _SENSORREADINGSRESPONSE._serialized_end = 3345
    _EXECUTEFUNCTIONREQUEST._serialized_start = 3347
    _EXECUTEFUNCTIONREQUEST._serialized_end = 3391
    _EXECUTEFUNCTIONRESPONSE._serialized_start = 3393
    _EXECUTEFUNCTIONRESPONSE._serialized_end = 3518
    _EXECUTESOURCEREQUEST._serialized_start = 3520
    _EXECUTESOURCEREQUEST._serialized_end = 3590
    _EXECUTESOURCERESPONSE._serialized_start = 3592
    _EXECUTESOURCERESPONSE._serialized_end = 3715
    _MOTORSTATUS._serialized_start = 3718
    _MOTORSTATUS._serialized_end = 3898
    _SERVOSTATUS._serialized_start = 3900
    _SERVOSTATUS._serialized_end = 3935
    _RESOURCERUNCOMMANDREQUEST._serialized_start = 3938
    _RESOURCERUNCOMMANDREQUEST._serialized_end = 4082
    _RESOURCERUNCOMMANDRESPONSE._serialized_start = 4084
    _RESOURCERUNCOMMANDRESPONSE._serialized_end = 4161
    _NAVIGATIONSERVICEMODEREQUEST._serialized_start = 4163
    _NAVIGATIONSERVICEMODEREQUEST._serialized_end = 4193
    _NAVIGATIONSERVICEMODERESPONSE._serialized_start = 4195
    _NAVIGATIONSERVICEMODERESPONSE._serialized_end = 4283
    _NAVIGATIONSERVICESETMODEREQUEST._serialized_start = 4285
    _NAVIGATIONSERVICESETMODEREQUEST._serialized_end = 4375
    _NAVIGATIONSERVICESETMODERESPONSE._serialized_start = 4377
    _NAVIGATIONSERVICESETMODERESPONSE._serialized_end = 4411
    _NAVIGATIONSERVICEWAYPOINT._serialized_start = 4413
    _NAVIGATIONSERVICEWAYPOINT._serialized_end = 4515
    _NAVIGATIONSERVICELOCATIONREQUEST._serialized_start = 4517
    _NAVIGATIONSERVICELOCATIONREQUEST._serialized_end = 4551
    _NAVIGATIONSERVICELOCATIONRESPONSE._serialized_start = 4553
    _NAVIGATIONSERVICELOCATIONRESPONSE._serialized_end = 4647
    _NAVIGATIONSERVICEWAYPOINTSREQUEST._serialized_start = 4649
    _NAVIGATIONSERVICEWAYPOINTSREQUEST._serialized_end = 4684
    _NAVIGATIONSERVICEWAYPOINTSRESPONSE._serialized_start = 4686
    _NAVIGATIONSERVICEWAYPOINTSRESPONSE._serialized_end = 4793
    _NAVIGATIONSERVICEADDWAYPOINTREQUEST._serialized_start = 4795
    _NAVIGATIONSERVICEADDWAYPOINTREQUEST._serialized_end = 4891
    _NAVIGATIONSERVICEADDWAYPOINTRESPONSE._serialized_start = 4893
    _NAVIGATIONSERVICEADDWAYPOINTRESPONSE._serialized_end = 4931
    _NAVIGATIONSERVICEREMOVEWAYPOINTREQUEST._serialized_start = 4933
    _NAVIGATIONSERVICEREMOVEWAYPOINTREQUEST._serialized_end = 4989
    _NAVIGATIONSERVICEREMOVEWAYPOINTRESPONSE._serialized_start = 4991
    _NAVIGATIONSERVICEREMOVEWAYPOINTRESPONSE._serialized_end = 5032
    _OBJECTMANIPULATIONSERVICEDOGRABREQUEST._serialized_start = 5035
    _OBJECTMANIPULATIONSERVICEDOGRABREQUEST._serialized_end = 5228
    _OBJECTMANIPULATIONSERVICEDOGRABRESPONSE._serialized_start = 5230
    _OBJECTMANIPULATIONSERVICEDOGRABRESPONSE._serialized_end = 5304
    _INPUTCONTROLLEREVENT._serialized_start = 5307
    _INPUTCONTROLLEREVENT._serialized_end = 5447
    _INPUTCONTROLLERSTATUS._serialized_start = 5449
    _INPUTCONTROLLERSTATUS._serialized_end = 5532
    _ROBOTSERVICE._serialized_start = 5676
    _ROBOTSERVICE._serialized_end = 8081