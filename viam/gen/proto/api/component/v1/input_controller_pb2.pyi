...
class InputControllerServiceGetEventsResponse(google.protobuf.message.Message):
    ...
    def __init__(self, *, events: typing.Optional[typing.Iterable[global___InputControllerServiceEvent]]=...) -> None:
        ...
...
class InputControllerServiceTriggerEventRequest(google.protobuf.message.Message):
    ...
    def __init__(self, *, controller: typing.Text=..., event: typing.Optional[global___InputControllerServiceEvent]=...) -> None:
        ...
...
class InputControllerServiceStreamEventsRequest(google.protobuf.message.Message):
    ...
    def __init__(self, *, controller: typing.Text=..., events: typing.Optional[typing.Iterable[global___InputControllerServiceStreamEventsRequest.Events]]=...) -> None:
        ...
...
class InputControllerServiceStreamEventsResponse(google.protobuf.message.Message):
    ...
    def __init__(self, *, event: typing.Optional[global___InputControllerServiceEvent]=...) -> None:
        ...
