...
Matrix = _reflection.GeneratedProtocolMessageType('Matrix', (_message.Message,), {'DESCRIPTOR': _MATRIX, '__module__': 'proto.api.component.v1.force_matrix_pb2'})
_sym_db.RegisterMessage(Matrix)
ForceMatrixServiceReadMatrixRequest = _reflection.GeneratedProtocolMessageType('ForceMatrixServiceReadMatrixRequest', (_message.Message,), {'DESCRIPTOR': _FORCEMATRIXSERVICEREADMATRIXREQUEST, '__module__': 'proto.api.component.v1.force_matrix_pb2'})
_sym_db.RegisterMessage(ForceMatrixServiceReadMatrixRequest)
ForceMatrixServiceReadMatrixResponse = _reflection.GeneratedProtocolMessageType('ForceMatrixServiceReadMatrixResponse', (_message.Message,), {'DESCRIPTOR': _FORCEMATRIXSERVICEREADMATRIXRESPONSE, '__module__': 'proto.api.component.v1.force_matrix_pb2'})
_sym_db.RegisterMessage(ForceMatrixServiceReadMatrixResponse)
ForceMatrixServiceDetectSlipRequest = _reflection.GeneratedProtocolMessageType('ForceMatrixServiceDetectSlipRequest', (_message.Message,), {'DESCRIPTOR': _FORCEMATRIXSERVICEDETECTSLIPREQUEST, '__module__': 'proto.api.component.v1.force_matrix_pb2'})
_sym_db.RegisterMessage(ForceMatrixServiceDetectSlipRequest)
ForceMatrixServiceDetectSlipResponse = _reflection.GeneratedProtocolMessageType('ForceMatrixServiceDetectSlipResponse', (_message.Message,), {'DESCRIPTOR': _FORCEMATRIXSERVICEDETECTSLIPRESPONSE, '__module__': 'proto.api.component.v1.force_matrix_pb2'})
...
if _descriptor._USE_C_DESCRIPTORS == False:
    ...
    _MATRIX._serialized_start = 99
    _MATRIX._serialized_end = 167
    _FORCEMATRIXSERVICEREADMATRIXREQUEST._serialized_start = 169
    _FORCEMATRIXSERVICEREADMATRIXREQUEST._serialized_end = 226
    _FORCEMATRIXSERVICEREADMATRIXRESPONSE._serialized_start = 228
    _FORCEMATRIXSERVICEREADMATRIXRESPONSE._serialized_end = 322
    _FORCEMATRIXSERVICEDETECTSLIPREQUEST._serialized_start = 324
    _FORCEMATRIXSERVICEDETECTSLIPREQUEST._serialized_end = 381
    _FORCEMATRIXSERVICEDETECTSLIPRESPONSE._serialized_start = 383
    _FORCEMATRIXSERVICEDETECTSLIPRESPONSE._serialized_end = 458
    _FORCEMATRIXSERVICE._serialized_start = 461
    _FORCEMATRIXSERVICE._serialized_end = 873