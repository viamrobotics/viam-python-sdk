...
if _descriptor._USE_C_DESCRIPTORS == False:
    ...
    _STATUS._serialized_end = 327
    _SERVOSERVICE._serialized_start = 330
    _SERVOSERVICE._serialized_end = 661