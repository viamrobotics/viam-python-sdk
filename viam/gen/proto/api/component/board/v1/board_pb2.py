...
PWMResponse = _reflection.GeneratedProtocolMessageType('PWMResponse', (_message.Message,), {'DESCRIPTOR': _PWMRESPONSE, '__module__': 'proto.api.component.board.v1.board_pb2', '__doc__': 'Attributes:\n      duty_cycle_pct:\n           0-1\n  '})
_sym_db.RegisterMessage(PWMResponse)
SetPWMRequest = _reflection.GeneratedProtocolMessageType('SetPWMRequest', (_message.Message,), {'DESCRIPTOR': _SETPWMREQUEST, '__module__': 'proto.api.component.board.v1.board_pb2', '__doc__': 'Attributes:\n      duty_cycle_pct:\n          0-1\n  '})
