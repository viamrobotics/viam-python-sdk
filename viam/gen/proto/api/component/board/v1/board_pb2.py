...
StatusRequest = _reflection.GeneratedProtocolMessageType('StatusRequest', (_message.Message,), {
                                                         'DESCRIPTOR': _STATUSREQUEST, '__module__': 'proto.api.component.board.v1.board_pb2'})
_sym_db.RegisterMessage(StatusRequest)
StatusResponse = _reflection.GeneratedProtocolMessageType('StatusResponse', (_message.Message,), {
                                                          'DESCRIPTOR': _STATUSRESPONSE, '__module__': 'proto.api.component.board.v1.board_pb2'})
_sym_db.RegisterMessage(StatusResponse)
SetGPIORequest = _reflection.GeneratedProtocolMessageType('SetGPIORequest', (_message.Message,), {
                                                          'DESCRIPTOR': _SETGPIOREQUEST, '__module__': 'proto.api.component.board.v1.board_pb2'})
_sym_db.RegisterMessage(SetGPIORequest)
SetGPIOResponse = _reflection.GeneratedProtocolMessageType('SetGPIOResponse', (_message.Message,), {
                                                           'DESCRIPTOR': _SETGPIORESPONSE, '__module__': 'proto.api.component.board.v1.board_pb2'})
_sym_db.RegisterMessage(SetGPIOResponse)
GetGPIORequest = _reflection.GeneratedProtocolMessageType('GetGPIORequest', (_message.Message,), {
                                                          'DESCRIPTOR': _GETGPIOREQUEST, '__module__': 'proto.api.component.board.v1.board_pb2'})
_sym_db.RegisterMessage(GetGPIORequest)
GetGPIOResponse = _reflection.GeneratedProtocolMessageType('GetGPIOResponse', (_message.Message,), {
                                                           'DESCRIPTOR': _GETGPIORESPONSE, '__module__': 'proto.api.component.board.v1.board_pb2'})
_sym_db.RegisterMessage(GetGPIOResponse)
PWMRequest = _reflection.GeneratedProtocolMessageType('PWMRequest', (_message.Message,), {
                                                      'DESCRIPTOR': _PWMREQUEST, '__module__': 'proto.api.component.board.v1.board_pb2'})
_sym_db.RegisterMessage(PWMRequest)
PWMResponse = _reflection.GeneratedProtocolMessageType('PWMResponse', (_message.Message,), {
                                                       'DESCRIPTOR': _PWMRESPONSE, '__module__': 'proto.api.component.board.v1.board_pb2', '__doc__': 'Attributes:\n      duty_cycle_pct:\n           0-1\n  '})
_sym_db.RegisterMessage(PWMResponse)
SetPWMRequest = _reflection.GeneratedProtocolMessageType('SetPWMRequest', (_message.Message,), {
                                                         'DESCRIPTOR': _SETPWMREQUEST, '__module__': 'proto.api.component.board.v1.board_pb2', '__doc__': 'Attributes:\n      duty_cycle_pct:\n          0-1\n  '})
_sym_db.RegisterMessage(SetPWMRequest)
SetPWMResponse = _reflection.GeneratedProtocolMessageType('SetPWMResponse', (_message.Message,), {
                                                          'DESCRIPTOR': _SETPWMRESPONSE, '__module__': 'proto.api.component.board.v1.board_pb2'})
_sym_db.RegisterMessage(SetPWMResponse)
PWMFrequencyRequest = _reflection.GeneratedProtocolMessageType('PWMFrequencyRequest', (_message.Message,), {
                                                               'DESCRIPTOR': _PWMFREQUENCYREQUEST, '__module__': 'proto.api.component.board.v1.board_pb2'})
_sym_db.RegisterMessage(PWMFrequencyRequest)
PWMFrequencyResponse = _reflection.GeneratedProtocolMessageType('PWMFrequencyResponse', (_message.Message,), {
                                                                'DESCRIPTOR': _PWMFREQUENCYRESPONSE, '__module__': 'proto.api.component.board.v1.board_pb2'})
_sym_db.RegisterMessage(PWMFrequencyResponse)
SetPWMFrequencyRequest = _reflection.GeneratedProtocolMessageType('SetPWMFrequencyRequest', (_message.Message,), {
                                                                  'DESCRIPTOR': _SETPWMFREQUENCYREQUEST, '__module__': 'proto.api.component.board.v1.board_pb2'})
_sym_db.RegisterMessage(SetPWMFrequencyRequest)
SetPWMFrequencyResponse = _reflection.GeneratedProtocolMessageType('SetPWMFrequencyResponse', (_message.Message,), {
                                                                   'DESCRIPTOR': _SETPWMFREQUENCYRESPONSE, '__module__': 'proto.api.component.board.v1.board_pb2'})
_sym_db.RegisterMessage(SetPWMFrequencyResponse)
ReadAnalogReaderRequest = _reflection.GeneratedProtocolMessageType('ReadAnalogReaderRequest', (_message.Message,), {
                                                                   'DESCRIPTOR': _READANALOGREADERREQUEST, '__module__': 'proto.api.component.board.v1.board_pb2'})
_sym_db.RegisterMessage(ReadAnalogReaderRequest)
ReadAnalogReaderResponse = _reflection.GeneratedProtocolMessageType('ReadAnalogReaderResponse', (_message.Message,), {
                                                                    'DESCRIPTOR': _READANALOGREADERRESPONSE, '__module__': 'proto.api.component.board.v1.board_pb2'})
_sym_db.RegisterMessage(ReadAnalogReaderResponse)
GetDigitalInterruptValueRequest = _reflection.GeneratedProtocolMessageType('GetDigitalInterruptValueRequest', (_message.Message,), {
                                                                           'DESCRIPTOR': _GETDIGITALINTERRUPTVALUEREQUEST, '__module__': 'proto.api.component.board.v1.board_pb2'})
_sym_db.RegisterMessage(GetDigitalInterruptValueRequest)
GetDigitalInterruptValueResponse = _reflection.GeneratedProtocolMessageType('GetDigitalInterruptValueResponse', (_message.Message,), {
                                                                            'DESCRIPTOR': _GETDIGITALINTERRUPTVALUERESPONSE, '__module__': 'proto.api.component.board.v1.board_pb2'})
...
if _descriptor._USE_C_DESCRIPTORS == False:
    ...
    _BOARDSERVICE.methods_by_name[
        'PWMFrequency']._serialized_options = b'\x82\xd3\xe4\x93\x02.\x12,/viam/api/v1/component/board/{name}/pwm_freq'
    _BOARDSERVICE.methods_by_name['SetPWMFrequency']._options = None
    _BOARDSERVICE.methods_by_name[
        'SetPWMFrequency']._serialized_options = b'\x82\xd3\xe4\x93\x02.\x1a,/viam/api/v1/component/board/{name}/pwm_freq'
    _BOARDSERVICE.methods_by_name['ReadAnalogReader']._options = None
    _BOARDSERVICE.methods_by_name[
        'ReadAnalogReader']._serialized_options = b'\x82\xd3\xe4\x93\x02S\x12Q/viam/api/v1/component/board/{board_name}/analog_reader/{analog_reader_name}/read'
    _BOARDSERVICE.methods_by_name['GetDigitalInterruptValue']._options = None
    _BOARDSERVICE.methods_by_name[
        'GetDigitalInterruptValue']._serialized_options = b'\x82\xd3\xe4\x93\x02\\\x12Z/viam/api/v1/component/board/{board_name}/digital_interrupt/{digital_interrupt_name}/value'
