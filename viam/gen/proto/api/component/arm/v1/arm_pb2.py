...
GetEndPositionRequest = _reflection.GeneratedProtocolMessageType('GetEndPositionRequest', (_message.Message,), {'DESCRIPTOR': _GETENDPOSITIONREQUEST, '__module__': 'proto.api.component.arm.v1.arm_pb2', '__doc__': 'Attributes:\n      name:\n          Name of an arm\n  '})
_sym_db.RegisterMessage(GetEndPositionRequest)
GetEndPositionResponse = _reflection.GeneratedProtocolMessageType('GetEndPositionResponse', (_message.Message,), {'DESCRIPTOR': _GETENDPOSITIONRESPONSE, '__module__': 'proto.api.component.arm.v1.arm_pb2', '__doc__': 'Attributes:\n      pose:\n          Returns 6d pose of the end effector relative to the base,\n          represented by X,Y,Z coordinates which express millimeters and\n          theta, ox, oy, oz coordinates which express an orientation\n          vector\n  '})
_sym_db.RegisterMessage(GetEndPositionResponse)
JointPositions = _reflection.GeneratedProtocolMessageType('JointPositions', (_message.Message,), {'DESCRIPTOR': _JOINTPOSITIONS, '__module__': 'proto.api.component.arm.v1.arm_pb2', '__doc__': 'Attributes:\n      degrees:\n          A list of joint positions represented in degrees The numbers\n          are ordered spatially from the base toward the end effector\n          This is used in GetJointPositionsResponse and\n          MoveToJointPositionsRequest\n  '})
_sym_db.RegisterMessage(JointPositions)
GetJointPositionsRequest = _reflection.GeneratedProtocolMessageType('GetJointPositionsRequest', (_message.Message,), {'DESCRIPTOR': _GETJOINTPOSITIONSREQUEST, '__module__': 'proto.api.component.arm.v1.arm_pb2', '__doc__': 'Attributes:\n      name:\n          Name of an arm\n  '})
_sym_db.RegisterMessage(GetJointPositionsRequest)
GetJointPositionsResponse = _reflection.GeneratedProtocolMessageType('GetJointPositionsResponse', (_message.Message,), {'DESCRIPTOR': _GETJOINTPOSITIONSRESPONSE, '__module__': 'proto.api.component.arm.v1.arm_pb2', '__doc__': 'Attributes:\n      position_degs:\n          a list JointPositions\n  '})
_sym_db.RegisterMessage(GetJointPositionsResponse)
MoveToPositionRequest = _reflection.GeneratedProtocolMessageType('MoveToPositionRequest', (_message.Message,), {'DESCRIPTOR': _MOVETOPOSITIONREQUEST, '__module__': 'proto.api.component.arm.v1.arm_pb2', '__doc__': 'Attributes:\n      name:\n          Name of an arm\n  '})
...
MoveToJointPositionsRequest = _reflection.GeneratedProtocolMessageType('MoveToJointPositionsRequest', (_message.Message,), {'DESCRIPTOR': _MOVETOJOINTPOSITIONSREQUEST, '__module__': 'proto.api.component.arm.v1.arm_pb2', '__doc__': 'Attributes:\n      name:\n          Name of an arm\n      position_degs:\n          A list of joint positions represented in degrees There should\n          be 1 entry in the list per joint, ordered spatially from the\n          base toward the end effector\n  '})
...
StopRequest = _reflection.GeneratedProtocolMessageType('StopRequest', (_message.Message,), {'DESCRIPTOR': _STOPREQUEST, '__module__': 'proto.api.component.arm.v1.arm_pb2', '__doc__': 'Attributes:\n      name:\n          Name of an arm\n  '})
