...
if _descriptor._USE_C_DESCRIPTORS == False:
    ...
    _POSETRACKERSERVICE.methods_by_name['GetPoses']._serialized_options = b'\x82\xd3\xe4\x93\x02-\x12+/api/v1/component/pose_tracker/{name}/poses'
    ...
    _POSETRACKERSERVICE._serialized_end = 668