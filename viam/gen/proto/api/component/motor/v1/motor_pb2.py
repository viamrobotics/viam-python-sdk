...
DESCRIPTOR = _descriptor_pool.Default().AddSerializedFile(b'\n(proto/api/component/motor/v1/motor.proto\x12\x1cproto.api.component.motor.v1\x1a\x1cgoogle/protobuf/struct.proto\x1a\x1cgoogle/api/annotations.proto"B\n\x0fSetPowerRequest\x12\x12\n\x04name\x18\x01 \x01(\tR\x04name\x12\x1b\n\tpower_pct\x18\x02 \x01(\x01R\x08powerPct"\x12\n\x10SetPowerResponse"V\n\x0cGoForRequest\x12\x12\n\x04name\x18\x01 \x01(\tR\x04name\x12\x10\n\x03rpm\x18\x02 \x01(\x01R\x03rpm\x12 \n\x0brevolutions\x18\x03 \x01(\x01R\x0brevolutions"\x0f\n\rGoForResponse"f\n\x0bGoToRequest\x12\x12\n\x04name\x18\x01 \x01(\tR\x04name\x12\x10\n\x03rpm\x18\x02 \x01(\x01R\x03rpm\x121\n\x14position_revolutions\x18\x03 \x01(\x01R\x13positionRevolutions"\x0e\n\x0cGoToResponse"F\n\x18ResetZeroPositionRequest\x12\x12\n\x04name\x18\x01 \x01(\tR\x04name\x12\x16\n\x06offset\x18\x02 \x01(\x01R\x06offset"\x1b\n\x19ResetZeroPositionResponse"(\n\x12GetPositionRequest\x12\x12\n\x04name\x18\x01 \x01(\tR\x04name"1\n\x13GetPositionResponse\x12\x1a\n\x08position\x18\x01 \x01(\x01R\x08position"!\n\x0bStopRequest\x12\x12\n\x04name\x18\x01 \x01(\tR\x04name"\x0e\n\x0cStopResponse"&\n\x10IsPoweredRequest\x12\x12\n\x04name\x18\x01 \x01(\tR\x04name"(\n\x11IsPoweredResponse\x12\x13\n\x05is_on\x18\x01 \x01(\x08R\x04isOn"(\n\x12GetFeaturesRequest\x12\x12\n\x04name\x18\x01 \x01(\tR\x04name"D\n\x13GetFeaturesResponse\x12-\n\x12position_reporting\x18\x01 \x01(\x08R\x11positionReporting2\xf4\t\n\x0cMotorService\x12\x97\x01\n\x08SetPower\x12-.proto.api.component.motor.v1.SetPowerRequest\x1a..proto.api.component.motor.v1.SetPowerResponse",\x82\xd3\xe4\x93\x02&\x1a$/api/v1/component/motor/{name}/power\x12\x8f\x01\n\x05GoFor\x12*.proto.api.component.motor.v1.GoForRequest\x1a+.proto.api.component.motor.v1.GoForResponse"-\x82\xd3\xe4\x93\x02\'\x1a%/api/v1/component/motor/{name}/go_for\x12\x8b\x01\n\x04GoTo\x12).proto.api.component.motor.v1.GoToRequest\x1a*.proto.api.component.motor.v1.GoToResponse",\x82\xd3\xe4\x93\x02&\x1a$/api/v1/component/motor/{name}/go_to\x12\xb1\x01\n\x11ResetZeroPosition\x126.proto.api.component.motor.v1.ResetZeroPositionRequest\x1a7.proto.api.component.motor.v1.ResetZeroPositionResponse"+\x82\xd3\xe4\x93\x02%\x1a#/api/v1/component/motor/{name}/zero\x12\xa3\x01\n\x0bGetPosition\x120.proto.api.component.motor.v1.GetPositionRequest\x1a1.proto.api.component.motor.v1.GetPositionResponse"/\x82\xd3\xe4\x93\x02)\x12\'/api/v1/component/motor/{name}/position\x12\xa3\x01\n\x0bGetFeatures\x120.proto.api.component.motor.v1.GetFeaturesRequest\x1a1.proto.api.component.motor.v1.GetFeaturesResponse"/\x82\xd3\xe4\x93\x02)\x12\'/api/v1/component/motor/{name}/features\x12\x8a\x01\n\x04Stop\x12).proto.api.component.motor.v1.StopRequest\x1a*.proto.api.component.motor.v1.StopResponse"+\x82\xd3\xe4\x93\x02%\x1a#/api/v1/component/motor/{name}/stop\x12\x9c\x01\n\tIsPowered\x12..proto.api.component.motor.v1.IsPoweredRequest\x1a/.proto.api.component.motor.v1.IsPoweredResponse".\x82\xd3\xe4\x93\x02(\x12&/api/v1/component/motor/{name}/poweredBM\n#com.viam.rdk.proto.api.component.v1Z&go.viam.com/rdk/proto/api/component/v1b\x06proto3')
...
SetPowerRequest = _reflection.GeneratedProtocolMessageType('SetPowerRequest', (_message.Message,), {'DESCRIPTOR': _SETPOWERREQUEST, '__module__': 'proto.api.component.motor.v1.motor_pb2'})
...
GoForRequest = _reflection.GeneratedProtocolMessageType('GoForRequest', (_message.Message,), {'DESCRIPTOR': _GOFORREQUEST, '__module__': 'proto.api.component.motor.v1.motor_pb2'})
...
GoToRequest = _reflection.GeneratedProtocolMessageType('GoToRequest', (_message.Message,), {'DESCRIPTOR': _GOTOREQUEST, '__module__': 'proto.api.component.motor.v1.motor_pb2'})
...
ResetZeroPositionRequest = _reflection.GeneratedProtocolMessageType('ResetZeroPositionRequest', (_message.Message,), {'DESCRIPTOR': _RESETZEROPOSITIONREQUEST, '__module__': 'proto.api.component.motor.v1.motor_pb2'})
...
GetPositionRequest = _reflection.GeneratedProtocolMessageType('GetPositionRequest', (_message.Message,), {'DESCRIPTOR': _GETPOSITIONREQUEST, '__module__': 'proto.api.component.motor.v1.motor_pb2'})
_sym_db.RegisterMessage(GetPositionRequest)
GetPositionResponse = _reflection.GeneratedProtocolMessageType('GetPositionResponse', (_message.Message,), {'DESCRIPTOR': _GETPOSITIONRESPONSE, '__module__': 'proto.api.component.motor.v1.motor_pb2'})
_sym_db.RegisterMessage(GetPositionResponse)
StopRequest = _reflection.GeneratedProtocolMessageType('StopRequest', (_message.Message,), {'DESCRIPTOR': _STOPREQUEST, '__module__': 'proto.api.component.motor.v1.motor_pb2'})
...
IsPoweredRequest = _reflection.GeneratedProtocolMessageType('IsPoweredRequest', (_message.Message,), {'DESCRIPTOR': _ISPOWEREDREQUEST, '__module__': 'proto.api.component.motor.v1.motor_pb2'})
_sym_db.RegisterMessage(IsPoweredRequest)
IsPoweredResponse = _reflection.GeneratedProtocolMessageType('IsPoweredResponse', (_message.Message,), {'DESCRIPTOR': _ISPOWEREDRESPONSE, '__module__': 'proto.api.component.motor.v1.motor_pb2'})
_sym_db.RegisterMessage(IsPoweredResponse)
GetFeaturesRequest = _reflection.GeneratedProtocolMessageType('GetFeaturesRequest', (_message.Message,), {'DESCRIPTOR': _GETFEATURESREQUEST, '__module__': 'proto.api.component.motor.v1.motor_pb2'})
_sym_db.RegisterMessage(GetFeaturesRequest)
GetFeaturesResponse = _reflection.GeneratedProtocolMessageType('GetFeaturesResponse', (_message.Message,), {'DESCRIPTOR': _GETFEATURESRESPONSE, '__module__': 'proto.api.component.motor.v1.motor_pb2'})
...
if _descriptor._USE_C_DESCRIPTORS == False:
    ...
    _MOTORSERVICE._serialized_start = 887
    _MOTORSERVICE._serialized_end = 2155