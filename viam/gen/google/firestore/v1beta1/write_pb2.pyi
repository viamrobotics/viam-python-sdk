...
class Write(google.protobuf.message.Message):
    ...
    @property
    def update(self) -> google.firestore.v1beta1.document_pb2.Document:
        """A document to write."""
        pass
    delete: typing.Text = ...
    ...
    def __init__(self,
        *,
        update : typing.Optional[google.firestore.v1beta1.document_pb2.Document] = ...,
        delete : typing.Text = ...,
...
class DocumentTransform(google.protobuf.message.Message):
    ...
    class FieldTransform(google.protobuf.message.Message):
        ...
        @property
        def increment(self) -> google.firestore.v1beta1.document_pb2.Value:
            ...
            pass
        @property
        def maximum(self) -> google.firestore.v1beta1.document_pb2.Value:
            ...
            pass
        @property
        def minimum(self) -> google.firestore.v1beta1.document_pb2.Value:
            ...
            pass
        @property
        def append_missing_elements(self) -> google.firestore.v1beta1.document_pb2.ArrayValue:
            ...
            pass
        @property
        def remove_all_from_array(self) -> google.firestore.v1beta1.document_pb2.ArrayValue:
        ...
        def __init__(self,
            *,
            field_path : typing.Text = ...,
            set_to_server_value : global___DocumentTransform.FieldTransform.ServerValue.ValueType = ...,
            increment : typing.Optional[google.firestore.v1beta1.document_pb2.Value] = ...,
            maximum : typing.Optional[google.firestore.v1beta1.document_pb2.Value] = ...,
            minimum : typing.Optional[google.firestore.v1beta1.document_pb2.Value] = ...,
            append_missing_elements : typing.Optional[google.firestore.v1beta1.document_pb2.ArrayValue] = ...,
            remove_all_from_array : typing.Optional[google.firestore.v1beta1.document_pb2.ArrayValue] = ...,
            ) -> None: ...
...
class WriteResult(google.protobuf.message.Message):
    ...
    def update_time(self) -> google.protobuf.timestamp_pb2.Timestamp:
        ...
        pass
    @property
    def transform_results(self) -> google.protobuf.internal.containers.RepeatedCompositeFieldContainer[google.firestore.v1beta1.document_pb2.Value]:
    ...
    def __init__(self,
        *,
        ...
        transform_results : typing.Optional[typing.Iterable[google.firestore.v1beta1.document_pb2.Value]] = ...,
        ) -> None: ...
