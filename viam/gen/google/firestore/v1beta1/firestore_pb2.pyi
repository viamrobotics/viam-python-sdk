...
class GetDocumentRequest(google.protobuf.message.Message):
    ...
    @property
    def mask(self) -> google.firestore.v1beta1.common_pb2.DocumentMask:
    ...
    def __init__(self,
        *,
        name : typing.Text = ...,
        mask : typing.Optional[google.firestore.v1beta1.common_pb2.DocumentMask] = ...,
        transaction : builtins.bytes = ...,
...
class ListDocumentsResponse(google.protobuf.message.Message):
    ...
    @property
    def documents(self) -> google.protobuf.internal.containers.RepeatedCompositeFieldContainer[google.firestore.v1beta1.document_pb2.Document]:
        """The Documents found."""
        pass
    ...
    def __init__(self,
        *,
        documents : typing.Optional[typing.Iterable[google.firestore.v1beta1.document_pb2.Document]] = ...,
        next_page_token : typing.Text = ...,
        ) -> None: ...
...
class CreateDocumentRequest(google.protobuf.message.Message):
    ...
    @property
    def document(self) -> google.firestore.v1beta1.document_pb2.Document:
    ...
    def __init__(self,
        *,
        ...
        collection_id : typing.Text = ...,
        document_id : typing.Text = ...,
        document : typing.Optional[google.firestore.v1beta1.document_pb2.Document] = ...,
        mask : typing.Optional[google.firestore.v1beta1.common_pb2.DocumentMask] = ...,
        ) -> None: ...
...
class UpdateDocumentRequest(google.protobuf.message.Message):
    ...
    def document(self) -> google.firestore.v1beta1.document_pb2.Document:
        ...
        pass
    @property
    def update_mask(self) -> google.firestore.v1beta1.common_pb2.DocumentMask:
    ...
    def mask(self) -> google.firestore.v1beta1.common_pb2.DocumentMask:
        ...
        pass
    @property
    def current_document(self) -> google.firestore.v1beta1.common_pb2.Precondition:
    ...
    def __init__(self,
        *,
        document : typing.Optional[google.firestore.v1beta1.document_pb2.Document] = ...,
        update_mask : typing.Optional[google.firestore.v1beta1.common_pb2.DocumentMask] = ...,
        mask : typing.Optional[google.firestore.v1beta1.common_pb2.DocumentMask] = ...,
        current_document : typing.Optional[google.firestore.v1beta1.common_pb2.Precondition] = ...,
        ) -> None: ...
...
class BatchGetDocumentsRequest(google.protobuf.message.Message):
    ...
    @property
    def new_transaction(self) -> google.firestore.v1beta1.common_pb2.TransactionOptions:
    ...
    def __init__(self,
        *,
        ...
        mask : typing.Optional[google.firestore.v1beta1.common_pb2.DocumentMask] = ...,
        transaction : builtins.bytes = ...,
        new_transaction : typing.Optional[google.firestore.v1beta1.common_pb2.TransactionOptions] = ...,
        read_time : typing.Optional[google.protobuf.timestamp_pb2.Timestamp] = ...,
        ) -> None: ...
...
class BatchGetDocumentsResponse(google.protobuf.message.Message):
    ...
    READ_TIME_FIELD_NUMBER: builtins.int
    @property
    def found(self) -> google.firestore.v1beta1.document_pb2.Document:
    ...
    def __init__(self,
        *,
        found : typing.Optional[google.firestore.v1beta1.document_pb2.Document] = ...,
        missing : typing.Text = ...,
        transaction : builtins.bytes = ...,
        read_time : typing.Optional[google.protobuf.timestamp_pb2.Timestamp] = ...,
        ) -> None: ...
...
class BeginTransactionRequest(google.protobuf.message.Message):
    ...
    @property
    def options(self) -> google.firestore.v1beta1.common_pb2.TransactionOptions:
    ...
    def __init__(self,
        *,
        database : typing.Text = ...,
        options : typing.Optional[google.firestore.v1beta1.common_pb2.TransactionOptions] = ...,
        ) -> None: ...
...
class CommitRequest(google.protobuf.message.Message):
    ...
    @property
    def writes(self) -> google.protobuf.internal.containers.RepeatedCompositeFieldContainer[google.firestore.v1beta1.write_pb2.Write]:
        """The writes to apply.
    ...
    def __init__(self,
        *,
        database : typing.Text = ...,
        writes : typing.Optional[typing.Iterable[google.firestore.v1beta1.write_pb2.Write]] = ...,
        transaction : builtins.bytes = ...,
        ) -> None: ...
...
class CommitResponse(google.protobuf.message.Message):
    ...
    @property
    def write_results(self) -> google.protobuf.internal.containers.RepeatedCompositeFieldContainer[google.firestore.v1beta1.write_pb2.WriteResult]:
    ...
    def __init__(self,
        *,
        write_results : typing.Optional[typing.Iterable[google.firestore.v1beta1.write_pb2.WriteResult]] = ...,
...
class RunQueryRequest(google.protobuf.message.Message):
    ...
    @property
    def structured_query(self) -> google.firestore.v1beta1.query_pb2.StructuredQuery:
        """A structured query."""
        pass
    transaction: builtins.bytes = ...
    """Reads documents in a transaction."""
    ...
    def __init__(self,
        *,
        parent : typing.Text = ...,
        structured_query : typing.Optional[google.firestore.v1beta1.query_pb2.StructuredQuery] = ...,
        transaction : builtins.bytes = ...,
        new_transaction : typing.Optional[google.firestore.v1beta1.common_pb2.TransactionOptions] = ...,
        read_time : typing.Optional[google.protobuf.timestamp_pb2.Timestamp] = ...,
        ) -> None: ...
...
class PartitionQueryResponse(google.protobuf.message.Message):
    ...
    NEXT_PAGE_TOKEN_FIELD_NUMBER: builtins.int
    @property
    def partitions(self) -> google.protobuf.internal.containers.RepeatedCompositeFieldContainer[google.firestore.v1beta1.query_pb2.Cursor]:
        """Partition results.
    ...
    def __init__(self,
        *,
        partitions : typing.Optional[typing.Iterable[google.firestore.v1beta1.query_pb2.Cursor]] = ...,
        next_page_token : typing.Text = ...,
        ) -> None: ...
...
class ListenResponse(google.protobuf.message.Message):
    ...
    def target_change(self) -> global___TargetChange:
        ...
        pass
    @property
    def document_change(self) -> google.firestore.v1beta1.write_pb2.DocumentChange:
        """A [Document][google.firestore.v1beta1.Document] has changed."""
        pass
    @property
    def document_delete(self) -> google.firestore.v1beta1.write_pb2.DocumentDelete:
        """A [Document][google.firestore.v1beta1.Document] has been deleted."""
        pass
    @property
    def document_remove(self) -> google.firestore.v1beta1.write_pb2.DocumentRemove:
        """A [Document][google.firestore.v1beta1.Document] has been removed from a target (because it is no longer
        relevant to that target).
        """
        pass
    @property
    def filter(self) -> google.firestore.v1beta1.write_pb2.ExistenceFilter:
    ...
    def __init__(self,
        *,
        ...
        document_change : typing.Optional[google.firestore.v1beta1.write_pb2.DocumentChange] = ...,
        document_delete : typing.Optional[google.firestore.v1beta1.write_pb2.DocumentDelete] = ...,
        document_remove : typing.Optional[google.firestore.v1beta1.write_pb2.DocumentRemove] = ...,
        filter : typing.Optional[google.firestore.v1beta1.write_pb2.ExistenceFilter] = ...,
        ) -> None: ...
