...
import google.ads.googleads.v7.enums.reach_plan_ad_length_pb2
import google.ads.googleads.v7.enums.reach_plan_age_range_pb2
import google.ads.googleads.v7.enums.reach_plan_network_pb2
...
class PlannableLocation(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing_extensions.Literal["_id",b"_id","_name",b"_name","_parent_country_id",b"_parent_country_id","id",b"id","name",b"name","parent_country_id",b"parent_country_id"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["_id",b"_id","_name",b"_name","_parent_country_id",b"_parent_country_id","id",b"id","name",b"name","parent_country_id",b"parent_country_id"]) -> None: ...
    @typing.overload
...
class PlannableTargeting(google.protobuf.message.Message):
    ...
    @property
    def age_ranges(self) -> google.protobuf.internal.containers.RepeatedScalarFieldContainer[google.ads.googleads.v7.enums.reach_plan_age_range_pb2.ReachPlanAgeRangeEnum.ReachPlanAgeRange.ValueType]:
        ...
        pass
    @property
    def genders(self) -> google.protobuf.internal.containers.RepeatedCompositeFieldContainer[google.ads.googleads.v7.common.criteria_pb2.GenderInfo]:
        """Targetable genders for the ad product."""
        pass
    @property
    def devices(self) -> google.protobuf.internal.containers.RepeatedCompositeFieldContainer[google.ads.googleads.v7.common.criteria_pb2.DeviceInfo]:
        ...
        pass
    @property
    def networks(self) -> google.protobuf.internal.containers.RepeatedScalarFieldContainer[google.ads.googleads.v7.enums.reach_plan_network_pb2.ReachPlanNetworkEnum.ReachPlanNetwork.ValueType]:
        """Targetable networks for the ad product."""
        pass
    def __init__(self,
        *,
        age_ranges : typing.Optional[typing.Iterable[google.ads.googleads.v7.enums.reach_plan_age_range_pb2.ReachPlanAgeRangeEnum.ReachPlanAgeRange.ValueType]] = ...,
        genders : typing.Optional[typing.Iterable[google.ads.googleads.v7.common.criteria_pb2.GenderInfo]] = ...,
        devices : typing.Optional[typing.Iterable[google.ads.googleads.v7.common.criteria_pb2.DeviceInfo]] = ...,
        networks : typing.Optional[typing.Iterable[google.ads.googleads.v7.enums.reach_plan_network_pb2.ReachPlanNetworkEnum.ReachPlanNetwork.ValueType]] = ...,
        ) -> None: ...
...
class Preferences(google.protobuf.message.Message):
    ...
    ad_length: google.ads.googleads.v7.enums.reach_plan_ad_length_pb2.ReachPlanAdLengthEnum.ReachPlanAdLength.ValueType = ...
...
class GenerateReachForecastRequest(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing_extensions.Literal["_cookie_frequency_cap",b"_cookie_frequency_cap","_currency_code",b"_currency_code","_min_effective_frequency",b"_min_effective_frequency","campaign_duration",b"campaign_duration","cookie_frequency_cap",b"cookie_frequency_cap","cookie_frequency_cap_setting",b"cookie_frequency_cap_setting","currency_code",b"currency_code","min_effective_frequency",b"min_effective_frequency","targeting",b"targeting"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["_cookie_frequency_cap",b"_cookie_frequency_cap","_currency_code",b"_currency_code","_min_effective_frequency",b"_min_effective_frequency","campaign_duration",b"campaign_duration","cookie_frequency_cap",b"cookie_frequency_cap","cookie_frequency_cap_setting",b"cookie_frequency_cap_setting","currency_code",b"currency_code","customer_id",b"customer_id","min_effective_frequency",b"min_effective_frequency","planned_products",b"planned_products","targeting",b"targeting"]) -> None: ...
    @typing.overload
...
class Targeting(google.protobuf.message.Message):
    ...
    age_range: google.ads.googleads.v7.enums.reach_plan_age_range_pb2.ReachPlanAgeRangeEnum.ReachPlanAgeRange.ValueType = ...
    """Targeted age range.
    ...
    def devices(self) -> google.protobuf.internal.containers.RepeatedCompositeFieldContainer[google.ads.googleads.v7.common.criteria_pb2.DeviceInfo]:
        ...
        """
        pass
    network: google.ads.googleads.v7.enums.reach_plan_network_pb2.ReachPlanNetworkEnum.ReachPlanNetwork.ValueType = ...
...
class CampaignDuration(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing_extensions.Literal["_duration_in_days",b"_duration_in_days","duration_in_days",b"duration_in_days"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["_duration_in_days",b"_duration_in_days","duration_in_days",b"duration_in_days"]) -> None: ...
...
class Forecast(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing_extensions.Literal["_on_target_impressions",b"_on_target_impressions","_on_target_reach",b"_on_target_reach","_total_impressions",b"_total_impressions","_total_reach",b"_total_reach","_viewable_impressions",b"_viewable_impressions","on_target_impressions",b"on_target_impressions","on_target_reach",b"on_target_reach","total_impressions",b"total_impressions","total_reach",b"total_reach","viewable_impressions",b"viewable_impressions"]) -> None: ...
    @typing.overload
