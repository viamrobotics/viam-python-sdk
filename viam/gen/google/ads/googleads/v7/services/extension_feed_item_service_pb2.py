...
if _descriptor._USE_C_DESCRIPTORS == False:
  ...
  _EXTENSIONFEEDITEMSERVICE.methods_by_name['GetExtensionFeedItem']._serialized_options = b'\332A\rresource_name\202\323\344\223\0026\0224/v7/{resource_name=customers/*/extensionFeedItems/*}'
  _EXTENSIONFEEDITEMSERVICE.methods_by_name['MutateExtensionFeedItems']._options = None
  _EXTENSIONFEEDITEMSERVICE.methods_by_name['MutateExtensionFeedItems']._serialized_options = b'\332A\026customer_id,operations\202\323\344\223\002<\"7/v7/customers/{customer_id=*}/extensionFeedItems:mutate:\001*'
