...
class BatchJobOperation(google.protobuf.message.Message):
    ...
    @property
    def create(self) -> google.ads.googleads.v7.resources.batch_job_pb2.BatchJob:
        """Create operation: No resource name is expected for the new batch job."""
        pass
    def __init__(self,
        *,
        create : typing.Optional[google.ads.googleads.v7.resources.batch_job_pb2.BatchJob] = ...,
        ) -> None: ...
...
class AddBatchJobOperationsRequest(google.protobuf.message.Message):
    ...
    @property
    def mutate_operations(self) -> google.protobuf.internal.containers.RepeatedCompositeFieldContainer[google.ads.googleads.v7.services.google_ads_service_pb2.MutateOperation]:
    ...
    def __init__(self,
        *,
        resource_name : typing.Text = ...,
        sequence_token : typing.Text = ...,
        mutate_operations : typing.Optional[typing.Iterable[google.ads.googleads.v7.services.google_ads_service_pb2.MutateOperation]] = ...,
        ) -> None: ...
...
class BatchJobResult(google.protobuf.message.Message):
    ...
    @property
    def mutate_operation_response(self) -> google.ads.googleads.v7.services.google_ads_service_pb2.MutateOperationResponse:
    ...
    def __init__(self,
        *,
        operation_index : builtins.int = ...,
        mutate_operation_response : typing.Optional[google.ads.googleads.v7.services.google_ads_service_pb2.MutateOperationResponse] = ...,
