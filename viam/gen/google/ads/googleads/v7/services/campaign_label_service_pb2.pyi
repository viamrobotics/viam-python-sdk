...
class MutateCampaignLabelsRequest(google.protobuf.message.Message):
    ...
    @property
    def operations(self) -> google.protobuf.internal.containers.RepeatedCompositeFieldContainer[global___CampaignLabelOperation]:
    ...
    def __init__(self,
        *,
        customer_id : typing.Text = ...,
        operations : typing.Optional[typing.Iterable[global___CampaignLabelOperation]] = ...,
        partial_failure : builtins.bool = ...,
        validate_only : builtins.bool = ...,
        ) -> None: ...
...
class CampaignLabelOperation(google.protobuf.message.Message):
    ...
    @property
    def create(self) -> google.ads.googleads.v7.resources.campaign_label_pb2.CampaignLabel:
    ...
    def __init__(self,
        *,
        create : typing.Optional[google.ads.googleads.v7.resources.campaign_label_pb2.CampaignLabel] = ...,
        remove : typing.Text = ...,
        ) -> None: ...
...
class MutateCampaignLabelsResponse(google.protobuf.message.Message):
    ...
    def partial_failure_error(self) -> google.rpc.status_pb2.Status:
        ...
        pass
    @property
    def results(self) -> google.protobuf.internal.containers.RepeatedCompositeFieldContainer[global___MutateCampaignLabelResult]:
        """All results for the mutate."""
        pass
    def __init__(self,
        *,
        partial_failure_error : typing.Optional[google.rpc.status_pb2.Status] = ...,
        results : typing.Optional[typing.Iterable[global___MutateCampaignLabelResult]] = ...,
        ) -> None: ...
