...
class MutateKeywordPlanCampaignsRequest(google.protobuf.message.Message):
    ...
    @property
    def operations(self) -> google.protobuf.internal.containers.RepeatedCompositeFieldContainer[global___KeywordPlanCampaignOperation]:
    ...
    def __init__(self,
        *,
        customer_id : typing.Text = ...,
        operations : typing.Optional[typing.Iterable[global___KeywordPlanCampaignOperation]] = ...,
        partial_failure : builtins.bool = ...,
        validate_only : builtins.bool = ...,
        ) -> None: ...
...
class KeywordPlanCampaignOperation(google.protobuf.message.Message):
    ...
    def update_mask(self) -> google.protobuf.field_mask_pb2.FieldMask:
        ...
        pass
    @property
    def create(self) -> google.ads.googleads.v7.resources.keyword_plan_campaign_pb2.KeywordPlanCampaign:
        """Create operation: No resource name is expected for the new Keyword Plan
        campaign.
        """
        pass
    @property
    def update(self) -> google.ads.googleads.v7.resources.keyword_plan_campaign_pb2.KeywordPlanCampaign:
    ...
    def __init__(self,
        *,
        ...
        create : typing.Optional[google.ads.googleads.v7.resources.keyword_plan_campaign_pb2.KeywordPlanCampaign] = ...,
        update : typing.Optional[google.ads.googleads.v7.resources.keyword_plan_campaign_pb2.KeywordPlanCampaign] = ...,
        remove : typing.Text = ...,
        ) -> None: ...
...
class MutateKeywordPlanCampaignsResponse(google.protobuf.message.Message):
    ...
    def partial_failure_error(self) -> google.rpc.status_pb2.Status:
        ...
        pass
    @property
    def results(self) -> google.protobuf.internal.containers.RepeatedCompositeFieldContainer[global___MutateKeywordPlanCampaignResult]:
        """All results for the mutate."""
        pass
    def __init__(self,
        *,
        partial_failure_error : typing.Optional[google.rpc.status_pb2.Status] = ...,
        results : typing.Optional[typing.Iterable[global___MutateKeywordPlanCampaignResult]] = ...,
        ) -> None: ...
