...
class MutateFeedItemsRequest(google.protobuf.message.Message):
    ...
    @property
    def operations(self) -> google.protobuf.internal.containers.RepeatedCompositeFieldContainer[global___FeedItemOperation]:
...
class FeedItemOperation(google.protobuf.message.Message):
    ...
    def update_mask(self) -> google.protobuf.field_mask_pb2.FieldMask:
        ...
        pass
    @property
    def create(self) -> google.ads.googleads.v7.resources.feed_item_pb2.FeedItem:
        """Create operation: No resource name is expected for the new feed item."""
        pass
    @property
    def update(self) -> google.ads.googleads.v7.resources.feed_item_pb2.FeedItem:
    ...
    def __init__(self,
        *,
        ...
        create : typing.Optional[google.ads.googleads.v7.resources.feed_item_pb2.FeedItem] = ...,
        update : typing.Optional[google.ads.googleads.v7.resources.feed_item_pb2.FeedItem] = ...,
        remove : typing.Text = ...,
        ) -> None: ...
...
class MutateFeedItemsResponse(google.protobuf.message.Message):
    ...
    def partial_failure_error(self) -> google.rpc.status_pb2.Status:
        ...
        pass
    @property
    def results(self) -> google.protobuf.internal.containers.RepeatedCompositeFieldContainer[global___MutateFeedItemResult]:
...
class MutateFeedItemResult(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing_extensions.Literal["feed_item",b"feed_item"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["feed_item",b"feed_item","resource_name",b"resource_name"]) -> None: ...
