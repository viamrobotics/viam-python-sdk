...
"""
import builtins
import google.ads.googleads.v7.common.user_lists_pb2
import google.ads.googleads.v7.enums.access_reason_pb2
import google.ads.googleads.v7.enums.user_list_access_status_pb2
import google.ads.googleads.v7.enums.user_list_closing_reason_pb2
import google.ads.googleads.v7.enums.user_list_membership_status_pb2
import google.ads.googleads.v7.enums.user_list_size_range_pb2
import google.ads.googleads.v7.enums.user_list_type_pb2
...
class UserList(google.protobuf.message.Message):
    ...
    membership_status: google.ads.googleads.v7.enums.user_list_membership_status_pb2.UserListMembershipStatusEnum.UserListMembershipStatus.ValueType = ...
    ...
    size_range_for_display: google.ads.googleads.v7.enums.user_list_size_range_pb2.UserListSizeRangeEnum.UserListSizeRange.ValueType = ...
    ...
    size_range_for_search: google.ads.googleads.v7.enums.user_list_size_range_pb2.UserListSizeRangeEnum.UserListSizeRange.ValueType = ...
    """Output only. Size range in terms of number of users of the UserList, for Search ads.

    This field is read-only.
    """

    type: google.ads.googleads.v7.enums.user_list_type_pb2.UserListTypeEnum.UserListType.ValueType = ...
    """Output only. Type of this list.

    This field is read-only.
    """

    closing_reason: google.ads.googleads.v7.enums.user_list_closing_reason_pb2.UserListClosingReasonEnum.UserListClosingReason.ValueType = ...
    ...
    access_reason: google.ads.googleads.v7.enums.access_reason_pb2.AccessReasonEnum.AccessReason.ValueType = ...
    ...
    account_user_list_status: google.ads.googleads.v7.enums.user_list_access_status_pb2.UserListAccessStatusEnum.UserListAccessStatus.ValueType = ...
    ...
    @property
    def crm_based_user_list(self) -> google.ads.googleads.v7.common.user_lists_pb2.CrmBasedUserListInfo:
        """User list of CRM users provided by the advertiser."""
        pass
    @property
    def similar_user_list(self) -> google.ads.googleads.v7.common.user_lists_pb2.SimilarUserListInfo:
        ...
        pass
    @property
    def rule_based_user_list(self) -> google.ads.googleads.v7.common.user_lists_pb2.RuleBasedUserListInfo:
        """User list generated by a rule."""
        pass
    @property
    def logical_user_list(self) -> google.ads.googleads.v7.common.user_lists_pb2.LogicalUserListInfo:
        """User list that is a custom combination of user lists and user interests."""
        pass
    @property
    def basic_user_list(self) -> google.ads.googleads.v7.common.user_lists_pb2.BasicUserListInfo:
    ...
    def __init__(self,
        *,
        ...
        crm_based_user_list : typing.Optional[google.ads.googleads.v7.common.user_lists_pb2.CrmBasedUserListInfo] = ...,
        similar_user_list : typing.Optional[google.ads.googleads.v7.common.user_lists_pb2.SimilarUserListInfo] = ...,
        rule_based_user_list : typing.Optional[google.ads.googleads.v7.common.user_lists_pb2.RuleBasedUserListInfo] = ...,
        logical_user_list : typing.Optional[google.ads.googleads.v7.common.user_lists_pb2.LogicalUserListInfo] = ...,
        basic_user_list : typing.Optional[google.ads.googleads.v7.common.user_lists_pb2.BasicUserListInfo] = ...,
        ) -> None: ...
