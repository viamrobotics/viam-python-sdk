...
"""
import builtins
import google.ads.googleads.v9.enums.user_identifier_source_pb2
...
class UserIdentifier(google.protobuf.message.Message):
    ...
    user_identifier_source: google.ads.googleads.v9.enums.user_identifier_source_pb2.UserIdentifierSourceEnum.UserIdentifierSource.ValueType = ...
...
class UserAttribute(google.protobuf.message.Message):
    ...
    SHOPPING_LOYALTY_FIELD_NUMBER: builtins.int
    ...
    @property
    def shopping_loyalty(self) -> global___ShoppingLoyalty:
    ...
    def __init__(self,
        *,
        ...
        average_purchase_value_micros : builtins.int = ...,
        acquisition_date_time : typing.Text = ...,
        shopping_loyalty : typing.Optional[global___ShoppingLoyalty] = ...,
        ) -> None: ...
    def HasField(self, field_name: typing_extensions.Literal["_lifetime_value_bucket",b"_lifetime_value_bucket","_lifetime_value_micros",b"_lifetime_value_micros","_shopping_loyalty",b"_shopping_loyalty","lifetime_value_bucket",b"lifetime_value_bucket","lifetime_value_micros",b"lifetime_value_micros","shopping_loyalty",b"shopping_loyalty"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["_lifetime_value_bucket",b"_lifetime_value_bucket","_lifetime_value_micros",b"_lifetime_value_micros","_shopping_loyalty",b"_shopping_loyalty","acquisition_date_time",b"acquisition_date_time","average_purchase_count",b"average_purchase_count","average_purchase_value_micros",b"average_purchase_value_micros","last_purchase_date_time",b"last_purchase_date_time","lifetime_value_bucket",b"lifetime_value_bucket","lifetime_value_micros",b"lifetime_value_micros","shopping_loyalty",b"shopping_loyalty"]) -> None: ...
    @typing.overload
    ...
    @typing.overload
    def WhichOneof(self, oneof_group: typing_extensions.Literal["_shopping_loyalty",b"_shopping_loyalty"]) -> typing.Optional[typing_extensions.Literal["shopping_loyalty"]]: ...
global___UserAttribute = UserAttribute

class ShoppingLoyalty(google.protobuf.message.Message):
    """The shopping loyalty related data. Shopping utilizes this data to provide
    users with a better experience.
    Accessible only to merchants on the allow-list.
    """
    DESCRIPTOR: google.protobuf.descriptor.Descriptor = ...
    LOYALTY_TIER_FIELD_NUMBER: builtins.int
    loyalty_tier: typing.Text = ...
    ...
    def __init__(self,
        *,
        loyalty_tier : typing.Optional[typing.Text] = ...,
        ) -> None: ...
    def HasField(self, field_name: typing_extensions.Literal["_loyalty_tier",b"_loyalty_tier","loyalty_tier",b"loyalty_tier"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["_loyalty_tier",b"_loyalty_tier","loyalty_tier",b"loyalty_tier"]) -> None: ...
    def WhichOneof(self, oneof_group: typing_extensions.Literal["_loyalty_tier",b"_loyalty_tier"]) -> typing.Optional[typing_extensions.Literal["loyalty_tier"]]: ...
global___ShoppingLoyalty = ShoppingLoyalty
