...
class MediaFileOperation(google.protobuf.message.Message):
    ...
    @property
    def create(self) -> google.ads.googleads.v9.resources.media_file_pb2.MediaFile:
        """Create operation: No resource name is expected for the new media file."""
        pass
    def __init__(self,
        *,
        create : typing.Optional[google.ads.googleads.v9.resources.media_file_pb2.MediaFile] = ...,
        ) -> None: ...
