...
class AdGroupLabelOperation(google.protobuf.message.Message):
    ...
    @property
    def create(self) -> google.ads.googleads.v9.resources.ad_group_label_pb2.AdGroupLabel:
    ...
    def __init__(self,
        *,
        create : typing.Optional[google.ads.googleads.v9.resources.ad_group_label_pb2.AdGroupLabel] = ...,
        remove : typing.Text = ...,
        ) -> None: ...
