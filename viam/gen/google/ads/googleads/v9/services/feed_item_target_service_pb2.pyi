...
class FeedItemTargetOperation(google.protobuf.message.Message):
    ...
    @property
    def create(self) -> google.ads.googleads.v9.resources.feed_item_target_pb2.FeedItemTarget:
    ...
    def __init__(self,
        *,
        create : typing.Optional[google.ads.googleads.v9.resources.feed_item_target_pb2.FeedItemTarget] = ...,
        remove : typing.Text = ...,
        ) -> None: ...
