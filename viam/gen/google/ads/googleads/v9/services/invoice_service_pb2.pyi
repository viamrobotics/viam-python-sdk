...
class ListInvoicesRequest(google.protobuf.message.Message):
    ...
    issue_month: google.ads.googleads.v9.enums.month_of_year_pb2.MonthOfYearEnum.MonthOfYear.ValueType = ...
...
class ListInvoicesResponse(google.protobuf.message.Message):
    ...
    @property
    def invoices(self) -> google.protobuf.internal.containers.RepeatedCompositeFieldContainer[google.ads.googleads.v9.resources.invoice_pb2.Invoice]:
        """The list of invoices that match the billing setup and time period."""
        pass
    def __init__(self,
        *,
        invoices : typing.Optional[typing.Iterable[google.ads.googleads.v9.resources.invoice_pb2.Invoice]] = ...,
        ) -> None: ...
