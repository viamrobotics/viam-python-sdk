...
class ClickConversion(google.protobuf.message.Message):
    ...
    GBRAID_FIELD_NUMBER: builtins.int
    WBRAID_FIELD_NUMBER: builtins.int
    ...
    def ClearField(self, field_name: typing_extensions.Literal["_conversion_action",b"_conversion_action","_conversion_date_time",b"_conversion_date_time","_conversion_value",b"_conversion_value","_currency_code",b"_currency_code","_gclid",b"_gclid","_order_id",b"_order_id","cart_data",b"cart_data","conversion_action",b"conversion_action","conversion_date_time",b"conversion_date_time","conversion_value",b"conversion_value","currency_code",b"currency_code","custom_variables",b"custom_variables","external_attribution_data",b"external_attribution_data","gbraid",b"gbraid","gclid",b"gclid","order_id",b"order_id","user_identifiers",b"user_identifiers","wbraid",b"wbraid"]) -> None: ...
    @typing.overload
...
class ClickConversionResult(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing_extensions.Literal["_conversion_action",b"_conversion_action","_conversion_date_time",b"_conversion_date_time","_gclid",b"_gclid","conversion_action",b"conversion_action","conversion_date_time",b"conversion_date_time","gbraid",b"gbraid","gclid",b"gclid","user_identifiers",b"user_identifiers","wbraid",b"wbraid"]) -> None: ...
    @typing.overload
    def WhichOneof(self, oneof_group: typing_extensions.Literal["_conversion_action",b"_conversion_action"]) -> typing.Optional[typing_extensions.Literal["conversion_action"]]: ...
    @typing.overload
    def WhichOneof(self, oneof_group: typing_extensions.Literal["_conversion_date_time",b"_conversion_date_time"]) -> typing.Optional[typing_extensions.Literal["conversion_date_time"]]: ...
