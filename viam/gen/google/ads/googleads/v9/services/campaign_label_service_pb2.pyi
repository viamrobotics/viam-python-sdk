...
class CampaignLabelOperation(google.protobuf.message.Message):
    ...
    @property
    def create(self) -> google.ads.googleads.v9.resources.campaign_label_pb2.CampaignLabel:
    ...
    def __init__(self,
        *,
        create : typing.Optional[google.ads.googleads.v9.resources.campaign_label_pb2.CampaignLabel] = ...,
        remove : typing.Text = ...,
        ) -> None: ...
