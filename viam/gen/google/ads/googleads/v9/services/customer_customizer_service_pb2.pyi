...
class MutateCustomerCustomizersRequest(google.protobuf.message.Message):
    """Request message for
    ...
    @property
    def operations(self) -> google.protobuf.internal.containers.RepeatedCompositeFieldContainer[global___CustomerCustomizerOperation]:
    ...
    def __init__(self,
        *,
        customer_id : typing.Text = ...,
        operations : typing.Optional[typing.Iterable[global___CustomerCustomizerOperation]] = ...,
        partial_failure : builtins.bool = ...,
        validate_only : builtins.bool = ...,
        response_content_type : google.ads.googleads.v9.enums.response_content_type_pb2.ResponseContentTypeEnum.ResponseContentType.ValueType = ...,
        ) -> None: ...
...
global___MutateCustomerCustomizersRequest = MutateCustomerCustomizersRequest

class CustomerCustomizerOperation(google.protobuf.message.Message):
    """A single operation (create, remove) on an customizer attribute."""
    DESCRIPTOR: google.protobuf.descriptor.Descriptor = ...
    CREATE_FIELD_NUMBER: builtins.int
    REMOVE_FIELD_NUMBER: builtins.int
    @property
    def create(self) -> google.ads.googleads.v9.resources.customer_customizer_pb2.CustomerCustomizer:
    ...
    def __init__(self,
        *,
        create : typing.Optional[google.ads.googleads.v9.resources.customer_customizer_pb2.CustomerCustomizer] = ...,
        remove : typing.Text = ...,
        ) -> None: ...
...
global___CustomerCustomizerOperation = CustomerCustomizerOperation

class MutateCustomerCustomizersResponse(google.protobuf.message.Message):
    """Response message for an customizer attribute mutate."""
    DESCRIPTOR: google.protobuf.descriptor.Descriptor = ...
    RESULTS_FIELD_NUMBER: builtins.int
    PARTIAL_FAILURE_ERROR_FIELD_NUMBER: builtins.int
    @property
    def results(self) -> google.protobuf.internal.containers.RepeatedCompositeFieldContainer[global___MutateCustomerCustomizerResult]:
    ...
    def __init__(self,
        *,
        results : typing.Optional[typing.Iterable[global___MutateCustomerCustomizerResult]] = ...,
...
global___MutateCustomerCustomizersResponse = MutateCustomerCustomizersResponse

class MutateCustomerCustomizerResult(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing_extensions.Literal["customer_customizer",b"customer_customizer"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["customer_customizer",b"customer_customizer","resource_name",b"resource_name"]) -> None: ...
global___MutateCustomerCustomizerResult = MutateCustomerCustomizerResult
