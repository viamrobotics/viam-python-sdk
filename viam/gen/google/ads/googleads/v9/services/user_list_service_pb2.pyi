...
class UserListOperation(google.protobuf.message.Message):
    ...
    def update_mask(self) -> google.protobuf.field_mask_pb2.FieldMask:
        ...
        pass
    @property
    def create(self) -> google.ads.googleads.v9.resources.user_list_pb2.UserList:
        """Create operation: No resource name is expected for the new user list."""
        pass
    @property
    def update(self) -> google.ads.googleads.v9.resources.user_list_pb2.UserList:
    ...
    def __init__(self,
        *,
        ...
        create : typing.Optional[google.ads.googleads.v9.resources.user_list_pb2.UserList] = ...,
        update : typing.Optional[google.ads.googleads.v9.resources.user_list_pb2.UserList] = ...,
        remove : typing.Text = ...,
        ) -> None: ...
