...
class CustomerUserAccessInvitationOperation(google.protobuf.message.Message):
    ...
    @property
    def create(self) -> google.ads.googleads.v9.resources.customer_user_access_invitation_pb2.CustomerUserAccessInvitation:
    ...
    def __init__(self,
        *,
        create : typing.Optional[google.ads.googleads.v9.resources.customer_user_access_invitation_pb2.CustomerUserAccessInvitation] = ...,
        remove : typing.Text = ...,
        ) -> None: ...
