...
class SmartCampaignSettingOperation(google.protobuf.message.Message):
    ...
    @property
    def update(self) -> google.ads.googleads.v9.resources.smart_campaign_setting_pb2.SmartCampaignSetting:
    ...
    def __init__(self,
        *,
        update : typing.Optional[google.ads.googleads.v9.resources.smart_campaign_setting_pb2.SmartCampaignSetting] = ...,
