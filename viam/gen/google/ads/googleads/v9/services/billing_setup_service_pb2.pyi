...
class BillingSetupOperation(google.protobuf.message.Message):
    ...
    @property
    def create(self) -> google.ads.googleads.v9.resources.billing_setup_pb2.BillingSetup:
    ...
    def __init__(self,
        *,
        create : typing.Optional[google.ads.googleads.v9.resources.billing_setup_pb2.BillingSetup] = ...,
        remove : typing.Text = ...,
        ) -> None: ...
