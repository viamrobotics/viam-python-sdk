...
class MutateAssetSetsRequest(google.protobuf.message.Message):
    ...
    @property
    def operations(self) -> google.protobuf.internal.containers.RepeatedCompositeFieldContainer[global___AssetSetOperation]:
    ...
    def __init__(self,
        *,
        customer_id : typing.Text = ...,
        operations : typing.Optional[typing.Iterable[global___AssetSetOperation]] = ...,
        partial_failure : builtins.bool = ...,
        validate_only : builtins.bool = ...,
        response_content_type : google.ads.googleads.v9.enums.response_content_type_pb2.ResponseContentTypeEnum.ResponseContentType.ValueType = ...,
        ) -> None: ...
...
global___MutateAssetSetsRequest = MutateAssetSetsRequest

class AssetSetOperation(google.protobuf.message.Message):
    ...
    def update_mask(self) -> google.protobuf.field_mask_pb2.FieldMask:
        ...
        pass
    @property
    def create(self) -> google.ads.googleads.v9.resources.asset_set_pb2.AssetSet:
        """Create operation: No resource name is expected for the new asset set"""
        pass
    @property
    def update(self) -> google.ads.googleads.v9.resources.asset_set_pb2.AssetSet:
    ...
    def __init__(self,
        *,
        ...
        create : typing.Optional[google.ads.googleads.v9.resources.asset_set_pb2.AssetSet] = ...,
        update : typing.Optional[google.ads.googleads.v9.resources.asset_set_pb2.AssetSet] = ...,
        remove : typing.Text = ...,
        ) -> None: ...
...
global___AssetSetOperation = AssetSetOperation

class MutateAssetSetsResponse(google.protobuf.message.Message):
    """Response message for an asset set mutate."""
    DESCRIPTOR: google.protobuf.descriptor.Descriptor = ...
    RESULTS_FIELD_NUMBER: builtins.int
    PARTIAL_FAILURE_ERROR_FIELD_NUMBER: builtins.int
    @property
    def results(self) -> google.protobuf.internal.containers.RepeatedCompositeFieldContainer[global___MutateAssetSetResult]:
    ...
    def __init__(self,
        *,
        results : typing.Optional[typing.Iterable[global___MutateAssetSetResult]] = ...,
...
global___MutateAssetSetsResponse = MutateAssetSetsResponse

class MutateAssetSetResult(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing_extensions.Literal["asset_set",b"asset_set"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["asset_set",b"asset_set","resource_name",b"resource_name"]) -> None: ...
global___MutateAssetSetResult = MutateAssetSetResult
