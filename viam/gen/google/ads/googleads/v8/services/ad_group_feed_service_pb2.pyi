...
class MutateAdGroupFeedsRequest(google.protobuf.message.Message):
    ...
    @property
    def operations(self) -> google.protobuf.internal.containers.RepeatedCompositeFieldContainer[global___AdGroupFeedOperation]:
    ...
    def __init__(self,
        *,
        customer_id : typing.Text = ...,
        operations : typing.Optional[typing.Iterable[global___AdGroupFeedOperation]] = ...,
        partial_failure : builtins.bool = ...,
        validate_only : builtins.bool = ...,
        response_content_type : google.ads.googleads.v8.enums.response_content_type_pb2.ResponseContentTypeEnum.ResponseContentType.ValueType = ...,
        ) -> None: ...
...
class AdGroupFeedOperation(google.protobuf.message.Message):
    ...
    def update_mask(self) -> google.protobuf.field_mask_pb2.FieldMask:
        ...
        pass
    @property
    def create(self) -> google.ads.googleads.v8.resources.ad_group_feed_pb2.AdGroupFeed:
        """Create operation: No resource name is expected for the new ad group feed."""
        pass
    @property
    def update(self) -> google.ads.googleads.v8.resources.ad_group_feed_pb2.AdGroupFeed:
    ...
    def __init__(self,
        *,
        ...
        create : typing.Optional[google.ads.googleads.v8.resources.ad_group_feed_pb2.AdGroupFeed] = ...,
        update : typing.Optional[google.ads.googleads.v8.resources.ad_group_feed_pb2.AdGroupFeed] = ...,
        remove : typing.Text = ...,
        ) -> None: ...
...
class MutateAdGroupFeedsResponse(google.protobuf.message.Message):
    ...
    def partial_failure_error(self) -> google.rpc.status_pb2.Status:
        ...
        pass
    @property
    def results(self) -> google.protobuf.internal.containers.RepeatedCompositeFieldContainer[global___MutateAdGroupFeedResult]:
        """All results for the mutate."""
        pass
    def __init__(self,
        *,
        partial_failure_error : typing.Optional[google.rpc.status_pb2.Status] = ...,
        results : typing.Optional[typing.Iterable[global___MutateAdGroupFeedResult]] = ...,
        ) -> None: ...
...
class MutateAdGroupFeedResult(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing_extensions.Literal["ad_group_feed",b"ad_group_feed"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["ad_group_feed",b"ad_group_feed","resource_name",b"resource_name"]) -> None: ...
