...
class GetBiddingSeasonalityAdjustmentRequest(google.protobuf.message.Message):
    """Request message for
...
global___GetBiddingSeasonalityAdjustmentRequest = GetBiddingSeasonalityAdjustmentRequest

class MutateBiddingSeasonalityAdjustmentsRequest(google.protobuf.message.Message):
    """Request message for
    ...
    @property
    def operations(self) -> google.protobuf.internal.containers.RepeatedCompositeFieldContainer[global___BiddingSeasonalityAdjustmentOperation]:
    ...
    def __init__(self,
        *,
        customer_id : typing.Text = ...,
        operations : typing.Optional[typing.Iterable[global___BiddingSeasonalityAdjustmentOperation]] = ...,
        partial_failure : builtins.bool = ...,
        validate_only : builtins.bool = ...,
        response_content_type : google.ads.googleads.v8.enums.response_content_type_pb2.ResponseContentTypeEnum.ResponseContentType.ValueType = ...,
        ) -> None: ...
...
global___MutateBiddingSeasonalityAdjustmentsRequest = MutateBiddingSeasonalityAdjustmentsRequest

class BiddingSeasonalityAdjustmentOperation(google.protobuf.message.Message):
    ...
    def update_mask(self) -> google.protobuf.field_mask_pb2.FieldMask:
        ...
        pass
    @property
    def create(self) -> google.ads.googleads.v8.resources.bidding_seasonality_adjustment_pb2.BiddingSeasonalityAdjustment:
        """Create operation: No resource name is expected for the new seasonality
        adjustment.
        """
        pass
    @property
    def update(self) -> google.ads.googleads.v8.resources.bidding_seasonality_adjustment_pb2.BiddingSeasonalityAdjustment:
    ...
    def __init__(self,
        *,
        ...
        create : typing.Optional[google.ads.googleads.v8.resources.bidding_seasonality_adjustment_pb2.BiddingSeasonalityAdjustment] = ...,
        update : typing.Optional[google.ads.googleads.v8.resources.bidding_seasonality_adjustment_pb2.BiddingSeasonalityAdjustment] = ...,
        remove : typing.Text = ...,
        ) -> None: ...
...
global___BiddingSeasonalityAdjustmentOperation = BiddingSeasonalityAdjustmentOperation

class MutateBiddingSeasonalityAdjustmentsResponse(google.protobuf.message.Message):
    ...
    def partial_failure_error(self) -> google.rpc.status_pb2.Status:
        ...
        pass
    @property
    def results(self) -> google.protobuf.internal.containers.RepeatedCompositeFieldContainer[global___MutateBiddingSeasonalityAdjustmentsResult]:
        """All results for the mutate."""
        pass
    def __init__(self,
        *,
        partial_failure_error : typing.Optional[google.rpc.status_pb2.Status] = ...,
        results : typing.Optional[typing.Iterable[global___MutateBiddingSeasonalityAdjustmentsResult]] = ...,
        ) -> None: ...
...
global___MutateBiddingSeasonalityAdjustmentsResponse = MutateBiddingSeasonalityAdjustmentsResponse

class MutateBiddingSeasonalityAdjustmentsResult(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing_extensions.Literal["bidding_seasonality_adjustment",b"bidding_seasonality_adjustment"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["bidding_seasonality_adjustment",b"bidding_seasonality_adjustment","resource_name",b"resource_name"]) -> None: ...
global___MutateBiddingSeasonalityAdjustmentsResult = MutateBiddingSeasonalityAdjustmentsResult
