...
if _descriptor._USE_C_DESCRIPTORS == False:
  ...
  _CONVERSIONCUSTOMVARIABLESERVICE.methods_by_name['GetConversionCustomVariable']._serialized_options = b'\332A\rresource_name\202\323\344\223\002=\022;/v8/{resource_name=customers/*/conversionCustomVariables/*}'
  _CONVERSIONCUSTOMVARIABLESERVICE.methods_by_name['MutateConversionCustomVariables']._options = None
  _CONVERSIONCUSTOMVARIABLESERVICE.methods_by_name['MutateConversionCustomVariables']._serialized_options = b'\332A\026customer_id,operations\202\323\344\223\002C\">/v8/customers/{customer_id=*}/conversionCustomVariables:mutate:\001*'
