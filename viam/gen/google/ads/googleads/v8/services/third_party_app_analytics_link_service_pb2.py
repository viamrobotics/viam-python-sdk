...
if _descriptor._USE_C_DESCRIPTORS == False:
  ...
  _THIRDPARTYAPPANALYTICSLINKSERVICE.methods_by_name['GetThirdPartyAppAnalyticsLink']._serialized_options = b'\202\323\344\223\002?\022=/v8/{resource_name=customers/*/thirdPartyAppAnalyticsLinks/*}'
  _THIRDPARTYAPPANALYTICSLINKSERVICE.methods_by_name['RegenerateShareableLinkId']._options = None
  _THIRDPARTYAPPANALYTICSLINKSERVICE.methods_by_name['RegenerateShareableLinkId']._serialized_options = b'\202\323\344\223\002\\\"W/v8/{resource_name=customers/*/thirdPartyAppAnalyticsLinks/*}:regenerateShareableLinkId:\001*'
