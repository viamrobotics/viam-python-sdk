...
class MutateSharedSetsRequest(google.protobuf.message.Message):
    ...
    @property
    def operations(self) -> google.protobuf.internal.containers.RepeatedCompositeFieldContainer[global___SharedSetOperation]:
...
class SharedSetOperation(google.protobuf.message.Message):
    ...
    def update_mask(self) -> google.protobuf.field_mask_pb2.FieldMask:
        ...
        pass
    @property
    def create(self) -> google.ads.googleads.v8.resources.shared_set_pb2.SharedSet:
        """Create operation: No resource name is expected for the new shared set."""
        pass
    @property
    def update(self) -> google.ads.googleads.v8.resources.shared_set_pb2.SharedSet:
    ...
    def __init__(self,
        *,
        ...
        create : typing.Optional[google.ads.googleads.v8.resources.shared_set_pb2.SharedSet] = ...,
        update : typing.Optional[google.ads.googleads.v8.resources.shared_set_pb2.SharedSet] = ...,
        remove : typing.Text = ...,
        ) -> None: ...
...
class MutateSharedSetsResponse(google.protobuf.message.Message):
    ...
    def partial_failure_error(self) -> google.rpc.status_pb2.Status:
        ...
        pass
    @property
    def results(self) -> google.protobuf.internal.containers.RepeatedCompositeFieldContainer[global___MutateSharedSetResult]:
...
class MutateSharedSetResult(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing_extensions.Literal["shared_set",b"shared_set"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["resource_name",b"resource_name","shared_set",b"shared_set"]) -> None: ...
