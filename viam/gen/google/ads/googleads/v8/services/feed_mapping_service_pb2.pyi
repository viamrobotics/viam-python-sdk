...
class FeedMappingOperation(google.protobuf.message.Message):
    ...
    @property
    def create(self) -> google.ads.googleads.v8.resources.feed_mapping_pb2.FeedMapping:
    ...
    def __init__(self,
        *,
        create : typing.Optional[google.ads.googleads.v8.resources.feed_mapping_pb2.FeedMapping] = ...,
        remove : typing.Text = ...,
        ) -> None: ...
