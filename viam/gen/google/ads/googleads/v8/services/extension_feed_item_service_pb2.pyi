...
class MutateExtensionFeedItemsRequest(google.protobuf.message.Message):
    ...
    @property
    def operations(self) -> google.protobuf.internal.containers.RepeatedCompositeFieldContainer[global___ExtensionFeedItemOperation]:
    ...
    def __init__(self,
        *,
        customer_id : typing.Text = ...,
        operations : typing.Optional[typing.Iterable[global___ExtensionFeedItemOperation]] = ...,
        partial_failure : builtins.bool = ...,
        validate_only : builtins.bool = ...,
        response_content_type : google.ads.googleads.v8.enums.response_content_type_pb2.ResponseContentTypeEnum.ResponseContentType.ValueType = ...,
        ) -> None: ...
...
class ExtensionFeedItemOperation(google.protobuf.message.Message):
    ...
    def update_mask(self) -> google.protobuf.field_mask_pb2.FieldMask:
        ...
        pass
    @property
    def create(self) -> google.ads.googleads.v8.resources.extension_feed_item_pb2.ExtensionFeedItem:
        """Create operation: No resource name is expected for the new extension
        feed item.
        """
        pass
    @property
    def update(self) -> google.ads.googleads.v8.resources.extension_feed_item_pb2.ExtensionFeedItem:
    ...
    def __init__(self,
        *,
        ...
        create : typing.Optional[google.ads.googleads.v8.resources.extension_feed_item_pb2.ExtensionFeedItem] = ...,
        update : typing.Optional[google.ads.googleads.v8.resources.extension_feed_item_pb2.ExtensionFeedItem] = ...,
        remove : typing.Text = ...,
        ) -> None: ...
...
class MutateExtensionFeedItemsResponse(google.protobuf.message.Message):
    ...
    def partial_failure_error(self) -> google.rpc.status_pb2.Status:
        ...
        pass
    @property
    def results(self) -> google.protobuf.internal.containers.RepeatedCompositeFieldContainer[global___MutateExtensionFeedItemResult]:
        """All results for the mutate."""
        pass
    def __init__(self,
        *,
        partial_failure_error : typing.Optional[google.rpc.status_pb2.Status] = ...,
        results : typing.Optional[typing.Iterable[global___MutateExtensionFeedItemResult]] = ...,
        ) -> None: ...
...
class MutateExtensionFeedItemResult(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing_extensions.Literal["extension_feed_item",b"extension_feed_item"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["extension_feed_item",b"extension_feed_item","resource_name",b"resource_name"]) -> None: ...
