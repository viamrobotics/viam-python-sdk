...
import google.ads.googleads.v8.enums.keyword_plan_aggregate_metric_type_pb2
import google.ads.googleads.v8.enums.keyword_plan_competition_level_pb2
import google.ads.googleads.v8.enums.keyword_plan_concept_group_type_pb2
...
class KeywordPlanHistoricalMetrics(google.protobuf.message.Message):
    ...
    def monthly_search_volumes(self) -> google.protobuf.internal.containers.RepeatedCompositeFieldContainer[global___MonthlySearchVolume]:
        ...
        pass
    competition: google.ads.googleads.v8.enums.keyword_plan_competition_level_pb2.KeywordPlanCompetitionLevelEnum.KeywordPlanCompetitionLevel.ValueType = ...
...
class HistoricalMetricsOptions(google.protobuf.message.Message):
    ...
    @property
    def year_month_range(self) -> google.ads.googleads.v8.common.dates_pb2.YearMonthRange:
    ...
    def __init__(self,
        *,
        year_month_range : typing.Optional[google.ads.googleads.v8.common.dates_pb2.YearMonthRange] = ...,
        ) -> None: ...
...
class KeywordPlanAggregateMetrics(google.protobuf.message.Message):
    ...
    @property
    def aggregate_metric_types(self) -> google.protobuf.internal.containers.RepeatedScalarFieldContainer[google.ads.googleads.v8.enums.keyword_plan_aggregate_metric_type_pb2.KeywordPlanAggregateMetricTypeEnum.KeywordPlanAggregateMetricType.ValueType]:
        """The list of aggregate metrics to fetch data."""
        pass
    def __init__(self,
        *,
        aggregate_metric_types : typing.Optional[typing.Iterable[google.ads.googleads.v8.enums.keyword_plan_aggregate_metric_type_pb2.KeywordPlanAggregateMetricTypeEnum.KeywordPlanAggregateMetricType.ValueType]] = ...,
        ) -> None: ...
...
class ConceptGroup(google.protobuf.message.Message):
    ...
    type: google.ads.googleads.v8.enums.keyword_plan_concept_group_type_pb2.KeywordPlanConceptGroupTypeEnum.KeywordPlanConceptGroupType.ValueType = ...
