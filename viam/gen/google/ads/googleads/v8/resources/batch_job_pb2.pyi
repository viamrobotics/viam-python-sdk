...
"""
import builtins
import google.ads.googleads.v8.enums.batch_job_status_pb2
...
class BatchJob(google.protobuf.message.Message):
    ...
    def metadata(self) -> global___BatchJob.BatchJobMetadata:
        ...
        pass
    status: google.ads.googleads.v8.enums.batch_job_status_pb2.BatchJobStatusEnum.BatchJobStatus.ValueType = ...
