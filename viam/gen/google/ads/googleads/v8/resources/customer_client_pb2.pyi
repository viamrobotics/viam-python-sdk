...
class CustomerClient(google.protobuf.message.Message):
    ...
    APPLIED_LABELS_FIELD_NUMBER: builtins.int
    ...
    @property
    def applied_labels(self) -> google.protobuf.internal.containers.RepeatedScalarFieldContainer[typing.Text]:
    ...
    def __init__(self,
        *,
        ...
        applied_labels : typing.Optional[typing.Iterable[typing.Text]] = ...,
        ) -> None: ...
    ...
    def ClearField(self, field_name: typing_extensions.Literal["_client_customer",b"_client_customer","_currency_code",b"_currency_code","_descriptive_name",b"_descriptive_name","_hidden",b"_hidden","_id",b"_id","_level",b"_level","_manager",b"_manager","_test_account",b"_test_account","_time_zone",b"_time_zone","applied_labels",b"applied_labels","client_customer",b"client_customer","currency_code",b"currency_code","descriptive_name",b"descriptive_name","hidden",b"hidden","id",b"id","level",b"level","manager",b"manager","resource_name",b"resource_name","test_account",b"test_account","time_zone",b"time_zone"]) -> None: ...
    @typing.overload
