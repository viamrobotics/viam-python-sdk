...
"""
import builtins
import google.ads.googleads.v8.common.click_location_pb2
...
class ClickView(google.protobuf.message.Message):
    ...
    @property
    def area_of_interest(self) -> google.ads.googleads.v8.common.click_location_pb2.ClickLocation:
        """Output only. The location criteria matching the area of interest associated with the
        impression.
        """
        pass
    @property
    def location_of_presence(self) -> google.ads.googleads.v8.common.click_location_pb2.ClickLocation:
    ...
    @property
    def keyword_info(self) -> google.ads.googleads.v8.common.criteria_pb2.KeywordInfo:
    ...
    def __init__(self,
        *,
        ...
        area_of_interest : typing.Optional[google.ads.googleads.v8.common.click_location_pb2.ClickLocation] = ...,
        location_of_presence : typing.Optional[google.ads.googleads.v8.common.click_location_pb2.ClickLocation] = ...,
        ...
        keyword : typing.Text = ...,
        keyword_info : typing.Optional[google.ads.googleads.v8.common.criteria_pb2.KeywordInfo] = ...,
        ) -> None: ...
