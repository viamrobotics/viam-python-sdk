...
class LookupRequest(google.protobuf.message.Message):
    ...
    def read_options(self) -> global___ReadOptions:
        ...
        pass
    @property
    def keys(self) -> google.protobuf.internal.containers.RepeatedCompositeFieldContainer[google.datastore.v1beta3.entity_pb2.Key]:
    ...
    def __init__(self,
        *,
        ...
        keys : typing.Optional[typing.Iterable[google.datastore.v1beta3.entity_pb2.Key]] = ...,
        ) -> None: ...
...
class LookupResponse(google.protobuf.message.Message):
    ...
    @property
    def found(self) -> google.protobuf.internal.containers.RepeatedCompositeFieldContainer[google.datastore.v1beta3.query_pb2.EntityResult]:
        ...
        pass
    @property
    def missing(self) -> google.protobuf.internal.containers.RepeatedCompositeFieldContainer[google.datastore.v1beta3.query_pb2.EntityResult]:
        ...
        pass
    @property
    def deferred(self) -> google.protobuf.internal.containers.RepeatedCompositeFieldContainer[google.datastore.v1beta3.entity_pb2.Key]:
    ...
    def __init__(self,
        *,
        found : typing.Optional[typing.Iterable[google.datastore.v1beta3.query_pb2.EntityResult]] = ...,
        missing : typing.Optional[typing.Iterable[google.datastore.v1beta3.query_pb2.EntityResult]] = ...,
        deferred : typing.Optional[typing.Iterable[google.datastore.v1beta3.entity_pb2.Key]] = ...,
        ) -> None: ...
...
class RunQueryRequest(google.protobuf.message.Message):
    ...
    @property
    def partition_id(self) -> google.datastore.v1beta3.entity_pb2.PartitionId:
    ...
    def read_options(self) -> global___ReadOptions:
        ...
        pass
    @property
    def query(self) -> google.datastore.v1beta3.query_pb2.Query:
        """The query to run."""
        pass
    @property
    def gql_query(self) -> google.datastore.v1beta3.query_pb2.GqlQuery:
        """The GQL query to run."""
        pass
    def __init__(self,
        *,
        project_id : typing.Text = ...,
        partition_id : typing.Optional[google.datastore.v1beta3.entity_pb2.PartitionId] = ...,
        read_options : typing.Optional[global___ReadOptions] = ...,
        query : typing.Optional[google.datastore.v1beta3.query_pb2.Query] = ...,
        gql_query : typing.Optional[google.datastore.v1beta3.query_pb2.GqlQuery] = ...,
        ) -> None: ...
...
class RunQueryResponse(google.protobuf.message.Message):
    ...
    QUERY_FIELD_NUMBER: builtins.int
    @property
    def batch(self) -> google.datastore.v1beta3.query_pb2.QueryResultBatch:
    ...
    def __init__(self,
        *,
        batch : typing.Optional[google.datastore.v1beta3.query_pb2.QueryResultBatch] = ...,
        query : typing.Optional[google.datastore.v1beta3.query_pb2.Query] = ...,
        ) -> None: ...
...
class Mutation(google.protobuf.message.Message):
    ...
    @property
    def insert(self) -> google.datastore.v1beta3.entity_pb2.Entity:
        """The entity to insert. The entity must not already exist.
        The entity key's final path element may be incomplete.
        """
        pass
    @property
    def update(self) -> google.datastore.v1beta3.entity_pb2.Entity:
        """The entity to update. The entity must already exist.
        Must have a complete key path.
        """
        pass
    @property
    def upsert(self) -> google.datastore.v1beta3.entity_pb2.Entity:
        """The entity to upsert. The entity may or may not already exist.
        The entity key's final path element may be incomplete.
        """
        pass
    @property
    def delete(self) -> google.datastore.v1beta3.entity_pb2.Key:
    ...
    def __init__(self,
        *,
        insert : typing.Optional[google.datastore.v1beta3.entity_pb2.Entity] = ...,
        update : typing.Optional[google.datastore.v1beta3.entity_pb2.Entity] = ...,
        upsert : typing.Optional[google.datastore.v1beta3.entity_pb2.Entity] = ...,
        delete : typing.Optional[google.datastore.v1beta3.entity_pb2.Key] = ...,
        base_version : builtins.int = ...,
        ) -> None: ...
...
class MutationResult(google.protobuf.message.Message):
    ...
    @property
    def key(self) -> google.datastore.v1beta3.entity_pb2.Key:
    ...
    def __init__(self,
        *,
        key : typing.Optional[google.datastore.v1beta3.entity_pb2.Key] = ...,
        version : builtins.int = ...,
        conflict_detected : builtins.bool = ...,
        ) -> None: ...
