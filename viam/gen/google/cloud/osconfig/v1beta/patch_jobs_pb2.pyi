...
class ExecutePatchJobRequest(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing_extensions.Literal["duration",b"duration","instance_filter",b"instance_filter","patch_config",b"patch_config"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["description",b"description","display_name",b"display_name","dry_run",b"dry_run","duration",b"duration","instance_filter",b"instance_filter","parent",b"parent","patch_config",b"patch_config"]) -> None: ...
