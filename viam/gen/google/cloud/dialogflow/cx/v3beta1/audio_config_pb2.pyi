...
class InputAudioConfig(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing_extensions.Literal["audio_encoding",b"audio_encoding","enable_word_info",b"enable_word_info","model",b"model","model_variant",b"model_variant","phrase_hints",b"phrase_hints","sample_rate_hertz",b"sample_rate_hertz","single_utterance",b"single_utterance"]) -> None: ...
