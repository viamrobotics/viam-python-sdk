...
class ConversationProfile(google.protobuf.message.Message):
    ...
    def new_message_event_notification_config(self) -> global___NotificationConfig:
        ...
        pass
    @property
    def stt_config(self) -> google.cloud.dialogflow.v2.audio_config_pb2.SpeechToTextConfig:
    ...
    def __init__(self,
        *,
        ...
        stt_config : typing.Optional[google.cloud.dialogflow.v2.audio_config_pb2.SpeechToTextConfig] = ...,
        language_code : typing.Text = ...,
        time_zone : typing.Text = ...,
        security_settings : typing.Text = ...,
        ) -> None: ...
...
class HumanAgentAssistantConfig(google.protobuf.message.Message):
    ...
    class SuggestionTriggerSettings(google.protobuf.message.Message):
        ...
        DESCRIPTOR: google.protobuf.descriptor.Descriptor = ...
        NO_SMALLTALK_FIELD_NUMBER: builtins.int
        ONLY_END_USER_FIELD_NUMBER: builtins.int
        no_smalltalk: builtins.bool = ...
        ...
        def ClearField(self, field_name: typing_extensions.Literal["no_smalltalk",b"no_smalltalk","only_end_user",b"only_end_user"]) -> None: ...
