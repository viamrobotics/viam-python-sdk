...
class SubAgent(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing_extensions.Literal["environment",b"environment","project",b"project"]) -> None: ...
global___SubAgent = SubAgent
