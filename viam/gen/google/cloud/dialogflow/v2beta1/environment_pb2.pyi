...
class Environment(google.protobuf.message.Message):
    ...
    def text_to_speech_settings(self) -> global___TextToSpeechSettings:
        ...
        pass
    @property
    def fulfillment(self) -> google.cloud.dialogflow.v2beta1.fulfillment_pb2.Fulfillment:
    ...
    def __init__(self,
        *,
        ...
        fulfillment : typing.Optional[google.cloud.dialogflow.v2beta1.fulfillment_pb2.Fulfillment] = ...,
        ) -> None: ...
...
class TextToSpeechSettings(google.protobuf.message.Message):
    ...
    class SynthesizeSpeechConfigsEntry(google.protobuf.message.Message):
        ...
        key: typing.Text = ...
        @property
        def value(self) -> google.cloud.dialogflow.v2beta1.audio_config_pb2.SynthesizeSpeechConfig: ...
        def __init__(self,
            *,
            key : typing.Text = ...,
            value : typing.Optional[google.cloud.dialogflow.v2beta1.audio_config_pb2.SynthesizeSpeechConfig] = ...,
            ) -> None: ...
    ...
    output_audio_encoding: google.cloud.dialogflow.v2beta1.audio_config_pb2.OutputAudioEncoding.ValueType = ...
    ...
    @property
    def synthesize_speech_configs(self) -> google.protobuf.internal.containers.MessageMap[typing.Text, google.cloud.dialogflow.v2beta1.audio_config_pb2.SynthesizeSpeechConfig]:
    ...
    def __init__(self,
        *,
        ...
        output_audio_encoding : google.cloud.dialogflow.v2beta1.audio_config_pb2.OutputAudioEncoding.ValueType = ...,
        sample_rate_hertz : builtins.int = ...,
        synthesize_speech_configs : typing.Optional[typing.Mapping[typing.Text, google.cloud.dialogflow.v2beta1.audio_config_pb2.SynthesizeSpeechConfig]] = ...,
        ) -> None: ...
