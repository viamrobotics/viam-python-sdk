...
class RestartWebServerRequest(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing_extensions.Literal["name",b"name"]) -> None: ...
global___RestartWebServerRequest = RestartWebServerRequest

class EnvironmentConfig(google.protobuf.message.Message):
    """Configuration information for an environment."""
    DESCRIPTOR: google.protobuf.descriptor.Descriptor = ...
    class _EnvironmentSize:
        ValueType = typing.NewType('ValueType', builtins.int)
        V: typing_extensions.TypeAlias = ValueType
    class _EnvironmentSizeEnumTypeWrapper(google.protobuf.internal.enum_type_wrapper._EnumTypeWrapper[_EnvironmentSize.ValueType], builtins.type):
        DESCRIPTOR: google.protobuf.descriptor.EnumDescriptor = ...
        ENVIRONMENT_SIZE_UNSPECIFIED: EnvironmentConfig.EnvironmentSize.ValueType = ...  # 0
        """The size of the environment is unspecified."""

        ENVIRONMENT_SIZE_SMALL: EnvironmentConfig.EnvironmentSize.ValueType = ...  # 1
        """The environment size is small."""

        ENVIRONMENT_SIZE_MEDIUM: EnvironmentConfig.EnvironmentSize.ValueType = ...  # 2
        """The environment size is medium."""

        ENVIRONMENT_SIZE_LARGE: EnvironmentConfig.EnvironmentSize.ValueType = ...  # 3
        """The environment size is large."""

    class EnvironmentSize(_EnvironmentSize, metaclass=_EnvironmentSizeEnumTypeWrapper):
    ...
    def maintenance_window(self) -> global___MaintenanceWindow:
        ...
        pass
    @property
    def workloads_config(self) -> global___WorkloadsConfig:
        ...
        """
        pass
    environment_size: global___EnvironmentConfig.EnvironmentSize.ValueType = ...
...
class IPAllocationPolicy(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing_extensions.Literal["cluster_ipv4_cidr_block",b"cluster_ipv4_cidr_block","cluster_secondary_range_name",b"cluster_secondary_range_name","services_ipv4_cidr_block",b"services_ipv4_cidr_block","services_secondary_range_name",b"services_secondary_range_name","use_ip_aliases",b"use_ip_aliases"]) -> None: ...
...
class NodeConfig(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing_extensions.Literal["disk_size_gb",b"disk_size_gb","ip_allocation_policy",b"ip_allocation_policy","location",b"location","machine_type",b"machine_type","max_pods_per_node",b"max_pods_per_node","network",b"network","oauth_scopes",b"oauth_scopes","service_account",b"service_account","subnetwork",b"subnetwork","tags",b"tags"]) -> None: ...
...
class PrivateEnvironmentConfig(google.protobuf.message.Message):
    ...
    CLOUD_COMPOSER_NETWORK_IPV4_RESERVED_RANGE_FIELD_NUMBER: builtins.int
    ...
    cloud_composer_network_ipv4_cidr_block: typing.Text = ...
    ...
    cloud_composer_network_ipv4_reserved_range: typing.Text = ...
    ...
    def ClearField(self, field_name: typing_extensions.Literal["cloud_composer_network_ipv4_cidr_block",b"cloud_composer_network_ipv4_cidr_block","cloud_composer_network_ipv4_reserved_range",b"cloud_composer_network_ipv4_reserved_range","cloud_sql_ipv4_cidr_block",b"cloud_sql_ipv4_cidr_block","enable_private_environment",b"enable_private_environment","private_cluster_config",b"private_cluster_config","web_server_ipv4_cidr_block",b"web_server_ipv4_cidr_block","web_server_ipv4_reserved_range",b"web_server_ipv4_reserved_range"]) -> None: ...
...
class WorkloadsConfig(google.protobuf.message.Message):
    """The Kubernetes workloads configuration for GKE cluster associated with the
    Cloud Composer environment. Supported for Cloud Composer environments in
    versions composer-2.*.*-airflow-*.*.* and newer.
    """
    DESCRIPTOR: google.protobuf.descriptor.Descriptor = ...
    class SchedulerResource(google.protobuf.message.Message):
    ...
    class WebServerResource(google.protobuf.message.Message):
    ...
    class WorkerResource(google.protobuf.message.Message):
    ...
    @property
    def scheduler(self) -> global___WorkloadsConfig.SchedulerResource:
        """Optional. Resources used by Airflow schedulers."""
        pass
    @property
    def web_server(self) -> global___WorkloadsConfig.WebServerResource:
        """Optional. Resources used by Airflow web server."""
        pass
    @property
    def worker(self) -> global___WorkloadsConfig.WorkerResource:
        """Optional. Resources used by Airflow workers."""
        pass
    def __init__(self,
        *,
        scheduler : typing.Optional[global___WorkloadsConfig.SchedulerResource] = ...,
        web_server : typing.Optional[global___WorkloadsConfig.WebServerResource] = ...,
        worker : typing.Optional[global___WorkloadsConfig.WorkerResource] = ...,
        ) -> None: ...
...
global___WorkloadsConfig = WorkloadsConfig
...
class CheckUpgradeRequest(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing_extensions.Literal["environment",b"environment","image_version",b"image_version"]) -> None: ...
global___CheckUpgradeRequest = CheckUpgradeRequest
