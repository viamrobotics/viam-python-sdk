...
class Instance(google.protobuf.message.Message):
    ...
    class Node(google.protobuf.message.Message):
        ...
        UPDATE_AVAILABLE_FIELD_NUMBER: builtins.int
        node_id: typing.Text = ...
        ...
        def ClearField(self, field_name: typing_extensions.Literal["host",b"host","node_id",b"node_id","parameters",b"parameters","port",b"port","state",b"state","update_available",b"update_available","zone",b"zone"]) -> None: ...
...
class ListInstancesResponse(google.protobuf.message.Message):
    ...
    @property
    def resources(self) -> google.protobuf.internal.containers.RepeatedCompositeFieldContainer[global___Instance]:
    ...
    def __init__(self,
        *,
        resources : typing.Optional[typing.Iterable[global___Instance]] = ...,
        next_page_token : typing.Text = ...,
...
class CreateInstanceRequest(google.protobuf.message.Message):
    ...
    * Must be unique within the user project / location.
    ...
    @property
    def resource(self) -> global___Instance:
    ...
    def __init__(self,
        *,
        parent : typing.Text = ...,
        instance_id : typing.Text = ...,
        resource : typing.Optional[global___Instance] = ...,
        ) -> None: ...
    def HasField(self, field_name: typing_extensions.Literal["resource",b"resource"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["instance_id",b"instance_id","parent",b"parent","resource",b"resource"]) -> None: ...
...
class ApplySoftwareUpdateRequest(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing_extensions.Literal["apply_all",b"apply_all","instance",b"instance","node_ids",b"node_ids"]) -> None: ...
global___ApplySoftwareUpdateRequest = ApplySoftwareUpdateRequest
