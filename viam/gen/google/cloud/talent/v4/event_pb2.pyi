...
class ClientEvent(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing_extensions.Literal["create_time",b"create_time","event",b"event","job_event",b"job_event"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["create_time",b"create_time","event",b"event","event_id",b"event_id","event_notes",b"event_notes","job_event",b"job_event","request_id",b"request_id"]) -> None: ...
    def WhichOneof(self, oneof_group: typing_extensions.Literal["event",b"event"]) -> typing.Optional[typing_extensions.Literal["job_event"]]: ...
...
class JobEvent(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing_extensions.Literal["jobs",b"jobs","type",b"type"]) -> None: ...
