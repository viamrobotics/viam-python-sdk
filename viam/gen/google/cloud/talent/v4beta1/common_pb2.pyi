...
class _ContactInfoUsage:
    ValueType = typing.NewType('ValueType', builtins.int)
    V: typing_extensions.TypeAlias = ValueType
class _ContactInfoUsageEnumTypeWrapper(google.protobuf.internal.enum_type_wrapper._EnumTypeWrapper[_ContactInfoUsage.ValueType], builtins.type):
    DESCRIPTOR: google.protobuf.descriptor.EnumDescriptor = ...
    CONTACT_INFO_USAGE_UNSPECIFIED: ContactInfoUsage.ValueType = ...  # 0
    """Default value."""

    PERSONAL: ContactInfoUsage.ValueType = ...  # 1
    """Personal use."""

    WORK: ContactInfoUsage.ValueType = ...  # 2
    """Work use."""

    SCHOOL: ContactInfoUsage.ValueType = ...  # 3
    """School use."""

class ContactInfoUsage(_ContactInfoUsage, metaclass=_ContactInfoUsageEnumTypeWrapper):
...
global___ContactInfoUsage = ContactInfoUsage
...
class _SkillProficiencyLevel:
    ValueType = typing.NewType('ValueType', builtins.int)
    V: typing_extensions.TypeAlias = ValueType
class _SkillProficiencyLevelEnumTypeWrapper(google.protobuf.internal.enum_type_wrapper._EnumTypeWrapper[_SkillProficiencyLevel.ValueType], builtins.type):
    DESCRIPTOR: google.protobuf.descriptor.EnumDescriptor = ...
    SKILL_PROFICIENCY_LEVEL_UNSPECIFIED: SkillProficiencyLevel.ValueType = ...  # 0
    """Default value."""

    UNSKILLED: SkillProficiencyLevel.ValueType = ...  # 6
    """Lacks any proficiency in this skill."""

    FUNDAMENTAL_AWARENESS: SkillProficiencyLevel.ValueType = ...  # 1
    """Have a common knowledge or an understanding of basic techniques and
    concepts.
    """

    NOVICE: SkillProficiencyLevel.ValueType = ...  # 2
    """Have the level of experience gained in a classroom and/or experimental
    scenarios or as a trainee on-the-job.
    """

    INTERMEDIATE: SkillProficiencyLevel.ValueType = ...  # 3
    ...
    ADVANCED: SkillProficiencyLevel.ValueType = ...  # 4
    """Can perform the actions associated with this skill without assistance."""

    EXPERT: SkillProficiencyLevel.ValueType = ...  # 5
    """Known as an expert in this area."""

class SkillProficiencyLevel(_SkillProficiencyLevel, metaclass=_SkillProficiencyLevelEnumTypeWrapper):
...
global___SkillProficiencyLevel = SkillProficiencyLevel
...
class _OutcomeEnumTypeWrapper(google.protobuf.internal.enum_type_wrapper._EnumTypeWrapper[_Outcome.ValueType], builtins.type):
    ...
    OUTCOME_NOT_AVAILABLE: Outcome.ValueType = ...  # 4
...
class _AvailabilitySignalType:
    ValueType = typing.NewType('ValueType', builtins.int)
    V: typing_extensions.TypeAlias = ValueType
class _AvailabilitySignalTypeEnumTypeWrapper(google.protobuf.internal.enum_type_wrapper._EnumTypeWrapper[_AvailabilitySignalType.ValueType], builtins.type):
    DESCRIPTOR: google.protobuf.descriptor.EnumDescriptor = ...
    AVAILABILITY_SIGNAL_TYPE_UNSPECIFIED: AvailabilitySignalType.ValueType = ...  # 0
    """Default value."""

    JOB_APPLICATION: AvailabilitySignalType.ValueType = ...  # 1
    ...
    RESUME_UPDATE: AvailabilitySignalType.ValueType = ...  # 2
    ...
    CANDIDATE_UPDATE: AvailabilitySignalType.ValueType = ...  # 3
    ...
    CLIENT_SUBMISSION: AvailabilitySignalType.ValueType = ...  # 4
...
class AvailabilitySignalType(_AvailabilitySignalType, metaclass=_AvailabilitySignalTypeEnumTypeWrapper):
...
global___AvailabilitySignalType = AvailabilitySignalType
...
class CustomAttribute(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing_extensions.Literal["filterable",b"filterable","long_values",b"long_values","string_values",b"string_values"]) -> None: ...
...
class Certification(google.protobuf.message.Message):
    """Resource that represents a license or certification."""
    DESCRIPTOR: google.protobuf.descriptor.Descriptor = ...
    DISPLAY_NAME_FIELD_NUMBER: builtins.int
    ACQUIRE_DATE_FIELD_NUMBER: builtins.int
    ...
    @property
    def acquire_date(self) -> google.type.date_pb2.Date:
        """Acquisition date or effective date of license or certification."""
        pass
    @property
    def expire_date(self) -> google.type.date_pb2.Date:
    ...
    def __init__(self,
        *,
        display_name : typing.Text = ...,
        acquire_date : typing.Optional[google.type.date_pb2.Date] = ...,
        expire_date : typing.Optional[google.type.date_pb2.Date] = ...,
        authority : typing.Text = ...,
        description : typing.Text = ...,
        ) -> None: ...
    def HasField(self, field_name: typing_extensions.Literal["acquire_date",b"acquire_date","expire_date",b"expire_date"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["acquire_date",b"acquire_date","authority",b"authority","description",b"description","display_name",b"display_name","expire_date",b"expire_date"]) -> None: ...
global___Certification = Certification

class Skill(google.protobuf.message.Message):
    """Resource that represents a skill of a candidate."""
    DESCRIPTOR: google.protobuf.descriptor.Descriptor = ...
    DISPLAY_NAME_FIELD_NUMBER: builtins.int
    LAST_USED_DATE_FIELD_NUMBER: builtins.int
    LEVEL_FIELD_NUMBER: builtins.int
    CONTEXT_FIELD_NUMBER: builtins.int
    SKILL_NAME_SNIPPET_FIELD_NUMBER: builtins.int
    display_name: typing.Text = ...
    """Skill display name.
    ...
    @property
    def last_used_date(self) -> google.type.date_pb2.Date:
        """The last time this skill was used."""
        pass
    level: global___SkillProficiencyLevel.ValueType = ...
    ...
    skill_name_snippet: typing.Text = ...
    ...
    def __init__(self,
        *,
        display_name : typing.Text = ...,
        last_used_date : typing.Optional[google.type.date_pb2.Date] = ...,
        level : global___SkillProficiencyLevel.ValueType = ...,
        context : typing.Text = ...,
        skill_name_snippet : typing.Text = ...,
        ) -> None: ...
    def HasField(self, field_name: typing_extensions.Literal["last_used_date",b"last_used_date"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["context",b"context","display_name",b"display_name","last_used_date",b"last_used_date","level",b"level","skill_name_snippet",b"skill_name_snippet"]) -> None: ...
global___Skill = Skill

class Interview(google.protobuf.message.Message):
    """Details of an interview."""
    DESCRIPTOR: google.protobuf.descriptor.Descriptor = ...
    RATING_FIELD_NUMBER: builtins.int
    OUTCOME_FIELD_NUMBER: builtins.int
    @property
    def rating(self) -> global___Rating:
    ...
    def __init__(self,
        *,
        rating : typing.Optional[global___Rating] = ...,
        outcome : global___Outcome.ValueType = ...,
        ) -> None: ...
    def HasField(self, field_name: typing_extensions.Literal["rating",b"rating"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["outcome",b"outcome","rating",b"rating"]) -> None: ...
global___Interview = Interview
...
class Rating(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing_extensions.Literal["interval",b"interval","max",b"max","min",b"min","overall",b"overall"]) -> None: ...
