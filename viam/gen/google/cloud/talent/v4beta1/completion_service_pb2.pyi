...
class CompleteQueryRequest(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing_extensions.Literal["company",b"company","language_codes",b"language_codes","page_size",b"page_size","parent",b"parent","query",b"query","scope",b"scope","type",b"type"]) -> None: ...
