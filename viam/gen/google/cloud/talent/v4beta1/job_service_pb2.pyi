...
import google.cloud.talent.v4beta1.job_pb2
...
class CreateJobRequest(google.protobuf.message.Message):
    ...
    @property
    def job(self) -> google.cloud.talent.v4beta1.job_pb2.Job:
        """Required. The Job to be created."""
        pass
    def __init__(self,
        *,
        parent : typing.Text = ...,
        job : typing.Optional[google.cloud.talent.v4beta1.job_pb2.Job] = ...,
        ) -> None: ...
...
class ListJobsResponse(google.protobuf.message.Message):
    ...
    @property
    def jobs(self) -> google.protobuf.internal.containers.RepeatedCompositeFieldContainer[google.cloud.talent.v4beta1.job_pb2.Job]:
    ...
    def __init__(self,
        *,
        jobs : typing.Optional[typing.Iterable[google.cloud.talent.v4beta1.job_pb2.Job]] = ...,
        next_page_token : typing.Text = ...,
...
class SearchJobsRequest(google.protobuf.message.Message):
    ...
    REQUIRE_PRECISE_RESULT_SIZE_FIELD_NUMBER: builtins.int
    ...
    def request_metadata(self) -> google.cloud.talent.v4beta1.common_pb2.RequestMetadata:
        ...
        pass
    @property
    def job_query(self) -> google.cloud.talent.v4beta1.filters_pb2.JobQuery:
    ...
    require_precise_result_size: builtins.bool = ...
    ...
    * Location sorting: Use the special syntax to order jobs by distance:<br>
    ...
    def __init__(self,
        *,
        ...
        job_query : typing.Optional[google.cloud.talent.v4beta1.filters_pb2.JobQuery] = ...,
        enable_broadening : builtins.bool = ...,
        require_precise_result_size : builtins.bool = ...,
...
class SearchJobsResponse(google.protobuf.message.Message):
    ...
    class CommuteInfo(google.protobuf.message.Message):
        ...
        @property
        def job_location(self) -> google.cloud.talent.v4beta1.common_pb2.Location:
        ...
        def __init__(self,
            *,
            job_location : typing.Optional[google.cloud.talent.v4beta1.common_pb2.Location] = ...,
    ...
    @property
    def location_filters(self) -> google.protobuf.internal.containers.RepeatedCompositeFieldContainer[google.cloud.talent.v4beta1.common_pb2.Location]:
    ...
    def __init__(self,
        *,
        ...
        next_page_token : typing.Text = ...,
        location_filters : typing.Optional[typing.Iterable[google.cloud.talent.v4beta1.common_pb2.Location]] = ...,
        estimated_total_size : builtins.int = ...,
        total_size : builtins.int = ...,
        metadata : typing.Optional[google.cloud.talent.v4beta1.common_pb2.ResponseMetadata] = ...,
        broadened_query_jobs_count : builtins.int = ...,
    ...
    def ClearField(self, field_name: typing_extensions.Literal["broadened_query_jobs_count",b"broadened_query_jobs_count","estimated_total_size",b"estimated_total_size","histogram_query_results",b"histogram_query_results","location_filters",b"location_filters","matching_jobs",b"matching_jobs","metadata",b"metadata","next_page_token",b"next_page_token","spell_correction",b"spell_correction","total_size",b"total_size"]) -> None: ...
...
class JobOperationResult(google.protobuf.message.Message):
    ...
    @property
    def job_results(self) -> google.protobuf.internal.containers.RepeatedCompositeFieldContainer[global___JobOperationResult.JobResult]:
    ...
    def __init__(self,
        *,
        job_results : typing.Optional[typing.Iterable[global___JobOperationResult.JobResult]] = ...,
        ) -> None: ...
    def ClearField(self, field_name: typing_extensions.Literal["job_results",b"job_results"]) -> None: ...
global___JobOperationResult = JobOperationResult
