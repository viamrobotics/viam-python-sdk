...
class Task(google.protobuf.message.Message):
    ...
    * `TASK_ID` can contain only letters ([A-Za-z]), numbers ([0-9]),
    ...
    @property
    def app_engine_http_request(self) -> google.cloud.tasks.v2beta3.target_pb2.AppEngineHttpRequest:
        ...
        pass
    @property
    def http_request(self) -> google.cloud.tasks.v2beta3.target_pb2.HttpRequest:
        ...
        pass
    @property
    def pull_message(self) -> google.cloud.tasks.v2beta3.target_pb2.PullMessage:
    ...
    def __init__(self,
        *,
        name : typing.Text = ...,
        app_engine_http_request : typing.Optional[google.cloud.tasks.v2beta3.target_pb2.AppEngineHttpRequest] = ...,
        http_request : typing.Optional[google.cloud.tasks.v2beta3.target_pb2.HttpRequest] = ...,
        pull_message : typing.Optional[google.cloud.tasks.v2beta3.target_pb2.PullMessage] = ...,
    ...
    def HasField(self, field_name: typing_extensions.Literal["app_engine_http_request",b"app_engine_http_request","create_time",b"create_time","dispatch_deadline",b"dispatch_deadline","first_attempt",b"first_attempt","http_request",b"http_request","last_attempt",b"last_attempt","payload_type",b"payload_type","pull_message",b"pull_message","schedule_time",b"schedule_time"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["app_engine_http_request",b"app_engine_http_request","create_time",b"create_time","dispatch_count",b"dispatch_count","dispatch_deadline",b"dispatch_deadline","first_attempt",b"first_attempt","http_request",b"http_request","last_attempt",b"last_attempt","name",b"name","payload_type",b"payload_type","pull_message",b"pull_message","response_count",b"response_count","schedule_time",b"schedule_time","view",b"view"]) -> None: ...
    def WhichOneof(self, oneof_group: typing_extensions.Literal["payload_type",b"payload_type"]) -> typing.Optional[typing_extensions.Literal["app_engine_http_request","http_request","pull_message"]]: ...
global___Task = Task
