...
class ReadSession(google.protobuf.message.Message):
    ...
    class TableReadOptions(google.protobuf.message.Message):
        ...
        @property
        def arrow_serialization_options(self) -> google.cloud.bigquery.storage.v1.arrow_pb2.ArrowSerializationOptions:
        ...
        def __init__(self,
            *,
            ...
            row_restriction : typing.Text = ...,
            arrow_serialization_options : typing.Optional[google.cloud.bigquery.storage.v1.arrow_pb2.ArrowSerializationOptions] = ...,
            ) -> None: ...
        def HasField(self, field_name: typing_extensions.Literal["arrow_serialization_options",b"arrow_serialization_options","output_format_serialization_options",b"output_format_serialization_options"]) -> builtins.bool: ...
        def ClearField(self, field_name: typing_extensions.Literal["arrow_serialization_options",b"arrow_serialization_options","output_format_serialization_options",b"output_format_serialization_options","row_restriction",b"row_restriction","selected_fields",b"selected_fields"]) -> None: ...
        def WhichOneof(self, oneof_group: typing_extensions.Literal["output_format_serialization_options",b"output_format_serialization_options"]) -> typing.Optional[typing_extensions.Literal["arrow_serialization_options"]]: ...
    ...
    ESTIMATED_TOTAL_BYTES_SCANNED_FIELD_NUMBER: builtins.int
    name: typing.Text = ...
    ...
    @property
    def avro_schema(self) -> google.cloud.bigquery.storage.v1.avro_pb2.AvroSchema:
        """Output only. Avro schema."""
        pass
    @property
    def arrow_schema(self) -> google.cloud.bigquery.storage.v1.arrow_pb2.ArrowSchema:
    ...
    def streams(self) -> google.protobuf.internal.containers.RepeatedCompositeFieldContainer[global___ReadStream]:
        ...
        """
        pass
    estimated_total_bytes_scanned: builtins.int = ...
    ...
    def __init__(self,
        *,
        ...
        data_format : global___DataFormat.ValueType = ...,
        avro_schema : typing.Optional[google.cloud.bigquery.storage.v1.avro_pb2.AvroSchema] = ...,
        arrow_schema : typing.Optional[google.cloud.bigquery.storage.v1.arrow_pb2.ArrowSchema] = ...,
        table : typing.Text = ...,
    ...
    def ClearField(self, field_name: typing_extensions.Literal["arrow_schema",b"arrow_schema","avro_schema",b"avro_schema","data_format",b"data_format","estimated_total_bytes_scanned",b"estimated_total_bytes_scanned","expire_time",b"expire_time","name",b"name","read_options",b"read_options","schema",b"schema","streams",b"streams","table",b"table","table_modifiers",b"table_modifiers"]) -> None: ...
...
class WriteStream(google.protobuf.message.Message):
    ...
    class _WriteMode:
        ValueType = typing.NewType('ValueType', builtins.int)
        V: typing_extensions.TypeAlias = ValueType
    class _WriteModeEnumTypeWrapper(google.protobuf.internal.enum_type_wrapper._EnumTypeWrapper[_WriteMode.ValueType], builtins.type):
        DESCRIPTOR: google.protobuf.descriptor.EnumDescriptor = ...
        WRITE_MODE_UNSPECIFIED: WriteStream.WriteMode.ValueType = ...  # 0
        """Unknown type."""

        INSERT: WriteStream.WriteMode.ValueType = ...  # 1
    ...
    def commit_time(self) -> google.protobuf.timestamp_pb2.Timestamp:
        ...
        pass
    @property
    def table_schema(self) -> google.cloud.bigquery.storage.v1.table_pb2.TableSchema:
        ...
        """
        pass
    write_mode: global___WriteStream.WriteMode.ValueType = ...
    ...
    def __init__(self,
        *,
        ...
        table_schema : typing.Optional[google.cloud.bigquery.storage.v1.table_pb2.TableSchema] = ...,
        write_mode : global___WriteStream.WriteMode.ValueType = ...,
        ) -> None: ...
    ...
    def ClearField(self, field_name: typing_extensions.Literal["commit_time",b"commit_time","create_time",b"create_time","name",b"name","table_schema",b"table_schema","type",b"type","write_mode",b"write_mode"]) -> None: ...
