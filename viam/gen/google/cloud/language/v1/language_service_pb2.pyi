...
class Entity(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing_extensions.Literal["mentions",b"mentions","metadata",b"metadata","name",b"name","salience",b"salience","sentiment",b"sentiment","type",b"type"]) -> None: ...
...
class DependencyEdge(google.protobuf.message.Message):
    ...
    class _LabelEnumTypeWrapper(google.protobuf.internal.enum_type_wrapper._EnumTypeWrapper[_Label.ValueType], builtins.type):
        ...
        ASP: DependencyEdge.Label.ValueType = ...  # 77
        """Aspect marker"""

        GMOD: DependencyEdge.Label.ValueType = ...  # 78
        """Genitive modifier"""

        GOBJ: DependencyEdge.Label.ValueType = ...  # 79
        """Genitive object"""

        INFMOD: DependencyEdge.Label.ValueType = ...  # 80
        """Infinitival modifier"""

        MES: DependencyEdge.Label.ValueType = ...  # 81
        """Measure"""

        NCOMP: DependencyEdge.Label.ValueType = ...  # 82
...
class EntityMention(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing_extensions.Literal["sentiment",b"sentiment","text",b"text"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["sentiment",b"sentiment","text",b"text","type",b"type"]) -> None: ...
...
class ClassificationCategory(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing_extensions.Literal["confidence",b"confidence","name",b"name"]) -> None: ...
global___ClassificationCategory = ClassificationCategory
...
class AnalyzeEntitySentimentRequest(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing_extensions.Literal["document",b"document"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["document",b"document","encoding_type",b"encoding_type"]) -> None: ...
global___AnalyzeEntitySentimentRequest = AnalyzeEntitySentimentRequest

class AnalyzeEntitySentimentResponse(google.protobuf.message.Message):
...
global___AnalyzeEntitySentimentResponse = AnalyzeEntitySentimentResponse
...
class ClassifyTextRequest(google.protobuf.message.Message):
...
global___ClassifyTextRequest = ClassifyTextRequest

class ClassifyTextResponse(google.protobuf.message.Message):
    """The document classification response message."""
    DESCRIPTOR: google.protobuf.descriptor.Descriptor = ...
    CATEGORIES_FIELD_NUMBER: builtins.int
    @property
    def categories(self) -> google.protobuf.internal.containers.RepeatedCompositeFieldContainer[global___ClassificationCategory]:
        """Categories representing the input document."""
        pass
    def __init__(self,
        *,
        categories : typing.Optional[typing.Iterable[global___ClassificationCategory]] = ...,
        ) -> None: ...
    def ClearField(self, field_name: typing_extensions.Literal["categories",b"categories"]) -> None: ...
global___ClassifyTextResponse = ClassifyTextResponse
...
class AnnotateTextRequest(google.protobuf.message.Message):
    ...
    class Features(google.protobuf.message.Message):
        ...
        EXTRACT_ENTITY_SENTIMENT_FIELD_NUMBER: builtins.int
        CLASSIFY_TEXT_FIELD_NUMBER: builtins.int
        ...
        extract_entity_sentiment: builtins.bool = ...
        """Extract entities and their associated sentiment."""

        classify_text: builtins.bool = ...
        ...
        def ClearField(self, field_name: typing_extensions.Literal["classify_text",b"classify_text","extract_document_sentiment",b"extract_document_sentiment","extract_entities",b"extract_entities","extract_entity_sentiment",b"extract_entity_sentiment","extract_syntax",b"extract_syntax"]) -> None: ...
...
class AnnotateTextResponse(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing_extensions.Literal["document_sentiment",b"document_sentiment"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["categories",b"categories","document_sentiment",b"document_sentiment","entities",b"entities","language",b"language","sentences",b"sentences","tokens",b"tokens"]) -> None: ...
