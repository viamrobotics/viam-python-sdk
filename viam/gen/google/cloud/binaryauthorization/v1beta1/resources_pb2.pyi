...
class Attestor(google.protobuf.message.Message):
    ...
    NAME_FIELD_NUMBER: builtins.int
    DESCRIPTION_FIELD_NUMBER: builtins.int
    USER_OWNED_DRYDOCK_NOTE_FIELD_NUMBER: builtins.int
    UPDATE_TIME_FIELD_NUMBER: builtins.int
    name: typing.Text = ...
    ...
    @property
    def user_owned_drydock_note(self) -> global___UserOwnedDrydockNote:
    ...
    def __init__(self,
        *,
        name : typing.Text = ...,
        description : typing.Text = ...,
        user_owned_drydock_note : typing.Optional[global___UserOwnedDrydockNote] = ...,
        update_time : typing.Optional[google.protobuf.timestamp_pb2.Timestamp] = ...,
        ) -> None: ...
    def HasField(self, field_name: typing_extensions.Literal["attestor_type",b"attestor_type","update_time",b"update_time","user_owned_drydock_note",b"user_owned_drydock_note"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["attestor_type",b"attestor_type","description",b"description","name",b"name","update_time",b"update_time","user_owned_drydock_note",b"user_owned_drydock_note"]) -> None: ...
    def WhichOneof(self, oneof_group: typing_extensions.Literal["attestor_type",b"attestor_type"]) -> typing.Optional[typing_extensions.Literal["user_owned_drydock_note"]]: ...
global___Attestor = Attestor

class UserOwnedDrydockNote(google.protobuf.message.Message):
...
global___UserOwnedDrydockNote = UserOwnedDrydockNote
