...
class Block(google.protobuf.message.Message):
    ...
    def property(self) -> global___TextAnnotation.TextProperty:
        ...
        pass
    @property
    def bounding_box(self) -> google.cloud.vision.v1p1beta1.geometry_pb2.BoundingPoly:
    ...
    def __init__(self,
        *,
        property : typing.Optional[global___TextAnnotation.TextProperty] = ...,
        bounding_box : typing.Optional[google.cloud.vision.v1p1beta1.geometry_pb2.BoundingPoly] = ...,
