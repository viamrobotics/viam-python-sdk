...
import google.cloud.vision.v1.product_search_pb2
import google.cloud.vision.v1.text_annotation_pb2
import google.cloud.vision.v1.web_detection_pb2
...
class Feature(google.protobuf.message.Message):
    ...
    class _TypeEnumTypeWrapper(google.protobuf.internal.enum_type_wrapper._EnumTypeWrapper[_Type.ValueType], builtins.type):
        ...
        PRODUCT_SEARCH: Feature.Type.ValueType = ...  # 12
        """Run Product Search."""

        OBJECT_LOCALIZATION: Feature.Type.ValueType = ...  # 19
...
class FaceAnnotation(google.protobuf.message.Message):
    ...
    class Landmark(google.protobuf.message.Message):
        ...
        class _TypeEnumTypeWrapper(google.protobuf.internal.enum_type_wrapper._EnumTypeWrapper[_Type.ValueType], builtins.type):
            ...
            LEFT_CHEEK_CENTER: FaceAnnotation.Landmark.Type.ValueType = ...  # 35
            """Left cheek center."""

            RIGHT_CHEEK_CENTER: FaceAnnotation.Landmark.Type.ValueType = ...  # 36
            """Right cheek center."""
        ...
        @property
        def position(self) -> google.cloud.vision.v1.geometry_pb2.Position:
            """Face landmark position."""
            pass
        def __init__(self,
            *,
            type : global___FaceAnnotation.Landmark.Type.ValueType = ...,
            position : typing.Optional[google.cloud.vision.v1.geometry_pb2.Position] = ...,
            ) -> None: ...
    ...
    @property
    def bounding_poly(self) -> google.cloud.vision.v1.geometry_pb2.BoundingPoly:
        ...
        pass
    @property
    def fd_bounding_poly(self) -> google.cloud.vision.v1.geometry_pb2.BoundingPoly:
    ...
    def __init__(self,
        *,
        bounding_poly : typing.Optional[google.cloud.vision.v1.geometry_pb2.BoundingPoly] = ...,
        fd_bounding_poly : typing.Optional[google.cloud.vision.v1.geometry_pb2.BoundingPoly] = ...,
...
class LocalizedObjectAnnotation(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing_extensions.Literal["bounding_poly",b"bounding_poly"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["bounding_poly",b"bounding_poly","language_code",b"language_code","mid",b"mid","name",b"name","score",b"score"]) -> None: ...
global___LocalizedObjectAnnotation = LocalizedObjectAnnotation
...
class SafeSearchAnnotation(google.protobuf.message.Message):
    ...
    ADULT_CONFIDENCE_FIELD_NUMBER: builtins.int
    SPOOF_CONFIDENCE_FIELD_NUMBER: builtins.int
    MEDICAL_CONFIDENCE_FIELD_NUMBER: builtins.int
    VIOLENCE_CONFIDENCE_FIELD_NUMBER: builtins.int
    RACY_CONFIDENCE_FIELD_NUMBER: builtins.int
    NSFW_CONFIDENCE_FIELD_NUMBER: builtins.int
    ...
    def ClearField(self, field_name: typing_extensions.Literal["adult",b"adult","adult_confidence",b"adult_confidence","medical",b"medical","medical_confidence",b"medical_confidence","nsfw_confidence",b"nsfw_confidence","racy",b"racy","racy_confidence",b"racy_confidence","spoof",b"spoof","spoof_confidence",b"spoof_confidence","violence",b"violence","violence_confidence",b"violence_confidence"]) -> None: ...
...
class ImageContext(google.protobuf.message.Message):
    ...
    PRODUCT_SEARCH_PARAMS_FIELD_NUMBER: builtins.int
    ...
    def crop_hints_params(self) -> global___CropHintsParams:
        ...
        pass
    @property
    def product_search_params(self) -> google.cloud.vision.v1.product_search_pb2.ProductSearchParams:
    ...
    def __init__(self,
        *,
        ...
        product_search_params : typing.Optional[google.cloud.vision.v1.product_search_pb2.ProductSearchParams] = ...,
    ...
    def HasField(self, field_name: typing_extensions.Literal["crop_hints_params",b"crop_hints_params","lat_long_rect",b"lat_long_rect","product_search_params",b"product_search_params","text_detection_params",b"text_detection_params","web_detection_params",b"web_detection_params"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["crop_hints_params",b"crop_hints_params","language_hints",b"language_hints","lat_long_rect",b"lat_long_rect","product_search_params",b"product_search_params","text_detection_params",b"text_detection_params","web_detection_params",b"web_detection_params"]) -> None: ...
...
class AnnotateImageResponse(google.protobuf.message.Message):
    ...
    LOCALIZED_OBJECT_ANNOTATIONS_FIELD_NUMBER: builtins.int
    ...
    PRODUCT_SEARCH_RESULTS_FIELD_NUMBER: builtins.int
    ...
    def label_annotations(self) -> google.protobuf.internal.containers.RepeatedCompositeFieldContainer[global___EntityAnnotation]:
        ...
        pass
    @property
    def localized_object_annotations(self) -> google.protobuf.internal.containers.RepeatedCompositeFieldContainer[global___LocalizedObjectAnnotation]:
    ...
    def text_annotations(self) -> google.protobuf.internal.containers.RepeatedCompositeFieldContainer[global___EntityAnnotation]:
        ...
        pass
    @property
    def full_text_annotation(self) -> google.cloud.vision.v1.text_annotation_pb2.TextAnnotation:
    ...
    def crop_hints_annotation(self) -> global___CropHintsAnnotation:
        ...
        pass
    @property
    def web_detection(self) -> google.cloud.vision.v1.web_detection_pb2.WebDetection:
        """If present, web detection has completed successfully."""
        pass
    @property
    def product_search_results(self) -> google.cloud.vision.v1.product_search_pb2.ProductSearchResults:
    ...
    def __init__(self,
        *,
        ...
        localized_object_annotations : typing.Optional[typing.Iterable[global___LocalizedObjectAnnotation]] = ...,
        text_annotations : typing.Optional[typing.Iterable[global___EntityAnnotation]] = ...,
        full_text_annotation : typing.Optional[google.cloud.vision.v1.text_annotation_pb2.TextAnnotation] = ...,
        ...
        web_detection : typing.Optional[google.cloud.vision.v1.web_detection_pb2.WebDetection] = ...,
        product_search_results : typing.Optional[google.cloud.vision.v1.product_search_pb2.ProductSearchResults] = ...,
        error : typing.Optional[google.rpc.status_pb2.Status] = ...,
        context : typing.Optional[global___ImageAnnotationContext] = ...,
        ) -> None: ...
    def HasField(self, field_name: typing_extensions.Literal["context",b"context","crop_hints_annotation",b"crop_hints_annotation","error",b"error","full_text_annotation",b"full_text_annotation","image_properties_annotation",b"image_properties_annotation","product_search_results",b"product_search_results","safe_search_annotation",b"safe_search_annotation","web_detection",b"web_detection"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["context",b"context","crop_hints_annotation",b"crop_hints_annotation","error",b"error","face_annotations",b"face_annotations","full_text_annotation",b"full_text_annotation","image_properties_annotation",b"image_properties_annotation","label_annotations",b"label_annotations","landmark_annotations",b"landmark_annotations","localized_object_annotations",b"localized_object_annotations","logo_annotations",b"logo_annotations","product_search_results",b"product_search_results","safe_search_annotation",b"safe_search_annotation","text_annotations",b"text_annotations","web_detection",b"web_detection"]) -> None: ...
...
class AnnotateFileRequest(google.protobuf.message.Message):
    ...
    def image_context(self) -> global___ImageContext:
        ...
        pass
    @property
    def pages(self) -> google.protobuf.internal.containers.RepeatedScalarFieldContainer[builtins.int]:
    ...
    def __init__(self,
        *,
        ...
        features : typing.Optional[typing.Iterable[global___Feature]] = ...,
        image_context : typing.Optional[global___ImageContext] = ...,
        pages : typing.Optional[typing.Iterable[builtins.int]] = ...,
        ) -> None: ...
    def HasField(self, field_name: typing_extensions.Literal["image_context",b"image_context","input_config",b"input_config"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["features",b"features","image_context",b"image_context","input_config",b"input_config","pages",b"pages"]) -> None: ...
global___AnnotateFileRequest = AnnotateFileRequest
...
class AnnotateFileResponse(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing_extensions.Literal["error",b"error","input_config",b"input_config"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["error",b"error","input_config",b"input_config","responses",b"responses","total_pages",b"total_pages"]) -> None: ...
global___AnnotateFileResponse = AnnotateFileResponse

class BatchAnnotateFilesRequest(google.protobuf.message.Message):
    """A list of requests to annotate files using the BatchAnnotateFiles API."""
    DESCRIPTOR: google.protobuf.descriptor.Descriptor = ...
    REQUESTS_FIELD_NUMBER: builtins.int
    PARENT_FIELD_NUMBER: builtins.int
    @property
    def requests(self) -> google.protobuf.internal.containers.RepeatedCompositeFieldContainer[global___AnnotateFileRequest]:
    ...
    def __init__(self,
        *,
        requests : typing.Optional[typing.Iterable[global___AnnotateFileRequest]] = ...,
        parent : typing.Text = ...,
        ) -> None: ...
    def ClearField(self, field_name: typing_extensions.Literal["parent",b"parent","requests",b"requests"]) -> None: ...
global___BatchAnnotateFilesRequest = BatchAnnotateFilesRequest

class BatchAnnotateFilesResponse(google.protobuf.message.Message):
    """A list of file annotation responses."""
    DESCRIPTOR: google.protobuf.descriptor.Descriptor = ...
    RESPONSES_FIELD_NUMBER: builtins.int
    @property
    def responses(self) -> google.protobuf.internal.containers.RepeatedCompositeFieldContainer[global___AnnotateFileResponse]:
    ...
    def __init__(self,
        *,
        responses : typing.Optional[typing.Iterable[global___AnnotateFileResponse]] = ...,
        ) -> None: ...
    def ClearField(self, field_name: typing_extensions.Literal["responses",b"responses"]) -> None: ...
global___BatchAnnotateFilesResponse = BatchAnnotateFilesResponse
...
class AsyncBatchAnnotateImagesRequest(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing_extensions.Literal["output_config",b"output_config"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["output_config",b"output_config","parent",b"parent","requests",b"requests"]) -> None: ...
global___AsyncBatchAnnotateImagesRequest = AsyncBatchAnnotateImagesRequest

class AsyncBatchAnnotateImagesResponse(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing_extensions.Literal["output_config",b"output_config"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["output_config",b"output_config"]) -> None: ...
global___AsyncBatchAnnotateImagesResponse = AsyncBatchAnnotateImagesResponse
...
class InputConfig(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing_extensions.Literal["content",b"content","gcs_source",b"gcs_source","mime_type",b"mime_type"]) -> None: ...
