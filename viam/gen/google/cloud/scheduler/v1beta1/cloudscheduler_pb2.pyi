...
class ListJobsResponse(google.protobuf.message.Message):
    ...
    @property
    def jobs(self) -> google.protobuf.internal.containers.RepeatedCompositeFieldContainer[google.cloud.scheduler.v1beta1.job_pb2.Job]:
        """The list of jobs."""
        pass
    ...
    def __init__(self,
        *,
        jobs : typing.Optional[typing.Iterable[google.cloud.scheduler.v1beta1.job_pb2.Job]] = ...,
        next_page_token : typing.Text = ...,
        ) -> None: ...
...
class CreateJobRequest(google.protobuf.message.Message):
    ...
    @property
    def job(self) -> google.cloud.scheduler.v1beta1.job_pb2.Job:
    ...
    def __init__(self,
        *,
        parent : typing.Text = ...,
        job : typing.Optional[google.cloud.scheduler.v1beta1.job_pb2.Job] = ...,
        ) -> None: ...
