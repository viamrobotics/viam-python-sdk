...
class Budget(google.protobuf.message.Message):
    ...
    NOTIFICATIONS_RULE_FIELD_NUMBER: builtins.int
    ...
    def threshold_rules(self) -> google.protobuf.internal.containers.RepeatedCompositeFieldContainer[global___ThresholdRule]:
        ...
        pass
    @property
    def notifications_rule(self) -> global___NotificationsRule:
    ...
    def __init__(self,
        *,
        ...
        notifications_rule : typing.Optional[global___NotificationsRule] = ...,
        etag : typing.Text = ...,
        ) -> None: ...
    def HasField(self, field_name: typing_extensions.Literal["amount",b"amount","budget_filter",b"budget_filter","notifications_rule",b"notifications_rule"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["amount",b"amount","budget_filter",b"budget_filter","display_name",b"display_name","etag",b"etag","name",b"name","notifications_rule",b"notifications_rule","threshold_rules",b"threshold_rules"]) -> None: ...
...
class NotificationsRule(google.protobuf.message.Message):
...
global___NotificationsRule = NotificationsRule
