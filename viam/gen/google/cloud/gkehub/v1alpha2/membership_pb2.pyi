...
class CreateMembershipRequest(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing_extensions.Literal["membership_id",b"membership_id","parent",b"parent","resource",b"resource"]) -> None: ...
...
class UpdateMembershipRequest(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing_extensions.Literal["name",b"name","resource",b"resource","update_mask",b"update_mask"]) -> None: ...
...
class GenerateConnectManifestRequest(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing_extensions.Literal["image_pull_secret_content",b"image_pull_secret_content","is_upgrade",b"is_upgrade","name",b"name","namespace",b"namespace","proxy",b"proxy","registry",b"registry","version",b"version"]) -> None: ...
...
class InitializeHubRequest(google.protobuf.message.Message):
...
global___InitializeHubRequest = InitializeHubRequest

class InitializeHubResponse(google.protobuf.message.Message):
    """Response message for the InitializeHub method."""
    DESCRIPTOR: google.protobuf.descriptor.Descriptor = ...
    SERVICE_IDENTITY_FIELD_NUMBER: builtins.int
    WORKLOAD_IDENTITY_POOL_FIELD_NUMBER: builtins.int
    service_identity: typing.Text = ...
    ...
    def ClearField(self, field_name: typing_extensions.Literal["service_identity",b"service_identity","workload_identity_pool",b"workload_identity_pool"]) -> None: ...
global___InitializeHubResponse = InitializeHubResponse
