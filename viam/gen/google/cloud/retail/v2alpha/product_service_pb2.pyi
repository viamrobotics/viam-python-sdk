...
class ListProductsRequest(google.protobuf.message.Message):
    ...
    REQUIRE_TOTAL_SIZE_FIELD_NUMBER: builtins.int
    parent: typing.Text = ...
    ...
    * List [Product][google.cloud.retail.v2alpha.Product]s with a partibular
    ...
    def read_mask(self) -> google.protobuf.field_mask_pb2.FieldMask:
        ...
        * [Product.brands][google.cloud.retail.v2alpha.Product.brands]
        ...
        """
        pass
    require_total_size: builtins.bool = ...
    """If true and
    ...
    def ClearField(self, field_name: typing_extensions.Literal["filter",b"filter","page_size",b"page_size","page_token",b"page_token","parent",b"parent","read_mask",b"read_mask","require_total_size",b"require_total_size"]) -> None: ...
...
class ListProductsResponse(google.protobuf.message.Message):
    ...
    @property
    def products(self) -> google.protobuf.internal.containers.RepeatedCompositeFieldContainer[google.cloud.retail.v2alpha.product_pb2.Product]:
    ...
    def __init__(self,
        *,
        products : typing.Optional[typing.Iterable[google.cloud.retail.v2alpha.product_pb2.Product]] = ...,
        next_page_token : typing.Text = ...,
        total_size : builtins.int = ...,
        ) -> None: ...
    def ClearField(self, field_name: typing_extensions.Literal["next_page_token",b"next_page_token","products",b"products","total_size",b"total_size"]) -> None: ...
...
class SetInventoryRequest(google.protobuf.message.Message):
    ...
    ALLOW_MISSING_FIELD_NUMBER: builtins.int
    @property
    def inventory(self) -> google.cloud.retail.v2alpha.product_pb2.Product:
    ...
    def __init__(self,
        *,
        inventory : typing.Optional[google.cloud.retail.v2alpha.product_pb2.Product] = ...,
...
class AddLocalInventoriesRequest(google.protobuf.message.Message):
    """Request message for [AddLocalInventories][] method."""
    DESCRIPTOR: google.protobuf.descriptor.Descriptor = ...
    PRODUCT_FIELD_NUMBER: builtins.int
    LOCAL_INVENTORIES_FIELD_NUMBER: builtins.int
    ADD_MASK_FIELD_NUMBER: builtins.int
    ADD_TIME_FIELD_NUMBER: builtins.int
    ALLOW_MISSING_FIELD_NUMBER: builtins.int
    product: typing.Text = ...
    """Required. Full resource name of
    ...
    @property
    def local_inventories(self) -> google.protobuf.internal.containers.RepeatedCompositeFieldContainer[google.cloud.retail.v2alpha.common_pb2.LocalInventory]:
        ...
        pass
    @property
    def add_mask(self) -> google.protobuf.field_mask_pb2.FieldMask:
    ...
    def __init__(self,
        *,
        product : typing.Text = ...,
        local_inventories : typing.Optional[typing.Iterable[google.cloud.retail.v2alpha.common_pb2.LocalInventory]] = ...,
        add_mask : typing.Optional[google.protobuf.field_mask_pb2.FieldMask] = ...,
        add_time : typing.Optional[google.protobuf.timestamp_pb2.Timestamp] = ...,
        allow_missing : builtins.bool = ...,
        ) -> None: ...
    def HasField(self, field_name: typing_extensions.Literal["add_mask",b"add_mask","add_time",b"add_time"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["add_mask",b"add_mask","add_time",b"add_time","allow_missing",b"allow_missing","local_inventories",b"local_inventories","product",b"product"]) -> None: ...
global___AddLocalInventoriesRequest = AddLocalInventoriesRequest

class AddLocalInventoriesMetadata(google.protobuf.message.Message):
...
global___AddLocalInventoriesMetadata = AddLocalInventoriesMetadata

class AddLocalInventoriesResponse(google.protobuf.message.Message):
...
global___AddLocalInventoriesResponse = AddLocalInventoriesResponse

class RemoveLocalInventoriesRequest(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing_extensions.Literal["allow_missing",b"allow_missing","place_ids",b"place_ids","product",b"product","remove_time",b"remove_time"]) -> None: ...
global___RemoveLocalInventoriesRequest = RemoveLocalInventoriesRequest

class RemoveLocalInventoriesMetadata(google.protobuf.message.Message):
...
global___RemoveLocalInventoriesMetadata = RemoveLocalInventoriesMetadata

class RemoveLocalInventoriesResponse(google.protobuf.message.Message):
...
global___RemoveLocalInventoriesResponse = RemoveLocalInventoriesResponse
