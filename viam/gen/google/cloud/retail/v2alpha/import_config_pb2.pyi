...
class UserEventInlineSource(google.protobuf.message.Message):
    ...
    @property
    def user_events(self) -> google.protobuf.internal.containers.RepeatedCompositeFieldContainer[google.cloud.retail.v2alpha.user_event_pb2.UserEvent]:
        """Required. A list of user events to import. Recommended max of 10k items."""
        pass
    def __init__(self,
        *,
        user_events : typing.Optional[typing.Iterable[google.cloud.retail.v2alpha.user_event_pb2.UserEvent]] = ...,
        ) -> None: ...
