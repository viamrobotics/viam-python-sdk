...
class SearchRequest(google.protobuf.message.Message):
    ...
    class _RelevanceThreshold:
        ValueType = typing.NewType('ValueType', builtins.int)
        V: typing_extensions.TypeAlias = ValueType
    class _RelevanceThresholdEnumTypeWrapper(google.protobuf.internal.enum_type_wrapper._EnumTypeWrapper[_RelevanceThreshold.ValueType], builtins.type):
        DESCRIPTOR: google.protobuf.descriptor.EnumDescriptor = ...
        RELEVANCE_THRESHOLD_UNSPECIFIED: SearchRequest.RelevanceThreshold.ValueType = ...  # 0
        """Default value. Defaults to
        [RelevanceThreshold.HIGH][google.cloud.retail.v2alpha.SearchRequest.RelevanceThreshold.HIGH].
        """

        HIGH: SearchRequest.RelevanceThreshold.ValueType = ...  # 1
        """High relevance threshold."""

        MEDIUM: SearchRequest.RelevanceThreshold.ValueType = ...  # 2
        """Medium relevance threshold."""

        LOW: SearchRequest.RelevanceThreshold.ValueType = ...  # 3
        """Low relevance threshold."""

        LOWEST: SearchRequest.RelevanceThreshold.ValueType = ...  # 4
        """Lowest relevance threshold."""

    class RelevanceThreshold(_RelevanceThreshold, metaclass=_RelevanceThresholdEnumTypeWrapper):
    ...
    class FacetSpec(google.protobuf.message.Message):
        ...
        class FacetKey(google.protobuf.message.Message):
            ...
            * numerical_field =
            ...
            @property
            def intervals(self) -> google.protobuf.internal.containers.RepeatedCompositeFieldContainer[google.cloud.retail.v2alpha.common_pb2.Interval]:
            ...
            * "value desc", which means order by [Facet.FacetValue.value][]
            ...
            def __init__(self,
                *,
                key : typing.Text = ...,
                intervals : typing.Optional[typing.Iterable[google.cloud.retail.v2alpha.common_pb2.Interval]] = ...,
    ...
    RELEVANCE_THRESHOLD_FIELD_NUMBER: builtins.int
    ...
    def query_expansion_spec(self) -> global___SearchRequest.QueryExpansionSpec:
        ...
        """
        pass
    relevance_threshold: global___SearchRequest.RelevanceThreshold.ValueType = ...
    ...
    def ClearField(self, field_name: typing_extensions.Literal["boost_spec",b"boost_spec","branch",b"branch","canonical_filter",b"canonical_filter","dynamic_facet_spec",b"dynamic_facet_spec","facet_specs",b"facet_specs","filter",b"filter","offset",b"offset","order_by",b"order_by","page_categories",b"page_categories","page_size",b"page_size","page_token",b"page_token","placement",b"placement","query",b"query","query_expansion_spec",b"query_expansion_spec","relevance_threshold",b"relevance_threshold","search_mode",b"search_mode","user_info",b"user_info","variant_rollup_keys",b"variant_rollup_keys","visitor_id",b"visitor_id"]) -> None: ...
...
class SearchResponse(google.protobuf.message.Message):
    ...
    class Facet(google.protobuf.message.Message):
        ...
        class FacetValue(google.protobuf.message.Message):
            ...
            @property
            def interval(self) -> google.cloud.retail.v2alpha.common_pb2.Interval:
            ...
            def __init__(self,
                *,
                value : typing.Text = ...,
                interval : typing.Optional[google.cloud.retail.v2alpha.common_pb2.Interval] = ...,
                count : builtins.int = ...,
                ) -> None: ...
