...
class ListSecretsResponse(google.protobuf.message.Message):
    ...
    @property
    def secrets(self) -> google.protobuf.internal.containers.RepeatedCompositeFieldContainer[google.cloud.secretmanager.v1.resources_pb2.Secret]:
    ...
    def __init__(self,
        *,
        secrets : typing.Optional[typing.Iterable[google.cloud.secretmanager.v1.resources_pb2.Secret]] = ...,
        next_page_token : typing.Text = ...,
        total_size : builtins.int = ...,
        ) -> None: ...
...
class CreateSecretRequest(google.protobuf.message.Message):
    ...
    @property
    def secret(self) -> google.cloud.secretmanager.v1.resources_pb2.Secret:
    ...
    def __init__(self,
        *,
        parent : typing.Text = ...,
        secret_id : typing.Text = ...,
        secret : typing.Optional[google.cloud.secretmanager.v1.resources_pb2.Secret] = ...,
        ) -> None: ...
...
class AddSecretVersionRequest(google.protobuf.message.Message):
    ...
    @property
    def payload(self) -> google.cloud.secretmanager.v1.resources_pb2.SecretPayload:
        """Required. The secret payload of the [SecretVersion][google.cloud.secretmanager.v1.SecretVersion]."""
        pass
    def __init__(self,
        *,
        parent : typing.Text = ...,
        payload : typing.Optional[google.cloud.secretmanager.v1.resources_pb2.SecretPayload] = ...,
        ) -> None: ...
...
class ListSecretVersionsResponse(google.protobuf.message.Message):
    ...
    TOTAL_SIZE_FIELD_NUMBER: builtins.int
    @property
    def versions(self) -> google.protobuf.internal.containers.RepeatedCompositeFieldContainer[google.cloud.secretmanager.v1.resources_pb2.SecretVersion]:
    ...
    def __init__(self,
        *,
        versions : typing.Optional[typing.Iterable[google.cloud.secretmanager.v1.resources_pb2.SecretVersion]] = ...,
        next_page_token : typing.Text = ...,
        total_size : builtins.int = ...,
        ) -> None: ...
