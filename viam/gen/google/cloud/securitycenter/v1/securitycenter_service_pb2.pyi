...
class BulkMuteFindingsRequest(google.protobuf.message.Message):
    ...
    MUTE_ANNOTATION_FIELD_NUMBER: builtins.int
    parent: typing.Text = ...
    ...
    * boolean literals `true` and `false` without quotes.
    ...
    def ClearField(self, field_name: typing_extensions.Literal["filter",b"filter","mute_annotation",b"mute_annotation","parent",b"parent"]) -> None: ...
global___BulkMuteFindingsRequest = BulkMuteFindingsRequest

class BulkMuteFindingsResponse(google.protobuf.message.Message):
    """The response to a BulkMute request. Contains the LRO information."""
    DESCRIPTOR: google.protobuf.descriptor.Descriptor = ...
    def __init__(self,
        ) -> None: ...
global___BulkMuteFindingsResponse = BulkMuteFindingsResponse
...
class CreateFindingRequest(google.protobuf.message.Message):
    ...
    @property
    def finding(self) -> google.cloud.securitycenter.v1.finding_pb2.Finding:
    ...
    def __init__(self,
        *,
        parent : typing.Text = ...,
        finding_id : typing.Text = ...,
        finding : typing.Optional[google.cloud.securitycenter.v1.finding_pb2.Finding] = ...,
        ) -> None: ...
...
class CreateMuteConfigRequest(google.protobuf.message.Message):
    """Request message for creating a mute config."""
    DESCRIPTOR: google.protobuf.descriptor.Descriptor = ...
    PARENT_FIELD_NUMBER: builtins.int
    MUTE_CONFIG_FIELD_NUMBER: builtins.int
    MUTE_CONFIG_ID_FIELD_NUMBER: builtins.int
    parent: typing.Text = ...
    ...
    @property
    def mute_config(self) -> google.cloud.securitycenter.v1.mute_config_pb2.MuteConfig:
        """Required. The mute config being created."""
        pass
    mute_config_id: typing.Text = ...
    """Required. Unique identifier provided by the client within the parent scope.
    ...
    def __init__(self,
        *,
        parent : typing.Text = ...,
        mute_config : typing.Optional[google.cloud.securitycenter.v1.mute_config_pb2.MuteConfig] = ...,
        mute_config_id : typing.Text = ...,
        ) -> None: ...
    def HasField(self, field_name: typing_extensions.Literal["mute_config",b"mute_config"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["mute_config",b"mute_config","mute_config_id",b"mute_config_id","parent",b"parent"]) -> None: ...
global___CreateMuteConfigRequest = CreateMuteConfigRequest
...
class CreateNotificationConfigRequest(google.protobuf.message.Message):
    ...
    @property
    def notification_config(self) -> google.cloud.securitycenter.v1.notification_config_pb2.NotificationConfig:
    ...
    def __init__(self,
        *,
        parent : typing.Text = ...,
        config_id : typing.Text = ...,
        notification_config : typing.Optional[google.cloud.securitycenter.v1.notification_config_pb2.NotificationConfig] = ...,
        ) -> None: ...
...
class CreateSourceRequest(google.protobuf.message.Message):
    ...
    @property
    def source(self) -> google.cloud.securitycenter.v1.source_pb2.Source:
    ...
    def __init__(self,
        *,
        parent : typing.Text = ...,
        source : typing.Optional[google.cloud.securitycenter.v1.source_pb2.Source] = ...,
        ) -> None: ...
...
class DeleteMuteConfigRequest(google.protobuf.message.Message):
...
global___DeleteMuteConfigRequest = DeleteMuteConfigRequest
...
class GetMuteConfigRequest(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing_extensions.Literal["name",b"name"]) -> None: ...
global___GetMuteConfigRequest = GetMuteConfigRequest
...
class ListMuteConfigsRequest(google.protobuf.message.Message):
...
global___ListMuteConfigsRequest = ListMuteConfigsRequest

class ListMuteConfigsResponse(google.protobuf.message.Message):
    """Response message for listing mute configs."""
    DESCRIPTOR: google.protobuf.descriptor.Descriptor = ...
    MUTE_CONFIGS_FIELD_NUMBER: builtins.int
    NEXT_PAGE_TOKEN_FIELD_NUMBER: builtins.int
    @property
    def mute_configs(self) -> google.protobuf.internal.containers.RepeatedCompositeFieldContainer[google.cloud.securitycenter.v1.mute_config_pb2.MuteConfig]:
    ...
    def __init__(self,
        *,
        mute_configs : typing.Optional[typing.Iterable[google.cloud.securitycenter.v1.mute_config_pb2.MuteConfig]] = ...,
        next_page_token : typing.Text = ...,
        ) -> None: ...
    def ClearField(self, field_name: typing_extensions.Literal["mute_configs",b"mute_configs","next_page_token",b"next_page_token"]) -> None: ...
global___ListMuteConfigsResponse = ListMuteConfigsResponse
...
class ListNotificationConfigsResponse(google.protobuf.message.Message):
    ...
    NEXT_PAGE_TOKEN_FIELD_NUMBER: builtins.int
    @property
    def notification_configs(self) -> google.protobuf.internal.containers.RepeatedCompositeFieldContainer[google.cloud.securitycenter.v1.notification_config_pb2.NotificationConfig]:
    ...
    def __init__(self,
        *,
        notification_configs : typing.Optional[typing.Iterable[google.cloud.securitycenter.v1.notification_config_pb2.NotificationConfig]] = ...,
        next_page_token : typing.Text = ...,
        ) -> None: ...
...
class ListSourcesResponse(google.protobuf.message.Message):
    ...
    NEXT_PAGE_TOKEN_FIELD_NUMBER: builtins.int
    @property
    def sources(self) -> google.protobuf.internal.containers.RepeatedCompositeFieldContainer[google.cloud.securitycenter.v1.source_pb2.Source]:
    ...
    def __init__(self,
        *,
        sources : typing.Optional[typing.Iterable[google.cloud.securitycenter.v1.source_pb2.Source]] = ...,
        next_page_token : typing.Text = ...,
        ) -> None: ...
...
class ListAssetsResponse(google.protobuf.message.Message):
    ...
    class ListAssetsResult(google.protobuf.message.Message):
        ...
        @property
        def asset(self) -> google.cloud.securitycenter.v1.asset_pb2.Asset:
        ...
        def __init__(self,
            *,
            asset : typing.Optional[google.cloud.securitycenter.v1.asset_pb2.Asset] = ...,
            state_change : global___ListAssetsResponse.ListAssetsResult.StateChange.ValueType = ...,
            ) -> None: ...
...
class ListFindingsResponse(google.protobuf.message.Message):
    ...
    class ListFindingsResult(google.protobuf.message.Message):
        ...
        class Resource(google.protobuf.message.Message):
            ...
            @property
            def folders(self) -> google.protobuf.internal.containers.RepeatedCompositeFieldContainer[google.cloud.securitycenter.v1.folder_pb2.Folder]:
            ...
            def __init__(self,
                *,
                ...
                parent_display_name : typing.Text = ...,
                type : typing.Text = ...,
                folders : typing.Optional[typing.Iterable[google.cloud.securitycenter.v1.folder_pb2.Folder]] = ...,
                display_name : typing.Text = ...,
                ) -> None: ...
            def ClearField(self, field_name: typing_extensions.Literal["display_name",b"display_name","folders",b"folders","name",b"name","parent_display_name",b"parent_display_name","parent_name",b"parent_name","project_display_name",b"project_display_name","project_name",b"project_name","type",b"type"]) -> None: ...
...
class SetFindingStateRequest(google.protobuf.message.Message):
    ...
    state: google.cloud.securitycenter.v1.finding_pb2.Finding.State.ValueType = ...
...
class SetMuteRequest(google.protobuf.message.Message):
    ...
    mute: google.cloud.securitycenter.v1.finding_pb2.Finding.Mute.ValueType = ...
    ...
    def ClearField(self, field_name: typing_extensions.Literal["mute",b"mute","name",b"name"]) -> None: ...
global___SetMuteRequest = SetMuteRequest
...
class UpdateExternalSystemRequest(google.protobuf.message.Message):
    """Request message for updating a ExternalSystem resource."""
    DESCRIPTOR: google.protobuf.descriptor.Descriptor = ...
    EXTERNAL_SYSTEM_FIELD_NUMBER: builtins.int
    UPDATE_MASK_FIELD_NUMBER: builtins.int
    @property
    def external_system(self) -> google.cloud.securitycenter.v1.external_system_pb2.ExternalSystem:
    ...
    def __init__(self,
        *,
        external_system : typing.Optional[google.cloud.securitycenter.v1.external_system_pb2.ExternalSystem] = ...,
        update_mask : typing.Optional[google.protobuf.field_mask_pb2.FieldMask] = ...,
        ) -> None: ...
    def HasField(self, field_name: typing_extensions.Literal["external_system",b"external_system","update_mask",b"update_mask"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["external_system",b"external_system","update_mask",b"update_mask"]) -> None: ...
global___UpdateExternalSystemRequest = UpdateExternalSystemRequest
...
class UpdateMuteConfigRequest(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing_extensions.Literal["mute_config",b"mute_config","update_mask",b"update_mask"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["mute_config",b"mute_config","update_mask",b"update_mask"]) -> None: ...
global___UpdateMuteConfigRequest = UpdateMuteConfigRequest
...
class UpdateOrganizationSettingsRequest(google.protobuf.message.Message):
    ...
    UPDATE_MASK_FIELD_NUMBER: builtins.int
    @property
    def organization_settings(self) -> google.cloud.securitycenter.v1.organization_settings_pb2.OrganizationSettings:
    ...
    def __init__(self,
        *,
        organization_settings : typing.Optional[google.cloud.securitycenter.v1.organization_settings_pb2.OrganizationSettings] = ...,
        update_mask : typing.Optional[google.protobuf.field_mask_pb2.FieldMask] = ...,
        ) -> None: ...
