...
class CreateTrainingPipelineRequest(google.protobuf.message.Message):
    ...
    @property
    def training_pipeline(self) -> google.cloud.aiplatform.v1.training_pipeline_pb2.TrainingPipeline:
        """Required. The TrainingPipeline to create."""
        pass
    def __init__(self,
        *,
        parent : typing.Text = ...,
        training_pipeline : typing.Optional[google.cloud.aiplatform.v1.training_pipeline_pb2.TrainingPipeline] = ...,
        ) -> None: ...
...
class ListTrainingPipelinesResponse(google.protobuf.message.Message):
    ...
    @property
    def training_pipelines(self) -> google.protobuf.internal.containers.RepeatedCompositeFieldContainer[google.cloud.aiplatform.v1.training_pipeline_pb2.TrainingPipeline]:
    ...
    def __init__(self,
        *,
        training_pipelines : typing.Optional[typing.Iterable[google.cloud.aiplatform.v1.training_pipeline_pb2.TrainingPipeline]] = ...,
        next_page_token : typing.Text = ...,
        ) -> None: ...
...
class CreatePipelineJobRequest(google.protobuf.message.Message):
    ...
    @property
    def pipeline_job(self) -> google.cloud.aiplatform.v1.pipeline_job_pb2.PipelineJob:
    ...
    def __init__(self,
        *,
        parent : typing.Text = ...,
        pipeline_job : typing.Optional[google.cloud.aiplatform.v1.pipeline_job_pb2.PipelineJob] = ...,
        pipeline_job_id : typing.Text = ...,
        ) -> None: ...
...
class ListPipelineJobsResponse(google.protobuf.message.Message):
    ...
    NEXT_PAGE_TOKEN_FIELD_NUMBER: builtins.int
    @property
    def pipeline_jobs(self) -> google.protobuf.internal.containers.RepeatedCompositeFieldContainer[google.cloud.aiplatform.v1.pipeline_job_pb2.PipelineJob]:
    ...
    def __init__(self,
        *,
        pipeline_jobs : typing.Optional[typing.Iterable[google.cloud.aiplatform.v1.pipeline_job_pb2.PipelineJob]] = ...,
        next_page_token : typing.Text = ...,
        ) -> None: ...
