...
import google.cloud.aiplatform.v1.model_monitoring_pb2
...
class ModelDeploymentMonitoringJob(google.protobuf.message.Message):
    ...
    def model_deployment_monitoring_schedule_config(self) -> global___ModelDeploymentMonitoringScheduleConfig:
        ...
        pass
    @property
    def logging_sampling_strategy(self) -> google.cloud.aiplatform.v1.model_monitoring_pb2.SamplingStrategy:
        """Required. Sample Strategy for logging."""
        pass
    @property
    def model_monitoring_alert_config(self) -> google.cloud.aiplatform.v1.model_monitoring_pb2.ModelMonitoringAlertConfig:
    ...
    def next_schedule_time(self) -> google.protobuf.timestamp_pb2.Timestamp:
        ...
        pass
    @property
    def stats_anomalies_base_directory(self) -> google.cloud.aiplatform.v1.io_pb2.GcsDestination:
    ...
    def __init__(self,
        *,
        ...
        logging_sampling_strategy : typing.Optional[google.cloud.aiplatform.v1.model_monitoring_pb2.SamplingStrategy] = ...,
        model_monitoring_alert_config : typing.Optional[google.cloud.aiplatform.v1.model_monitoring_pb2.ModelMonitoringAlertConfig] = ...,
        predict_instance_schema_uri : typing.Text = ...,
        ...
        stats_anomalies_base_directory : typing.Optional[google.cloud.aiplatform.v1.io_pb2.GcsDestination] = ...,
...
class ModelDeploymentMonitoringObjectiveConfig(google.protobuf.message.Message):
    ...
    @property
    def objective_config(self) -> google.cloud.aiplatform.v1.model_monitoring_pb2.ModelMonitoringObjectiveConfig:
        """The objective config of for the modelmonitoring job of this deployed model."""
        pass
    def __init__(self,
        *,
        deployed_model_id : typing.Text = ...,
        objective_config : typing.Optional[google.cloud.aiplatform.v1.model_monitoring_pb2.ModelMonitoringObjectiveConfig] = ...,
        ) -> None: ...
...
class ModelMonitoringStatsAnomalies(google.protobuf.message.Message):
    ...
    class FeatureHistoricStatsAnomalies(google.protobuf.message.Message):
        ...
        @property
        def threshold(self) -> google.cloud.aiplatform.v1.model_monitoring_pb2.ThresholdConfig:
            """Threshold for anomaly detection."""
            pass
        @property
        def training_stats(self) -> google.cloud.aiplatform.v1.feature_monitoring_stats_pb2.FeatureStatsAnomaly:
            """Stats calculated for the Training Dataset."""
            pass
        @property
        def prediction_stats(self) -> google.protobuf.internal.containers.RepeatedCompositeFieldContainer[google.cloud.aiplatform.v1.feature_monitoring_stats_pb2.FeatureStatsAnomaly]:
        ...
        def __init__(self,
            *,
            feature_display_name : typing.Text = ...,
            threshold : typing.Optional[google.cloud.aiplatform.v1.model_monitoring_pb2.ThresholdConfig] = ...,
            training_stats : typing.Optional[google.cloud.aiplatform.v1.feature_monitoring_stats_pb2.FeatureStatsAnomaly] = ...,
            prediction_stats : typing.Optional[typing.Iterable[google.cloud.aiplatform.v1.feature_monitoring_stats_pb2.FeatureStatsAnomaly]] = ...,
            ) -> None: ...
