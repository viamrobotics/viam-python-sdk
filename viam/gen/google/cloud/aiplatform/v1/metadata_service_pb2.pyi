...
class CreateMetadataStoreRequest(google.protobuf.message.Message):
    ...
    @property
    def metadata_store(self) -> google.cloud.aiplatform.v1.metadata_store_pb2.MetadataStore:
    ...
    def __init__(self,
        *,
        parent : typing.Text = ...,
        metadata_store : typing.Optional[google.cloud.aiplatform.v1.metadata_store_pb2.MetadataStore] = ...,
        metadata_store_id : typing.Text = ...,
        ) -> None: ...
...
class ListMetadataStoresResponse(google.protobuf.message.Message):
    ...
    @property
    def metadata_stores(self) -> google.protobuf.internal.containers.RepeatedCompositeFieldContainer[google.cloud.aiplatform.v1.metadata_store_pb2.MetadataStore]:
    ...
    def __init__(self,
        *,
        metadata_stores : typing.Optional[typing.Iterable[google.cloud.aiplatform.v1.metadata_store_pb2.MetadataStore]] = ...,
        next_page_token : typing.Text = ...,
        ) -> None: ...
...
class CreateArtifactRequest(google.protobuf.message.Message):
    ...
    @property
    def artifact(self) -> google.cloud.aiplatform.v1.artifact_pb2.Artifact:
    ...
    def __init__(self,
        *,
        parent : typing.Text = ...,
        artifact : typing.Optional[google.cloud.aiplatform.v1.artifact_pb2.Artifact] = ...,
        artifact_id : typing.Text = ...,
        ) -> None: ...
...
class CreateContextRequest(google.protobuf.message.Message):
    ...
    @property
    def context(self) -> google.cloud.aiplatform.v1.context_pb2.Context:
    ...
    def __init__(self,
        *,
        parent : typing.Text = ...,
        context : typing.Optional[google.cloud.aiplatform.v1.context_pb2.Context] = ...,
        context_id : typing.Text = ...,
        ) -> None: ...
...
class ListContextsResponse(google.protobuf.message.Message):
    ...
    NEXT_PAGE_TOKEN_FIELD_NUMBER: builtins.int
    @property
    def contexts(self) -> google.protobuf.internal.containers.RepeatedCompositeFieldContainer[google.cloud.aiplatform.v1.context_pb2.Context]:
    ...
    def __init__(self,
        *,
        contexts : typing.Optional[typing.Iterable[google.cloud.aiplatform.v1.context_pb2.Context]] = ...,
        next_page_token : typing.Text = ...,
        ) -> None: ...
...
class ListExecutionsResponse(google.protobuf.message.Message):
    ...
    NEXT_PAGE_TOKEN_FIELD_NUMBER: builtins.int
    @property
    def executions(self) -> google.protobuf.internal.containers.RepeatedCompositeFieldContainer[google.cloud.aiplatform.v1.execution_pb2.Execution]:
    ...
    def __init__(self,
        *,
        executions : typing.Optional[typing.Iterable[google.cloud.aiplatform.v1.execution_pb2.Execution]] = ...,
        next_page_token : typing.Text = ...,
        ) -> None: ...
...
class AddExecutionEventsRequest(google.protobuf.message.Message):
    ...
    @property
    def events(self) -> google.protobuf.internal.containers.RepeatedCompositeFieldContainer[google.cloud.aiplatform.v1.event_pb2.Event]:
        """The Events to create and add."""
        pass
    def __init__(self,
        *,
        execution : typing.Text = ...,
        events : typing.Optional[typing.Iterable[google.cloud.aiplatform.v1.event_pb2.Event]] = ...,
        ) -> None: ...
...
class CreateMetadataSchemaRequest(google.protobuf.message.Message):
    ...
    @property
    def metadata_schema(self) -> google.cloud.aiplatform.v1.metadata_schema_pb2.MetadataSchema:
    ...
    def __init__(self,
        *,
        parent : typing.Text = ...,
        metadata_schema : typing.Optional[google.cloud.aiplatform.v1.metadata_schema_pb2.MetadataSchema] = ...,
        metadata_schema_id : typing.Text = ...,
        ) -> None: ...
...
class ListMetadataSchemasResponse(google.protobuf.message.Message):
    ...
    NEXT_PAGE_TOKEN_FIELD_NUMBER: builtins.int
    @property
    def metadata_schemas(self) -> google.protobuf.internal.containers.RepeatedCompositeFieldContainer[google.cloud.aiplatform.v1.metadata_schema_pb2.MetadataSchema]:
    ...
    def __init__(self,
        *,
        metadata_schemas : typing.Optional[typing.Iterable[google.cloud.aiplatform.v1.metadata_schema_pb2.MetadataSchema]] = ...,
        next_page_token : typing.Text = ...,
        ) -> None: ...
