...
class UploadModelRequest(google.protobuf.message.Message):
    ...
    @property
    def model(self) -> google.cloud.aiplatform.v1beta1.model_pb2.Model:
        """Required. The Model to create."""
        pass
    def __init__(self,
        *,
        parent : typing.Text = ...,
        model : typing.Optional[google.cloud.aiplatform.v1beta1.model_pb2.Model] = ...,
        ) -> None: ...
...
class ListModelsResponse(google.protobuf.message.Message):
    ...
    @property
    def models(self) -> google.protobuf.internal.containers.RepeatedCompositeFieldContainer[google.cloud.aiplatform.v1beta1.model_pb2.Model]:
    ...
    def __init__(self,
        *,
        models : typing.Optional[typing.Iterable[google.cloud.aiplatform.v1beta1.model_pb2.Model]] = ...,
        next_page_token : typing.Text = ...,
        ) -> None: ...
...
class ExportModelRequest(google.protobuf.message.Message):
    ...
    class OutputConfig(google.protobuf.message.Message):
        ...
        @property
        def artifact_destination(self) -> google.cloud.aiplatform.v1beta1.io_pb2.GcsDestination:
            ...
            pass
        @property
        def image_destination(self) -> google.cloud.aiplatform.v1beta1.io_pb2.ContainerRegistryDestination:
        ...
        def __init__(self,
            *,
            export_format_id : typing.Text = ...,
            artifact_destination : typing.Optional[google.cloud.aiplatform.v1beta1.io_pb2.GcsDestination] = ...,
            image_destination : typing.Optional[google.cloud.aiplatform.v1beta1.io_pb2.ContainerRegistryDestination] = ...,
            ) -> None: ...
...
class ListModelEvaluationsResponse(google.protobuf.message.Message):
    ...
    NEXT_PAGE_TOKEN_FIELD_NUMBER: builtins.int
    @property
    def model_evaluations(self) -> google.protobuf.internal.containers.RepeatedCompositeFieldContainer[google.cloud.aiplatform.v1beta1.model_evaluation_pb2.ModelEvaluation]:
    ...
    def __init__(self,
        *,
        model_evaluations : typing.Optional[typing.Iterable[google.cloud.aiplatform.v1beta1.model_evaluation_pb2.ModelEvaluation]] = ...,
        next_page_token : typing.Text = ...,
        ) -> None: ...
...
class ListModelEvaluationSlicesResponse(google.protobuf.message.Message):
    ...
    NEXT_PAGE_TOKEN_FIELD_NUMBER: builtins.int
    @property
    def model_evaluation_slices(self) -> google.protobuf.internal.containers.RepeatedCompositeFieldContainer[google.cloud.aiplatform.v1beta1.model_evaluation_slice_pb2.ModelEvaluationSlice]:
        """List of ModelEvaluations in the requested page."""
        pass
    next_page_token: typing.Text = ...
    """A token to retrieve next page of results.
    ...
    def __init__(self,
        *,
        model_evaluation_slices : typing.Optional[typing.Iterable[google.cloud.aiplatform.v1beta1.model_evaluation_slice_pb2.ModelEvaluationSlice]] = ...,
        next_page_token : typing.Text = ...,
        ) -> None: ...
