...
class TrainingPipeline(google.protobuf.message.Message):
    ...
    def training_task_metadata(self) -> google.protobuf.struct_pb2.Value:
        ...
        pass
    @property
    def model_to_upload(self) -> google.cloud.aiplatform.v1beta1.model_pb2.Model:
    ...
    def __init__(self,
        *,
        ...
        model_to_upload : typing.Optional[google.cloud.aiplatform.v1beta1.model_pb2.Model] = ...,
        state : google.cloud.aiplatform.v1beta1.pipeline_state_pb2.PipelineState.ValueType = ...,
