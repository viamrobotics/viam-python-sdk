...
import google.cloud.aiplatform.v1beta1.pipeline_state_pb2
import google.cloud.aiplatform.v1beta1.value_pb2
...
class PipelineJob(google.protobuf.message.Message):
    ...
    class RuntimeConfig(google.protobuf.message.Message):
        ...
        class ParametersEntry(google.protobuf.message.Message):
            ...
            key: typing.Text = ...
            @property
            def value(self) -> google.cloud.aiplatform.v1beta1.value_pb2.Value: ...
            def __init__(self,
                *,
                key : typing.Text = ...,
                value : typing.Optional[google.cloud.aiplatform.v1beta1.value_pb2.Value] = ...,
                ) -> None: ...
        ...
        @property
        def parameters(self) -> google.protobuf.internal.containers.MessageMap[typing.Text, google.cloud.aiplatform.v1beta1.value_pb2.Value]:
        ...
        def __init__(self,
            *,
            parameters : typing.Optional[typing.Mapping[typing.Text, google.cloud.aiplatform.v1beta1.value_pb2.Value]] = ...,
            gcs_output_directory : typing.Text = ...,
    ...
    def pipeline_spec(self) -> google.protobuf.struct_pb2.Struct:
        ...
        pass
    state: google.cloud.aiplatform.v1beta1.pipeline_state_pb2.PipelineState.ValueType = ...
...
class PipelineJobDetail(google.protobuf.message.Message):
    ...
    @property
    def pipeline_context(self) -> google.cloud.aiplatform.v1beta1.context_pb2.Context:
        """Output only. The context of the pipeline."""
        pass
    @property
    def pipeline_run_context(self) -> google.cloud.aiplatform.v1beta1.context_pb2.Context:
    ...
    def __init__(self,
        *,
        pipeline_context : typing.Optional[google.cloud.aiplatform.v1beta1.context_pb2.Context] = ...,
        pipeline_run_context : typing.Optional[google.cloud.aiplatform.v1beta1.context_pb2.Context] = ...,
