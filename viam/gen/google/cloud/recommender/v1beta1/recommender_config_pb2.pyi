...
class RecommenderConfig(google.protobuf.message.Message):
    ...
    RECOMMENDER_GENERATION_CONFIG_FIELD_NUMBER: builtins.int
    ...
    @property
    def recommender_generation_config(self) -> global___RecommenderGenerationConfig:
    ...
    def __init__(self,
        *,
        name : typing.Text = ...,
        recommender_generation_config : typing.Optional[global___RecommenderGenerationConfig] = ...,
        etag : typing.Text = ...,
    ...
    def HasField(self, field_name: typing_extensions.Literal["recommender_generation_config",b"recommender_generation_config","update_time",b"update_time"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["annotations",b"annotations","display_name",b"display_name","etag",b"etag","name",b"name","recommender_generation_config",b"recommender_generation_config","revision_id",b"revision_id","update_time",b"update_time"]) -> None: ...
global___RecommenderConfig = RecommenderConfig

class RecommenderGenerationConfig(google.protobuf.message.Message):
...
global___RecommenderGenerationConfig = RecommenderGenerationConfig
