...
class ProcessDocumentRequest(google.protobuf.message.Message):
    ...
    AUTOML_PARAMS_FIELD_NUMBER: builtins.int
    parent: typing.Text = ...
    """Target project and location to make a call.
    ...
    def ocr_params(self) -> global___OcrParams:
        ...
        pass
    @property
    def automl_params(self) -> global___AutoMlParams:
    ...
    def __init__(self,
        *,
        ...
        automl_params : typing.Optional[global___AutoMlParams] = ...,
        ) -> None: ...
    def HasField(self, field_name: typing_extensions.Literal["automl_params",b"automl_params","entity_extraction_params",b"entity_extraction_params","form_extraction_params",b"form_extraction_params","input_config",b"input_config","ocr_params",b"ocr_params","output_config",b"output_config","table_extraction_params",b"table_extraction_params"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["automl_params",b"automl_params","document_type",b"document_type","entity_extraction_params",b"entity_extraction_params","form_extraction_params",b"form_extraction_params","input_config",b"input_config","ocr_params",b"ocr_params","output_config",b"output_config","parent",b"parent","table_extraction_params",b"table_extraction_params"]) -> None: ...
...
class TableBoundHint(google.protobuf.message.Message):
    ...
    @property
    def bounding_box(self) -> google.cloud.documentai.v1beta2.geometry_pb2.BoundingPoly:
    ...
    def __init__(self,
        *,
        page_number : builtins.int = ...,
        bounding_box : typing.Optional[google.cloud.documentai.v1beta2.geometry_pb2.BoundingPoly] = ...,
        ) -> None: ...
...
class AutoMlParams(google.protobuf.message.Message):
...
global___AutoMlParams = AutoMlParams
...
class InputConfig(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing_extensions.Literal["contents",b"contents","gcs_source",b"gcs_source","source",b"source"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["contents",b"contents","gcs_source",b"gcs_source","mime_type",b"mime_type","source",b"source"]) -> None: ...
    def WhichOneof(self, oneof_group: typing_extensions.Literal["source",b"source"]) -> typing.Optional[typing_extensions.Literal["gcs_source","contents"]]: ...
