...
class ClassificationEvaluationMetrics(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing_extensions.Literal["annotation_spec_id",b"annotation_spec_id","au_prc",b"au_prc","au_roc",b"au_roc","confidence_metrics_entry",b"confidence_metrics_entry","confusion_matrix",b"confusion_matrix","log_loss",b"log_loss"]) -> None: ...
