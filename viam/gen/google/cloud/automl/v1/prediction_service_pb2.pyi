...
class PredictRequest(google.protobuf.message.Message):
    ...
    @property
    def payload(self) -> google.cloud.automl.v1.data_items_pb2.ExamplePayload:
    ...
    def __init__(self,
        *,
        name : typing.Text = ...,
        payload : typing.Optional[google.cloud.automl.v1.data_items_pb2.ExamplePayload] = ...,
...
class PredictResponse(google.protobuf.message.Message):
    ...
    @property
    def payload(self) -> google.protobuf.internal.containers.RepeatedCompositeFieldContainer[google.cloud.automl.v1.annotation_payload_pb2.AnnotationPayload]:
        """Prediction result.
        ...
        pass
    @property
    def preprocessed_input(self) -> google.cloud.automl.v1.data_items_pb2.ExamplePayload:
    ...
    def __init__(self,
        *,
        payload : typing.Optional[typing.Iterable[google.cloud.automl.v1.annotation_payload_pb2.AnnotationPayload]] = ...,
        preprocessed_input : typing.Optional[google.cloud.automl.v1.data_items_pb2.ExamplePayload] = ...,
...
class BatchPredictRequest(google.protobuf.message.Message):
    ...
    def input_config(self) -> google.cloud.automl.v1.io_pb2.BatchPredictInputConfig:
        ...
        pass
    @property
    def output_config(self) -> google.cloud.automl.v1.io_pb2.BatchPredictOutputConfig:
    ...
    def __init__(self,
        *,
        ...
        output_config : typing.Optional[google.cloud.automl.v1.io_pb2.BatchPredictOutputConfig] = ...,
        params : typing.Optional[typing.Mapping[typing.Text, typing.Text]] = ...,
        ) -> None: ...
