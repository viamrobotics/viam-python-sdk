...
class InputConfig(google.protobuf.message.Message):
    ...
    **Input field definitions:**
    ...
    def ClearField(self, field_name: typing_extensions.Literal["gcs_source",b"gcs_source","params",b"params","source",b"source"]) -> None: ...
...
class ModelExportOutputConfig(google.protobuf.message.Message):
    ...
    * core_ml - Used for iOS mobile devices.
    ...
    def HasField(self, field_name: typing_extensions.Literal["destination",b"destination","gcs_destination",b"gcs_destination"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["destination",b"destination","gcs_destination",b"gcs_destination","model_format",b"model_format","params",b"params"]) -> None: ...
    def WhichOneof(self, oneof_group: typing_extensions.Literal["destination",b"destination"]) -> typing.Optional[typing_extensions.Literal["gcs_destination"]]: ...
