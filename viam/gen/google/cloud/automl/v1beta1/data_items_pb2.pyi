...
class Image(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing_extensions.Literal["data",b"data","image_bytes",b"image_bytes","input_config",b"input_config"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["data",b"data","image_bytes",b"image_bytes","input_config",b"input_config","thumbnail_uri",b"thumbnail_uri"]) -> None: ...
    def WhichOneof(self, oneof_group: typing_extensions.Literal["data",b"data"]) -> typing.Optional[typing_extensions.Literal["image_bytes","input_config"]]: ...
...
class Document(google.protobuf.message.Message):
    ...
    class Layout(google.protobuf.message.Message):
        ...
        @property
        def bounding_poly(self) -> google.cloud.automl.v1beta1.geometry_pb2.BoundingPoly:
        ...
        def __init__(self,
            *,
            ...
            page_number : builtins.int = ...,
            bounding_poly : typing.Optional[google.cloud.automl.v1beta1.geometry_pb2.BoundingPoly] = ...,
            text_segment_type : global___Document.Layout.TextSegmentType.ValueType = ...,
            ) -> None: ...
    ...
    @property
    def input_config(self) -> google.cloud.automl.v1beta1.io_pb2.DocumentInputConfig:
    ...
    def __init__(self,
        *,
        input_config : typing.Optional[google.cloud.automl.v1beta1.io_pb2.DocumentInputConfig] = ...,
...
class Row(google.protobuf.message.Message):
    ...
    DESCRIPTOR: google.protobuf.descriptor.Descriptor = ...
    COLUMN_SPEC_IDS_FIELD_NUMBER: builtins.int
    VALUES_FIELD_NUMBER: builtins.int
    @property
    def column_spec_ids(self) -> google.protobuf.internal.containers.RepeatedScalarFieldContainer[typing.Text]:
    ...
    def __init__(self,
        *,
        column_spec_ids : typing.Optional[typing.Iterable[typing.Text]] = ...,
        values : typing.Optional[typing.Iterable[google.protobuf.struct_pb2.Value]] = ...,
        ) -> None: ...
    def ClearField(self, field_name: typing_extensions.Literal["column_spec_ids",b"column_spec_ids","values",b"values"]) -> None: ...
global___Row = Row
...
class ExamplePayload(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing_extensions.Literal["document",b"document","image",b"image","payload",b"payload","row",b"row","text_snippet",b"text_snippet"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["document",b"document","image",b"image","payload",b"payload","row",b"row","text_snippet",b"text_snippet"]) -> None: ...
    def WhichOneof(self, oneof_group: typing_extensions.Literal["payload",b"payload"]) -> typing.Optional[typing_extensions.Literal["image","text_snippet","document","row"]]: ...
