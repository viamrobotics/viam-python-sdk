...
class ImageClassificationDatasetMetadata(google.protobuf.message.Message):
    ...
    classification_type: google.cloud.automl.v1beta1.classification_pb2.ClassificationType.ValueType = ...
...
class ImageClassificationModelMetadata(google.protobuf.message.Message):
    ...
    TRAIN_BUDGET_FIELD_NUMBER: builtins.int
    TRAIN_COST_FIELD_NUMBER: builtins.int
    ...
    *   `mobile-core-ml-high-accuracy-1` - A model that, in addition to
    ...
    def ClearField(self, field_name: typing_extensions.Literal["base_model_id",b"base_model_id","model_type",b"model_type","node_count",b"node_count","node_qps",b"node_qps","stop_reason",b"stop_reason","train_budget",b"train_budget","train_cost",b"train_cost"]) -> None: ...
