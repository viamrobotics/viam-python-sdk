...
"""
import builtins
import google.cloud.networkservices.v1.common_pb2
...
class EndpointPolicy(google.protobuf.message.Message):
    ...
    @property
    def endpoint_matcher(self) -> google.cloud.networkservices.v1.common_pb2.EndpointMatcher:
        """Required. A matcher that selects endpoints to which the policies should be applied."""
        pass
    @property
    def traffic_port_selector(self) -> google.cloud.networkservices.v1.common_pb2.TrafficPortSelector:
    ...
    def __init__(self,
        *,
        ...
        type : global___EndpointPolicy.EndpointPolicyType.ValueType = ...,
        authorization_policy : typing.Text = ...,
        endpoint_matcher : typing.Optional[google.cloud.networkservices.v1.common_pb2.EndpointMatcher] = ...,
        traffic_port_selector : typing.Optional[google.cloud.networkservices.v1.common_pb2.TrafficPortSelector] = ...,
        description : typing.Text = ...,
        server_tls_policy : typing.Text = ...,
        client_tls_policy : typing.Text = ...,
        ) -> None: ...
